...
static void test_load_and_exchange() {
    ...
    if (z8001()) {
        ...
        TEST("LDA", "R8, %1234",      0x7608, 0x1234);
    ...
    if (z8001()) {
        ...
        ERRT("", "R15, @RR2, #2",          OVERFLOW_RANGE, 0x1C21, 0x0F01);
        ...
        ERRT("", "@RR2, R15, #2",          OVERFLOW_RANGE,  0x1C29, 0x0F01);
    } else {
        TEST("LDM", "R9, @R2, #7",        0x1C21, 0x0906);
        ERRT("", "R9, @R2, #8",        OVERFLOW_RANGE, 0x1C21, 0x0907);
        ...
        ERRT("", "@R2, R9, #8",        OVERFLOW_RANGE, 0x1C29, 0x0907);
    ...
    if (z8001()) {
        ...
        ERRT("POP",  "R5, @RR4", REGISTERS_OVERLAPPED,             0x9745);
        ERRT("POP",  "@RR4, @RR4", REGISTERS_OVERLAPPED,           0x1744);
        ERRT("POP",  "|%120034|(R4), @RR4", REGISTERS_OVERLAPPED,  0x5744, 0x1234);
        ERRT("POPL", "RR4, @RR4", REGISTERS_OVERLAPPED,            0x9544);
        ERRT("POPL", "@RR4, @RR4", REGISTERS_OVERLAPPED,           0x1544);
        ERRT("POPL", "|%120034|(R5), @RR4", REGISTERS_OVERLAPPED,  0x5545, 0x1234);
    } else {
        ...
        ERRT("POP",  "R4,@R4", REGISTERS_OVERLAPPED,          0x9744);
        ERRT("POP",  "@R4,@R4", REGISTERS_OVERLAPPED,         0x1744);
        ERRT("POP",  "%1234(R4), @R4", REGISTERS_OVERLAPPED,  0x5744, 0x1234);
        ERRT("POPL", "RR2, @R3", REGISTERS_OVERLAPPED,        0x9532);
        ERRT("POPL", "@R4, @R4", REGISTERS_OVERLAPPED,        0x1544);
        ERRT("POPL", "%1234(R4), @R4", REGISTERS_OVERLAPPED,  0x5544, 0x1234);
    }
    ...
    if (z8001()) {
        ...
        ERRT("PUSH",  "@RR4, R5", REGISTERS_OVERLAPPED,             0x9345);
        ERRT("PUSH",  "@RR4, @RR4", REGISTERS_OVERLAPPED,           0x1344);
        ERRT("PUSH",  "@RR4, |%120034|(R4)", REGISTERS_OVERLAPPED,  0x5344, 0x1234);
        ERRT("PUSHL", "@RR4, RR4", REGISTERS_OVERLAPPED,            0x9144);
        ERRT("PUSHL", "@RR4, @RR4", REGISTERS_OVERLAPPED,           0x1144);
        ERRT("PUSHL", "@RR4, |%120034|(R5)", REGISTERS_OVERLAPPED,  0x5145, 0x1234);
    } else {
        ...
        ERRT("PUSH",  "@R4, R4", REGISTERS_OVERLAPPED,       0x9344);
        ERRT("PUSH",  "@R4, @R4", REGISTERS_OVERLAPPED,        0x1344);
        ERRT("PUSH",  "@R4, %1234(R4)", REGISTERS_OVERLAPPED,  0x5344, 0x1234);
        ERRT("PUSHL", "@R5, RR4", REGISTERS_OVERLAPPED,        0x9154);
        ERRT("PUSHL", "@R4, @R4", REGISTERS_OVERLAPPED,        0x1144);
        ERRT("PUSHL", "@R4, %1234(R4)", REGISTERS_OVERLAPPED,  0x5144, 0x1234);
    }
}
...
static void test_arithmetic() {
    ...
    ERRT("EXTS",  "RR7", ILLEGAL_REGISTER,  0xB17A);
    ERRT("EXTS",  "RR15", ILLEGAL_REGISTER, 0xB1FA);
    ERRT("EXTSL", "RQ6", ILLEGAL_REGISTER,  0xB167);
    ERRT("EXTSL", "RQ14", ILLEGAL_REGISTER, 0xB1E7);
...
static void test_bit_manipulation() {
    ...
    ERRT("BITB", "RL2, #8", ILLEGAL_BIT_NUMBER,0xA6A8);
    TEST("BITB", "RL2, R1", 0x2601, 0x0A00);
    ERRT("BITB", "RL2, R8", REGISTER_NOT_ALLOWED, 0x2608, 0x0A00);
    if (z8001()) {
    ...
    ERRT("RESB", "RL2, #8", ILLEGAL_BIT_NUMBER, 0xA2A8);
    TEST("RESB", "RL2, R1", 0x2201, 0x0A00);
    ERRT("RESB", "RL2, R8", REGISTER_NOT_ALLOWED, 0x2208, 0x0A00);
    if (z8001()) {
    ...
    ERRT("SETB", "RL2, #8", ILLEGAL_BIT_NUMBER, 0xA4AF);
    TEST("SETB", "RL2, R1", 0x2401, 0x0A00);
    ERRT("SETB", "RL2, R8", REGISTER_NOT_ALLOWED, 0x2408, 0x0A00);
    if (z8001()) {
...
static void test_shift() {
    ...
    ERRT("SLA", "R2, #17", ILLEGAL_OPERAND,   0xB329, 0x0011);
    TEST("SLAB", "RH2, #8",  0xB229, 0x0008);
    ERRT("SLAB", "RH2, #9", ILLEGAL_OPERAND,  0xB229, 0x0009);
    TEST("SLAL", "RR2, #32", 0xB32D, 0x0020);
    ERRT("SLAL", "RR2, #33", ILLEGAL_OPERAND, 0xB32D, 0x0021);

    // Shift Right Arithmetic
    TEST("SRA", "R2, #16",   0xB329, 0xFFF0);
    ERRT("SRA", "R2, #17", ILLEGAL_OPERAND,   0xB329, 0xFFEF);
    TEST("SRAB", "RH2, #8",  0xB229, 0x00F8);
    ERRT("SRAB", "RH2, #9", ILLEGAL_OPERAND,  0xB229, 0x00F7);
    TEST("SRAL", "RR2, #32", 0xB32D, 0xFFE0);
    ERRT("SRAL", "RR2, #33", ILLEGAL_OPERAND, 0xB32D, 0xFFDF);

    // Shift Left Logical
    TEST("SLL", "R2, #16",   0xB321, 0x0010);
    ERRT("SLL", "R2, #17", ILLEGAL_OPERAND,   0xB321, 0x0011);
    TEST("SLLB", "RH2, #8",  0xB221, 0x0008);
    ERRT("SLLB", "RH2, #9", ILLEGAL_OPERAND,  0xB221, 0x0009);
    TEST("SLLL", "RR2, #32", 0xB325, 0x0020);
    ERRT("SLLL", "RR2, #33", ILLEGAL_OPERAND, 0xB325, 0x0021);

    // Shift Right Logical
    TEST("SRL", "R2, #16",   0xB321, 0xFFF0);
    ERRT("SRL", "R2, #17", ILLEGAL_OPERAND,   0xB321, 0xFFEF);
    TEST("SRLB", "RH2, #8",  0xB221, 0x00F8);
    ERRT("SRLB", "RH2, #9", ILLEGAL_OPERAND,  0xB221, 0x00F7);
    TEST("SRLL", "RR2, #32", 0xB325, 0xFFE0);
    ERRT("SRLL", "RR2, #33", ILLEGAL_OPERAND, 0xB325, 0xFFDF);
}
...
static void test_compare_block() {
    ...
    if (z8001()) {
        ...
        ERRT("",  "R2, @RR0, R4, F",   REGISTER_NOT_ALLOWED, 0xBB08, 0x0420);
        ERRT("",  "R2, @RR2, R4, F",   REGISTERS_OVERLAPPED, 0xBB28, 0x0420);
        ERRT("",  "R1, @RR2, R1, F",   REGISTERS_OVERLAPPED, 0xBB28, 0x0110);
        ERRT("",  "R1, @RR2, R2, F",   REGISTERS_OVERLAPPED, 0xBB28, 0x0210);
        TEST("CPDB", "RH5, @RR2, R4, LT", 0xBA28, 0x0451);
        TEST("CPDB", "RH0, @RR2, R4, LT", 0xBA28, 0x0401);
        TEST("CPDB", "RH5, @RR2, R0, LT", 0xBA28, 0x0051);
        ERRT("", "RH5, @RR0, R4, LT", REGISTER_NOT_ALLOWED, 0xBA08, 0x0451);
        ERRT("", "RH3, @RR2, R4, LT", REGISTERS_OVERLAPPED, 0xBA28, 0x0431);
        ERRT("", "RH5, @RR2, R5, LT", REGISTERS_OVERLAPPED, 0xBA28, 0x0551);
        ERRT("", "RH5, @RR2, R3, LT", REGISTERS_OVERLAPPED, 0xBA28, 0x0351);
    } else {
        TEST("CPD",  "R3, @R1, R2, F",   0xBB18, 0x0230);
        TEST("CPD",  "R0, @R1, R2, F",   0xBB18, 0x0200);
        TEST("CPD",  "R3, @R1, R0, F",   0xBB18, 0x0030);
        ERRT("",  "R2, @R0, R4, F",   REGISTER_NOT_ALLOWED, 0xBB08, 0x0420);
        ERRT("",  "R3, @R3, R2, F",   REGISTERS_OVERLAPPED, 0xBB38, 0x0230);
        ERRT("",  "R3, @R1, R3, F",   REGISTERS_OVERLAPPED, 0xBB18, 0x0330);
        ERRT("",  "R3, @R1, R1, F",   REGISTERS_OVERLAPPED, 0xBB18, 0x0130);
        TEST("CPDB", "RL3, @R1, R2, LT", 0xBA18, 0x02B1);
        TEST("CPDB", "RL0, @R1, R2, LT", 0xBA18, 0x0281);
        TEST("CPDB", "RL3, @R1, R0, LT", 0xBA18, 0x00B1);
        ERRT("", "RL0, @R0, R4, LT", REGISTER_NOT_ALLOWED, 0xBA08, 0x0481);
        ERRT("", "RL3, @R3, R2, LT", REGISTERS_OVERLAPPED, 0xBA38, 0x02B1);
        ERRT("", "RL3, @R1, R3, LT", REGISTERS_OVERLAPPED, 0xBA18, 0x03B1);
        ERRT("", "RL3, @R1, R1, LT", REGISTERS_OVERLAPPED, 0xBA18, 0x01B1);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "R1, @RR0, R4, LE",   REGISTER_NOT_ALLOWED, 0xBB0C, 0x0412);
        ERRT("",  "R5, @RR4, R3, LE",   REGISTERS_OVERLAPPED, 0xBB4C, 0x0352);
        ERRT("",  "R1, @RR4, R1, LE",   REGISTERS_OVERLAPPED, 0xBB4C, 0x0112);
        ERRT("",  "R1, @RR4, R4, LE",   REGISTERS_OVERLAPPED, 0xBB4C, 0x0412);
        TEST("CPDRB", "RL1, @RR4, R3, ULE", 0xBA4C, 0x0393);
        TEST("CPDRB", "RL0, @RR4, R3, ULE", 0xBA4C, 0x0383);
        TEST("CPDRB", "RL1, @RR4, R0, ULE", 0xBA4C, 0x0093);
        ERRT("", "RL1, @RR0, R4, ULE", REGISTER_NOT_ALLOWED, 0xBA0C, 0x0493);
        ERRT("", "RL5, @RR4, R3, ULE", REGISTERS_OVERLAPPED, 0xBA4C, 0x03D3);
        ERRT("", "RL1, @RR4, R1, ULE", REGISTERS_OVERLAPPED, 0xBA4C, 0x0193);
        ERRT("", "RL1, @RR4, R4, ULE", REGISTERS_OVERLAPPED, 0xBA4C, 0x0493);
    } else {
        TEST("CPDR",  "R3, @R4, R5, LE",   0xBB4C, 0x0532);
        TEST("CPDR",  "R0, @R4, R5, LE",   0xBB4C, 0x0502);
        TEST("CPDR",  "R3, @R4, R0, LE",   0xBB4C, 0x0032);
        ERRT("",  "R1, @R0, R4, LE",   REGISTER_NOT_ALLOWED, 0xBB0C, 0x0412);
        ERRT("",  "R3, @R3, R5, LE",   REGISTERS_OVERLAPPED, 0xBB3C, 0x0532);
        ERRT("",  "R3, @R4, R3, LE",   REGISTERS_OVERLAPPED, 0xBB4C, 0x0332);
        ERRT("",  "R3, @R4, R4, LE",   REGISTERS_OVERLAPPED, 0xBB4C, 0x0432);
        TEST("CPDRB", "RL3, @R4, R5, ULE", 0xBA4C, 0x05B3);
        TEST("CPDRB", "RL0, @R4, R5, ULE", 0xBA4C, 0x0583);
        TEST("CPDRB", "RL3, @R4, R0, ULE", 0xBA4C, 0x00B3);
        ERRT("", "RL1, @R0, R4, ULE", REGISTER_NOT_ALLOWED, 0xBA0C, 0x0493);
        ERRT("", "RL3, @R3, R5, ULE", REGISTERS_OVERLAPPED, 0xBA3C, 0x05B3);
        ERRT("", "RL3, @R4, R3, ULE", REGISTERS_OVERLAPPED, 0xBA4C, 0x03B3);
        ERRT("", "RL3, @R4, R4, ULE", REGISTERS_OVERLAPPED, 0xBA4C, 0x04B3);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "R1, @RR0, R4, OV", REGISTER_NOT_ALLOWED, 0xBB00, 0x0414);
        ERRT("",  "R7, @RR6, R4, OV", REGISTERS_OVERLAPPED, 0xBB60, 0x0474);
        ERRT("",  "R2, @RR6, R2, OV", REGISTERS_OVERLAPPED, 0xBB60, 0x0224);
        ERRT("",  "R2, @RR6, R6, OV", REGISTERS_OVERLAPPED, 0xBB60, 0x0624);
        TEST("CPIB", "RL2, @RR6, R4",   0xBA60, 0x04A8);
        TEST("CPIB", "RL0, @RR6, R4",   0xBA60, 0x0488);
        TEST("CPIB", "RL2, @RR6, R0",   0xBA60, 0x00A8);
        ERRT("", "RL1, @RR0, R4",   REGISTER_NOT_ALLOWED, 0xBA00, 0x0498);
        ERRT("", "RL7, @RR6, R4",   REGISTERS_OVERLAPPED, 0xBA60, 0x04F8);
        ERRT("", "RL2, @RR6, R2",   REGISTERS_OVERLAPPED, 0xBA60, 0x02A8);
        ERRT("", "RL2, @RR6, R7",   REGISTERS_OVERLAPPED, 0xBA60, 0x07A8);
    } else {
        TEST("CPI",  "R6, @R7, R8, OV", 0xBB70, 0x0864);
        TEST("CPI",  "R0, @R7, R8, OV", 0xBB70, 0x0804);
        TEST("CPI",  "R6, @R7, R0, OV", 0xBB70, 0x0064);
        ERRT("",  "R2, @R0, R4, OV", REGISTER_NOT_ALLOWED, 0xBB00, 0x0424);
        ERRT("",  "R6, @R6, R8, OV", REGISTERS_OVERLAPPED, 0xBB60, 0x0864);
        ERRT("",  "R6, @R7, R6, OV", REGISTERS_OVERLAPPED, 0xBB70, 0x0664);
        ERRT("",  "R6, @R7, R7, OV", REGISTERS_OVERLAPPED, 0xBB70, 0x0764);
        TEST("CPIB", "RL6, @R7, R8",   0xBA70, 0x08E8);
        TEST("CPIB", "RL0, @R7, R8",   0xBA70, 0x0888);
        TEST("CPIB", "RL6, @R7, R0",   0xBA70, 0x00E8);
        ERRT("", "RL0, @R0, R4",   REGISTER_NOT_ALLOWED, 0xBA00, 0x0488);
        ERRT("", "RL6, @R6, R8",   REGISTERS_OVERLAPPED, 0xBA60, 0x08E8);
        ERRT("", "RL6, @R7, R6",   REGISTERS_OVERLAPPED, 0xBA70, 0x06E8);
        ERRT("", "RL6, @R7, R7",   REGISTERS_OVERLAPPED, 0xBA70, 0x07E8);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "R1, @RR0, R4, Z",  REGISTER_NOT_ALLOWED, 0xBB04, 0x0416);
        ERRT("",  "R8, @RR8, R5, Z",  REGISTERS_OVERLAPPED, 0xBB84, 0x0586);
        ERRT("",  "R3, @RR8, R3, Z",  REGISTERS_OVERLAPPED, 0xBB84, 0x0336);
        ERRT("",  "R3, @RR8, R9, Z",  REGISTERS_OVERLAPPED, 0xBB84, 0x0936);
        TEST("CPIRB", "RL3, @RR8, R5, C", 0xBA84, 0x05B7);
        TEST("CPIRB", "RL0, @RR8, R5, C", 0xBA84, 0x0587);
        TEST("CPIRB", "RL3, @RR8, R0, C", 0xBA84, 0x00B7);
        ERRT("", "RL1, @RR0, R4, C", REGISTER_NOT_ALLOWED, 0xBA04, 0x0497);
        ERRT("", "RL2, @RR2, R5, C", REGISTERS_OVERLAPPED, 0xBA24, 0x05A7);
        ERRT("", "RL3, @RR8, R3, C", REGISTERS_OVERLAPPED, 0xBA84, 0x03B7);
        ERRT("", "RL3, @RR8, R8, C", REGISTERS_OVERLAPPED, 0xBA84, 0x08B7);
    } else {
        TEST("CPIR",  "R9, @R10, R11, Z",  0xBBA4, 0x0B96);
        TEST("CPIR",  "R0, @R10, R11, Z",  0xBBA4, 0x0B06);
        TEST("CPIR",  "R9, @R10, R0, Z",   0xBBA4, 0x0096);
        ERRT("",  "R1, @R0, R4, LE",   REGISTER_NOT_ALLOWED, 0xBB04, 0x0412);
        ERRT("",  "R9, @R9, R11, Z",   REGISTERS_OVERLAPPED, 0xBB94, 0x0B96);
        ERRT("",  "R9, @R10, R9, Z",   REGISTERS_OVERLAPPED, 0xBBA4, 0x0996);
        ERRT("",  "R9, @R10, R10, Z",  REGISTERS_OVERLAPPED, 0xBBA4, 0x0A96);
        TEST("CPIRB", "RH1, @R10, R11, C", 0xBAA4, 0x0B17);
        TEST("CPIRB", "RH0, @R10, R11, C", 0xBAA4, 0x0B07);
        TEST("CPIRB", "RH1, @R10, R0, C",  0xBAA4, 0x0017);
        ERRT("", "RL1, @R0, R4, ULE", REGISTER_NOT_ALLOWED, 0xBA04, 0x0493);
        ERRT("", "RH2, @R2, R11, C",  REGISTERS_OVERLAPPED, 0xBA24, 0x0B27);
        ERRT("", "RH1, @R2, R1, C",   REGISTERS_OVERLAPPED, 0xBA24, 0x0117);
        ERRT("", "RH1, @R2, R2, C",   REGISTERS_OVERLAPPED, 0xBA24, 0x0217);
    }
...
static void test_block_transfer() {
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR4, R6", REGISTER_NOT_ALLOWED, 0xBB49, 0x0608);
        ERRT("",  "@RR2, @RR0, R6", REGISTER_NOT_ALLOWED, 0xBB09, 0x0628);
        ERRT("",  "@RR2, @RR2, R6", REGISTERS_OVERLAPPED, 0xBB29, 0x0628);
        ERRT("",  "@RR2, @RR4, R2", REGISTERS_OVERLAPPED, 0xBB49, 0x0228);
        ERRT("",  "@RR2, @RR4, R4", REGISTERS_OVERLAPPED, 0xBB49, 0x0428);
        TEST("LDDB", "@RR2, @RR4, R6", 0xBA49, 0x0628);
        TEST("LDDB", "@RR2, @RR4, R0", 0xBA49, 0x0028);
        ERRT("", "@RR0, @RR4, R6", REGISTER_NOT_ALLOWED, 0xBA49, 0x0608);
        ERRT("", "@RR2, @RR0, R6", REGISTER_NOT_ALLOWED, 0xBA09, 0x0628);
        ERRT("", "@RR2, @RR2, R6", REGISTERS_OVERLAPPED, 0xBA29, 0x0628);
        ERRT("", "@RR2, @RR4, R2", REGISTERS_OVERLAPPED, 0xBA49, 0x0228);
        ERRT("", "@RR2, @RR4, R4", REGISTERS_OVERLAPPED, 0xBA49, 0x0428);
    } else {
        TEST("LDD",  "@R1, @R2, R3", 0xBB29, 0x0318);
        TEST("LDD",  "@R1, @R2, R0", 0xBB29, 0x0018);
        ERRT("",  "@R0, @R2, R3", REGISTER_NOT_ALLOWED, 0xBB29, 0x0308);
        ERRT("",  "@R1, @R0, R3", REGISTER_NOT_ALLOWED, 0xBB09, 0x0318);
        ERRT("",  "@R1, @R1, R3", REGISTERS_OVERLAPPED, 0xBB19, 0x0318);
        ERRT("",  "@R1, @R2, R1", REGISTERS_OVERLAPPED, 0xBB29, 0x0118);
        ERRT("",  "@R1, @R2, R2", REGISTERS_OVERLAPPED, 0xBB29, 0x0218);
        TEST("LDDB", "@R1, @R2, R3", 0xBA29, 0x0318);
        TEST("LDDB", "@R1, @R2, R0", 0xBA29, 0x0018);
        ERRT("", "@R0, @R2, R3", REGISTER_NOT_ALLOWED, 0xBA29, 0x0308);
        ERRT("", "@R1, @R0, R3", REGISTER_NOT_ALLOWED, 0xBA09, 0x0318);
        ERRT("", "@R1, @R1, R3", REGISTERS_OVERLAPPED, 0xBA19, 0x0318);
        ERRT("", "@R1, @R2, R1", REGISTERS_OVERLAPPED, 0xBA29, 0x0118);
        ERRT("", "@R1, @R2, R2", REGISTERS_OVERLAPPED, 0xBA29, 0x0218);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR6, R8", REGISTER_NOT_ALLOWED, 0xBB69, 0x0800);
        ERRT("",  "@RR4, @RR0, R8", REGISTER_NOT_ALLOWED, 0xBB09, 0x0840);
        ERRT("",  "@RR4, @RR4, R8", REGISTERS_OVERLAPPED, 0xBB49, 0x0840);
        ERRT("",  "@RR4, @RR6, R4", REGISTERS_OVERLAPPED, 0xBB69, 0x0440);
        ERRT("",  "@RR4, @RR6, R6", REGISTERS_OVERLAPPED, 0xBB69, 0x0640);
        TEST("LDDRB", "@RR4, @RR6, R8", 0xBA69, 0x0840);
        TEST("LDDRB", "@RR4, @RR6, R0", 0xBA69, 0x0040);
        ERRT("", "@RR0, @RR6, R8", REGISTER_NOT_ALLOWED, 0xBA69, 0x0800);
        ERRT("", "@RR4, @RR0, R8", REGISTER_NOT_ALLOWED, 0xBA09, 0x0840);
        ERRT("", "@RR4, @RR4, R8", REGISTERS_OVERLAPPED, 0xBA49, 0x0840);
        ERRT("", "@RR4, @RR6, R5", REGISTERS_OVERLAPPED, 0xBA69, 0x0540);
        ERRT("", "@RR4, @RR6, R7", REGISTERS_OVERLAPPED, 0xBA69, 0x0740);
    } else {
        TEST("LDDR",  "@R4, @R5, R6", 0xBB59, 0x0640);
        TEST("LDDR",  "@R4, @R5, R0", 0xBB59, 0x0040);
        ERRT("",  "@R0, @R5, R6", REGISTER_NOT_ALLOWED, 0xBB59, 0x0600);
        ERRT("",  "@R4, @R0, R6", REGISTER_NOT_ALLOWED, 0xBB09, 0x0640);
        ERRT("",  "@R4, @R4, R6", REGISTERS_OVERLAPPED, 0xBB49, 0x0640);
        ERRT("",  "@R4, @R5, R4", REGISTERS_OVERLAPPED, 0xBB59, 0x0440);
        ERRT("",  "@R4, @R5, R5", REGISTERS_OVERLAPPED, 0xBB59, 0x0540);
        TEST("LDDRB", "@R4, @R5, R6", 0xBA59, 0x0640);
        TEST("LDDRB", "@R4, @R5, R0", 0xBA59, 0x0040);
        ERRT("", "@R0, @R5, R6", REGISTER_NOT_ALLOWED, 0xBA59, 0x0600);
        ERRT("", "@R4, @R0, R6", REGISTER_NOT_ALLOWED, 0xBA09, 0x0640);
        ERRT("", "@R4, @R4, R6", REGISTERS_OVERLAPPED, 0xBA49, 0x0640);
        ERRT("", "@R4, @R5, R4", REGISTERS_OVERLAPPED, 0xBA59, 0x0440);
        ERRT("", "@R4, @R5, R5", REGISTERS_OVERLAPPED, 0xBA59, 0x0540);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR8, R10", REGISTER_NOT_ALLOWED, 0xBB81, 0x0A08);
        ERRT("",  "@RR6, @RR0, R10", REGISTER_NOT_ALLOWED, 0xBB01, 0x0A68);
        ERRT("",  "@RR6, @RR6, R10", REGISTERS_OVERLAPPED, 0xBB61, 0x0A68);
        ERRT("",  "@RR6, @RR8, R7",  REGISTERS_OVERLAPPED, 0xBB81, 0x0768);
        ERRT("",  "@RR6, @RR8, R9",  REGISTERS_OVERLAPPED, 0xBB81, 0x0968);
        TEST("LDIB", "@RR6, @RR8, R10", 0xBA81, 0x0A68);
        TEST("LDIB", "@RR6, @RR8, R0",  0xBA81, 0x0068);
        ERRT("", "@RR0, @RR8, R10", REGISTER_NOT_ALLOWED, 0xBA81, 0x0A08);
        ERRT("", "@RR6, @RR0, R10", REGISTER_NOT_ALLOWED, 0xBA01, 0x0A68);
        ERRT("", "@RR6, @RR6, R10", REGISTERS_OVERLAPPED, 0xBA61, 0x0A68);
        ERRT("", "@RR6, @RR8, R6",  REGISTERS_OVERLAPPED, 0xBA81, 0x0668);
        ERRT("", "@RR6, @RR8, R8",  REGISTERS_OVERLAPPED, 0xBA81, 0x0868);
    } else {
        TEST("LDI",  "@R7, @R8, R9", 0xBB81, 0x0978);
        TEST("LDI",  "@R7, @R8, R0", 0xBB81, 0x0078);
        ERRT("",  "@R0, @R8, R9", REGISTER_NOT_ALLOWED, 0xBB81, 0x0908);
        ERRT("",  "@R7, @R0, R9", REGISTER_NOT_ALLOWED, 0xBB01, 0x0978);
        ERRT("",  "@R7, @R7, R9", REGISTERS_OVERLAPPED, 0xBB71, 0x0978);
        ERRT("",  "@R7, @R8, R7", REGISTERS_OVERLAPPED, 0xBB81, 0x0778);
        ERRT("",  "@R7, @R8, R8", REGISTERS_OVERLAPPED, 0xBB81, 0x0878);
        TEST("LDIB", "@R7, @R8, R9", 0xBA81, 0x0978);
        TEST("LDIB", "@R7, @R8, R0", 0xBA81, 0x0078);
        ERRT("", "@R0, @R8, R9", REGISTER_NOT_ALLOWED, 0xBA81, 0x0908);
        ERRT("", "@R7, @R0, R9", REGISTER_NOT_ALLOWED, 0xBA01, 0x0978);
        ERRT("", "@R7, @R7, R9", REGISTERS_OVERLAPPED, 0xBA71, 0x0978);
        ERRT("", "@R7, @R8, R7", REGISTERS_OVERLAPPED, 0xBA81, 0x0778);
        ERRT("", "@R7, @R8, R8", REGISTERS_OVERLAPPED, 0xBA81, 0x0878);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR10, R12", REGISTER_NOT_ALLOWED, 0xBBA1, 0x0C00);
        ERRT("",  "@RR8, @RR0, R12",  REGISTER_NOT_ALLOWED, 0xBB01, 0x0C80);
        ERRT("",  "@RR8, @RR8, R12",  REGISTERS_OVERLAPPED, 0xBB81, 0x0C80);
        ERRT("",  "@RR8, @RR10, R9",  REGISTERS_OVERLAPPED, 0xBBA1, 0x0980);
        ERRT("",  "@RR8, @RR10, R11", REGISTERS_OVERLAPPED, 0xBBA1, 0x0B80);
        TEST("LDIRB", "@RR8, @RR10, R12", 0xBAA1, 0x0C80);
        TEST("LDIRB", "@RR8, @RR10, R0",  0xBAA1, 0x0080);
        ERRT("", "@RR0, @RR10, R12", REGISTER_NOT_ALLOWED, 0xBAA1, 0x0C00);
        ERRT("", "@RR8, @RR0, R12",  REGISTER_NOT_ALLOWED, 0xBA01, 0x0C80);
        ERRT("", "@RR8, @RR8, R12",  REGISTERS_OVERLAPPED, 0xBA81, 0x0C80);
        ERRT("", "@RR8, @RR10, R8",  REGISTERS_OVERLAPPED, 0xBAA1, 0x0880);
        ERRT("", "@RR8, @RR10, R10", REGISTERS_OVERLAPPED, 0xBAA1, 0x0A80);
    } else {
        TEST("LDIR",  "@R10, @R11, R12", 0xBBB1, 0x0CA0);
        TEST("LDIR",  "@R10, @R11, R0",  0xBBB1, 0x00A0);
        ERRT("",  "@R0, @R11, R12",  REGISTER_NOT_ALLOWED, 0xBBB1, 0x0C00);
        ERRT("",  "@R10, @R0, R12",  REGISTER_NOT_ALLOWED, 0xBB01, 0x0CA0);
        ERRT("",  "@R10, @R10, R12", REGISTERS_OVERLAPPED, 0xBBA1, 0x0CA0);
        ERRT("",  "@R10, @R11, R10", REGISTERS_OVERLAPPED, 0xBBB1, 0x0AA0);
        ERRT("",  "@R10, @R11, R11", REGISTERS_OVERLAPPED, 0xBBB1, 0x0BA0);
        TEST("LDIRB", "@R10, @R11, R12", 0xBAB1, 0x0CA0);
        TEST("LDIRB", "@R10, @R11, R0",  0xBAB1, 0x00A0);
        ERRT("", "@R0, @R11, R12",  REGISTER_NOT_ALLOWED, 0xBAB1, 0x0C00);
        ERRT("", "@R10, @R0, R12",  REGISTER_NOT_ALLOWED, 0xBA01, 0x0CA0);
        ERRT("", "@R10, @R10, R12", REGISTERS_OVERLAPPED, 0xBAA1, 0x0CA0);
        ERRT("", "@R10, @R11, R10", REGISTERS_OVERLAPPED, 0xBAB1, 0x0AA0);
        ERRT("", "@R10, @R11, R11", REGISTERS_OVERLAPPED, 0xBAB1, 0x0BA0);
    }
}
...
static void test_compare_string() {
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR2, R0",    REGISTER_NOT_ALLOWED, 0xBB2A, 0x0008);
        ERRT("",  "@RR4, @RR0, R0",    REGISTER_NOT_ALLOWED, 0xBB0A, 0x0048);
        TEST("CPSDB", "@RR4, @RR2, R6, GE", 0xBA2A, 0x0649);
        TEST("CPSDB", "@RR4, @RR2, R0, GE", 0xBA2A, 0x0049);
        ERRT("", "@RR0, @RR2, R4, GE", REGISTER_NOT_ALLOWED, 0xBA2A, 0x0409);
        ERRT("", "@RR2, @RR0, R4, GE", REGISTER_NOT_ALLOWED, 0xBA0A, 0x0429);
    } else {
        TEST("CPSD",  "@R3, @R1, R2",    0xBB1A, 0x0238);
        TEST("CPSD",  "@R3, @R1, R0",    0xBB1A, 0x0038);
        ERRT("",  "@R3, @R0, R2",    REGISTER_NOT_ALLOWED, 0xBB0A, 0x0238);
        ERRT("",  "@R0, @R3, R2",    REGISTER_NOT_ALLOWED, 0xBB3A, 0x0208);
        TEST("CPSDB", "@R3, @R1, R2, GE", 0xBA1A, 0x0239);
        TEST("CPSDB", "@R3, @R1, R0, GE", 0xBA1A, 0x0039);
        ERRT("", "@R3, @R0, R2, GE", REGISTER_NOT_ALLOWED, 0xBA0A, 0x0239);
        ERRT("", "@R0, @R3, R2, GE", REGISTER_NOT_ALLOWED, 0xBA3A, 0x0209);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR4, R5, GT",  REGISTER_NOT_ALLOWED, 0xBB4E, 0x050A);
        ERRT("",  "@RR2, @RR0, R5, GT",  REGISTER_NOT_ALLOWED, 0xBB0E, 0x052A);
        TEST("CPSDRB", "@RR2, @RR4, R6, UGT", 0xBA4E, 0x062B);
        TEST("CPSDRB", "@RR2, @RR4, R0, UGT", 0xBA4E, 0x002B);
        ERRT("", "@RR0, @RR4, R5, UGT", REGISTER_NOT_ALLOWED, 0xBA4E, 0x050B);
        ERRT("", "@RR2, @RR0, R5, UGT", REGISTER_NOT_ALLOWED, 0xBA0E, 0x052B);
    } else {
        TEST("CPSDR",  "@R3, @R4, R5, GT",  0xBB4E, 0x053A);
        TEST("CPSDR",  "@R3, @R4, R0, GT",  0xBB4E, 0x003A);
        ERRT("",  "@R0, @R4, R5, GT",  REGISTER_NOT_ALLOWED, 0xBB4E, 0x050A);
        ERRT("",  "@R3, @R0, R5, GT",  REGISTER_NOT_ALLOWED, 0xBB0E, 0x053A);
        TEST("CPSDRB", "@R3, @R4, R2, UGT", 0xBA4E, 0x023B);
        TEST("CPSDRB", "@R3, @R4, R0, UGT", 0xBA4E, 0x003B);
        ERRT("", "@R0, @R4, R0, UGT", REGISTER_NOT_ALLOWED, 0xBA4E, 0x000B);
        ERRT("", "@R3, @R0, R0, UGT", REGISTER_NOT_ALLOWED, 0xBA0E, 0x003B);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR6, R5, NOV", REGISTER_NOT_ALLOWED, 0xBB62, 0x050C);
        ERRT("",  "@RR4, @RR0, R5, NOV", REGISTER_NOT_ALLOWED, 0xBB02, 0x054C);
        TEST("CPSIB", "@RR4, @RR6, R2, PL",  0xBA62, 0x024D);
        TEST("CPSIB", "@RR4, @RR6, R0, PL",  0xBA62, 0x004D);
        ERRT("", "@RR0, @RR6, R5, PL",  REGISTER_NOT_ALLOWED, 0xBA62, 0x050D);
        ERRT("", "@RR4, @RR0, R5, PL",  REGISTER_NOT_ALLOWED, 0xBA02, 0x054D);
    } else {
        TEST("CPSI",  "@R6, @R7, R8, NOV", 0xBB72, 0x086C);
        TEST("CPSI",  "@R6, @R7, R0, NOV", 0xBB72, 0x006C);
        ERRT("",  "@R0, @R7, R8, NOV", REGISTER_NOT_ALLOWED, 0xBB72, 0x080C);
        ERRT("",  "@R6, @R0, R8, NOV", REGISTER_NOT_ALLOWED, 0xBB02, 0x086C);
        TEST("CPSIB", "@R6, @R7, R8, PL",  0xBA72, 0x086D);
        TEST("CPSIB", "@R6, @R7, R0, PL",  0xBA72, 0x006D);
        ERRT("", "@R0, @R7, R8, PL",  REGISTER_NOT_ALLOWED, 0xBA72, 0x080D);
        ERRT("", "@R6, @R0, R8, PL",  REGISTER_NOT_ALLOWED, 0xBA02, 0x086D);
    }
    ...
    if (z8001()) {
        ...
        ERRT("",  "@RR0, @RR8, R6, NZ", REGISTER_NOT_ALLOWED, 0xBB86, 0x060E);
        ERRT("",  "@RR4, @RR0, R6, NZ", REGISTER_NOT_ALLOWED, 0xBB06, 0x064E);
        TEST("CPSIRB", "@RR4, @RR8, R6, NC", 0xBA86, 0x064F);
        TEST("CPSIRB", "@RR4, @RR8, R0, NC", 0xBA86, 0x004F);
        ERRT("", "@RR0, @RR8, R6, NC", REGISTER_NOT_ALLOWED, 0xBA86, 0x060F);
        ERRT("", "@RR4, @RR0, R6, NC", REGISTER_NOT_ALLOWED, 0xBA06, 0x064F);
    } else {
        TEST("CPSIR",  "@R9, @R10, R11, NZ", 0xBBA6, 0x0B9E);
        TEST("CPSIR",  "@R9, @R10, R0, NZ",  0xBBA6, 0x009E);
        ERRT("",  "@R0, @R10, R11, NZ", REGISTER_NOT_ALLOWED, 0xBBA6, 0x0B0E);
        ERRT("",  "@R9, @R0, R11, NZ",  REGISTER_NOT_ALLOWED, 0xBB06, 0x0B9E);
        TEST("CPSIRB", "@R1, @R10, R11, NC", 0xBAA6, 0x0B1F);
        TEST("CPSIRB", "@R1, @R10, R0, NC",  0xBAA6, 0x001F);
        ERRT("", "@R0, @R10, R11, NC", REGISTER_NOT_ALLOWED, 0xBAA6, 0x0B0F);
        ERRT("", "@R1, @R0, R11, NC",  REGISTER_NOT_ALLOWED, 0xBA06, 0x0B1F);
    }
}
...
static void test_translation() {
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR4, R6", REGISTER_NOT_ALLOWED, 0xB808, 0x0640);
        ERRT("", "@RR2, @RR0, R6", REGISTER_NOT_ALLOWED, 0xB828, 0x0600);
        ERRT("", "@RR2, @RR4, R1", REGISTER_NOT_ALLOWED, 0xB828, 0x0140);
        ERRT("", "@RR2, @RR2, R6", REGISTERS_OVERLAPPED, 0xB828, 0x0620);
        ERRT("", "@RR2, @RR4, R3", REGISTERS_OVERLAPPED, 0xB828, 0x0340);
        ERRT("", "@RR2, @RR4, R5", REGISTERS_OVERLAPPED, 0xB828, 0x0540);
    } else {
        TEST("TRDB", "@R3, @R2, R4", 0xB838, 0x0420);
        TEST("TRDB", "@R3, @R2, R0", 0xB838, 0x0020);
        ERRT("", "@R0, @R2, R3", REGISTER_NOT_ALLOWED, 0xB808, 0x0320);
        ERRT("", "@R1, @R2, R3", REGISTER_NOT_ALLOWED, 0xB818, 0x0320);
        ERRT("", "@R2, @R0, R3", REGISTER_NOT_ALLOWED, 0xB828, 0x0300);
        ERRT("", "@R2, @R1, R3", REGISTER_NOT_ALLOWED, 0xB828, 0x0310);
        ERRT("", "@R3, @R2, R1", REGISTER_NOT_ALLOWED, 0xB838, 0x0120);
        ERRT("", "@R3, @R3, R4", REGISTERS_OVERLAPPED, 0xB838, 0x0430);
        ERRT("", "@R3, @R2, R3", REGISTERS_OVERLAPPED, 0xB838, 0x0320);
        ERRT("", "@R3, @R2, R2", REGISTERS_OVERLAPPED, 0xB838, 0x0220);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR6, R2", REGISTER_NOT_ALLOWED, 0xB80C, 0x0260);
        ERRT("", "@RR4, @RR0, R2", REGISTER_NOT_ALLOWED, 0xB84C, 0x0200);
        ERRT("", "@RR4, @RR6, R1", REGISTER_NOT_ALLOWED, 0xB84C, 0x0160);
        ERRT("", "@RR4, @RR4, R2", REGISTERS_OVERLAPPED, 0xB84C, 0x0240);
        ERRT("", "@RR4, @RR6, R5", REGISTERS_OVERLAPPED, 0xB84C, 0x0560);
        ERRT("", "@RR4, @RR6, R7", REGISTERS_OVERLAPPED, 0xB84C, 0x0760);
    } else {
        TEST("TRDRB", "@R4, @R5, R6", 0xB84C, 0x0650);
        TEST("TRDRB", "@R4, @R5, R0", 0xB84C, 0x0050);
        ERRT("", "@R0, @R5, R6", REGISTER_NOT_ALLOWED, 0xB80C, 0x0650);
        ERRT("", "@R1, @R5, R6", REGISTER_NOT_ALLOWED, 0xB81C, 0x0650);
        ERRT("", "@R4, @R0, R6", REGISTER_NOT_ALLOWED, 0xB84C, 0x0600);
        ERRT("", "@R4, @R1, R6", REGISTER_NOT_ALLOWED, 0xB84C, 0x0610);
        ERRT("", "@R4, @R5, R1", REGISTER_NOT_ALLOWED, 0xB84C, 0x0150);
        ERRT("", "@R4, @R4, R6", REGISTERS_OVERLAPPED, 0xB84C, 0x0640);
        ERRT("", "@R4, @R5, R4", REGISTERS_OVERLAPPED, 0xB84C, 0x0450);
        ERRT("", "@R4, @R5, R5", REGISTERS_OVERLAPPED, 0xB84C, 0x0550);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR8, R3", REGISTER_NOT_ALLOWED, 0xB800, 0x0380);
        ERRT("", "@RR6, @RR0, R3", REGISTER_NOT_ALLOWED, 0xB860, 0x0300);
        ERRT("", "@RR6, @RR8, R1", REGISTER_NOT_ALLOWED, 0xB860, 0x0180);
        ERRT("", "@RR6, @RR6, R3", REGISTERS_OVERLAPPED, 0xB860, 0x0360);
        ERRT("", "@RR6, @RR8, R7", REGISTERS_OVERLAPPED, 0xB860, 0x0780);
        ERRT("", "@RR6, @RR8, R9", REGISTERS_OVERLAPPED, 0xB860, 0x0980);
    } else {
        TEST("TRIB", "@R7, @R8, R9", 0xB870, 0x0980);
        TEST("TRIB", "@R7, @R8, R0", 0xB870, 0x0080);
        ERRT("", "@R0, @R8, R9", REGISTER_NOT_ALLOWED, 0xB800, 0x0980);
        ERRT("", "@R1, @R8, R9", REGISTER_NOT_ALLOWED, 0xB810, 0x0980);
        ERRT("", "@R7, @R8, R1", REGISTER_NOT_ALLOWED, 0xB870, 0x0180);
        ERRT("", "@R7, @R0, R9", REGISTER_NOT_ALLOWED, 0xB870, 0x0900);
        ERRT("", "@R7, @R1, R9", REGISTER_NOT_ALLOWED, 0xB870, 0x0910);
        ERRT("", "@R7, @R7, R9", REGISTERS_OVERLAPPED, 0xB870, 0x0970);
        ERRT("", "@R7, @R8, R7", REGISTERS_OVERLAPPED, 0xB870, 0x0780);
        ERRT("", "@R7, @R8, R8", REGISTERS_OVERLAPPED, 0xB870, 0x0880);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR10, R12", REGISTER_NOT_ALLOWED, 0xB804, 0x0CA0);
        ERRT("", "@RR8, @RR0, R12",  REGISTER_NOT_ALLOWED, 0xB884, 0x0C00);
        ERRT("", "@RR8, @RR10, R1",  REGISTER_NOT_ALLOWED, 0xB884, 0x01A0);
        ERRT("", "@RR8, @RR8, R12",  REGISTERS_OVERLAPPED, 0xB884, 0x0C80);
        ERRT("", "@RR8, @RR10, R9",  REGISTERS_OVERLAPPED, 0xB884, 0x09A0);
        ERRT("", "@RR8, @RR10, R11", REGISTERS_OVERLAPPED, 0xB884, 0x0BA0);
    } else {
        TEST("TRIRB", "@R10, @R11, R12", 0xB8A4, 0x0CB0);
        TEST("TRIRB", "@R10, @R11, R0",  0xB8A4, 0x00B0);
        ERRT("", "@R0, @R11, R12",  REGISTER_NOT_ALLOWED, 0xB804, 0x0CB0);
        ERRT("", "@R1, @R11, R12",  REGISTER_NOT_ALLOWED, 0xB814, 0x0CB0);
        ERRT("", "@R10, @R11, R1",  REGISTER_NOT_ALLOWED, 0xB8A4, 0x01B0);
        ERRT("", "@R10, @R0, R12",  REGISTER_NOT_ALLOWED, 0xB8A4, 0x0C00);
        ERRT("", "@R10, @R1, R12",  REGISTER_NOT_ALLOWED, 0xB8A4, 0x0C10);
        ERRT("", "@R10, @R10, R12", REGISTERS_OVERLAPPED, 0xB8A4, 0x0CA0);
        ERRT("", "@R10, @R11, R10", REGISTERS_OVERLAPPED, 0xB8A4, 0x0AB0);
        ERRT("", "@R10, @R11, R11", REGISTERS_OVERLAPPED, 0xB8A4, 0x0BB0);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR12, R9",   REGISTER_NOT_ALLOWED, 0xB80A, 0x09C0);
        ERRT("", "@RR10, @RR0, R9",   REGISTER_NOT_ALLOWED, 0xB8AA, 0x0900);
        ERRT("", "@RR10, @RR12, R1",  REGISTER_NOT_ALLOWED, 0xB8AA, 0x01C0);
        ERRT("", "@RR10, @RR10, R9",  REGISTERS_OVERLAPPED, 0xB8AA, 0x09A0);
        ERRT("", "@RR10, @RR12, R10", REGISTERS_OVERLAPPED, 0xB8AA, 0x0AC0);
        ERRT("", "@RR10, @RR12, R13", REGISTERS_OVERLAPPED, 0xB8AA, 0x0DC0);
    } else {
        TEST("TRTDB", "@R13, @R14, R15", 0xB8DA, 0x0FE0);
        TEST("TRTDB", "@R13, @R14, R0",  0xB8DA, 0x00E0);
        ERRT("", "@R0, @R14, R15",  REGISTER_NOT_ALLOWED, 0xB80A, 0x0FE0);
        ERRT("", "@R1, @R14, R15",  REGISTER_NOT_ALLOWED, 0xB81A, 0x0FE0);
        ERRT("", "@R13, @R14, R1",  REGISTER_NOT_ALLOWED, 0xB8DA, 0x01E0);
        ERRT("", "@R13, @R0, R15",  REGISTER_NOT_ALLOWED, 0xB8DA, 0x0F00);
        ERRT("", "@R13, @R1, R15",  REGISTER_NOT_ALLOWED, 0xB8DA, 0x0F10);
        ERRT("", "@R13, @R13, R15", REGISTERS_OVERLAPPED, 0xB8DA, 0x0FD0);
        ERRT("", "@R13, @R14, R13", REGISTERS_OVERLAPPED, 0xB8DA, 0x0DE0);
        ERRT("", "@R13, @R14, R14", REGISTERS_OVERLAPPED, 0xB8DA, 0x0EE0);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR14, R2",   REGISTER_NOT_ALLOWED, 0xB80E, 0x02EE);
        ERRT("", "@RR12, @RR0, R2",   REGISTER_NOT_ALLOWED, 0xB8CE, 0x020E);
        ERRT("", "@RR12, @RR14, R1",  REGISTER_NOT_ALLOWED, 0xB8CE, 0x01EE);
        ERRT("", "@RR12, @RR12, R2",  REGISTERS_OVERLAPPED, 0xB8CE, 0x02CE);
        ERRT("", "@RR12, @RR14, R13", REGISTERS_OVERLAPPED, 0xB8CE, 0x0DEE);
        ERRT("", "@RR12, @RR14, R14", REGISTERS_OVERLAPPED, 0xB8CE, 0x0EEE);
    } else {
        TEST("TRTDRB", "@R15, @R14, R13", 0xB8FE, 0x0DEE);
        TEST("TRTDRB", "@R15, @R14, R0",  0xB8FE, 0x00EE);
        ERRT("", "@R0, @R14, R13",  REGISTER_NOT_ALLOWED, 0xB80E, 0x0DEE);
        ERRT("", "@R1, @R14, R13",  REGISTER_NOT_ALLOWED, 0xB81E, 0x0DEE);
        ERRT("", "@R15, @R14, R1",  REGISTER_NOT_ALLOWED, 0xB8FE, 0x01EE);
        ERRT("", "@R15, @R0, R13",  REGISTER_NOT_ALLOWED, 0xB8FE, 0x0D0E);
        ERRT("", "@R15, @R1, R13",  REGISTER_NOT_ALLOWED, 0xB8FE, 0x0D1E);
        ERRT("", "@R15, @R15, R13", REGISTERS_OVERLAPPED, 0xB8FE, 0x0DFE);
        ERRT("", "@R15, @R14, R15", REGISTERS_OVERLAPPED, 0xB8FE, 0x0FEE);
        ERRT("", "@R15, @R14, R14", REGISTERS_OVERLAPPED, 0xB8FE, 0x0EEE);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR12, R11",  REGISTER_NOT_ALLOWED, 0xB802, 0x0BC0);
        ERRT("", "@RR14, @RR0, R11",  REGISTER_NOT_ALLOWED, 0xB8E2, 0x0B00);
        ERRT("", "@RR14, @RR12, R1",  REGISTER_NOT_ALLOWED, 0xB8E2, 0x01C0);
        ERRT("", "@RR14, @RR14, R11", REGISTERS_OVERLAPPED, 0xB8E2, 0x0BE0);
        ERRT("", "@RR14, @RR12, R14", REGISTERS_OVERLAPPED, 0xB8E2, 0x0EC0);
        ERRT("", "@RR14, @RR12, R12", REGISTERS_OVERLAPPED, 0xB8E2, 0x0CC0);
    } else {
        TEST("TRTIB", "@R12, @R11, R10", 0xB8C2, 0x0AB0);
        TEST("TRTIB", "@R12, @R11, R0" , 0xB8C2, 0x00B0);
        ERRT("", "@R0, @R11, R10",  REGISTER_NOT_ALLOWED, 0xB802, 0x0AB0);
        ERRT("", "@R1, @R11, R10",  REGISTER_NOT_ALLOWED, 0xB812, 0x0AB0);
        ERRT("", "@R12, @R11, R1",  REGISTER_NOT_ALLOWED, 0xB8C2, 0x01B0);
        ERRT("", "@R12, @R0, R10",  REGISTER_NOT_ALLOWED, 0xB8C2, 0x0A00);
        ERRT("", "@R12, @R1, R10",  REGISTER_NOT_ALLOWED, 0xB8C2, 0x0A10);
        ERRT("", "@R12, @R12, R10", REGISTERS_OVERLAPPED, 0xB8C2, 0x0AC0);
        ERRT("", "@R12, @R11, R12", REGISTERS_OVERLAPPED, 0xB8C2, 0x0CB0);
        ERRT("", "@R12, @R11, R11", REGISTERS_OVERLAPPED, 0xB8C2, 0x0BB0);
    }
    ...
    if (z8001()) {
        ...
        ERRT("", "@RR0, @RR8, R7",   REGISTER_NOT_ALLOWED, 0xB806, 0x078E);
        ERRT("", "@RR10, @RR0, R7",  REGISTER_NOT_ALLOWED, 0xB8A6, 0x070E);
        ERRT("", "@RR10, @RR8, R1",  REGISTER_NOT_ALLOWED, 0xB8A6, 0x018E);
        ERRT("", "@RR10, @RR10, R7", REGISTERS_OVERLAPPED, 0xB8A6, 0x07AE);
        ERRT("", "@RR10, @RR8, R11", REGISTERS_OVERLAPPED, 0xB8A6, 0x0B8E);
        ERRT("", "@RR10, @RR8, R9",  REGISTERS_OVERLAPPED, 0xB8A6, 0x098E);
    } else {
        TEST("TRTIRB", "@R9, @R8, R7", 0xB896, 0x078E);
        TEST("TRTIRB", "@R9, @R8, R0", 0xB896, 0x008E);
        ERRT("", "@R0, @R8, R7", REGISTER_NOT_ALLOWED, 0xB806, 0x078E);
        ERRT("", "@R1, @R8, R7", REGISTER_NOT_ALLOWED, 0xB816, 0x078E);
        ERRT("", "@R9, @R8, R1", REGISTER_NOT_ALLOWED, 0xB896, 0x018E);
        ERRT("", "@R9, @R0, R7", REGISTER_NOT_ALLOWED, 0xB896, 0x070E);
        ERRT("", "@R9, @R1, R7", REGISTER_NOT_ALLOWED, 0xB896, 0x071E);
        ERRT("", "@R9, @R9, R7", REGISTERS_OVERLAPPED, 0xB896, 0x079E);
        ERRT("", "@R9, @R8, R9", REGISTERS_OVERLAPPED, 0xB896, 0x098E);
        ERRT("", "@R9, @R8, R8", REGISTERS_OVERLAPPED, 0xB896, 0x088E);
    }
}
...
static void test_input() {
    ...
    ERRT("IN",  "R0, @R2",    REGISTER_NOT_ALLOWED, 0x3D01);
    ERRT("INB", "RH0, @R2",   REGISTER_NOT_ALLOWED, 0x3C01);
    ...
    if (z8001()) {
        ...
        ERRT("IND",  "@RR2, @R0, R6", REGISTER_NOT_ALLOWED,  0x3B08, 0x0628);
        ERRT("IND",  "@RR0, @R4, R6", REGISTER_NOT_ALLOWED,  0x3B48, 0x0608);
        ERRT("INDB", "@RR2, @R0, R6", REGISTER_NOT_ALLOWED,  0x3A08, 0x0628);
        ERRT("INDB", "@RR0, @R4, R6", REGISTER_NOT_ALLOWED,  0x3A48, 0x0608);
    } else {
        TEST("IND",  "@R1, @R2, R0", 0x3B28, 0x0018);
        TEST("INDB", "@R1, @R2, R0", 0x3A28, 0x0018);
        ERRT("IND",  "@R1, @R0, R0", REGISTER_NOT_ALLOWED,  0x3B08, 0x0018);
        ERRT("IND",  "@R0, @R2, R0", REGISTER_NOT_ALLOWED,  0x3B28, 0x0008);
        ERRT("INDB", "@R1, @R0, R0", REGISTER_NOT_ALLOWED,  0x3A08, 0x0018);
        ERRT("INDB", "@R0, @R2, R0", REGISTER_NOT_ALLOWED,  0x3A28, 0x0008);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SIND",  "@RR4, @R0, R0", REGISTER_NOT_ALLOWED,  0x3B09, 0x0048);
        ERRT("SIND",  "@RR0, @R3, R0", REGISTER_NOT_ALLOWED,  0x3B39, 0x0008);
        ERRT("SINDB", "@RR4, @R0, R0", REGISTER_NOT_ALLOWED,  0x3A09, 0x0048);
        ERRT("SINDB", "@RR0, @R3, R0", REGISTER_NOT_ALLOWED,  0x3A39, 0x0008);
    } else {
        TEST("SIND",  "@R3, @R4, R5", 0x3B49, 0x0538);
        TEST("SINDB", "@R3, @R4, R5", 0x3A49, 0x0538);
        ERRT("SIND",  "@R3, @R0, R5", REGISTER_NOT_ALLOWED,  0x3B09, 0x0538);
        ERRT("SIND",  "@R0, @R4, R5", REGISTER_NOT_ALLOWED,  0x3B49, 0x0508);
        ERRT("SINDB", "@R3, @R0, R5", REGISTER_NOT_ALLOWED,  0x3A09, 0x0538);
        ERRT("SINDB", "@R0, @R4, R0", REGISTER_NOT_ALLOWED,  0x3A49, 0x0508);
    }
    ...
    if (z8001()) {
        ...
        ERRT("INDR",  "@RR6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3B08, 0x0860);
        ERRT("INDR",  "@RR0, @R4, R8", REGISTER_NOT_ALLOWED,  0x3B48, 0x0800);
        ERRT("INDRB", "@RR6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3A08, 0x0860);
        ERRT("INDRB", "@RR0, @R4, R8", REGISTER_NOT_ALLOWED,  0x3A48, 0x0600);
    } else {
        TEST("INDR",  "@R6, @R7, R8", 0x3B78, 0x0860);
        TEST("INDRB", "@R6, @R7, R8", 0x3A78, 0x0860);
        ERRT("INDR",  "@R6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3B08, 0x0860);
        ERRT("INDR",  "@R0, @R7, R8", REGISTER_NOT_ALLOWED,  0x3B78, 0x0800);
        ERRT("INDRB", "@R6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3A08, 0x0860);
        ERRT("INDRB", "@R0, @R7, R8", REGISTER_NOT_ALLOWED,  0x3A78, 0x0600);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINDR",  "@RR8, @R0, R12", REGISTER_NOT_ALLOWED,   0x3B09, 0x0C80);
        ERRT("SINDR",  "@RR0, @R10, R12", REGISTER_NOT_ALLOWED,  0x3BA9, 0x0C00);
        ERRT("SINDRB", "@RR8, @R0, R12", REGISTER_NOT_ALLOWED,   0x3A09, 0x0C80);
        ERRT("SINDRB", "@RR0, @R10, R12", REGISTER_NOT_ALLOWED,  0x3AA9, 0x0C00);
    } else {
        TEST("SINDR",  "@R9, @R10, R11", 0x3BA9, 0x0B90);
        TEST("SINDRB", "@R9, @R10, R11", 0x3AA9, 0x0B90);
        ERRT("SINDR",  "@R9, @R0, R11", REGISTER_NOT_ALLOWED,   0x3B09, 0x0B90);
        ERRT("SINDR",  "@R0, @R10, R11", REGISTER_NOT_ALLOWED,  0x3BA9, 0x0B00);
        ERRT("SINDRB", "@R9, @R0, R11", REGISTER_NOT_ALLOWED,   0x3A09, 0x0B90);
        ERRT("SINDRB", "@R0, @R10, R11", REGISTER_NOT_ALLOWED,  0x3AA9, 0x0B00);
    }
    ...
    if (z8001()) {
        ...
        ERRT("INI",  "@RR14, @R0, R1", REGISTER_NOT_ALLOWED,  0x3B00, 0x01E8);
        ERRT("INI",  "@RR0, @R2, R1", REGISTER_NOT_ALLOWED,   0x3B20, 0x0108);
        ERRT("INIB", "@RR14, @R0, R1", REGISTER_NOT_ALLOWED,  0x3A00, 0x01E8);
        ERRT("INIB", "@RR0, @R2, R1", REGISTER_NOT_ALLOWED,   0x3A20, 0x0108);
    } else {
        TEST("INI",  "@R12, @R13, R14", 0x3BD0, 0x0EC8);
        TEST("INIB", "@R12, @R13, R14", 0x3AD0, 0x0EC8);
        ERRT("INI",  "@R12, @R0, R14", REGISTER_NOT_ALLOWED,   0x3B00, 0x0EC8);
        ERRT("INI",  "@R0, @R13, R14", REGISTER_NOT_ALLOWED,   0x3BD0, 0x0E08);
        ERRT("INIB", "@R12, @R0, R14", REGISTER_NOT_ALLOWED,   0x3A00, 0x0EC8);
        ERRT("INIB", "@R0, @R13, R14", REGISTER_NOT_ALLOWED,   0x3AD0, 0x0E08);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINI",  "@RR12, @R0, R10", REGISTER_NOT_ALLOWED,  0x3B01, 0x0AC8);
        ERRT("SINI",  "@RR0, @R11, R10", REGISTER_NOT_ALLOWED,  0x3BB1, 0x0A08);
        ERRT("SINIB", "@RR12, @R0, R10", REGISTER_NOT_ALLOWED,  0x3A01, 0x0AC8);
        ERRT("SINIB", "@RR0, @R11, R10", REGISTER_NOT_ALLOWED,  0x3AB1, 0x0A08);
    } else {
        TEST("SINI",  "@R15, @R1, R0", 0x3B11, 0x00F8);
        TEST("SINIB", "@R15, @R1, R0", 0x3A11, 0x00F8);
        ERRT("SINI",  "@R15, @R0, R0", REGISTER_NOT_ALLOWED,  0x3B01, 0x00F8);
        ERRT("SINI",  "@R0, @R1, R0", REGISTER_NOT_ALLOWED,   0x3B11, 0x0008);
        ERRT("SINIB", "@R15, @R0, R0", REGISTER_NOT_ALLOWED,  0x3A01, 0x00F8);
        ERRT("SINIB", "@R0, @R1, R0", REGISTER_NOT_ALLOWED,   0x3A11, 0x0008);
    }
    ...
    if (z8001()) {
        ...
        ERRT("INIR",  "@RR10, @R0, R1", REGISTER_NOT_ALLOWED,  0x3B00, 0x08A0);
        ERRT("INIR",  "@RR0, @R9, R1", REGISTER_NOT_ALLOWED,   0x3B90, 0x0800);
        ERRT("INIRB", "@RR10, @R0, R1", REGISTER_NOT_ALLOWED,  0x3A00, 0x08A0);
        ERRT("INIRB", "@RR0, @R9, R1", REGISTER_NOT_ALLOWED,   0x3A90, 0x0800);
    } else {
        TEST("INIR",  "@R3, @R2, R1", 0x3B20, 0x0130);
        TEST("INIRB", "@R3, @R2, R1", 0x3A20, 0x0130);
        ERRT("INIR",  "@R3, @R0, R1", REGISTER_NOT_ALLOWED,  0x3B00, 0x0130);
        ERRT("INIR",  "@R0, @R2, R1", REGISTER_NOT_ALLOWED,  0x3B20, 0x0100);
        ERRT("INIRB", "@R3, @R0, R1", REGISTER_NOT_ALLOWED,  0x3A00, 0x0130);
        ERRT("INIRB", "@R0, @R2, R1", REGISTER_NOT_ALLOWED,  0x3A20, 0x0100);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINIR",  "@RR8, @R0, R6", REGISTER_NOT_ALLOWED,  0x3B01, 0x0680);
        ERRT("SINIR",  "@RR0, @R7, R6", REGISTER_NOT_ALLOWED,  0x3B71, 0x0600);
        ERRT("SINIRB", "@RR8, @R0, R6", REGISTER_NOT_ALLOWED,  0x3A01, 0x0680);
        ERRT("SINIRB", "@RR0, @R7, R6", REGISTER_NOT_ALLOWED,  0x3A71, 0x0600);
    } else {
        TEST("SINIR",  "@R4, @R3, R2", 0x3B31, 0x0240);
        TEST("SINIRB", "@R4, @R3, R2", 0x3A31, 0x0240);
        ERRT("SINIR",  "@R4, @R0, R2", REGISTER_NOT_ALLOWED,  0x3B01, 0x0240);
        ERRT("SINIR",  "@R0, @R3, R2", REGISTER_NOT_ALLOWED,  0x3B31, 0x0200);
        ERRT("SINIRB", "@R4, @R0, R2", REGISTER_NOT_ALLOWED,  0x3A01, 0x0240);
        ERRT("SINIRB", "@R0, @R3, R2", REGISTER_NOT_ALLOWED,  0x3A31, 0x0200);
    }
}
...
static void test_output() {
    ...
    ERRT("OUT",  "@R0, R1", REGISTER_NOT_ALLOWED,   0x3F01);
    ERRT("OUTB", "@R0, RH1", REGISTER_NOT_ALLOWED,  0x3E01);
    ...
    if (z8001()) {
        ...
        ERRT("OUTD",  "@R2, @RR0, R6", REGISTER_NOT_ALLOWED,  0x3B0A, 0x0628);
        ERRT("OUTD",  "@R0, @RR4, R6", REGISTER_NOT_ALLOWED,  0x3B4A, 0x0608);
        ERRT("OUTDB", "@R2, @RR0, R6", REGISTER_NOT_ALLOWED,  0x3A0A, 0x0628);
        ERRT("OUTDB", "@R0, @RR4, R6", REGISTER_NOT_ALLOWED,  0x3A4A, 0x0608);
    } else {
        TEST("OUTD",  "@R2, @R1, R0", 0x3B1A, 0x0028);
        TEST("OUTDB", "@R2, @R1, R0", 0x3A1A, 0x0028);
        ERRT("OUTD",  "@R2, @R0, R0", REGISTER_NOT_ALLOWED,  0x3B0A, 0x0028);
        ERRT("OUTD",  "@R0, @R1, R0", REGISTER_NOT_ALLOWED,  0x3B1A, 0x0008);
        ERRT("OUTDB", "@R2, @R0, R0", REGISTER_NOT_ALLOWED,  0x3A0A, 0x0028);
        ERRT("OUTDB", "@R0, @R1, R0", REGISTER_NOT_ALLOWED,  0x3A1A, 0x0008);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOUTD",  "@R3, @RR0, R0", REGISTER_NOT_ALLOWED,  0x3B0B, 0x0038);
        ERRT("SOUTD",  "@R0, @RR4, R0", REGISTER_NOT_ALLOWED,  0x3B4B, 0x0008);
        ERRT("SOUTDB", "@R3, @RR0, R0", REGISTER_NOT_ALLOWED,  0x3A0B, 0x0038);
        ERRT("SOUTDB", "@R0, @RR4, R0", REGISTER_NOT_ALLOWED,  0x3A4B, 0x0008);
    } else {
        TEST("SOUTD",  "@R3, @R4, R5", 0x3B4B, 0x0538);
        TEST("SOUTDB", "@R3, @R4, R5", 0x3A4B, 0x0538);
        ERRT("SOUTD",  "@R3, @R0, R5", REGISTER_NOT_ALLOWED,  0x3B0B, 0x0538);
        ERRT("SOUTD",  "@R0, @R4, R5", REGISTER_NOT_ALLOWED,  0x3B4B, 0x0508);
        ERRT("SOUTDB", "@R3, @R0, R5", REGISTER_NOT_ALLOWED,  0x3A0B, 0x0538);
        ERRT("SOUTDB", "@R0, @R4, R5", REGISTER_NOT_ALLOWED,  0x3A4B, 0x0508);
    }
    ...
    if (z8001()) {
        ...
        ERRT("OTDR",  "@R4, @RR0, R8", REGISTER_NOT_ALLOWED,  0x3B0A, 0x0840);
        ERRT("OTDR",  "@R0, @RR6, R8", REGISTER_NOT_ALLOWED,  0x3B6A, 0x0800);
        ERRT("OTDRB", "@R4, @RR0, R8", REGISTER_NOT_ALLOWED,  0x3A0A, 0x0840);
        ERRT("OTDRB", "@R0, @RR6, R8", REGISTER_NOT_ALLOWED,  0x3A6A, 0x0600);
    } else {
        TEST("OTDR",  "@R6, @R7, R8", 0x3B7A, 0x0860);
        TEST("OTDRB", "@R6, @R7, R8", 0x3A7A, 0x0860);
        ERRT("OTDR",  "@R6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3B0A, 0x0860);
        ERRT("OTDR",  "@R0, @R7, R8", REGISTER_NOT_ALLOWED,  0x3B7A, 0x0800);
        ERRT("OTDRB", "@R6, @R0, R8", REGISTER_NOT_ALLOWED,  0x3A0A, 0x0860);
        ERRT("OTDRB", "@R0, @R7, R8", REGISTER_NOT_ALLOWED,  0x3A7A, 0x0600);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOTDR",  "@R8, @RR0, R12", REGISTER_NOT_ALLOWED,   0x3B0B, 0x0C80);
        ERRT("SOTDR",  "@R0, @RR10, R12", REGISTER_NOT_ALLOWED,  0x3BAB, 0x0C00);
        ERRT("SOTDRB", "@R8, @RR0, R12", REGISTER_NOT_ALLOWED,   0x3A0B, 0x0C80);
        ERRT("SOTDRB", "@R0, @RR10, R12", REGISTER_NOT_ALLOWED,  0x3AAB, 0x0C00);
    } else {
        TEST("SOTDR",  "@R9, @R10, R11", 0x3BAB, 0x0B90);
        TEST("SOTDRB", "@R9, @R10, R11", 0x3AAB, 0x0B90);
        ERRT("SOTDR",  "@R9, @R0, R11", REGISTER_NOT_ALLOWED,   0x3B0B, 0x0B90);
        ERRT("SOTDR",  "@R0, @R10, R11", REGISTER_NOT_ALLOWED,  0x3BAB, 0x0B00);
        ERRT("SOTDRB", "@R9, @R0, R11", REGISTER_NOT_ALLOWED,   0x3A0B, 0x0B90);
        ERRT("SOTDRB", "@R0, @R10, R11", REGISTER_NOT_ALLOWED,  0x3AAB, 0x0B00);
    }
    ...
    if (z8001()) {
        ...
        ERRT("OUTI",  "@R14, @RR0, R1", REGISTER_NOT_ALLOWED,  0x3B02, 0x01E8);
        ERRT("OUTI",  "@R0, @RR2, R1", REGISTER_NOT_ALLOWED,   0x3B22, 0x0108);
        ERRT("OUTIB", "@R14, @RR0, R1", REGISTER_NOT_ALLOWED,  0x3A02, 0x01E8);
        ERRT("OUTIB", "@R0, @RR2, R1", REGISTER_NOT_ALLOWED,   0x3A22, 0x0108);
    } else {
        TEST("OUTI",  "@R12, @R13, R14", 0x3BD2, 0x0EC8);
        TEST("OUTIB", "@R12, @R13, R14", 0x3AD2, 0x0EC8);
        ERRT("OUTI",  "@R12, @R0, R14", REGISTER_NOT_ALLOWED,   0x3B02, 0x0EC8);
        ERRT("OUTI",  "@R0, @R13, R14", REGISTER_NOT_ALLOWED,   0x3BD2, 0x0E08);
        ERRT("OUTIB", "@R12, @R0, R14", REGISTER_NOT_ALLOWED,   0x3A02, 0x0EC8);
        ERRT("OUTIB", "@R0, @R13, R14", REGISTER_NOT_ALLOWED,   0x3AD2, 0x0E08);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOUTI",  "@R10, @RR0, R11", REGISTER_NOT_ALLOWED,   0x3B03, 0x0BA8);
        ERRT("SOUTI",  "@R0, @RR12, R11", REGISTER_NOT_ALLOWED,   0x3BC3, 0x0B08);
        ERRT("SOUTIB", "@R10, @RR0, R11", REGISTER_NOT_ALLOWED,   0x3A03, 0x0BA8);
        ERRT("SOUTIB", "@R0, @RR12, R11", REGISTER_NOT_ALLOWED,   0x3AC3, 0x0B08);
    } else {
        TEST("SOUTI",  "@R15, @R1, R0", 0x3B13, 0x00F8);
        TEST("SOUTIB", "@R15, @R1, R0", 0x3A13, 0x00F8);
        ERRT("SOUTI",  "@R15, @R0, R0", REGISTER_NOT_ALLOWED,  0x3B03, 0x00F8);
        ERRT("SOUTI",  "@R0, @R1, R0", REGISTER_NOT_ALLOWED,   0x3B13, 0x0008);
        ERRT("SOUTIB", "@R15, @R0, R0", REGISTER_NOT_ALLOWED,  0x3A03, 0x00F8);
        ERRT("SOUTIB", "@R0, @R1, R0", REGISTER_NOT_ALLOWED,   0x3A13, 0x0008);
    }
    ...
    if (z8001()) {
        ...
        ERRT("OTIR",  "@R9, @RR0, R8", REGISTER_NOT_ALLOWED,   0x3B02, 0x0890);
        ERRT("OTIR",  "@R0, @RR10, R8", REGISTER_NOT_ALLOWED,  0x3BA2, 0x0800);
        ERRT("OTIRB", "@R9, @RR0, R8", REGISTER_NOT_ALLOWED,   0x3A02, 0x0890);
        ERRT("OTIRB", "@R0, @RR10, R8", REGISTER_NOT_ALLOWED,  0x3AA2, 0x0800);
    } else {
        TEST("OTIR",  "@R3, @R2, R1", 0x3B22, 0x0130);
        TEST("OTIRB", "@R3, @R2, R1", 0x3A22, 0x0130);
        ERRT("OTIR",  "@R3, @R0, R1", REGISTER_NOT_ALLOWED,  0x3B02, 0x0130);
        ERRT("OTIR",  "@R0, @R2, R1", REGISTER_NOT_ALLOWED,  0x3B22, 0x0100);
        ERRT("OTIRB", "@R3, @R0, R1", REGISTER_NOT_ALLOWED,  0x3A02, 0x0130);
        ERRT("OTIRB", "@R0, @R2, R1", REGISTER_NOT_ALLOWED,  0x3A22, 0x0100);
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOTIR",  "@R7, @RR0, R6", REGISTER_NOT_ALLOWED,  0x3B03, 0x0670);
        ERRT("SOTIR",  "@R0, @RR8, R6", REGISTER_NOT_ALLOWED,  0x3B83, 0x0600);
        ERRT("SOTIRB", "@R7, @RR0, R6", REGISTER_NOT_ALLOWED,  0x3A03, 0x0670);
        ERRT("SOTIRB", "@R0, @RR8, R6", REGISTER_NOT_ALLOWED,  0x3A83, 0x0600);
    } else {
        TEST("SOTIR",  "@R4, @R3, R2", 0x3B33, 0x0240);
        TEST("SOTIRB", "@R4, @R3, R2", 0x3A33, 0x0240);
        ERRT("SOTIR",  "@R4, @R0, R2", REGISTER_NOT_ALLOWED,  0x3B03, 0x0240);
        ERRT("SOTIR",  "@R0, @R3, R2", REGISTER_NOT_ALLOWED,  0x3B33, 0x0200);
        ERRT("SOTIRB", "@R4, @R0, R2", REGISTER_NOT_ALLOWED,  0x3A03, 0x0240);
        ERRT("SOTIRB", "@R0, @R3, R2", REGISTER_NOT_ALLOWED,  0x3A33, 0x0200);
    }
}
...
static void test_cpu_conrtol() {
    ...
    ERRT("LDCTL", "R14, FLAGS", ILLEGAL_SIZE,  0x7DE1);
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL", "R11, PSAPSEG", ILLEGAL_REGISTER, 0x7DB4);
        TEST("LDCTL", "R10, PSAP", 0x7DA5);
        ERRT("LDCTL", "R9, NSPSEG", ILLEGAL_REGISTER, 0x7D96);
        TEST("LDCTL", "R8, NSP", 0x7D87);
    }
    ERRT("LDCTL", "FLAGS, R6", ILLEGAL_SIZE,  0x7D69);
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL", "PSAPSEG, R3", ILLEGAL_REGISTER, 0x7D3C);
        TEST("LDCTL", "PSAP, R2", 0x7D2D);
        ERRT("LDCTL", "NSPSEG, R1", ILLEGAL_REGISTER, 0x7D1E);
