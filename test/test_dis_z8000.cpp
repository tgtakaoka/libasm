...
static void test_cpu() {
    asserter.equals(
        "cpu 8001", true, disassembler.setCpu("Z8001"));
    asserter.equals(
        "get cpu", "Z8001", disassembler.getCpu());

    asserter.equals(
        "cpu Z8002", true, disassembler.setCpu("Z8002"));
    asserter.equals(
        "get cpu", "Z8002", disassembler.getCpu());
}
...
static void test_load_and_exchange() {
    ...
    TEST(LDB, "RH2,#0x56",       0x2002, 0x5656);
    ...
    if (z8001()) {
        ...
        ATEST(0x2000, LDAR, "RR8,0xFFA004", 0x3408, 0x8000);
        ...
        ATEST(0x2000, LDAR, "R8,0xA004", 0x3408, 0x8000);
