...
static void test_load_and_exchange() {
    ...
    if (z8001()) {
        ...
        ERRT("PUSHL", "@RR2, @RR0",          REGISTER_NOT_ALLOWED, 0x1120);
        ...
        ERRT("PUSHL", "@R4, @R0",       REGISTER_NOT_ALLOWED, 0x1140);
...
static void test_logical() {
    ...
    if (z8001()) {
        ...
        TEST("COM",  "%561234(R2)",   0x4D20, 0xD600, 0x1234);        TEST("COMB", "@RR2",          0x0C20);
...
static void test_bit_manipulation() {
    ...
    ERRT("SETB", "RL2, #15", ILLEGAL_BIT_NUMBER, 0xA4AF);
...
static void test_input() {
    ...
    ERRT("IN",  "R1, @R0",    REGISTER_NOT_ALLOWED, 0x3D01);
    ERRT("INB", "RH1, @R0",   REGISTER_NOT_ALLOWED, 0x3C01);
    ...
    if (z8001()) {
        ...
        ERRT("SINDB", "@R0, @R4, R5", REGISTER_NOT_ALLOWED, 0x3A49, 0x0508);
    }
    ...
    if (z8001()) {
        ...
        ERRT("INDRB", "@RR0, @R4, R8", REGISTER_NOT_ALLOWED, 0x3A48, 0x0800);
    } else {
        ...
        ERRT("INDRB", "@R0, @R7, R8", REGISTER_NOT_ALLOWED, 0x3A78, 0x0800);
    }
    ...
    if (z8001()) {
        ...
        UNKN(                                                 0x3B90, 0x08A2);
        UNKN(                                                 0x3A90, 0x08A3);
        ERRT("INIR",  "@RR10, @R0, R8", REGISTER_NOT_ALLOWED, 0x3B00, 0x08A0);
        ERRT("INIR",  "@RR0, @R9, R8",  REGISTER_NOT_ALLOWED, 0x3B90, 0x0800);
        ERRT("INIRB", "@RR10, @R0, R8", REGISTER_NOT_ALLOWED, 0x3A00, 0x08A0);
        ERRT("INIRB", "@RR0, @R9, R8",  REGISTER_NOT_ALLOWED, 0x3A90, 0x0800);
    } else {
...
static void test_output() {
    ...
    if (z8001()) {
        ...
        ERRT("OTDRB", "@R0, @RR6, R8", REGISTER_NOT_ALLOWED, 0x3A6A, 0x0800);
    } else {
        ...
        ERRT("OTDRB", "@R0, @R7, R8", REGISTER_NOT_ALLOWED, 0x3A7A, 0x0800);
    }
...
static void test_cpu_conrtol() {
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL", "R11, ", ILLEGAL_REGISTER, 0x7DB4);
        TEST("LDCTL", "R10, PSAP",               0x7DA5);
        ERRT("LDCTL", "R9, ",  ILLEGAL_REGISTER, 0x7D96);
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL", ", R3", ILLEGAL_REGISTER, 0x7D3C);
        TEST("LDCTL", "PSAP, R2",               0x7D2D);
        ERRT("LDCTL", ", R1", ILLEGAL_REGISTER, 0x7D1E);
