...
void test_jump() {
    ...
    if (isZ380()) {
        ...
        AERRT(0xFFF00000, "CALR", "00000005H", OVERFLOW_RANGE, "00000005H",
              0xFD, 0xCD, 0x00, 0x00, 0x10);
        extmode(false);
...
void test_illegal_z380() {
    static constexpr Config::opcode_t ed_illegals[] = {
        ...
        0x31, 0x35, 0x3A, 0x3D, 0x5D, 0x66, 0x6D, 0x6E, 0x70, 0x77, 0x7D, 0x7E, 0x7F,
    ...
    static constexpr Config::opcode_t fd_illegals[] = {
        0x00, 0x04, 0x05, 0x06, 0x08, 0x0A, 0x0E, 0x14, 0x15, 0x16, 0x1A, 0x1E,
        0x2F, 0x3A, 0x76, 0x78, 0x7A, 0x7B, 0x7F,
        0xC5, 0xC7, 0xC8, 0xC9, 0xCA, 0xCF,
        0xD1, 0xD2, 0xD5, 0xD7, 0xDD, 0xDF,
        0xE0, 0xE2, 0xE7, 0xE8, 0xEA, 0xEB, 0xED, 0xEF,
        0xF0, 0xF1, 0xF2, 0xF3, 0xF8, 0xFA, 0xFB, 0xFD, 0xFF,
    };
    ...
    static constexpr Config::opcode_t ddcb_legals[] = {
        ...
        0x46, 0x4E, 0x56, 0x5E, 0x66, 0x6E, 0x76, 0x7E,
        0x86, 0x8E, 0x92, 0x96, 0x9A, 0x9E, 0xA6, 0xAE, 0xB6, 0xBA, 0xBE,
        0xC6, 0xCE, 0xD6, 0xDE, 0xE6, 0xEE, 0xF6, 0xFE,
    };
    for (auto i = 0; i < 0x100; i++) {
        const auto opc = static_cast<Config::opcode_t>(i);
