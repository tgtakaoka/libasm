...
#define AERRF(addr, name, opr, ...) AERRT(addr, name, opr, OPERAND_TOO_FAR, __VA_ARGS__)
#define AERVR(addr, name, opr, ...) AERRT(addr, name, opr, OVERFLOW_RANGE, __VA_ARGS__)
...
#define ERNA(name, opr, ...) ERRT(name, opr, OPERAND_NOT_ALIGNED, __VA_ARGS__)
...
#define ERVR(name, opr, ...) ERRT(name, opr, OVERFLOW_RANGE, __VA_ARGS__)
