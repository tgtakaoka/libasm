...
static void test_move_immediate() {
    TEST(LD, "B,0F6H", "246", 0x06, 0xF6);
    TEST(LD, "C,9FH",  "159", 0x0E, 0x9F);
    TEST(LD, "D,3AH",  "58",  0x16, 0x3A);
    TEST(LD, "E,80H",  "128", 0x1E, 0x80);
    TEST(LD, "H,0F6H", "246", 0x26, 0xF6);
    TEST(LD, "L,0F6H", "246", 0x2E, 0xF6);
    TEST(LD, "(HL),0F6H", "246", 0x36, 0xF6);
    TEST(LD, "A,0FEH", "254", 0x3E, 0xFE);

    TEST(LD,  "BC,0BEEFH", "-16657", 0x01, 0xEF, 0xBE);
    TEST(LD,  "DE,1234H",  "4660" ,  0x11, 0x34, 0x12);
    TEST(LD,  "HL,0BEEFH", "-16657", 0x21, 0xEF, 0xBE);
    TEST(LD,  "SP,6789H",  "26505",  0x31, 0x89, 0x67);
}
...
static void test_alu_immediate() {
    TEST(ADD, "A,02H",  "2",   0xC6, 0x02);
    TEST(ADC, "A,0FFH", "255", 0xCE, 0xFF);
    TEST(SUB, "A,02H",  "2",   0xD6, 0x02);
    TEST(SBC, "A,0FFH", "255", 0xDE, 0xFF);
    TEST(AND, "A,02H",  "2",   0xE6, 0x02);
    TEST(XOR, "A,0FFH", "255", 0xEE, 0xFF);
    TEST(OR,  "A,02H",  "2",   0xF6, 0x02);
    TEST(CP,  "A,0FFH", "255", 0xFE, 0xFF);
}
...
static void test_relative() {
    ATEST(0x1000, DJNZ, "1000H",    "-2",   0x10, 0xFE);
    ATEST(0x1000, JR,   "1000H",    "-2",   0x18, 0xFE);
    ATEST(0x1000, JR,   "NZ,1004H", "+2",   0x20, 0x02);
    ATEST(0x1000, JR,   "Z,1081H",  "+127", 0x28, 0x7F);
    ATEST(0x1000, JR,   "NC,0F82H", "-128", 0x30, 0x80);
    ATEST(0x1000, JR,   "C,0F82H",  "-128", 0x38, 0x80);
}
...
static void test_indexed() {
    ...
    TEST(LD, "(IX+2),0F6H", "246", 0xDD, 0x36, 0x02, 0xF6);
    ...
    TEST(LD, "(IY-2),0F6H", "246", 0xFD, 0x36, 0xFE, 0xF6);
