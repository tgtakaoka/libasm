...
void test_load() {
    ...
    if (z380()) {
        ...
        TEST("LDW", "(IX+127), BC", 0xDD, 0xCB, 0x7F, 0x0B);
        TEST("LDW", "(IX+127), DE", 0xDD, 0xCB, 0x7F, 0x1B);
        TEST("LDW", "(IX+127), IY", 0xDD, 0xCB, 0x7F, 0x2B);
        TEST("LDW", "(IX+127), HL", 0xDD, 0xCB, 0x7F, 0x3B);

        TEST("LDW", "(IY-128), BC", 0xFD, 0xCB, 0x80, 0x0B);
        TEST("LDW", "(IY-128), DE", 0xFD, 0xCB, 0x80, 0x1B);
        TEST("LDW", "(IY-128), IX", 0xFD, 0xCB, 0x80, 0x2B);
        TEST("LDW", "(IY-128), HL", 0xFD, 0xCB, 0x80, 0x3B);

        TEST("LDW", "(SP-128), BC", 0xDD, 0xCB, 0x80, 0x09);
        TEST("LDW", "(SP-128), DE", 0xDD, 0xCB, 0x80, 0x19);
        TEST("LDW", "(SP-128), HL", 0xDD, 0xCB, 0x80, 0x39);
        TEST("LDW", "(SP+127), IX", 0xDD, 0xCB, 0x7F, 0x29);
        TEST("LDW", "(SP-127), IY", 0xFD, 0xCB, 0x81, 0x29);
    }
}
...
void test_jump() {
    ...
    if (z380()) {
        ...
        disz80.setExtendedMode(true);
        AERRT(0xFF80, "JR", "C, 00010001H",  OVERFLOW_RANGE,  "00010001H", 0x38, 0x7F);
        AERRT(0x007C, "JR", "C, 0FFFFFFFEH", OVERFLOW_RANGE, "0FFFFFFFEH", 0x38, 0x80);
        disz80.setExtendedMode(false);
    ...
    if (z380()) {
        ...
        disz80.setExtendedMode(true);
        AERRT(0xFF80, "DJNZ", "00010001H", OVERFLOW_RANGE,   "00010001H",  0x10, 0x7F);
        AERRT(0x007C, "DJNZ", "0FFFFFFFEH", OVERFLOW_RANGE, "0FFFFFFFEH", 0x10, 0x80);
        disz80.setExtendedMode(false);
