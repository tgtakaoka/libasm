...
static void test_float_move() {
    ...
    TEST("FMOVE.X", "#-89000000000, FP0",  0xF200|074, 0x4000|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FMOVE.P", "#9.12E20, FP1",       0xF200|074, 0x4000|(3<<10)|(1<<7),
...
static void test_float_arithmetic() {
    ...
    TEST("FINT.X", "#-89000000000, FP0",  0xF200|074, 0x4001|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FINT.P", "#9.12E20, FP1",       0xF200|074, 0x4001|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSINH.X", "#-89000000000, FP0",  0xF200|074, 0x4002|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSINH.P", "#9.12E20, FP1",       0xF200|074, 0x4002|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FINTRZ.X", "#-89000000000, FP0",  0xF200|074, 0x4003|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FINTRZ.P", "#9.12E20, FP1",       0xF200|074, 0x4003|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSQRT.X", "#-89000000000, FP0",  0xF200|074, 0x4004|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSQRT.P", "#9.12E20, FP1",       0xF200|074, 0x4004|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FLOGNP1.X", "#-89000000000, FP0",  0xF200|074, 0x4006|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FLOGNP1.P", "#9.12E20, FP1",       0xF200|074, 0x4006|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FETOXM1.X", "#-89000000000, FP0",  0xF200|074, 0x4008|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FETOXM1.P", "#9.12E20, FP1",       0xF200|074, 0x4008|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTANH.X", "#-89000000000, FP0",  0xF200|074, 0x4009|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FTANH.P", "#9.12E20, FP1",       0xF200|074, 0x4009|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FATAN.X", "#-89000000000, FP0",  0xF200|074, 0x400A|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FATAN.P", "#9.12E20, FP1",       0xF200|074, 0x400A|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FASIN.X", "#-89000000000, FP0",  0xF200|074, 0x400C|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FASIN.P", "#9.12E20, FP1",       0xF200|074, 0x400C|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FATANH.X", "#-89000000000, FP0",  0xF200|074, 0x400D|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FATANH.P", "#9.12E20, FP1",       0xF200|074, 0x400D|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSIN.X", "#-89000000000, FP0",  0xF200|074, 0x400E|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSIN.P", "#9.12E20, FP1",       0xF200|074, 0x400E|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTAN.X", "#-89000000000, FP0",  0xF200|074, 0x400F|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FTAN.P", "#9.12E20, FP1",       0xF200|074, 0x400F|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FETOX.X", "#-89000000000, FP0",  0xF200|074, 0x4010|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FETOX.P", "#9.12E20, FP1",       0xF200|074, 0x4010|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTWOTOX.X", "#-89000000000, FP0",  0xF200|074, 0x4011|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FTWOTOX.P", "#9.12E20, FP1",       0xF200|074, 0x4011|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTENTOX.X", "#-89000000000, FP0",  0xF200|074, 0x4012|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FTENTOX.P", "#9.12E20, FP1",       0xF200|074, 0x4012|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FLOGN.X", "#-89000000000, FP0",  0xF200|074, 0x4014|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FLOGN.P", "#9.12E20, FP1",       0xF200|074, 0x4014|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FLOG10.X", "#-89000000000, FP0",  0xF200|074, 0x4015|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FLOG10.P", "#9.12E20, FP1",       0xF200|074, 0x4015|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FLOG2.X", "#-89000000000, FP0",  0xF200|074, 0x4016|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FLOG2.P", "#9.12E20, FP1",       0xF200|074, 0x4016|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FABS.X", "#-89000000000, FP0",  0xF200|074, 0x4018|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FABS.P", "#9.12E20, FP1",       0xF200|074, 0x4018|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FCOSH.X", "#-89000000000, FP0",  0xF200|074, 0x4019|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FCOSH.P", "#9.12E20, FP1",       0xF200|074, 0x4019|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FNEG.X", "#-89000000000, FP0",  0xF200|074, 0x401A|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FNEG.P", "#9.12E20, FP1",       0xF200|074, 0x401A|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FACOS.X", "#-89000000000, FP0",  0xF200|074, 0x401C|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FACOS.P", "#9.12E20, FP1",       0xF200|074, 0x401C|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FCOS.X", "#-89000000000, FP0",  0xF200|074, 0x401D|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FCOS.P", "#9.12E20, FP1",       0xF200|074, 0x401D|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FGETEXP.X", "#-89000000000, FP0",  0xF200|074, 0x401E|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FGETEXP.P", "#9.12E20, FP1",       0xF200|074, 0x401E|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FGETMAN.X", "#-89000000000, FP0",  0xF200|074, 0x401F|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FGETMAN.P", "#9.12E20, FP1",       0xF200|074, 0x401F|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FDIV.X", "#-89000000000, FP0",  0xF200|074, 0x4020|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FDIV.P", "#9.12E20, FP1",       0xF200|074, 0x4020|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FMOD.X", "#-89000000000, FP0",  0xF200|074, 0x4021|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FMOD.P", "#9.12E20, FP1",       0xF200|074, 0x4021|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FADD.X", "#-89000000000, FP0",  0xF200|074, 0x4022|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FADD.P", "#9.12E20, FP1",       0xF200|074, 0x4022|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FMUL.X", "#-89000000000, FP0",  0xF200|074, 0x4023|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FMUL.P", "#9.12E20, FP1",       0xF200|074, 0x4023|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSGLDIV.X", "#-89000000000, FP0",  0xF200|074, 0x4024|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSGLDIV.P", "#9.12E20, FP1",       0xF200|074, 0x4024|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FREM.X", "#-89000000000, FP0",  0xF200|074, 0x4025|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FREM.P", "#9.12E20, FP1",       0xF200|074, 0x4025|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSCALE.X", "#-89000000000, FP0",  0xF200|074, 0x4026|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSCALE.P", "#9.12E20, FP1",       0xF200|074, 0x4026|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSGLMUL.X", "#-89000000000, FP0",  0xF200|074, 0x4027|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSGLMUL.P", "#9.12E20, FP1",       0xF200|074, 0x4027|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSUB.X", "#-89000000000, FP0",  0xF200|074, 0x4028|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSUB.P", "#9.12E20, FP1",       0xF200|074, 0x4028|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSINCOS.X", "#-89000000000, FP4:FP0",  0xF200|074, 0x4034|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FSINCOS.P", "#9.12E20, FP3:FP1",       0xF200|074, 0x4033|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FCMP.X", "#-89000000000, FP0",  0xF200|074, 0x4038|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FCMP.P", "#9.12E20, FP1",       0xF200|074, 0x4038|(3<<10)|(1<<7),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTST.X", "#-89000000000",  0xF200|074, 0x403A|(2<<10),
         0xC023, 0x0000, 0xA5C6, 0x81D0, 0x0000, 0x0000);
    TEST("FTST.P", "#9.12E20",       0xF200|074, 0x403A|(3<<10),
         0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
