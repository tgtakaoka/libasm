...
static void test_data_move() {
    ...
    ERRT("LEA", "D2, A1", OPERAND_NOT_ALLOWED,              0041702);
    ERRT("LEA", "A3, A1", OPERAND_NOT_ALLOWED,              0041712);
    TEST("LEA", "(A2), A1",           0041722);
    ERRT("LEA", "(A2)+, A1", OPERAND_NOT_ALLOWED,           0041732);
    ERRT("LEA", "-(A2), A1", OPERAND_NOT_ALLOWED,           0041742);
    ...
    ERRT("LEA", "#$5678", OPERAND_NOT_ALLOWED,             0041774, 0x5678);
    ...
    ERRT("MOVE.B", "A2, D7", OPERAND_NOT_ALLOWED,               0017012);
    ...
    ERRT("MOVE.B", "A2, (A6)", OPERAND_NOT_ALLOWED,               0016212);
    ...
    ERRT("MOVE.B", "A2, (A6)+", OPERAND_NOT_ALLOWED,               0016312);
    ...
    ERRT("MOVE.B", "A2, -(A6)", OPERAND_NOT_ALLOWED,               0016412);
    ...
    ERRT("MOVE.B", "A2, ($5678,A6)", OPERAND_NOT_ALLOWED,               0016512, 0x5678);
    ...
    ERRT("MOVE.B", "A2, ($56,A6,D5.W)", OPERAND_NOT_ALLOWED,               0016612, 0x5056);
    ...
    ERRT("MOVE.B", "A2, ($005678).W", OPERAND_NOT_ALLOWED,               0010712, 0x5678);
    ...
    ERRT("MOVE.B", "A2, ($56789A).L", OPERAND_NOT_ALLOWED,               0011712, 0x0056, 0x789A);
    ...
    ERRT("MOVE.B", "D2, (d16,PC)", OPERAND_NOT_ALLOWED,                  0012702);
    ERRT("MOVE.W", "D2, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,                0033702);
    ERRT("MOVE.L", "D2, #nnnn", OPERAND_NOT_ALLOWED,                     0024702);
    ...
    ERRT("MOVEM.W", "D0-D6, A2", OPERAND_NOT_ALLOWED,             0044212, 0x007F);
    TEST("MOVEM.W", "D0-D6, (A2)",          0044222, 0x007F);
    ERRT("MOVEM.W", "D0-D6, (A2)+", OPERAND_NOT_ALLOWED,          0044232, 0x007F);
    ...
    ERRT("MOVEM.W", "D0-D6, (d16,PC)", OPERAND_NOT_ALLOWED,       0044272);
    ERRT("MOVEM.W", "D0-D6, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0044273);
    ERRT("MOVEM.W", "D0-D6, #nnnn", OPERAND_NOT_ALLOWED,          0044274);
    ...
    ERRT("MOVEM.L", "D1/A0, A2", OPERAND_NOT_ALLOWED,             0044312, 0x0102);
    TEST("MOVEM.L", "D1/A0, (A2)",          0044322, 0x0102);
    ERRT("MOVEM.L", "D1/A0, (A2)+", OPERAND_NOT_ALLOWED,          0044332, 0x0102);
    ...
    ERRT("MOVEM.L", "D1/A0, (d16,PC)", OPERAND_NOT_ALLOWED,       0044372);
    ERRT("MOVEM.L", "D1/A0, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0044373);
    ERRT("MOVEM.L", "D1/A0, #nnnn", OPERAND_NOT_ALLOWED,          0044374);
    ...
    ERRT("MOVEM.W", "D2, A3-A6", OPERAND_NOT_ALLOWED,               0046202, 0x7800);
    ERRT("MOVEM.W", "A2, A3-A6", OPERAND_NOT_ALLOWED,               0046212, 0x7800);
    TEST("MOVEM.W", "(A2), A3-A6",            0046222, 0x7800);
    TEST("MOVEM.W", "(A2)+, A3-A6",           0046232, 0x7800);
    ERRT("MOVEM.W", "-(A2), A3-A6", OPERAND_NOT_ALLOWED,            0046242, 0x7800);
    ...
    ERRT("MOVEM.W", "#nnnn, A3-A6", OPERAND_NOT_ALLOWED,            0046274);
    ...
    ERRT("MOVEM.L", "D2, A3-A6", OPERAND_NOT_ALLOWED,               0046302, 0x7800);
    ERRT("MOVEM.L", "A2, A3-A6", OPERAND_NOT_ALLOWED,               0046312, 0x7800);
    TEST("MOVEM.L", "(A2), A3-A6",            0046322, 0x7800);
    TEST("MOVEM.L", "(A2)+, A3-A6",           0046332, 0x7800);
    ERRT("MOVEM.L", "-(A2), A3-A6", OPERAND_NOT_ALLOWED,            0046342, 0x7800);
    ...
    ERRT("MOVEM.L", "#nnnn, A3-A6", OPERAND_NOT_ALLOWED,            0046374);
    ...
    ERRT("PEA", "A2", OPERAND_NOT_ALLOWED,              0044112);
    TEST("PEA", "(A2)",           0044122);
    ERRT("PEA", "(A2)+", OPERAND_NOT_ALLOWED,           0044132);
    ERRT("PEA", "-(A2)", OPERAND_NOT_ALLOWED,           0044142);
    ...
    ERRT("PEA", "#$5678", OPERAND_NOT_ALLOWED,          0044174, 0x5678);
...
static void test_integer() {
    ...
    ERRT("ADD.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0157472);
    ERRT("ADD.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0157473);
    ERRT("ADD.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0157474);
    ...
    ERRT("ADD.W", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0157572);
    ERRT("ADD.W", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0157573);
    ERRT("ADD.W", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0157574);
    ...
    ERRT("ADD.L", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0157672);
    ERRT("ADD.L", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0157673);
    ERRT("ADD.L", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0157674);

    // ADD src,Dn: 015|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ADD.B", "D2, D7",             0157002);
    ERRT("ADD.B", "A2, D7", OPERAND_NOT_ALLOWED,              0157012);
    ...
    ERRT("ADDI.B", "#18, A2", OPERAND_NOT_ALLOWED,             0003012, 0x0012);
    ...
    ERRT("ADDI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,       0003072, 0x0012);
    ERRT("ADDI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0003073, 0x0012);
    ERRT("ADDI.B", "#18, #nnnn", OPERAND_NOT_ALLOWED,          0003074, 0x0012);
    TEST("ADDI.W", "#$5678, D2",           0003102, 0x5678);
    ERRT("ADDI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0003112, 0x5678);
    ...
    ERRT("ADDI.W", "#$5678, (d16,PC)", OPERAND_NOT_ALLOWED,      0003172, 0x5678);
    ERRT("ADDI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0003173, 0x5678);
    ERRT("ADDI.W", "#$5678, #nnnn", OPERAND_NOT_ALLOWED,         0003174, 0x5678);
    TEST("ADDI.L", "#$3456789A, D2",           0003202, 0x3456, 0x789A);
    ERRT("ADDI.L", "#$3456789A, A2", OPERAND_NOT_ALLOWED,            0003212, 0x3456, 0x789A);
    ...
    ERRT("ADDI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0003272, 0x3456, 0x789A);
    ERRT("ADDI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0003273, 0x3456, 0x789A);
    ERRT("ADDI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0003274, 0x3456, 0x789A);

    // ADDQ #nn,dst: 005|nn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ADDQ.B", "#8, D2",           0050002);
    ERRT("ADDQ.B", "#8, A2", OPERAND_NOT_ALLOWED,            0050012);
    ...
    ERRT("ADDQ.B", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050072);
    ERRT("ADDQ.B", "#8, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050073);
    ERRT("ADDQ.B", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050074);
    ...
    ERRT("ADDQ.W", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050172);
    ERRT("ADDQ.W", "#8, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050173);
    ERRT("ADDQ.W", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050174);
    ...
    ERRT("ADDQ.L", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050272);
    ERRT("ADDQ.L", "#8, (d8,pC,Xn)", OPERAND_NOT_ALLOWED,    0050273);
    ERRT("ADDQ.L", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050274);
    ...
    ERRT("CLR.B", "A2", OPERAND_NOT_ALLOWED,            0041012);
    ...
    ERRT("CLR.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0041072);
    ERRT("CLR.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0041073);
    ERRT("CLR.B", "#nnnn", OPERAND_NOT_ALLOWED,         0041074);
    TEST("CLR.W", "D2",           0041102);
    ERRT("CLR.W", "A2", OPERAND_NOT_ALLOWED,            0041112);
    ...
    ERRT("CLR.W", "(d16,PC)", OPERAND_NOT_ALLOWED,      0041172);
    ERRT("CLR.W", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0041173);
    ERRT("CLR.W", "#nnnn", OPERAND_NOT_ALLOWED,         0041174);
    TEST("CLR.L", "D2",           0041202);
    ERRT("CLR.L", "A2", OPERAND_NOT_ALLOWED,            0041212);
    ...
    ERRT("CLR.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0041272);
    ERRT("CLR.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0041273);
    ERRT("CLR.B", "#nnnn", OPERAND_NOT_ALLOWED,         0041274);

    // CMP src,Dn: 013|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("CMP.B", "D2, D7",             0137002);
    ERRT("CMP.B", "A2", OPERAND_NOT_ALLOWED,                 0137012);
    ...
    ERRT("CMPI.B", "#18, A2", OPERAND_NOT_ALLOWED,            0006012, 0x0012);
    ...
    ERRT("CMPI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,      0006072, 0x0012);
    ERRT("CMPI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0006073, 0x0012);
    ERRT("CMPI.B", "#18, #nnnn", OPERAND_NOT_ALLOWED,         0006074, 0x0012);
    TEST("CMPI.W", "#$5678, D2",           0006102, 0x5678);
    ERRT("CMPI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0006112, 0x5678);
    ...
    ERRT("CMPI.W", "#$5678, (d16,PC)", OPERAND_NOT_ALLOWED,      0006172, 0x5678);
    ERRT("CMPI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0006173, 0x5678);
    ERRT("CMPI.W", "#$5678, #nnnn", OPERAND_NOT_ALLOWED,         0006174, 0x5678);
    TEST("CMPI.L", "#$3456789A, D2",           0006202, 0x3456, 0x789A);
    ERRT("CMPI.L", "#$3456789A, A2", OPERAND_NOT_ALLOWED,            0006212, 0x3456, 0x789A);
    ...
    ERRT("CMPI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0006272, 0x3456, 0x789A);
    ERRT("CMPI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0006273, 0x3456, 0x789A);
    ERRT("CMPI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0006274, 0x3456, 0x789A);
    ...
    ERRT("DIVS.W", "A2, D7", OPERAND_NOT_ALLOWED,              0107712);
    ...
    ERRT("DIVU.W", "A2, D7", OPERAND_NOT_ALLOWED,              0107312);
    ...
    ERRT("MULS.W", "A2, D7", OPERAND_NOT_ALLOWED,              0147712);
    ...
    ERRT("MULU.W", "A2, D7", OPERAND_NOT_ALLOWED,              0147312);
    ...
    ERRT("NEG.B", "A2", OPERAND_NOT_ALLOWED,            0042012);
    ...
    ERRT("NEG.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0042072);
    ERRT("NEG.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0042073);
    ERRT("NEG.B", "#nnnn", OPERAND_NOT_ALLOWED,         0042074);
    TEST("NEG.W", "D2",           0042102);
    ERRT("NEG.W", "A2", OPERAND_NOT_ALLOWED,            0042112);
    ...
    ERRT("NEG.W", "(d16,PC)", OPERAND_NOT_ALLOWED,      0042172);
    ERRT("NEG.W", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0042173);
    ERRT("NEG.W", "#nnnn", OPERAND_NOT_ALLOWED,         0042174);
    TEST("NEG.L", "D2",           0042202);
    ERRT("NEG.L", "A2", OPERAND_NOT_ALLOWED,            0042212);
    ...
    ERRT("NEG.L", "(d16,PC)", OPERAND_NOT_ALLOWED,      0042272);
    ERRT("NEG.L", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0042273);
    ERRT("NEG.L", "#nnnn", OPERAND_NOT_ALLOWED,         0042274);

    // NEGX dst: 0040|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("NEGX.B", "D2",           0040002);
    ERRT("NEGX.B", "A2", OPERAND_NOT_ALLOWED,            0040012);
    ...
    ERRT("NEGX.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0040072);
    ERRT("NEGX.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0040073);
    ERRT("NEGX.B", "#nnnn", OPERAND_NOT_ALLOWED,         0040074);
    TEST("NEGX.W", "D2",           0040102);
    ERRT("NEGX.W", "A2", OPERAND_NOT_ALLOWED,            0040112);
    ...
    ERRT("NEGX.W", "(d16,PC)", OPERAND_NOT_ALLOWED,      0040172);
    ERRT("NEGX.W", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0040173);
    ERRT("NEGX.W", "#nnnn", OPERAND_NOT_ALLOWED,         0040174);
    TEST("NEGX.L", "D2",           0040202);
    ERRT("NEGX.L", "A2", OPERAND_NOT_ALLOWED,            0040212);
    ...
    ERRT("NEGX.L", "(d16,PC)", OPERAND_NOT_ALLOWED,      0040272);
    ERRT("NEGX.L", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0040273);
    ERRT("NEGX.L", "#nnnn", OPERAND_NOT_ALLOWED,         0040274);

    // SUB src,Dn: 011|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("SUB.B", "D2, D7",             0117002);
    ERRT("SUB.B", "A2, D7", OPERAND_NOT_ALLOWED,              0117012);
    ...
    ERRT("SUB.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0117472);
    ERRT("SUB.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0117473);
    ERRT("SUB.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0117474);
    ...
    ERRT("SUB.W", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0117572);
    ERRT("SUB.W", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0117573);
    ERRT("SUB.W", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0117574);
    ...
    ERRT("SUB.L", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0117672);
    ERRT("SUB.L", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0117673);
    ERRT("SUB.L", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0117674);
    ...
    ERRT("SUBI.B", "#18, A2", OPERAND_NOT_ALLOWED,            0002012, 0x0012);
    ...
    ERRT("SUBI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,      0002072, 0x0012);
    ERRT("SUBI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0002073, 0x0012);
    ERRT("SUBI.B", "#18, #nnnn", OPERAND_NOT_ALLOWED,         0002074, 0x0012);
    TEST("SUBI.W", "#$5678, D2",           0002102, 0x5678);
    ERRT("SUBI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0002112, 0x5678);
    ...
    ERRT("SUBI.W", "#$5678, (d16,PC)", OPERAND_NOT_ALLOWED,      0002172, 0x5678);
    ERRT("SUBI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0002173, 0x5678);
    ERRT("SUBI.W", "#$5678, #nnnn", OPERAND_NOT_ALLOWED,         0002174, 0x5678);
    TEST("SUBI.L", "#$3456789A, D2",           0002202, 0x3456, 0x789A);
    ERRT("SUBI.L", "#$3456789A,A2,", OPERAND_NOT_ALLOWED,           0002212, 0x3456, 0x789A);
    ...
    ERRT("SUBI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0002272, 0x3456, 0x789A);
    ERRT("SUBI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0002273, 0x3456, 0x789A);
    ERRT("SUBI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0002274, 0x3456, 0x789A);

    // SUBQ #nn,dst: 005|nn|Sz|M\En, Sz:B=4/W=5/L=6
    TEST("SUBQ.B", "#8, D2",           0050402);
    ERRT("SUBQ.B", "#8, A2", OPERAND_NOT_ALLOWED,            0050412);
    ...
    ERRT("SUBQ.B", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050472);
    ERRT("SUBQ.B", "#8, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050473);
    ERRT("SUBQ.B", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050474);
    ...
    ERRT("SUBQ.W", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050572);
    ERRT("SUBQ.W", "#8, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050573);
    ERRT("SUBQ.W", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050574);
    ...
    ERRT("SUBQ.L", "#8, (d16,PC)", OPERAND_NOT_ALLOWED,      0050672);
    ERRT("SUBQ.L", "#8, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050673);
    ERRT("SUBQ.L", "#8, #nnnn", OPERAND_NOT_ALLOWED,         0050674);
...
static void test_logical() {
    ...
    ERRT("AND.B", "A2, D7", OPERAND_NOT_ALLOWED,              0147012);
    ...
    ERRT("AND.W", "A2, D7", OPERAND_NOT_ALLOWED,              0147112);
    ...
    ERRT("AND.L", "A2, D7", OPERAND_NOT_ALLOWED,              0147212);
    ...
    ERRT("AND.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0147472);
    ERRT("AND.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0147473);
    ERRT("AND.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0147474);
    ...
    ERRT("AND.W", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0147572);
    ERRT("AND.W", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0147573);
    ERRT("AND.W", "D7,  #nnnn", OPERAND_NOT_ALLOWED,        0147574);
    ERRT("AND.L", "D7, D2", OPERAND_NOT_ALLOWED,            0147602);
    ...
    ERRT("AND.L", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0147672);
    ERRT("AND.L", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0147673);
    ERRT("AND.L", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0147674);

    // ANDI #nn,dst: 0001|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ANDI.B", "#18, D2",           0001002, 0x0012);
    ERRT("ANDI.B", "#18, A2", OPERAND_NOT_ALLOWED,            0001012, 0x0012);
    ...
    ERRT("ANDI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,      0001072, 0x0012);
    ERRT("ANDI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0001073, 0x0012);
    TEST("ANDI",   "#18, CCR",          0001074, 0x0012); // ANDI CCR
    TEST("ANDI.W", "#$5678, D2",           0001102, 0x5678);
    ERRT("ANDI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0001112, 0x5678);
    ...
    ERRT("ANDI.W", "#$5678,m(d16,PC)", OPERAND_NOT_ALLOWED,     0001172, 0x5678);
    ERRT("ANDI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0001173, 0x5678);
    TEST("ANDI",   "#$5678, SR",           0001174, 0x5678); // ANDI SR
    TEST("ANDI.L", "#$3456789A, D2",           0001202, 0x3456, 0x789A);
    ERRT("ANDI.L", "#$3456789A, A2", OPERAND_NOT_ALLOWED,            0001212, 0x3456, 0x789A);
    ...
    ERRT("ANDI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0001272, 0x3456, 0x789A);
    ERRT("ANDI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0001273, 0x3456, 0x789A);
    ERRT("ANDI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0001274, 0x3456, 0x789A);
    ...
    ERRT("EOR.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0137472);
    ERRT("EOR.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0137473);
    ERRT("EOR.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0137474);
    ...
    ERRT("EOR.W", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0137572);
    ERRT("EOR.W", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0137573);
    ERRT("EOR.W", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0137574);
    ...
    ERRT("EOR.L", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0137672);
    ERRT("EOR.L", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0137673);
    ERRT("EOR.L", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0137674);

    // EORI #nn,dst: 0005|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("EORI.B", "#18, D2",           0005002, 0x0012);
    ERRT("EORI.B", "#18, A2", OPERAND_NOT_ALLOWED,            0005012, 0x0012);
    ...
    ERRT("EORI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,      0005072, 0x0012);
    ERRT("EORI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0005073, 0x0012);
    TEST("EORI",   "#18, CCR",          0005074, 0x0012); // EORI CCR
    TEST("EORI.W", "#$5678, D2",           0005102, 0x5678);
    ERRT("EORI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0005112, 0x5678);
    ...
    ERRT("EORI.W", "#$5678, (d16,PC)", OPERAND_NOT_ALLOWED,      0005172, 0x5678);
    ERRT("EORI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0005173, 0x5678);
    TEST("EORI",   "#$5678, SR",           0005174, 0x5678); // EORI SR
    TEST("EORI.L", "#$3456789A, D2",           0005202, 0x3456, 0x789A);
    ERRT("EORI.L", "#$3456789A, A2", OPERAND_NOT_ALLOWED,            0005212, 0x3456, 0x789A);
    ...
    ERRT("EORI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0005272, 0x3456, 0x789A);
    ERRT("EORI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0005273, 0x3456, 0x789A);
    ERRT("EORI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0005274, 0x3456, 0x789A);

    // NOT dst: 0043|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("NOT.B", "D2",           0043002);
    ERRT("NOT.B", "A2", OPERAND_NOT_ALLOWED,            0043012);
    ...
    ERRT("NOT.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0043072);
    ERRT("NOT.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0043073);
    ERRT("NOT.B", "#nnnn", OPERAND_NOT_ALLOWED,         0043074);
    TEST("NOT.W", "D2",           0043102);
    ERRT("NOT.W", "A2", OPERAND_NOT_ALLOWED,            0043112);
    ...
    ERRT("NOT.W", "(d16,PC)", OPERAND_NOT_ALLOWED,      0043172);
    ERRT("NOT.W", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0043173);
    ERRT("NOT.W", "#nnnn", OPERAND_NOT_ALLOWED,         0043174);
    TEST("NOT.L", "D2",           0043202);
    ERRT("NOT.L", "A2", OPERAND_NOT_ALLOWED,            0043212);
    ...
    ERRT("NOT.L", "(d16,PC)", OPERAND_NOT_ALLOWED,      0043272);
    ERRT("NOT.L", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0043273);
    ERRT("NOT.L", "#nnnn", OPERAND_NOT_ALLOWED,         0043274);

    // OR src,Dn, 010|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("OR.B", "D2, D7",             0107002);
    ERRT("OR.B", "A2, D7", OPERAND_NOT_ALLOWED,              0107012);
    ...
    ERRT("OR.W", "A2, D7", OPERAND_NOT_ALLOWED,              0107112);
    ...
    ERRT("OR.L", "A2, D7", OPERAND_NOT_ALLOWED,              0107212);
    ...
    ERRT("OR.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0107472);
    ERRT("OR.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0107473);
    ERRT("OR.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0107474);
    ERRT("OR.W", "D7, D2", OPERAND_NOT_ALLOWED,            0107502);
    ERRT("OR.W", "D7, A2", OPERAND_NOT_ALLOWED,            0107512);
    ...
    ERRT("OR.W", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0107572);
    ERRT("OR.W", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0107573);
    ERRT("OR.W", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0107574);
    ERRT("OR.L", "D7, D2", OPERAND_NOT_ALLOWED,            0107602);
    ERRT("OR.L", "D7, A2", OPERAND_NOT_ALLOWED,            0107612);
    ...
    ERRT("OR.L", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0107672);
    ERRT("OR.L", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0107673);
    ERRT("OR.L", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0107674);

    // ORI #nn,dst: 0000|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ORI.B", "#18, D2",           0000002, 0x0012);
    ERRT("ORI.B", "#18, A2", OPERAND_NOT_ALLOWED,            0000012, 0x0012);
    ...
    ERRT("ORI.B", "#18, (d16,PC)", OPERAND_NOT_ALLOWED,      0000072, 0x0012);
    ERRT("ORI.B", "#18, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0000073, 0x0012);
    TEST("ORI",   "#18, CCR",          0000074, 0x0012); // ORI CCR
    TEST("ORI.W", "#$5678, D2",           0000102, 0x5678);
    ERRT("ORI.W", "#$5678, A2", OPERAND_NOT_ALLOWED,            0000112, 0x5678);
    ...
    ERRT("ORI.W", "#$5678, (d16,PC)", OPERAND_NOT_ALLOWED,      0000172, 0x5678);
    ERRT("ORI.W", "#$5678, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0000173, 0x5678);
    TEST("ORI",   "#$5678, SR",           0000174, 0x5678); // ORI SR
    TEST("ORI.L", "#$3456789A, D2",           0000202, 0x3456, 0x789A);
    ERRT("ORI.L", "#$3456789A, A2", OPERAND_NOT_ALLOWED,            0000212, 0x3456, 0x789A);
    ...
    ERRT("ORI.L", "#$3456789A, (d16,PC)", OPERAND_NOT_ALLOWED,      0000272, 0x3456, 0x789A);
    ERRT("ORI.L", "#$3456789A, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0000273, 0x3456, 0x789A);
    ERRT("ORI.L", "#$3456789A, #nnnn", OPERAND_NOT_ALLOWED,         0000274, 0x3456, 0x789A);
}
...
static void test_shift_rotate() {
    ...
    // ASL dst: 01607|M|Rn
    ERRT("ASL",   "D2", OPERAND_NOT_ALLOWED,             0160702);
    ERRT("ASL",   "A2", OPERAND_NOT_ALLOWED,             0160712);
    ...
    ERRT("ASL.W", "(d16,PC)", OPERAND_NOT_ALLOWED,       0160772);
    ERRT("ASL",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0160773);
    ERRT("ASL",   "#nnnn", OPERAND_NOT_ALLOWED,          0160774);
    ...
    // ASR dst: 01603|M|Rn
    ERRT("ASR",   "D2", OPERAND_NOT_ALLOWED,             0160302);
    ERRT("ASR",   "A2", OPERAND_NOT_ALLOWED,             0160312);
    ...
    ERRT("ASR",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0160372);
    ERRT("ASR",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0160373);
    ERRT("ASR",   "#nnnn", OPERAND_NOT_ALLOWED,          0160374);
    ...
    // LSL dst: 01617|M|Rn
    ERRT("LSL",   "D2", OPERAND_NOT_ALLOWED,             0161702);
    ERRT("LSL",   "A2", OPERAND_NOT_ALLOWED,             0161712);
    ...
    ERRT("LSL",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0161772);
    ERRT("LSL",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0161773);
    ERRT("LSL",   "#nnnn", OPERAND_NOT_ALLOWED,          0161774);
    ...
    // LSR dst: 01613|M|Rn
    ERRT("LSR",   "D2", OPERAND_NOT_ALLOWED,             0161302);
    ERRT("LSR",   "A2", OPERAND_NOT_ALLOWED,             0161312);
    ...
    ERRT("LSR",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0161372);
    ERRT("LSR",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0161373);
    ERRT("LSR",   "#nnnn", OPERAND_NOT_ALLOWED,          0161374);
    ...
    // ROL dst: 01637|M|Rn
    ERRT("ROL",   "D2", OPERAND_NOT_ALLOWED,             0163702);
    ERRT("ROL",   "A2", OPERAND_NOT_ALLOWED,             0163712);
    ...
    ERRT("ROL",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0163772);
    ERRT("ROL",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0163773);
    ERRT("ROL",   "#nnnn", OPERAND_NOT_ALLOWED,          0163774);
    ...
    // ROR dst: 01633|M|Rn
    ERRT("ROR",   "D2", OPERAND_NOT_ALLOWED,             0163302);
    ERRT("ROR",   "A2", OPERAND_NOT_ALLOWED,             0163312);
    ...
    ERRT("ROR",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0163372);
    ERRT("ROR",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0163373);
    ERRT("ROR",   "#nnnn", OPERAND_NOT_ALLOWED,          0163374);
    ...
    // ROXL dst: 01627|M|Rn
    ERRT("ROXL",   "D2", OPERAND_NOT_ALLOWED,             0162702);
    ERRT("ROXL",   "A2", OPERAND_NOT_ALLOWED,             0162712);
    ...
    ERRT("ROXL",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0162772);
    ERRT("ROXL",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0162773);
    ERRT("ROXL",   "#nnnn", OPERAND_NOT_ALLOWED,          0162774);
    ...
    // ROXR dst: 01623|M|Rn
    ERRT("ROXR",   "D2", OPERAND_NOT_ALLOWED,             0162302);
    ERRT("ROXR",   "A2", OPERAND_NOT_ALLOWED,             0162312);
    ...
    ERRT("ROXR",   "(d16,PC)", OPERAND_NOT_ALLOWED,       0162372);
    ERRT("ROXR",   "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,     0162373);
    ERRT("ROXR",   "#nnnn", OPERAND_NOT_ALLOWED,          0162374);
...
static void test_bit() {
    ...
    ERRT("BCHG.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0007572);
    ERRT("BCHG.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0007573);
    ERRT("BCHG.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0007574);
    ...
    ERRT("BCHG.L", "#6, A2", OPERAND_NOT_ALLOWED,            0004112, 0x0006);
    ...
    ERRT("BCHG.B", "#0, (d16,PC)", OPERAND_NOT_ALLOWED,      0004172, 0x0000);
    ERRT("BCHG.B", "#7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0004173, 0x0007);
    ERRT("BCHG.B", "#6, #nnnn", OPERAND_NOT_ALLOWED,         0004174, 0x0006);
    ...
    ERRT("BCLR.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0007672);
    ERRT("BCLR.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0007673);
    ERRT("BCLR.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0007674);

    // BCLR #n,dst: 00042|M|Rn
    TEST("BCLR.L", "#0, D2",           0004202, 0x0000);
    ERRT("BCLR.L", "#1, A2", OPERAND_NOT_ALLOWED,            0004212, 0x0001);
    ...
    ERRT("BCLR.B", "#0, (d16,PC)", OPERAND_NOT_ALLOWED,      0004272, 0x0000);
    ERRT("BCLR.B", "#7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0004273, 0x0007);
    ERRT("BCLR.B", "#6, #nnnn", OPERAND_NOT_ALLOWED,         0004274, 0x0006);
    ...
    ERRT("BSET.B", "D7, (d16,PC)", OPERAND_NOT_ALLOWED,      0007772);
    ERRT("BSET.B", "D7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0007773);
    ERRT("BSET.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,         0007774);

    // BSET #n,dst: 00043|M|Rn
    TEST("BSET.L", "#0, D2",           0004302, 0x0000);
    ERRT("BSET.L", "#1, A2", OPERAND_NOT_ALLOWED,            0004312, 0x0001);
    ...
    ERRT("BSET.B", "#0, (d16,PC)", OPERAND_NOT_ALLOWED,      0004372, 0x0000);
    ERRT("BSET.B", "#7, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0004373, 0x0007);
    ERRT("BSET.B", "#6, #nnnn", OPERAND_NOT_ALLOWED,         0004374, 0x0006);
    ...
    ERRT("BTST.B", "D7, #nnnn", OPERAND_NOT_ALLOWED,           0007474);

    // BTST #n,dst: 00040|M|Rn
    TEST("BTST.L", "#0, D2",             0004002, 0x0000);
    ERRT("BTST.L", "#1, A2", OPERAND_NOT_ALLOWED,              0004012, 0x0001);
    ...
    ERRT("BTST.B", "#6, #nnnn", OPERAND_NOT_ALLOWED,           0004074, 0x0006);
}
...
static void test_bcd() {
    ...
    ERRT("NBCD", "A2", OPERAND_NOT_ALLOWED,            0044012);
    ...
    ERRT("NBCD", "(d16,PC)", OPERAND_NOT_ALLOWED,      0044072);
    ERRT("NBCD", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0044073);
    ERRT("NBCD", "#nnnn", OPERAND_NOT_ALLOWED,         0044074);
...
static void test_program() {
    ...
    ERRT("ST", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x000);
    ERRT("ST", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x000);
    ERRT("ST", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x000);
    ...
    ERRT("SF", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x100);
    ERRT("SF", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x100);
    ERRT("SF", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x100);
    ...
    ERRT("SHI", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x200);
    ERRT("SHI", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x200);
    ERRT("SHI", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x200);
    ...
    ERRT("SLS", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x300);
    ERRT("SLS", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x300);
    ERRT("SLS", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x300);
    ...
    ERRT("SCC", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x400);
    ERRT("SCC", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x400);
    ERRT("SCC", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x400);
    ...
    ERRT("SCS", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x500);
    ERRT("SCS", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x500);
    ERRT("SCS", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x500);
    ...
    ERRT("SNE", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x600);
    ERRT("SNE", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x600);
    ERRT("SNE", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x600);
    ...
    ERRT("SEQ", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x700);
    ERRT("SEQ", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x700);
    ERRT("SEQ", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x700);
    ...
    ERRT("SVC", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x800);
    ERRT("SVC", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x800);
    ERRT("SVC", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x800);
    ...
    ERRT("SVS", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0x900);
    ERRT("SVS", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0x900);
    ERRT("SVS", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0x900);
    ...
    ERRT("SPL", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xA00);
    ERRT("SPL", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xA00);
    ERRT("SPL", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xA00);
    ...
    ERRT("SMI", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xB00);
    ERRT("SMI", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xB00);
    ERRT("SMI", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xB00);
    ...
    ERRT("SGE", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xC00);
    ERRT("SGE", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xC00);
    ERRT("SGE", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xC00);
    ...
    ERRT("SLT", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xD00);
    ERRT("SLT", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xD00);
    ERRT("SLT", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xD00);
    ...
    ERRT("SGT", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xE00);
    ERRT("SGT", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xE00);
    ERRT("SGT", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xE00);
    ...
    ERRT("SLE", "(d16,PC)", OPERAND_NOT_ALLOWED,      0050372 | 0xF00);
    ERRT("SLE", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0050373 | 0xF00);
    ERRT("SLE", "#nnnn", OPERAND_NOT_ALLOWED,         0050374 | 0xF00);
    ...
    // JMP dst: 00473|M|Rn
    ERRT("JMP", "D2", OPERAND_NOT_ALLOWED,              0047302);
    ERRT("JMP", "A2", OPERAND_NOT_ALLOWED,              0047312);
    TEST("JMP", "(A2)",           0047322);
    ERRT("JMP", "(A2)+", OPERAND_NOT_ALLOWED,           0047332);
    ERRT("JMP", "-(A2)", OPERAND_NOT_ALLOWED,           0047342);
    ...
    ERRT("JMP", "#nnnn", OPERAND_NOT_ALLOWED,           0047374);

    // JSR dst, 00472|M|Rn
    ERRT("JSR", "D2", OPERAND_NOT_ALLOWED,              0047202);
    ERRT("JSR", "A2", OPERAND_NOT_ALLOWED,              0047212);
    TEST("JSR", "(A2)",           0047222);
    ERRT("JSR", "(A2)+", OPERAND_NOT_ALLOWED,           0047232);
    ERRT("JSR", "-(A2)", OPERAND_NOT_ALLOWED,           0047242);
    ...
    ERRT("JSR", "#nnnn", OPERAND_NOT_ALLOWED,           0047274);
    ...
    ERRT("TST.B", "A2", OPERAND_NOT_ALLOWED,            0045012);
    ...
    ERRT("TST.B", "(d16,PC)", OPERAND_NOT_ALLOWED,      0045072);
    ERRT("TST.B", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0045073);
    ERRT("TST.B", "#nnnn", OPERAND_NOT_ALLOWED,         0045074);
    TEST("TST.W", "D2",           0045102);
    ERRT("TST.W", "A2", OPERAND_NOT_ALLOWED,            0045112);
    ...
    ERRT("TST.W", "(d16,PC)", OPERAND_NOT_ALLOWED,      0045172);
    ERRT("TST.W", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0045173);
    ERRT("TST.W", "#nnnn", OPERAND_NOT_ALLOWED,         0045174);
    TEST("TST.L", "D2",           0045202);
    ERRT("TST.L", "A2", OPERAND_NOT_ALLOWED,            0045212);
    ...
    ERRT("TST.L", "(d16,PC)", OPERAND_NOT_ALLOWED,      0045272);
    ERRT("TST.L", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0045273);
    ERRT("TST.L", "#nnnn", OPERAND_NOT_ALLOWED,         0045274);
}
...
static void test_system() {
    ...
    ERRT("MOVE.W", "A2, SR", OPERAND_NOT_ALLOWED,              0043312);
    ...
    ERRT("MOVE.W", "SR, A2", OPERAND_NOT_ALLOWED,            0040312);
    ...
    ERRT("MOVE.W", "SR, (d16,PC)", OPERAND_NOT_ALLOWED,      0040372, 0x1232);
    ERRT("MOVE.W", "SR, (d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0040373);
    ERRT("MOVE.W", "SR, #nnnn", OPERAND_NOT_ALLOWED,         0040374);
    ...
    ERRT("CHK.W", "A2, D7", OPERAND_NOT_ALLOWED,              0047612);
    ...
    ERRT("MOVE.W", "A2, CCR", OPERAND_NOT_ALLOWED,              0042312);
    ...
    ERRT("MOVE.W", "($001233).W, CCR",    OPERAND_NOT_ALIGNED, 0042370, 0x1235);
    TEST("MOVE.W", "($234568).L, CCR",    0042371, 0x0023, 0x4568);
    ERRT("MOVE.W", "($234567).L, CCR",    OPERAND_NOT_ALIGNED, 0042371, 0x0023, 0x4569);
    TEST("MOVE.W", "(*+$1234,PC), CCR",   0042372, 0x1232);
    ERRT("MOVE.W", "(*+$1233,PC), CCR",   OPERAND_NOT_ALIGNED, 0042372, 0x1233);
...
static void test_multiproc() {
    // TAS dst: 00453|M|Rn
    TEST("TAS", "D2",           0045302);
    ERRT("TAS", "A2", OPERAND_NOT_ALLOWED,            0045312);
    TEST("TAS", "(A2)",         0045322);
    TEST("TAS", "(A2)+",        0045332);
    TEST("TAS", "-(A2)",        0045342);
    ...
    ERRT("TAS", "(d16,PC)", OPERAND_NOT_ALLOWED,      0045372);
    ERRT("TAS", "(d8,PC,Xn)", OPERAND_NOT_ALLOWED,    0045373);
