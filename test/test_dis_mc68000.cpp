...
static void test_float_move() {
    ...
    TEST("FMOVE.P", "#0.0912, FP1",        0xF200|074, 0x4000|(3<<10)|(1<<7),
         0x4002, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
...
static void test_float_arithmetic() {
    ...
    TEST("FINT.X", "#-89000000032, FP0",  0xF200|074, 0x4001|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FINT.P", "#912, FP1",           0xF200|074, 0x4001|(3<<10)|(1<<7),
         0x0002, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSINH.P", "#-9.12E+20, FP1",     0xF200|074, 0x4002|(3<<10)|(1<<7),
         0x8020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FINTRZ.P", "#9.12E-20, FP1",      0xF200|074, 0x4003|(3<<10)|(1<<7),
         0x4020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FSQRT.X", "#-89000000032, FP0",  0xF200|074, 0x4004|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FSQRT.P", "#9.1234567891234567, FP1", 0xF200|074, 0x4004|(3<<10)|(1<<7),
         0x0000, 0x0009, 0x1234, 0x5678, 0x9123, 0x4567);
    ...
    TEST("FLOGNP1.X", "#-89000000032, FP0",  0xF200|074, 0x4006|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FLOGNP1.P", "#-INF, FP1",       0xF200|074, 0x4006|(3<<10)|(1<<7),
    ...
    TEST("FETOXM1.X", "#-89000000032, FP0",  0xF200|074, 0x4008|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FETOXM1.P", "#NAN, FP1",           0xF200|074, 0x4008|(3<<10)|(1<<7),
         0x7FFF, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FTANH.X", "#-89000000032, FP0",  0xF200|074, 0x4009|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FTANH.P", "#9.12E+999, FP1",     0xF200|074, 0x4009|(3<<10)|(1<<7),
         0x0999, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    ...
    TEST("FATAN.X", "#-89000000032, FP0",  0xF200|074, 0x400A|(2<<10)|(0<<7),
         0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TEST("FATAN.P", "#9.12E-999, FP1",     0xF200|074, 0x400A|(3<<10)|(1<<7),
         0x4999, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
