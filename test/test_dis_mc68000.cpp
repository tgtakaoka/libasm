...
void test_float_move() {
    ...
    TFLT("FMOVE.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FMOVE.X", "#-89000000032.0, FP0",  "#$C0230001A5C681D100000000, FP0",
...
void test_float_common() {
    ...
    TFLT("FSQRT.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FABS.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FNEG.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FDIV.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FADD.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FMUL.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSGLDIV.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSGLMUL.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSUB.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FCMP.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FTST.X", "#-89000000032.0", "#$C0230000A5C681D100000000",
...
void test_float_mc68040() {
    ...
    ERRT("FSMOVE.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4040|(2<<10)|(3<<7));
    ERRT("FSMOVE.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4040|(3<<10)|(3<<7));
    TEST("FSMOVE.W", "D2, FP3",             0xF200|002, 0x4040|(4<<10)|(3<<7));
    ERRT("FSMOVE.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4040|(5<<10)|(3<<7));
    TEST("FSMOVE.B", "D2, FP3",             0xF200|002, 0x4040|(6<<10)|(3<<7));
    UNKN(/* FSMOVE.P A4{D3}, FP5 */         0xF200|002, 0x4040|(7<<10)|(5<<7));
    UNKN(/* FSMOVE.L A4, FP5 */             0xF200|014, 0x4040|(0<<10)|(5<<7));
    UNKN(/* FSMOVE.S A4, FP5 */             0xF200|014, 0x4040|(1<<10)|(5<<7));
    ...
    ABST("FSMOVE.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4040|(0<<10)|(1<<7), 0x4566);
    ABST("FSMOVE.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4040|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSMOVE.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4040|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSMOVE.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4040|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSMOVE.P", "#0.0912, FP1",        "#$400200091200000000000000, FP1",
         0xF200|074, 0x4040|(3<<10)|(1<<7), 0x4002, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSMOVE.D", "#-8.25, FP3",         "#$C020800000000000, FP3",
    ...
    ERRT("FDMOVE.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4044|(2<<10)|(3<<7));
    ERRT("FDMOVE.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4044|(3<<10)|(3<<7));
    TEST("FDMOVE.W", "D2, FP3",             0xF200|002, 0x4044|(4<<10)|(3<<7));
    ERRT("FDMOVE.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4044|(5<<10)|(3<<7));
    TEST("FDMOVE.B", "D2, FP3",             0xF200|002, 0x4044|(6<<10)|(3<<7));
    UNKN(/* FDMOVE.P A4{D3}, FP5 */         0xF200|002, 0x4044|(7<<10)|(5<<7));
    UNKN(/* FDMOVE.L A4, FP5 */             0xF200|014, 0x4044|(0<<10)|(5<<7));
    UNKN(/* FDMOVE.S A4, FP5 */             0xF200|014, 0x4044|(1<<10)|(5<<7));
    ...
    ABST("FDMOVE.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4044|(0<<10)|(1<<7), 0x4566);
    ABST("FDMOVE.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4044|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDMOVE.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4044|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDMOVE.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4044|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDMOVE.P", "#0.0912, FP1",        "#$400200091200000000000000, FP1",
         0xF200|074, 0x4044|(3<<10)|(1<<7), 0x4002, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDMOVE.D", "#-8.25, FP3",         "#$C020800000000000, FP3",
    ...
    ERRT("FSSQRT.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4041|(2<<10)|(3<<7));
    ERRT("FSSQRT.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4041|(3<<10)|(3<<7));
    TEST("FSSQRT.W", "D2, FP3",             0xF200|002, 0x4041|(4<<10)|(3<<7));
    ERRT("FSSQRT.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4041|(5<<10)|(3<<7));
    TEST("FSSQRT.B", "D2, FP3",             0xF200|002, 0x4041|(6<<10)|(3<<7));
    UNKN(/* FSSQRT.P D2, FP3 */             0xF200|002, 0x4041|(7<<10)|(3<<7));
    UNKN(/* FSSQRT.S A4, FP5 */             0xF200|014, 0x4041|(1<<10)|(5<<7));
    ...
    ABST("FSSQRT.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4041|(0<<10)|(1<<7), 0x4566);
    ABST("FSSQRT.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4041|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSSQRT.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4041|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSSQRT.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4041|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSSQRT.P", "#9.1234567891234567, FP1", "#$000000091234567891234567, FP1",
         0xF200|074, 0x4041|(3<<10)|(1<<7), 0x0000, 0x0009, 0x1234, 0x5678, 0x9123, 0x4567);
    TFLT("FSSQRT.D", "#-8.25, FP3",         "#$C020800000000000, FP3",
    ...
    ERRT("FDSQRT.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4045|(2<<10)|(3<<7));
    ERRT("FDSQRT.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4045|(3<<10)|(3<<7));
    TEST("FDSQRT.W", "D2, FP3",             0xF200|002, 0x4045|(4<<10)|(3<<7));
    ERRT("FDSQRT.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                            0xF200|002, 0x4045|(5<<10)|(3<<7));
    TEST("FDSQRT.B", "D2, FP3",             0xF200|002, 0x4045|(6<<10)|(3<<7));
    UNKN(/* FDSQRT.P D2, FP3 */             0xF200|002, 0x4045|(7<<10)|(3<<7));
    UNKN(/* FDSQRT.S A4, FP5 */             0xF200|014, 0x4045|(1<<10)|(5<<7));
    ...
    ABST("FDSQRT.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4045|(0<<10)|(1<<7), 0x4566);
    ABST("FDSQRT.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4045|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDSQRT.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4045|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDSQRT.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4045|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDSQRT.P", "#9.1234567891234567, FP1", "#$000000091234567891234567, FP1",
         0xF200|074, 0x4045|(3<<10)|(1<<7), 0x0000, 0x0009, 0x1234, 0x5678, 0x9123, 0x4567);
    TFLT("FDSQRT.D", "#-8.25, FP3",         "#$C020800000000000, FP3",
    ...
    ERRT("FSABS.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4058|(2<<10)|(3<<7));
    ERRT("FSABS.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4058|(3<<10)|(3<<7));
    TEST("FSABS.W", "D2, FP3",             0xF200|002, 0x4058|(4<<10)|(3<<7));
    ERRT("FSABS.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4058|(5<<10)|(3<<7));
    TEST("FSABS.B", "D2, FP3",             0xF200|002, 0x4058|(6<<10)|(3<<7));
    UNKN(/* FSABS.P D2, FP3 */             0xF200|002, 0x4058|(7<<10)|(3<<7));
    UNKN(/* FSABS.S A4, FP5 */             0xF200|014, 0x4058|(1<<10)|(5<<7));
    ...
    ABST("FSABS.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4058|(0<<10)|(1<<7), 0x4566);
    ABST("FSABS.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4058|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSABS.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4058|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSABS.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4058|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSABS.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4058|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSABS.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDABS.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405C|(2<<10)|(3<<7));
    ERRT("FDABS.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405C|(3<<10)|(3<<7));
    TEST("FDABS.W", "D2, FP3",             0xF200|002, 0x405C|(4<<10)|(3<<7));
    ERRT("FDABS.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405C|(5<<10)|(3<<7));
    TEST("FDABS.B", "D2, FP3",             0xF200|002, 0x405C|(6<<10)|(3<<7));
    UNKN(/* FDABS.P D2, FP3 */             0xF200|002, 0x405C|(7<<10)|(3<<7));
    UNKN(/* FDABS.S A4, FP5 */             0xF200|014, 0x405C|(1<<10)|(5<<7));
    ...
    ABST("FDABS.L", "(@A).W, FP1", "4566",   0xF200|070, 0x405C|(0<<10)|(1<<7), 0x4566);
    ABST("FDABS.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x405C|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDABS.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x405C|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDABS.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x405C|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDABS.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x405C|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDABS.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FSNEG.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405A|(2<<10)|(3<<7));
    ERRT("FSNEG.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405A|(3<<10)|(3<<7));
    TEST("FSNEG.W", "D2, FP3",             0xF200|002, 0x405A|(4<<10)|(3<<7));
    ERRT("FSNEG.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405A|(5<<10)|(3<<7));
    TEST("FSNEG.B", "D2, FP3",             0xF200|002, 0x405A|(6<<10)|(3<<7));
    UNKN(/* FSNEG.P D2, FP3 */             0xF200|002, 0x405A|(7<<10)|(3<<7));
    UNKN(/* FSNEG.S A4, FP5 */             0xF200|014, 0x405A|(1<<10)|(5<<7));
    ...
    ABST("FSNEG.L", "(@A).W, FP1", "4566",   0xF200|070, 0x405A|(0<<10)|(1<<7), 0x4566);
    ABST("FSNEG.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x405A|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSNEG.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x405A|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSNEG.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x405A|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSNEG.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x405A|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSNEG.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDNEG.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405E|(2<<10)|(3<<7));
    ERRT("FDNEG.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405E|(3<<10)|(3<<7));
    TEST("FDNEG.W", "D2, FP3",             0xF200|002, 0x405E|(4<<10)|(3<<7));
    ERRT("FDNEG.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x405E|(5<<10)|(3<<7));
    TEST("FDNEG.B", "D2, FP3",             0xF200|002, 0x405E|(6<<10)|(3<<7));
    UNKN(/* FDNEG.P D2, FP3 */             0xF200|002, 0x405E|(7<<10)|(3<<7));
    UNKN(/* FDNEG.S A4, FP5 */             0xF200|014, 0x405E|(1<<10)|(5<<7));
    ...
    ABST("FDNEG.L", "(@A).W, FP1", "4566",   0xF200|070, 0x405E|(0<<10)|(1<<7), 0x4566);
    ABST("FDNEG.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x405E|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDNEG.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x405E|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDNEG.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x405E|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDNEG.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x405E|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDNEG.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FSDIV.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4060|(2<<10)|(3<<7));
    ERRT("FSDIV.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4060|(3<<10)|(3<<7));
    TEST("FSDIV.W", "D2, FP3",             0xF200|002, 0x4060|(4<<10)|(3<<7));
    ERRT("FSDIV.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4060|(5<<10)|(3<<7));
    TEST("FSDIV.B", "D2, FP3",             0xF200|002, 0x4060|(6<<10)|(3<<7));
    UNKN(/* FSDIV.P D2, FP3 */             0xF200|002, 0x4060|(7<<10)|(3<<7));
    UNKN(/* FSDIV.S A4, FP5 */             0xF200|014, 0x4060|(1<<10)|(5<<7));
    ...
    ABST("FSDIV.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4060|(0<<10)|(1<<7), 0x4566);
    ABST("FSDIV.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4060|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSDIV.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4060|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSDIV.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4060|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSDIV.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4060|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSDIV.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDDIV.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4064|(2<<10)|(3<<7));
    ERRT("FDDIV.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4064|(3<<10)|(3<<7));
    TEST("FDDIV.W", "D2, FP3",             0xF200|002, 0x4064|(4<<10)|(3<<7));
    ERRT("FDDIV.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4064|(5<<10)|(3<<7));
    TEST("FDDIV.B", "D2, FP3",             0xF200|002, 0x4064|(6<<10)|(3<<7));
    UNKN(/* FDDIV.P D2, FP3 */             0xF200|002, 0x4064|(7<<10)|(3<<7));
    UNKN(/* FDDIV.S A4, FP5 */             0xF200|014, 0x4064|(1<<10)|(5<<7));
    ...
    ABST("FDDIV.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4064|(0<<10)|(1<<7), 0x4566);
    ABST("FDDIV.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4064|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDDIV.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4064|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDDIV.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4064|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDDIV.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4064|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDDIV.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FSADD.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4062|(2<<10)|(3<<7));
    ERRT("FSADD.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4062|(3<<10)|(3<<7));
    TEST("FSADD.W", "D2, FP3",             0xF200|002, 0x4062|(4<<10)|(3<<7));
    ERRT("FSADD.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4062|(5<<10)|(3<<7));
    TEST("FSADD.B", "D2, FP3",             0xF200|002, 0x4062|(6<<10)|(3<<7));
    UNKN(/* FSADD.P D2, FP3 */             0xF200|002, 0x4062|(7<<10)|(3<<7));
    UNKN(/* FSADD.S A4, FP5 */             0xF200|014, 0x4062|(1<<10)|(5<<7));
    ...
    ABST("FSADD.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4062|(0<<10)|(1<<7), 0x4566);
    ABST("FSADD.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4062|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSADD.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4062|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSADD.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4062|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSADD.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4062|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSADD.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDADD.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4066|(2<<10)|(3<<7));
    ERRT("FDADD.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4066|(3<<10)|(3<<7));
    TEST("FDADD.W", "D2, FP3",             0xF200|002, 0x4066|(4<<10)|(3<<7));
    ERRT("FDADD.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4066|(5<<10)|(3<<7));
    TEST("FDADD.B", "D2, FP3",             0xF200|002, 0x4066|(6<<10)|(3<<7));
    UNKN(/* FDADD.P D2, FP3 */             0xF200|002, 0x4066|(7<<10)|(3<<7));
    UNKN(/* FDADD.S A4, FP5 */             0xF200|014, 0x4066|(1<<10)|(5<<7));
    ...
    ABST("FDADD.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4066|(0<<10)|(1<<7), 0x4566);
    ABST("FDADD.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4066|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDADD.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4066|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDADD.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4066|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDADD.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4066|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDADD.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FSMUL.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4063|(2<<10)|(3<<7));
    ERRT("FSMUL.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4063|(3<<10)|(3<<7));
    TEST("FSMUL.W", "D2, FP3",             0xF200|002, 0x4063|(4<<10)|(3<<7));
    ERRT("FSMUL.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4063|(5<<10)|(3<<7));
    TEST("FSMUL.B", "D2, FP3",             0xF200|002, 0x4063|(6<<10)|(3<<7));
    UNKN(/* FSMUL.P D2, FP3 */             0xF200|002, 0x4063|(7<<10)|(3<<7));
    UNKN(/* FSMUL.S A4, FP5 */             0xF200|014, 0x4063|(1<<10)|(5<<7));
    ...
    ABST("FSMUL.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4063|(0<<10)|(1<<7), 0x4566);
    ABST("FSMUL.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4063|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSMUL.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4063|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSMUL.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4063|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSMUL.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4063|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSMUL.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDMUL.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4067|(2<<10)|(3<<7));
    ERRT("FDMUL.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4067|(3<<10)|(3<<7));
    TEST("FDMUL.W", "D2, FP3",             0xF200|002, 0x4067|(4<<10)|(3<<7));
    ERRT("FDMUL.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4067|(5<<10)|(3<<7));
    TEST("FDMUL.B", "D2, FP3",             0xF200|002, 0x4067|(6<<10)|(3<<7));
    UNKN(/* FDMUL.P D2, FP3 */             0xF200|002, 0x4067|(7<<10)|(3<<7));
    UNKN(/* FDMUL.S A4, FP5 */             0xF200|014, 0x4067|(1<<10)|(5<<7));
    ...
    ABST("FDMUL.L", "(@A).W, FP1", "4566",   0xF200|070, 0x4067|(0<<10)|(1<<7), 0x4566);
    ABST("FDMUL.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4067|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDMUL.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4067|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDMUL.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4067|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDMUL.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4067|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDMUL.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FSSUB.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4068|(2<<10)|(3<<7));
    ERRT("FSSUB.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4068|(3<<10)|(3<<7));
    TEST("FSSUB.W", "D2, FP3",             0xF200|002, 0x4068|(4<<10)|(3<<7));
    ERRT("FSSUB.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x4068|(5<<10)|(3<<7));
    TEST("FSSUB.B", "D2, FP3",             0xF200|002, 0x4068|(6<<10)|(3<<7));
    UNKN(/* FSSUB.P D2, FP3 */             0xF200|002, 0x4068|(7<<10)|(3<<7));
    UNKN(/* FSSUB.S A4, FP5 */             0xF200|014, 0x4068|(1<<10)|(5<<7));
    ...
    ABST("FSSUB.L", "(@A).W, FP1", "8566",   0xF200|070, 0x4068|(0<<10)|(1<<7), 0x8566);
    ABST("FSSUB.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x4068|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FSSUB.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x4068|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FSSUB.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4068|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FSSUB.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x4068|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FSSUB.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
    ...
    ERRT("FDSUB.X", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x406C|(2<<10)|(3<<7));
    ERRT("FDSUB.P", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x406C|(3<<10)|(3<<7));
    TEST("FDSUB.W", "D2, FP3",             0xF200|002, 0x406C|(4<<10)|(3<<7));
    ERRT("FDSUB.D", "D2, FP3", ILLEGAL_SIZE, "D2, FP3",
                                           0xF200|002, 0x406C|(5<<10)|(3<<7));
    TEST("FDSUB.B", "D2, FP3",             0xF200|002, 0x406C|(6<<10)|(3<<7));
    UNKN(/* FDSUB.P D2, FP3 */             0xF200|002, 0x406C|(7<<10)|(3<<7));
    UNKN(/* FDSUB.S A4, FP5 */             0xF200|014, 0x406C|(1<<10)|(5<<7));
    ...
    ABST("FDSUB.L", "(@A).W, FP1", "8566",   0xF200|070, 0x406C|(0<<10)|(1<<7), 0x8566);
    ABST("FDSUB.S", "(@A).L, FP2", "56789A", 0xF200|071, 0x406C|(1<<10)|(2<<7), 0x0056, 0x789A);
    ...
    TFLT("FDSUB.S", "#7.88999976E-10, FP7", "#$3058E0F0, FP7",
         0xF200|074, 0x406C|(1<<10)|(7<<7), 0x3058, 0xE0F0);
    TFLT("FDSUB.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x406C|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FDSUB.P", "#9.12E+20, FP1",       "#$002000091200000000000000, FP1",
         0xF200|074, 0x406C|(3<<10)|(1<<7), 0x0020, 0x0009, 0x1200, 0x0000, 0x0000, 0x0000);
    TFLT("FDSUB.D", "#-8.25, FP3",          "#$C020800000000000, FP3",
...
void test_float_mc68881() {
    ...
    TFLT("FINT.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
         0xF200|074, 0x4001|(2<<10)|(0<<7), 0xC023, 0x0000, 0xA5C6, 0x81D1, 0x0000, 0x0000);
    TFLT("FINT.P", "#912.0, FP1",            "#$000200091200000000000000, FP1",
    ...
    TFLT("FSINH.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FINTRZ.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FLOGNP1.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FETOXM1.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FTANH.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FATAN.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FASIN.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FATANH.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSIN.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FTAN.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FETOX.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FTWOTOX.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FTENTOX.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FLOGN.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FLOG10.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FLOG2.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FCOSH.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FACOS.X", "#-89000000032.0, FP0",  "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FCOS.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FGETEXP.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FGETMAN.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FMOD.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FREM.X", "#-89000000032.0, FP0",   "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSCALE.X", "#-89000000032.0, FP0", "#$C0230000A5C681D100000000, FP0",
    ...
    TFLT("FSINCOS.X", "#-89000000032.0, FP4:FP0", "#$C0230000A5C681D100000000, FP4:FP0",
