...
void test_system() {
    ...
    if (mc68k00()) {
        ...
        ERRT("MOVEC", "CACR, D2", UNKNOWN_REGISTER, "CACR, D2", 0047172, 0020000 | 0x002);
        ...
        ERRT("MOVEC", "CAAR, D4", UNKNOWN_REGISTER, "CAAR, D4", 0047172, 0040000 | 0x802);
        ERRT("MOVEC", "MSP, A5",  UNKNOWN_REGISTER, "MSP, A5",  0047172, 0150000 | 0x803);
        ERRT("MOVEC", "ISP, D5",  UNKNOWN_REGISTER, "ISP, D5",  0047172, 0050000 | 0x804);
        ...
        ERRT("MOVEC", "D7, CACR", UNKNOWN_REGISTER, "CACR", 0047173, 0070000 | 0x002);
        ...
        ERRT("MOVEC", "A2, CAAR", UNKNOWN_REGISTER, "CAAR", 0047173, 0120000 | 0x802);
        ERRT("MOVEC", "D2, MSP",  UNKNOWN_REGISTER, "MSP",  0047173, 0020000 | 0x803);
        ERRT("MOVEC", "A3, ISP",  UNKNOWN_REGISTER, "ISP",  0047173, 0130000 | 0x804);
...
#define IIDX(opr, mr, ...)                                               \
    ...
    if (firstGen()) {
        ...
        TIDX("($12345678,A7)",             067, 0010560, 0x1234, 0x5678);
        TIDX("([$12345678,A7])",           067, 0010561, 0x1234, 0x5678);
        ...
        TIDX("([*+$1234567A,D1.W])",           073, 0010661, 0x1234, 0x5678);
...
void test_mmu_move() {
    ...
    ERRT("PMOVEFD.Q", "D2, SRP", ILLEGAL_SIZE, "D2, SRP", 0xF000|002, 0x4100|(2<<10));
    ERRT("PMOVEFD.Q", "D2, CRP", ILLEGAL_SIZE, "D2, CRP", 0xF000|002, 0x4100|(3<<10));
    UNKN(0xF000|002, 0x6100|(8<<10));
    ...
    ERRT("PMOVEFD.Q", "A2, SRP", ILLEGAL_SIZE, "A2, SRP", 0xF000|012, 0x4100|(2<<10));
    ERRT("PMOVEFD.Q", "A2, CRP", ILLEGAL_SIZE, "A2, CRP", 0xF000|012, 0x4100|(3<<10));
    UNKN(0xF000|012, 0x6100|(8<<10));
    ...
    UNKN(0xF000|072, 0x0200);   // (d16,PC)
    UNKN(0xF000|073, 0x0200);   // (d8,PC,Xn)
    UNKN(0xF000|074, 0x0200);   // #n
}
