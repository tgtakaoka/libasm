...
static void test_format_0() {
    ...
    AERVR(0x000000, BLE, "*+0x01000000", 0x7A, 0xC1, 0x00, 0x00, 0x00);
    AERVR(0xFFFFFF, BFS, "*-0x01000000", 0x8A, 0xFF, 0x00, 0x00, 0x00);
    AERVR(0x000000, BLE, "*+0x1FFFFFFF", 0x7A, 0xDF, 0xFF, 0xFF, 0xFF);
    AERVR(0xFFFFFF, BFS, "*-0x1F000000", 0x8A, 0xE1, 0x00, 0x00, 0x00);
...
static void test_generic_addressing() {
    ...
    TEST(ADDF, "3.1415901, F1",
         0xBE, 0x41, 0xA0, 0x40, 0x49, 0x0F, 0xD0);
    TEST(ADDF, "2.99792e+08, F3",
    ...
    ERVR(MOVW, "@0x1000000, R0",0x15, 0xA8, 0xC1, 0x00, 0x00, 0x00);
    // External
