...
void test_format_9_fpu() {
    ...
    TFLT("MOVF", "0.0, F3",    "0x00000000, F3", 0xBE, 0xC5, 0xA0, 0x00, 0x00, 0x00, 0x00);
    TFLT("MOVF", "-0.0, F3",   "0x00000080, F3", 0xBE, 0xC5, 0xA0, 0x80, 0x00, 0x00, 0x00);
    ...
    TFLT("MOVL", "0.0, F4",    "0x0000000000000000, F4",
         0xBE, 0x04, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
    TFLT("MOVL", "-0.0, F4",   "0x0000000000000080, F4",
...
void test_generic_addressing() {
    ...
    TFLT("ADDF", "299792000.0, F3",  "0xB4F38E4D, F3",
...
#else
    ERRT("ADDF", "F1, 0.0", OPERAND_NOT_ALLOWED, "0.0", 0xBE, 0x01, 0x0D);
    ERRT("ADDL", "F2, 0.0", OPERAND_NOT_ALLOWED, "0.0", 0xBE, 0x00, 0x15);
#endif
#endif
...
void test_formatter() {
    ...
    TFLT("ADDF", "3.14159012, F1", "X'D00F4940, F1",
         0xBE, 0x41, 0xA0, 0x40, 0x49, 0x0F, 0xD0);
    TFLT("ADDF", "299792000.0, F3",  "X'B4F38E4D, F3",
         0xBE, 0xC1, 0xA0, 0x4D, 0x8E, 0xF3, 0xB4);
    ...
    TFLT("ADDF", "0F3.14159012, F1", "0xD00F4940, F1",
         0xBE, 0x41, 0xA0, 0x40, 0x49, 0x0F, 0xD0);
    TFLT("ADDF", "0F299792000.0, F3",  "0xB4F38E4D, F3",
         0xBE, 0xC1, 0xA0, 0x4D, 0x8E, 0xF3, 0xB4);
