...
void test_load_registers() {
    ...
    if (z280()) {
        ...
        ERRT("LD H, IXH", REGISTER_NOT_ALLOWED, "H, IXH");
        ERRT("LD H, IXL", REGISTER_NOT_ALLOWED, "H, IXL");
        ERRT("LD H, IYH", REGISTER_NOT_ALLOWED, "H, IYH");
        ERRT("LD H, IYL", REGISTER_NOT_ALLOWED, "H, IYL");

        ERRT("LD L, IXH", REGISTER_NOT_ALLOWED, "L, IXH");
        ERRT("LD L, IXL", REGISTER_NOT_ALLOWED, "L, IXL");
        ERRT("LD L, IYH", REGISTER_NOT_ALLOWED, "L, IYH");
        ERRT("LD L, IYL", REGISTER_NOT_ALLOWED, "L, IYL");
