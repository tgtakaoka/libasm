...
static void test_move_inherent() {
    ...
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "LD I,A");
        ETEST(OPERAND_NOT_ALLOWED, "LD R,A");
        ETEST(OPERAND_NOT_ALLOWED, "LD A,I");
        ETEST(OPERAND_NOT_ALLOWED, "LD A,R");
...
static void test_move_direct() {
    ...
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "LD (0ABCDH),BC");
        ETEST(OPERAND_NOT_ALLOWED, "LD (0ABCDH),DE");
        ETEST(OPERAND_NOT_ALLOWED, "LD (0ABCDH),SP");
        ETEST(OPERAND_NOT_ALLOWED, "LD BC,(5678H)");
        ETEST(OPERAND_NOT_ALLOWED, "LD DE,(5678H)");
        ETEST(OPERAND_NOT_ALLOWED, "LD SP,(5678H)");
    }
}
...
static void test_stack_op() {
    ...
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "EX AF,AF'");
...
static void test_alu_register() {
    ...
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "ADC HL,BC");
        ETEST(OPERAND_NOT_ALLOWED, "ADC HL,DE");
        ETEST(OPERAND_NOT_ALLOWED, "ADC HL,HL");
        ETEST(OPERAND_NOT_ALLOWED, "ADC HL,SP");
        ETEST(OPERAND_NOT_ALLOWED, "SBC HL,BC");
        ETEST(OPERAND_NOT_ALLOWED, "SBC HL,DE");
        ETEST(OPERAND_NOT_ALLOWED, "SBC HL,HL");
        ETEST(OPERAND_NOT_ALLOWED, "SBC HL,SP");
    }
}
...
static void test_io() {
    ...
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "IN  B,(C)");
        ETEST(OPERAND_NOT_ALLOWED, "OUT (C),A");
    }
}
...
static void test_inherent() {
    ...
    if (is8085()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "LD A,IM");
        ETEST(OPERAND_NOT_ALLOWED, "LD IM,A");
    }
...
static void test_index_registers() {
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "ADD IX,BC");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IX,DE");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IX,IX");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IX,SP");
        ETEST(OPERAND_NOT_ALLOWED, "LD (0ABCDH),IX");
        ETEST(OPERAND_NOT_ALLOWED, "LD IX,(5678H)");
        ETEST(OPERAND_NOT_ALLOWED, "INC IX");
        ETEST(OPERAND_NOT_ALLOWED, "DEC IX");
        ETEST(OPERAND_NOT_ALLOWED, "POP IX");
        ETEST(OPERAND_NOT_ALLOWED, "PUSH IX");
        ETEST(OPERAND_NOT_ALLOWED, "EX (SP),IX");
        ETEST(OPERAND_NOT_ALLOWED, "JP (IX)");
        ETEST(OPERAND_NOT_ALLOWED, "LD SP,IX");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IY,BC");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IY,DE");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IY,IY");
        ETEST(OPERAND_NOT_ALLOWED, "ADD IY,SP");
        ETEST(OPERAND_NOT_ALLOWED, "LD (0ABCDH),IY");
        ETEST(OPERAND_NOT_ALLOWED, "LD IY,(5678H)");
        ETEST(OPERAND_NOT_ALLOWED, "INC IY");
        ETEST(OPERAND_NOT_ALLOWED, "DEC IY");
        ETEST(OPERAND_NOT_ALLOWED, "POP IY");
        ETEST(OPERAND_NOT_ALLOWED, "PUSH IY");
        ETEST(OPERAND_NOT_ALLOWED, "EX (SP),IY");
        ETEST(OPERAND_NOT_ALLOWED, "JP (IY)");
        ETEST(OPERAND_NOT_ALLOWED, "LD SP,IY");
    }
}
...
static void test_indexed() {
    if (isZ80()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "INC (IX+2)");
        ETEST(OPERAND_NOT_ALLOWED, "INC (IY-2)");
        ETEST(OPERAND_NOT_ALLOWED, "DEC (IX+2)");
        ETEST(OPERAND_NOT_ALLOWED, "DEC (IY-2)");
        ETEST(OPERAND_NOT_ALLOWED, "LD B,(IX+2)");
        ETEST(OPERAND_NOT_ALLOWED, "LD C,(IY-2)");
        ETEST(OPERAND_NOT_ALLOWED, "LD (IX+2),D");
        ETEST(OPERAND_NOT_ALLOWED, "LD (IY-2),E");
        ETEST(OPERAND_NOT_ALLOWED, "ADD A,(IX+2)");
        ETEST(OPERAND_NOT_ALLOWED, "ADC A,(IY-2)");
        ETEST(OPERAND_NOT_ALLOWED, "AND (IX+2)");
        ETEST(OPERAND_NOT_ALLOWED, "SUB (IY-2)");
    }
}
