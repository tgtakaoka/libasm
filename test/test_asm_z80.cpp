...
void test_load() {
    ...
    if (z380()) {
        ...
        TEST("LD  (IX+127), BC", 0xDD, 0xCB, 0x7F, 0x0B);
        TEST("LD  (IX+127), DE", 0xDD, 0xCB, 0x7F, 0x1B);
        TEST("LD  (IX+127), IY", 0xDD, 0xCB, 0x7F, 0x2B);
        TEST("LD  (IX+127), HL", 0xDD, 0xCB, 0x7F, 0x3B);
        ...
        TEST("LD  (IY-128), BC", 0xFD, 0xCB, 0x80, 0x0B);
        TEST("LD  (IY-128), DE", 0xFD, 0xCB, 0x80, 0x1B);
        TEST("LD  (IY-128), IX", 0xFD, 0xCB, 0x80, 0x2B);
        TEST("LD  (IY-128), HL", 0xFD, 0xCB, 0x80, 0x3B);
        ...
        TEST("LD  (SP-128), BC", 0xDD, 0xCB, 0x80, 0x09);
        TEST("LD  (SP-128), DE", 0xDD, 0xCB, 0x80, 0x19);
        TEST("LD  (SP-128), HL", 0xDD, 0xCB, 0x80, 0x39);
        TEST("LD  (SP+127), IX", 0xDD, 0xCB, 0x7F, 0x29);
        TEST("LD  (SP-127), IY", 0xFD, 0xCB, 0x81, 0x29);
    }
}
...
void test_jump() {
    ...
    if (z380()) {
        ...
        assembler.setOption("extmode", "on");
        ATEST(0xFFF0, "CALR 10072H", 0xED, 0xCD, 0x7F);
        ATEST(0xF000, "CALR 11004H", 0xDD, 0xCD, 0x00, 0x20);
        ATEST(0x1000, "CALR 11005H", 0xFD, 0xCD, 0x00, 0x00, 0x01);
        assembler.setOption("extmode", "off");
        AERRT(0xFFF0, "CALR 10072H", OVERFLOW_RANGE, "10072H", 0xED, 0xCD, 0x7F);
        AERRT(0xF000, "CALR 11004H", OVERFLOW_RANGE, "11004H", 0xDD, 0xCD, 0x00, 0x20);
        AERRT(0x1000, "CALR 11005H", OVERFLOW_RANGE, "11005H", 0xFD, 0xCD, 0x00, 0x00, 0x01);
    }
    ...
    if (z380()) {
        ...
        AERRT(0xFFFFFF80, "JR C, 000000001H", OVERFLOW_RANGE, "000000001H", 0x38, 0x7F);
        AERRT(0x0000007D, "JR C, 0FFFFFFFFH", OVERFLOW_RANGE, "0FFFFFFFFH", 0x38, 0x80);

        assembler.setOption("extmode", "on");
        ATEST(0xFFF0, "JR C, 10071H", 0x38, 0x7F);
        ATEST(0xF000, "JR C, 11004H", 0xDD, 0x38, 0x00, 0x20);
        ATEST(0x1000, "JR C, 11005H", 0xFD, 0x38, 0x00, 0x00, 0x01);
        assembler.setOption("extmode", "off");
        AERRT(0xFFF0, "JR C, 10071H", OVERFLOW_RANGE, "10071H", 0x38, 0x7F);
        AERRT(0xF000, "JR C, 11004H", OVERFLOW_RANGE, "11004H", 0xDD, 0x38, 0x00, 0x20);
        AERRT(0x1000, "JR C, 11005H", OVERFLOW_RANGE, "11005H", 0xFD, 0x38, 0x00, 0x00, 0x01);
    } else {
