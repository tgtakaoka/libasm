...
static void test_float() {
    ...
    TEST("FIADD WORD PTR [SI]",          0x9B, 0xDA, 0004);
    TEST("FIADD WORD PTR [1234H]",       0x9B, 0xDA, 0006, 0x34, 0x12);
    TEST("FIADD WORD PTR [DI+52]",       0x9B, 0xDA, 0105, 0x34);
    TEST("FIADD WORD PTR [BP+1234H]",    0x9B, 0xDA, 0206, 0x34, 0x12);
    TEST("FIADD WORD PTR [BX+SI]",       0x9B, 0xDA, 0000);
    TEST("FIADD WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0101, 0xCC);
    TEST("FIADD WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0202, 0xAB, 0x89);

    TEST("FIADD DWORD PTR [SI]",          0x9B, 0xDE, 0004);
    TEST("FIADD DWORD PTR [1234H]",       0x9B, 0xDE, 0006, 0x34, 0x12);
    TEST("FIADD DWORD PTR [DI+52]",       0x9B, 0xDE, 0105, 0x34);
    TEST("FIADD DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0206, 0x34, 0x12);
    TEST("FIADD DWORD PTR [BX+SI]",       0x9B, 0xDE, 0000);
    TEST("FIADD DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0101, 0xCC);
    TEST("FIADD DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0202, 0xAB, 0x89);

    TEST("FIMUL WORD PTR [SI]",          0x9B, 0xDA, 0014);
    TEST("FIMUL WORD PTR [1234H]",       0x9B, 0xDA, 0016, 0x34, 0x12);
    TEST("FIMUL WORD PTR [DI+52]",       0x9B, 0xDA, 0115, 0x34);
    TEST("FIMUL WORD PTR [BP+1234H]",    0x9B, 0xDA, 0216, 0x34, 0x12);
    TEST("FIMUL WORD PTR [BX+SI]",       0x9B, 0xDA, 0010);
    TEST("FIMUL WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0111, 0xCC);
    TEST("FIMUL WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0212, 0xAB, 0x89);

    TEST("FIMUL DWORD PTR [SI]",          0x9B, 0xDE, 0014);
    TEST("FIMUL DWORD PTR [1234H]",       0x9B, 0xDE, 0016, 0x34, 0x12);
    TEST("FIMUL DWORD PTR [DI+52]",       0x9B, 0xDE, 0115, 0x34);
    TEST("FIMUL DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0216, 0x34, 0x12);
    TEST("FIMUL DWORD PTR [BX+SI]",       0x9B, 0xDE, 0010);
    TEST("FIMUL DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0111, 0xCC);
    TEST("FIMUL DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0212, 0xAB, 0x89);

    TEST("FISUB WORD PTR [SI]",          0x9B, 0xDA, 0044);
    TEST("FISUB WORD PTR [1234H]",       0x9B, 0xDA, 0046, 0x34, 0x12);
    TEST("FISUB WORD PTR [DI+52]",       0x9B, 0xDA, 0145, 0x34);
    TEST("FISUB WORD PTR [BP+1234H]",    0x9B, 0xDA, 0246, 0x34, 0x12);
    TEST("FISUB WORD PTR [BX+SI]",       0x9B, 0xDA, 0040);
    TEST("FISUB WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0141, 0xCC);
    TEST("FISUB WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0242, 0xAB, 0x89);

    TEST("FISUB DWORD PTR [SI]",          0x9B, 0xDE, 0044);
    TEST("FISUB DWORD PTR [1234H]",       0x9B, 0xDE, 0046, 0x34, 0x12);
    TEST("FISUB DWORD PTR [DI+52]",       0x9B, 0xDE, 0145, 0x34);
    TEST("FISUB DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0246, 0x34, 0x12);
    TEST("FISUB DWORD PTR [BX+SI]",       0x9B, 0xDE, 0040);
    TEST("FISUB DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0141, 0xCC);
    TEST("FISUB DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0242, 0xAB, 0x89);

    TEST("FISUBR WORD PTR [SI]",          0x9B, 0xDA, 0054);
    TEST("FISUBR WORD PTR [1234H]",       0x9B, 0xDA, 0056, 0x34, 0x12);
    TEST("FISUBR WORD PTR [DI+52]",       0x9B, 0xDA, 0155, 0x34);
    TEST("FISUBR WORD PTR [BP+1234H]",    0x9B, 0xDA, 0256, 0x34, 0x12);
    TEST("FISUBR WORD PTR [BX+SI]",       0x9B, 0xDA, 0050);
    TEST("FISUBR WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0151, 0xCC);
    TEST("FISUBR WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0252, 0xAB, 0x89);

    TEST("FISUBR DWORD PTR [SI]",          0x9B, 0xDE, 0054);
    TEST("FISUBR DWORD PTR [1234H]",       0x9B, 0xDE, 0056, 0x34, 0x12);
    TEST("FISUBR DWORD PTR [DI+52]",       0x9B, 0xDE, 0155, 0x34);
    TEST("FISUBR DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0256, 0x34, 0x12);
    TEST("FISUBR DWORD PTR [BX+SI]",       0x9B, 0xDE, 0050);
    TEST("FISUBR DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0151, 0xCC);
    TEST("FISUBR DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0252, 0xAB, 0x89);

    TEST("FIDIV WORD PTR [SI]",          0x9B, 0xDA, 0064);
    TEST("FIDIV WORD PTR [1234H]",       0x9B, 0xDA, 0066, 0x34, 0x12);
    TEST("FIDIV WORD PTR [DI+52]",       0x9B, 0xDA, 0165, 0x34);
    TEST("FIDIV WORD PTR [BP+1234H]",    0x9B, 0xDA, 0266, 0x34, 0x12);
    TEST("FIDIV WORD PTR [BX+SI]",       0x9B, 0xDA, 0060);
    TEST("FIDIV WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0161, 0xCC);
    TEST("FIDIV WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0262, 0xAB, 0x89);

    TEST("FIDIV DWORD PTR [SI]",          0x9B, 0xDE, 0064);
    TEST("FIDIV DWORD PTR [1234H]",       0x9B, 0xDE, 0066, 0x34, 0x12);
    TEST("FIDIV DWORD PTR [DI+52]",       0x9B, 0xDE, 0165, 0x34);
    TEST("FIDIV DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0266, 0x34, 0x12);
    TEST("FIDIV DWORD PTR [BX+SI]",       0x9B, 0xDE, 0060);
    TEST("FIDIV DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0161, 0xCC);
    TEST("FIDIV DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0262, 0xAB, 0x89);

    TEST("FIDIVR WORD PTR [SI]",          0x9B, 0xDA, 0074);
    TEST("FIDIVR WORD PTR [1234H]",       0x9B, 0xDA, 0076, 0x34, 0x12);
    TEST("FIDIVR WORD PTR [DI+52]",       0x9B, 0xDA, 0175, 0x34);
    TEST("FIDIVR WORD PTR [BP+1234H]",    0x9B, 0xDA, 0276, 0x34, 0x12);
    TEST("FIDIVR WORD PTR [BX+SI]",       0x9B, 0xDA, 0070);
    TEST("FIDIVR WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0171, 0xCC);
    TEST("FIDIVR WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0272, 0xAB, 0x89);

    TEST("FIDIVR DWORD PTR [SI]",          0x9B, 0xDE, 0074);
    TEST("FIDIVR DWORD PTR [1234H]",       0x9B, 0xDE, 0076, 0x34, 0x12);
    TEST("FIDIVR DWORD PTR [DI+52]",       0x9B, 0xDE, 0175, 0x34);
    TEST("FIDIVR DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0276, 0x34, 0x12);
    TEST("FIDIVR DWORD PTR [BX+SI]",       0x9B, 0xDE, 0070);
    TEST("FIDIVR DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0171, 0xCC);
    TEST("FIDIVR DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0272, 0xAB, 0x89);

    TEST("FICOM WORD PTR [SI]",          0x9B, 0xDA, 0024);
    TEST("FICOM WORD PTR [1234H]",       0x9B, 0xDA, 0026, 0x34, 0x12);
    TEST("FICOM WORD PTR [DI+52]",       0x9B, 0xDA, 0125, 0x34);
    TEST("FICOM WORD PTR [BP+1234H]",    0x9B, 0xDA, 0226, 0x34, 0x12);
    TEST("FICOM WORD PTR [BX+SI]",       0x9B, 0xDA, 0020);
    TEST("FICOM WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0121, 0xCC);
    TEST("FICOM WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0222, 0xAB, 0x89);

    TEST("FICOM DWORD PTR [SI]",          0x9B, 0xDE, 0024);
    TEST("FICOM DWORD PTR [1234H]",       0x9B, 0xDE, 0026, 0x34, 0x12);
    TEST("FICOM DWORD PTR [DI+52]",       0x9B, 0xDE, 0125, 0x34);
    TEST("FICOM DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0226, 0x34, 0x12);
    TEST("FICOM DWORD PTR [BX+SI]",       0x9B, 0xDE, 0020);
    TEST("FICOM DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0121, 0xCC);
    TEST("FICOM DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0222, 0xAB, 0x89);

    TEST("FICOMP WORD PTR [SI]",          0x9B, 0xDA, 0034);
    TEST("FICOMP WORD PTR [1234H]",       0x9B, 0xDA, 0036, 0x34, 0x12);
    TEST("FICOMP WORD PTR [DI+52]",       0x9B, 0xDA, 0135, 0x34);
    TEST("FICOMP WORD PTR [BP+1234H]",    0x9B, 0xDA, 0236, 0x34, 0x12);
    TEST("FICOMP WORD PTR [BX+SI]",       0x9B, 0xDA, 0030);
    TEST("FICOMP WORD PTR [BX+DI-52]",    0x9B, 0xDA, 0131, 0xCC);
    TEST("FICOMP WORD PTR [BP+SI+89ABH]", 0x9B, 0xDA, 0232, 0xAB, 0x89);

    TEST("FICOMP DWORD PTR [SI]",          0x9B, 0xDE, 0034);
    TEST("FICOMP DWORD PTR [1234H]",       0x9B, 0xDE, 0036, 0x34, 0x12);
    TEST("FICOMP DWORD PTR [DI+52]",       0x9B, 0xDE, 0135, 0x34);
    TEST("FICOMP DWORD PTR [BP+1234H]",    0x9B, 0xDE, 0236, 0x34, 0x12);
    TEST("FICOMP DWORD PTR [BX+SI]",       0x9B, 0xDE, 0030);
    TEST("FICOMP DWORD PTR [BX+DI-52]",    0x9B, 0xDE, 0131, 0xCC);
    TEST("FICOMP DWORD PTR [BP+SI+89ABH]", 0x9B, 0xDE, 0232, 0xAB, 0x89);
...
static void test_float_nowait() {
    ...
    ERRT("FNLDCW [1234H]",      UNKNOWN_INSTRUCTION, "FNLDCW [1234H]");
    ...
    ERRT("FNLDENV [SI]",         UNKNOWN_INSTRUCTION, "FNLDENV [SI]");
    ...
    ERRT("FNRSTOR [DI+52]",      UNKNOWN_INSTRUCTION, "FNRSTOR [DI+52]");
...
static void test_data_constant() {
    ...
    TEST("DD 'A''B\"C'", 0x41, 0x27, 0x42, 0x22, 0x43, 0x00, 0x00, 0x00);
    ERRT("DD 'A''B\"C",  MISSING_CLOSING_QUOTE, "'A''B\"C");
