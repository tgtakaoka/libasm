...
static void test_cpu() {
    ...
    EQUALS("cpu i8086", "8086", assembler.getCpu());
}
...
static void test_undefined_symbol() {
    ETEST(UNDEFINED_SYMBOL, "MOV [UNDEF],BH",       0x88, 0076, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [DI+UNDEF],AL",    0x88, 0205, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BP+UNDEF],CL",    0x88, 0216, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BX+DI+UNDEF],BL", 0x88, 0231, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BP+SI+UNDEF],AH", 0x88, 0242, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [UNDEF],DI",       0x89, 0076, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [DI-UNDEF],AX",    0x89, 0205, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BP+UNDEF],CX",    0x89, 0216, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BX+DI-UNDEF],BX", 0x89, 0231, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [BP+SI+UNDEF],SP", 0x89, 0242, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV AL,UNDEF", 0260, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV CH,UNDEF", 0265, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV AX,UNDEF", 0270, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV BP,UNDEF", 0275, 0x00, 0x00);

    ETEST(UNDEFINED_SYMBOL, "MOV AL,[UNDEF]", 0xA0, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV AX,[UNDEF]", 0xA1, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [UNDEF],AL", 0xA2, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "MOV [UNDEF],AX", 0xA3, 0x00, 0x00);

    ETEST(UNDEFINED_SYMBOL, "ADD AL,UNDEF", 0x04, 0x00);
    ETEST(UNDEFINED_SYMBOL, "ADD CL,UNDEF", 0x80, 0301, 0x00);
    ETEST(UNDEFINED_SYMBOL, "ADD AX,UNDEF", 0x05, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "ADD CX,UNDEF", 0x81, 0301, 0x00, 0x00);

    ETEST(UNDEFINED_SYMBOL, "IN   AL,UNDEF", 0xE4, 0x00);
    ETEST(UNDEFINED_SYMBOL, "IN   AX,UNDEF", 0xE5, 0x00);
    ETEST(UNDEFINED_SYMBOL, "OUT  UNDEF,AL", 0xE6, 0x00);
    ETEST(UNDEFINED_SYMBOL, "OUT  UNDEF,AX", 0xE7, 0x00);

    ETEST(UNDEFINED_SYMBOL, "CALLF UNDEF:5678H", 0x9A, 0x78, 0x56, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "CALLF 1234H:UNDEF", 0x9A, 0x00, 0x00, 0x34, 0x12);
    ETEST(UNDEFINED_SYMBOL, "CALLF UNDEF:UNDEF", 0x9A, 0x00, 0x00, 0x00, 0x00);

    ETEST(UNDEFINED_SYMBOL, "RET  UNDEF", 0xC2, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "RETF UNDEF", 0xCA, 0x00, 0x00);

    ETEST(UNDEFINED_SYMBOL, "CALL UNDEF", 0xE8, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JMP  UNDEF", 0xE9, 0x00, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JE   UNDEF", 0x74, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JL   UNDEF", 0x7C, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JLE  UNDEF", 0x7E, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JB   UNDEF", 0x72, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JBE  UNDEF", 0x76, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JPE  UNDEF", 0x7A, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JO   UNDEF", 0x70, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JS   UNDEF", 0x78, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JNE  UNDEF", 0x75, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JGE  UNDEF", 0x7D, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JG   UNDEF", 0x7F, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JAE  UNDEF", 0x73, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JA   UNDEF", 0x77, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JPO  UNDEF", 0x7B, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JNO  UNDEF", 0x71, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JNS  UNDEF", 0x79, 0x00);
    ETEST(UNDEFINED_SYMBOL, "LOOP   UNDEF", 0xE2, 0x00);
    ETEST(UNDEFINED_SYMBOL, "LOOPE  UNDEF", 0xE1, 0x00);
    ETEST(UNDEFINED_SYMBOL, "LOOPNE UNDEF", 0xE0, 0x00);
    ETEST(UNDEFINED_SYMBOL, "JCXZ   UNDEF", 0xE3, 0x00);
...
static void test_error() {
    ...
    ETEST(OPERAND_NOT_ALLOWED, "OUT 34H,BL");
    ETEST(OPERAND_NOT_ALLOWED, "OUT CX,AX");

    ETEST(OPERAND_NOT_ALLOWED, "ROR AL,2");
    ETEST(OPERAND_NOT_ALLOWED, "ROR AL,CH");

    ETEST(OPERAND_NOT_ALLOWED, "MOV AX,BL");
    ETEST(OPERAND_NOT_ALLOWED, "MOV DI,AL");
    ETEST(OPERAND_NOT_ALLOWED, "MOV BYTE PTR [SI], AX");
    ETEST(OPERAND_NOT_ALLOWED, "MOV WORD PTR [SI], AL");
    ETEST(OPERAND_NOT_ALLOWED, "MOV [SI], 34H");
    ETEST(OPERAND_NOT_ALLOWED, "INC [SI]");

    ETEST(OPERAND_TOO_FAR, "JE $+130");
    ETEST(OPERAND_TOO_FAR, "JE $-127");

    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[DI],[SI+0]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[DI],[DI]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[DI],[BP]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[DI],[BX]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[DI+0],[SI]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[SI],[SI]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[BP],[SI]");
    ETEST(ILLEGAL_OPERAND, "MOVSB ES:[BX],[SI]");

    ETEST(ILLEGAL_OPERAND, "CMPSB [SI],ES:[SI]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [SI],ES:[DI+0]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [SI],ES:[BP]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [SI],ES:[BX]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [SI+0],ES:[DI]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [DI],ES:[DI]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [BP],ES:[DI]");
    ETEST(ILLEGAL_OPERAND, "CMPSB [BX],ES:[DI]");

    ETEST(ILLEGAL_OPERAND, "SCASB ES:[SI]");
    ETEST(ILLEGAL_OPERAND, "SCASW ES:[DI+0]");
    ETEST(ILLEGAL_OPERAND, "SCASB ES:[BP]");
    ETEST(ILLEGAL_OPERAND, "SCASB ES:[BX]");

    ETEST(ILLEGAL_OPERAND, "LODSB [SI+0]");
    ETEST(ILLEGAL_OPERAND, "LODSW [DI]");
    ETEST(ILLEGAL_OPERAND, "LODSB [BP]");
    ETEST(ILLEGAL_OPERAND, "LODSB [BX]");

    ETEST(ILLEGAL_OPERAND, "STOSB ES:[SI]");
    ETEST(ILLEGAL_OPERAND, "STOSW ES:[DI+0]");
