...
void test_minmode() {
    // The general 32-bit registers XWA-XHL decode as illegal in minimum mode.
    ERRT("LD",   "XWA, XBC",  UNKNOWN_INSTRUCTION, "", 0xE9, 0x88);
    ERRT("MULA", "XWA",       UNKNOWN_INSTRUCTION, "", 0xD8, 0x19);
    ERRT("LD",   "A, (XHL)",  UNKNOWN_INSTRUCTION, "", 0xC3, 0xEC, 0x21);
    ERRT("LD",   "A, (-XWA)", UNKNOWN_INSTRUCTION, "", 0xC4, 0xE0, 0x21);
