...
Disassembler disassembler(R65C02);
...
static void test_zeropage_indexed() {
    ...
    // R65C02
    TEST(BIT, "zero10,X", "$10", 0x34, 0x10);
}
...
static void test_absolute() {
    ...
    // R65C02
    TEST(TSB, "abs1234", "$1234", 0x0C, 0x34, 0x12);
}
...
static void test_absolute_indexed() {
    ...
    // R65C02
    TEST(STZ, "abs1234,X",  "$1234", 0x9E, 0x34, 0x12);
}
...
static void test_indexed_absolute_indirect() {
    ...
    // R65C02
    TEST(JMP, "(>abs0010,X)", "$0010", 0x7C, 0x10, 0x00);
    TEST(JMP, "(abs1234,X)",  "$1234", 0x7C, 0x34, 0x12);
}
...
static void test_zeropage_indirect() {
    ...
    TEST(ORA, "(zero10)", "$10", 0x12, 0x10);
    TEST(AND, "(zeroFF)", "$FF", 0x32, 0xFF);
}
...
static void test_relative() {
    ...
    // R65C02
    ATEST(0x1000, BRA, "$1002", "+0", 0x80, 0x00);
   ...
   // R65C02
    ATEST(0x1000, BRA, "label1000", "$1000 (-2)",   0x80, 0xFE);
}
...
static void test_bit_manipulation() {
    ...
    TEST(RMB7, "zero10", "$10", 0x77, 0x10);
    TEST(SMB0, "zero10", "$10", 0x87, 0x10);
}

static void test_zeropage_relative() {
    // R65C02
    ATEST(0x1000, BBR0, "$10,$1003", "+0", 0x0F, 0x10, 0x00);
    ATEST(0x1000, BBR1, "$10,$1000", "-3", 0x1F, 0x10, 0xFD);
    ATEST(0x1000, BBR2, "$10,$1006", "+3", 0x2F, 0x10, 0x03);
    ATEST(0x1000, BBR3, "$10,$1082", "+127", 0x3F, 0x10, 0x7F);
    ATEST(0x1000, BBR4, "$10,$0F83", "-128", 0x4F, 0x10, 0x80);
    ATEST(0x1000, BBR5, "$10,$1003", "+0", 0x5F, 0x10, 0x00);
    ATEST(0x1000, BBR6, "$10,$1003", "+0", 0x6F, 0x10, 0x00);
    ATEST(0x1000, BBR7, "$10,$1003", "+0", 0x7F, 0x10, 0x00);
    ATEST(0x1000, BBS0, "$10,$1003", "+0", 0x8F, 0x10, 0x00);
    ATEST(0x1000, BBS1, "$10,$1000", "-3", 0x9F, 0x10, 0xFD);
    ATEST(0x1000, BBS2, "$10,$1006", "+3", 0xAF, 0x10, 0x03);
    ATEST(0x1000, BBS3, "$10,$1082", "+127", 0xBF, 0x10, 0x7F);
    ATEST(0x1000, BBS4, "$10,$0F83", "-128", 0xCF, 0x10, 0x80);
    ATEST(0x1000, BBS5, "$10,$1003", "+0", 0xDF, 0x10, 0x00);
    ATEST(0x1000, BBS6, "$10,$1003", "+0", 0xEF, 0x10, 0x00);
    ATEST(0x1000, BBS7, "$10,$1003", "+0", 0xFF, 0x10, 0x00);
    ...
    ATEST(0x1000, BBR3, "zero10,label1082", "$1082 (+127)", 0x3F, 0x10, 0x7F);
    ATEST(0x1000, BBR4, "zero10,label0F83", "$0F83 (-128)", 0x4F, 0x10, 0x80);
    ATEST(0x1000, BBS4, "zero10,label1003", "$1003 (+0)"  , 0xCF, 0x10, 0x00);
    ATEST(0x1000, BBS5, "zero10,label1000", "$1000 (-3)",   0xDF, 0x10, 0xFD);
}
