...
static void test_load_and_exchange() {
    ...
    if (z8001()) {
        ...
        ERRT("CLR  0x10000",     OVERFLOW_RANGE, "0x10000");
        TEST("CLR  0x1234(R2)",  0x4D28, 0x1234);
        TEST("CLR  0xFFFF(R2)",  0x4D28, 0xFFFF);
        ERRT("CLR  0x10000(R2)", OVERFLOW_RANGE, "0x10000(R2)");
        TEST("CLRB @R2",         0x0C28);
    ...
    if (z8001()) {
        ...
        ERRT("LD  R9,RR2(#32768)",   OVERFLOW_RANGE, "RR2(#32768)");
        ERRT("LD  R9,RR2(#-32769)",  OVERFLOW_RANGE, "RR2(#-32769)");
    ...
    if (z8001()) {
        ...
        ERRT("LDM R15,@RR2,#2",        OVERFLOW_RANGE, "#2");
        ...
        ERRT("LDM @RR2,R15,#2",        OVERFLOW_RANGE, "#2");
        ...
        ERRT("LDM R9,@R2,#8",         OVERFLOW_RANGE, "#8");
        ...
        ERRT("LDM @R2,R9,#8",        OVERFLOW_RANGE, "#8");
    ...
    if (z8001()) {
        ...
        AERRT(0xA000, "LDR  0x002003,R1",  OPERAND_TOO_FAR, "0x002003,R1");
        ATEST(0x2000, "LDR  0x00A003,R1",  0x3301, 0x7FFF);
        AERRT(0x2000, "LDR  0x00A004,R1",  OPERAND_TOO_FAR, "0x00A004,R1");
        ...
        AERRT(0xA000, "LDR  0x2003,R1",  OPERAND_TOO_FAR, "0x2003,R1");
        ATEST(0x2000, "LDR  0xA003,R1",  0x3301, 0x7FFF);
        AERRT(0x2000, "LDR  0xA004,R1",  OPERAND_TOO_FAR, "0xA004,R1");
    ...
    if (z8001()) {
        ...
        ERRT("POP  R5,@RR4",           REGISTERS_OVERLAPPED, "R5,@RR4");
        ERRT("POP  @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4");
        ERRT("POP  0x120034(R4),@RR4", REGISTERS_OVERLAPPED, "0x120034(R4),@RR4");
        ERRT("POPL RR4,@RR4",          REGISTERS_OVERLAPPED, "RR4,@RR4");
        ERRT("POPL @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4");
        ERRT("POPL 0x120034(R5),@RR4", REGISTERS_OVERLAPPED, "0x120034(R5),@RR4");
    } else {
        ...
        ERRT("POP  R4,@R4",         REGISTERS_OVERLAPPED, "R4,@R4");
        ERRT("POP  @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4");
        ERRT("POP  0x1234(R4),@R4", REGISTERS_OVERLAPPED, "0x1234(R4),@R4");
        ERRT("POPL RR2,@R3",        REGISTERS_OVERLAPPED, "RR2,@R3");
        ERRT("POPL @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4");
        ERRT("POPL 0x1234(R4),@R4", REGISTERS_OVERLAPPED, "0x1234(R4),@R4");
    }
    ...
    if (z8001()) {
        ...
        ERRT("PUSH  @RR4,R5",           REGISTERS_OVERLAPPED, "@RR4,R5");
        ERRT("PUSH  @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4");
        ERRT("PUSH  @RR4,0x120034(R4)", REGISTERS_OVERLAPPED, "@RR4,0x120034(R4)");
        ERRT("PUSHL @RR4,RR4",          REGISTERS_OVERLAPPED, "@RR4,RR4");
        ERRT("PUSHL @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4");
        ERRT("PUSHL @RR4,0x120034(R5)", REGISTERS_OVERLAPPED, "@RR4,0x120034(R5)");
    } else {
        ...
        ERRT("PUSH  @R4,R4" ,        REGISTERS_OVERLAPPED, "@R4,R4");
        ERRT("PUSH  @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4");
        ERRT("PUSH  @R4,0x1234(R4)", REGISTERS_OVERLAPPED, "@R4,0x1234(R4)");
        ERRT("PUSHL @R5,RR4",        REGISTERS_OVERLAPPED, "@R5,RR4");
        ERRT("PUSHL @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4");
        ERRT("PUSHL @R4,0x1234(R4)", REGISTERS_OVERLAPPED, "@R4,0x1234(R4)");
    }
}
...
static void test_arithmetic() {
    ...
    ERRT("EXTS  R15", REGISTER_NOT_ALLOWED,  "R15");
    ERRT("EXTSL RQ6", ILLEGAL_REGISTER,      "RQ6");
    ERRT("EXTSL RR14", REGISTER_NOT_ALLOWED, "RR14");
...
static void test_program_control() {
    ...
    ERRT("CALR $+0x1004", OPERAND_TOO_FAR, "$+0x1004");
    ERRT("CALR $-0x0FFE", OPERAND_TOO_FAR, "$-0x0FFE");
    TEST("CALR $-10",     0xD006);
    TEST("CALR $",        0xD001);
    ERRT("CALR $+13",     OPERAND_NOT_ALIGNED, "$+13");
    ERRT("CALR $-13",     OPERAND_NOT_ALIGNED, "$-13");
    ...
    ERRT("DBJNZ RL0,$+3",   OPERAND_NOT_ALIGNED, "$+3");
    ERRT("DBJNZ RL0,$+4",   OPERAND_TOO_FAR,     "$+4");
    TEST("DBJNZ RL0,$-252", 0xF87F);
    ERRT("DBJNZ RL0,$-253", OPERAND_NOT_ALIGNED, "$-253");
    ERRT("DBJNZ RL0,$-254", OPERAND_TOO_FAR,     "$-254");
    ...
    TEST("JR UGE,$", 0xEFFF);
    TEST("JR $-254", 0xE880);
    ERRT("JR $-255", OPERAND_NOT_ALIGNED, "$-255");
    ERRT("JR $-256", OPERAND_TOO_FAR,     "$-256");
    TEST("JR $+256", 0xE87F);
    ERRT("JR $+257", OPERAND_NOT_ALIGNED, "$+257");
    ERRT("JR $+258", OPERAND_TOO_FAR,     "$+258");
...
static void test_bit_manipulation() {
    ...
    ERRT("BITB RL2,#8", ILLEGAL_BIT_NUMBER,   "#8");
    ERRT("BITB RL2,R8", REGISTER_NOT_ALLOWED, "R8");
    if (z8001()) {
    ...
    ERRT("RESB RL2,#8", ILLEGAL_BIT_NUMBER,   "#8");
    ERRT("RESB RL2,R8", REGISTER_NOT_ALLOWED, "R8");
    if (z8001()) {
    ...
    ERRT("SETB RL2,#8", ILLEGAL_BIT_NUMBER,   "#8");
    ERRT("SETB RL2,R8", REGISTER_NOT_ALLOWED, "R8");
    if (z8001()) {
...
static void test_rotate() {
    ...
    TEST("RL  R1,#1",  0xB310);
    TEST("RL  R8,#2",  0xB382);
    ERRT("RL  R8,#0",  OPERAND_NOT_ALLOWED, "#0");
    ERRT("RL  R8,#3",  OVERFLOW_RANGE,      "#3");
...
static void test_shift() {
    ...
    ERRT("SLA  R2,#17",   OVERFLOW_RANGE, "#17");
    ERRT("SLAB R2,#9",    OVERFLOW_RANGE, "#9");
    ERRT("SLAL R2,#33",   OVERFLOW_RANGE, "#33");
    ERRT("SLA  R2,#-1",   OVERFLOW_RANGE, "#-1");
    ERRT("SLAB RH2,#-1",  OVERFLOW_RANGE, "#-1");
    ERRT("SLAL RR2,#-1",  OVERFLOW_RANGE, "#-1");
    ...
    ERRT("SRA  R2,#17",   OVERFLOW_RANGE, "#17");
    ERRT("SRAB R2,#9",    OVERFLOW_RANGE, "#9");
    ERRT("SRAL R2,#33",   OVERFLOW_RANGE, "#33");
    ERRT("SRA  R2,#-1",   OVERFLOW_RANGE, "#-1");
    ERRT("SRAB RH2,#-1",  OVERFLOW_RANGE, "#-1");
    ERRT("SRAL RR2,#-1",  OVERFLOW_RANGE, "#-1");

    // Shift Left Logical
    TEST("SLL  R2,#16",  0xB321, 0x0010);
    TEST("SLLB RH2,#8",  0xB221, 0x0008);
    TEST("SLLL RR2,#32", 0xB325, 0x0020);
    ERRT("SLL  R2,#17",  OVERFLOW_RANGE, "#17");
    ERRT("SLLB R2,#9",   OVERFLOW_RANGE, "#9");
    ERRT("SLLL R2,#33",  OVERFLOW_RANGE, "#33");

    // Shift Right Logical
    TEST("SRL  R2,#16",  0xB321, 0xFFF0);
    TEST("SRLB RH2,#8",  0xB221, 0x00F8);
    TEST("SRLL RR2,#32", 0xB325, 0xFFE0);
    ERRT("SRL  R2,#17",  OVERFLOW_RANGE, "#17");
    ERRT("SRLB R2,#9",   OVERFLOW_RANGE, "#9");
    ERRT("SRLL R2,#33",  OVERFLOW_RANGE, "#33");
}
...
static void test_block_transfer() {
    ...
    if (z8001()) {
        ...
        ERRT("CPD  R2,@RR0,R4,F",   REGISTER_NOT_ALLOWED, "@RR0,R4,F");
        ERRT("CPDB RL0,@RR0,R4,LT", REGISTER_NOT_ALLOWED, "@RR0,R4,LT");
    } else {
        TEST("CPD  R0,@R1,R2,F",   0xBB18, 0x0200);
        TEST("CPDB RL0,@R1,R2,LT", 0xBA18, 0x0281);
        ERRT("CPD  R2,@R0,R4,F",   REGISTER_NOT_ALLOWED, "@R0,R4,F");
        ERRT("CPDB RL0,@R0,R4,LT", REGISTER_NOT_ALLOWED, "@R0,R4,LT");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPDR  R1,@RR0,R4,LE",   REGISTER_NOT_ALLOWED, "@RR0,R4,LE");
        ERRT("CPDRB RL1,@RR0,R4,ULE", REGISTER_NOT_ALLOWED, "@RR0,R4,ULE");
    } else {
        TEST("CPDR  R3,@R4,R5,LE",   0xBB4C, 0x0532);
        TEST("CPDRB RL3,@R4,R5,ULE", 0xBA4C, 0x05B3);
        ERRT("CPDR  R1,@R0,R4,LE",   REGISTER_NOT_ALLOWED, "@R0,R4,LE");
        ERRT("CPDRB RL1,@R0,R4,ULE", REGISTER_NOT_ALLOWED, "@R0,R4,ULE");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPI  R1,@RR0,R4,OV", REGISTER_NOT_ALLOWED, "@RR0,R4,OV");
        ERRT("CPIB RL1,@RR0,R4",   REGISTER_NOT_ALLOWED, "@RR0,R4");
    } else {
        TEST("CPI  R6,@R7,R8,OV", 0xBB70, 0x0864);
        TEST("CPIB RL6,@R7,R8",   0xBA70, 0x08E8);
        ERRT("CPI  R2,@R0,R4,OV", REGISTER_NOT_ALLOWED, "@R0,R4,OV");
        ERRT("CPIB RL0,@R0,R4",   REGISTER_NOT_ALLOWED, "@R0,R4");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPIR  R1,@RR0,R4,Z",  REGISTER_NOT_ALLOWED, "@RR0,R4,Z");
        ERRT("CPIRB RL1,@RR0,R4,C", REGISTER_NOT_ALLOWED, "@RR0,R4,C");
    } else {
        TEST("CPIR  R9,@R10,R11,Z",  0xBBA4, 0x0B96);
        TEST("CPIRB RH1,@R10,R11,C", 0xBAA4, 0x0B17);
        ERRT("CPIR  R1,@R0,R4,LE",   REGISTER_NOT_ALLOWED, "@R0,R4,LE");
        ERRT("CPIRB RL1,@R0,R4,ULE", REGISTER_NOT_ALLOWED, "@R0,R4,ULE");
    }
    ...
    if (z8001()) {
        ...
        ERRT("LDD  @RR0,@RR4,R6", REGISTER_NOT_ALLOWED, "@RR0,@RR4,R6");
        ERRT("LDDB @RR0,@RR4,R6", REGISTER_NOT_ALLOWED, "@RR0,@RR4,R6");
        ERRT("LDD  @RR2,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
        ERRT("LDDB @RR2,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
    } else {
        TEST("LDD  @R1,@R2,R3", 0xBB29, 0x0318);
        TEST("LDDB @R1,@R2,R3", 0xBA29, 0x0318);
        ERRT("LDD  @R0,@R2,R3", REGISTER_NOT_ALLOWED, "@R0,@R2,R3");
        ERRT("LDDB @R0,@R2,R3", REGISTER_NOT_ALLOWED, "@R0,@R2,R3");
        ERRT("LDD  @R1,@R0,R3", REGISTER_NOT_ALLOWED, "@R0,R3");
        ERRT("LDDB @R1,@R0,R3", REGISTER_NOT_ALLOWED, "@R0,R3");
    }
    ...
    if (z8001()) {
        ...
        ERRT("LDDR  @RR0,@RR6,R8", REGISTER_NOT_ALLOWED, "@RR0,@RR6,R8");
        ERRT("LDDRB @RR0,@RR6,R8", REGISTER_NOT_ALLOWED, "@RR0,@RR6,R8");
        ERRT("LDDR  @RR4,@RR0,R8", REGISTER_NOT_ALLOWED, "@RR0,R8");
        ERRT("LDDRB @RR4,@RR0,R8", REGISTER_NOT_ALLOWED, "@RR0,R8");
    } else {
        TEST("LDDR  @R4,@R5,R6", 0xBB59, 0x0640);
        TEST("LDDRB @R4,@R5,R6", 0xBA59, 0x0640);
        ERRT("LDDR  @R0,@R5,R6", REGISTER_NOT_ALLOWED, "@R0,@R5,R6");
        ERRT("LDDRB @R0,@R5,R6", REGISTER_NOT_ALLOWED, "@R0,@R5,R6");
        ERRT("LDDR  @R4,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
        ERRT("LDDRB @R4,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
    }
    ...
    if (z8001()) {
        ...
        ERRT("LDI  @RR0,@RR8,R10", REGISTER_NOT_ALLOWED, "@RR0,@RR8,R10");
        ERRT("LDIB @RR0,@RR8,R10", REGISTER_NOT_ALLOWED, "@RR0,@RR8,R10");
        ERRT("LDI  @RR6,@RR0,R10", REGISTER_NOT_ALLOWED, "@RR0,R10");
        ERRT("LDIB @RR6,@RR0,R10", REGISTER_NOT_ALLOWED, "@RR0,R10");
    } else {
        TEST("LDI  @R7,@R8,R9", 0xBB81, 0x0978);
        TEST("LDIB @R7,@R8,R9", 0xBA81, 0x0978);
        ERRT("LDI  @R0,@R8,R9", REGISTER_NOT_ALLOWED, "@R0,@R8,R9");
        ERRT("LDIB @R0,@R8,R9", REGISTER_NOT_ALLOWED, "@R0,@R8,R9");
        ERRT("LDI  @R7,@R0,R9", REGISTER_NOT_ALLOWED, "@R0,R9");
        ERRT("LDIB @R7,@R0,R9", REGISTER_NOT_ALLOWED, "@R0,R9");
    }
    ...
    if (z8001()) {
        ...
        ERRT("LDIR  @RR0,@RR10,R12", REGISTER_NOT_ALLOWED, "@RR0,@RR10,R12");
        ERRT("LDIRB @RR0,@RR10,R12", REGISTER_NOT_ALLOWED, "@RR0,@RR10,R12");
        ERRT("LDIR  @RR8,@RR0,R12",  REGISTER_NOT_ALLOWED, "@RR0,R12");
        ERRT("LDIRB @RR8,@RR0,R12",  REGISTER_NOT_ALLOWED, "@RR0,R12");
    } else {
        TEST("LDIR  @R10,@R11,R12", 0xBBB1, 0x0CA0);
        TEST("LDIRB @R10,@R11,R12", 0xBAB1, 0x0CA0);
        ERRT("LDIR  @R0,@R11,R12",  REGISTER_NOT_ALLOWED, "@R0,@R11,R12");
        ERRT("LDIRB @R0,@R11,R12",  REGISTER_NOT_ALLOWED, "@R0,@R11,R12");
        ERRT("LDIR  @R10,@R0,R12",  REGISTER_NOT_ALLOWED, "@R0,R12");
        ERRT("LDIRB @R10,@R0,R12",  REGISTER_NOT_ALLOWED, "@R0,R12");
    }
}
...
static void test_string_manipulation() {
    ...
    if (z8001()) {
        ...
        ERRT("CPSD  @RR0,@RR2,R0",    REGISTER_NOT_ALLOWED, "@RR0,@RR2,R0");
        ERRT("CPSD  @RR4,@RR0,R0",    REGISTER_NOT_ALLOWED, "@RR0,R0");
        ERRT("CPSDB @RR0,@RR2,R4,GE", REGISTER_NOT_ALLOWED, "@RR0,@RR2,R4,GE");
        ERRT("CPSDB @RR2,@RR0,R4,GE", REGISTER_NOT_ALLOWED, "@RR0,R4,GE");
    } else {
        TEST("CPSD  @R3,@R1,R2",    0xBB1A, 0x0238);
        TEST("CPSDB @R3,@R1,R2,GE", 0xBA1A, 0x0239);
        ERRT("CPSD  @R3,@R0,R2",    REGISTER_NOT_ALLOWED, "@R0,R2");
        ERRT("CPSD  @R0,@R3,R2",    REGISTER_NOT_ALLOWED, "@R0,@R3,R2");
        ERRT("CPSDB @R3,@R0,R2,GE", REGISTER_NOT_ALLOWED, "@R0,R2,GE");
        ERRT("CPSDB @R0,@R3,R2,GE", REGISTER_NOT_ALLOWED, "@R0,@R3,R2,GE");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPSDR  @RR0,@RR4,R5,GT",  REGISTER_NOT_ALLOWED, "@RR0,@RR4,R5,GT");
        ERRT("CPSDR  @RR2,@RR0,R5,GT",  REGISTER_NOT_ALLOWED, "@RR0,R5,GT");
        ERRT("CPSDRB @RR0,@RR4,R5,UGT", REGISTER_NOT_ALLOWED, "@RR0,@RR4,R5,UGT");
        ERRT("CPSDRB @RR2,@RR0,R5,UGT", REGISTER_NOT_ALLOWED, "@RR0,R5,UGT");
    } else {
        TEST("CPSDR  @R3,@R4,R5,GT",  0xBB4E, 0x053A);
        TEST("CPSDRB @R3,@R4,R0,UGT", 0xBA4E, 0x003B);
        ERRT("CPSDR  @R0,@R4,R5,GT",  REGISTER_NOT_ALLOWED, "@R0,@R4,R5,GT");
        ERRT("CPSDR  @R3,@R0,R5,GT",  REGISTER_NOT_ALLOWED, "@R0,R5,GT");
        ERRT("CPSDRB @R0,@R4,R0,UGT", REGISTER_NOT_ALLOWED, "@R0,@R4,R0,UGT");
        ERRT("CPSDRB @R3,@R0,R0,UGT", REGISTER_NOT_ALLOWED, "@R0,R0,UGT");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPSI  @RR0,@RR6,R5,NOV", REGISTER_NOT_ALLOWED, "@RR0,@RR6,R5,NOV");
        ERRT("CPSI  @RR4,@RR0,R5,NOV", REGISTER_NOT_ALLOWED, "@RR0,R5,NOV");
        ERRT("CPSIB @RR0,@RR6,R5,PL",  REGISTER_NOT_ALLOWED, "@RR0,@RR6,R5,PL");
        ERRT("CPSIB @RR4,@RR0,R5,PL",  REGISTER_NOT_ALLOWED, "@RR0,R5,PL");
    } else {
        TEST("CPSI  @R6,@R7,R8,NOV", 0xBB72, 0x086C);
        TEST("CPSIB @R6,@R7,R8,PL",  0xBA72, 0x086D);
        ERRT("CPSI  @R0,@R7,R8,NOV", REGISTER_NOT_ALLOWED, "@R0,@R7,R8,NOV");
        ERRT("CPSI  @R6,@R0,R8,NOV", REGISTER_NOT_ALLOWED, "@R0,R8,NOV");
        ERRT("CPSIB @R0,@R7,R8,PL",  REGISTER_NOT_ALLOWED, "@R0,@R7,R8,PL");
        ERRT("CPSIB @R6,@R0,R8,PL",  REGISTER_NOT_ALLOWED, "@R0,R8,PL");
    }
    ...
    if (z8001()) {
        ...
        ERRT("CPSIR  @RR0,@RR8,R6,NZ", REGISTER_NOT_ALLOWED, "@RR0,@RR8,R6,NZ");
        ERRT("CPSIR  @RR4,@RR0,R6,NZ", REGISTER_NOT_ALLOWED, "@RR0,R6,NZ");
        ERRT("CPSIRB @RR0,@RR8,R6,NC", REGISTER_NOT_ALLOWED, "@RR0,@RR8,R6,NC");
        ERRT("CPSIRB @RR4,@RR0,R6,NC", REGISTER_NOT_ALLOWED, "@RR0,R6,NC");
    } else {
        TEST("CPSIR  @R9,@R10,R11,NZ", 0xBBA6, 0x0B9E);
        TEST("CPSIRB @R1,@R10,R11,NC", 0xBAA6, 0x0B1F);
        ERRT("CPSIR  @R0,@R10,R11,NZ", REGISTER_NOT_ALLOWED, "@R0,@R10,R11,NZ");
        ERRT("CPSIR  @R9,@R0,R11,NZ",  REGISTER_NOT_ALLOWED, "@R0,R11,NZ");
        ERRT("CPSIRB @R0,@R10,R11,NC", REGISTER_NOT_ALLOWED, "@R0,@R10,R11,NC");
        ERRT("CPSIRB @R1,@R0,R11,NC",  REGISTER_NOT_ALLOWED, "@R0,R11,NC");
    }
    ...
    if (z8001()) {
        ...
        ERRT("TRDB @RR2,@RR4,R1", REGISTER_NOT_ALLOWED, "R1");
        ERRT("TRDB @RR0,@RR4,R6", REGISTER_NOT_ALLOWED, "@RR0,@RR4,R6");
        ERRT("TRDB @RR2,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
    } else {
        ERRT("TRDB @R0,@R2,R3", REGISTER_NOT_ALLOWED, "@R0,@R2,R3");
        ERRT("TRDB @R1,@R2,R3", REGISTER_NOT_ALLOWED, "@R1,@R2,R3");
        ERRT("TRDB @R2,@R0,R3", REGISTER_NOT_ALLOWED, "@R0,R3");
        ERRT("TRDB @R2,@R1,R3", REGISTER_NOT_ALLOWED, "@R1,R3");
        ERRT("TRDB @R2,@R2,R3", REGISTERS_OVERLAPPED, "@R2,@R2,R3");
        TEST("TRDB @R3,@R2,R4", 0xB838, 0x0420);
        TEST("TRDB @R3,@R2,R0", 0xB838, 0x0020);
        ERRT("TRDB @R3,@R2,R1", REGISTER_NOT_ALLOWED, "R1");
    }

    // Translate, Decrement, and Repeat
    if (z8001()) {
        TEST("TRDRB @RR4,@RR6,R2", 0xB84C, 0x0260);
        ERRT("TRDRB @RR0,@RR6,R2", REGISTER_NOT_ALLOWED, "@RR0,@RR6,R2");
        ERRT("TRDRB @RR4,@RR0,R2", REGISTER_NOT_ALLOWED, "@RR0,R2");
    } else {
        TEST("TRDRB @R4,@R5,R6",   0xB84C, 0x0650);
        ERRT("TRDRB @R0,@R5,R6", REGISTER_NOT_ALLOWED, "@R0,@R5,R6");
        ERRT("TRDRB @R4,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
    }

    // Translate and Increment
    if (z8001()) {
        TEST("TRIB @RR6,@RR8,R3", 0xB860, 0x0380);
        ERRT("TRIB @RR0,@RR8,R3", REGISTER_NOT_ALLOWED, "@RR0,@RR8,R3");
        ERRT("TRIB @RR6,@RR0,R3", REGISTER_NOT_ALLOWED, "@RR0,R3");
    } else {
        TEST("TRIB @R7,@R8,R9", 0xB870, 0x0980);
        ERRT("TRIB @R0,@R8,R9", REGISTER_NOT_ALLOWED, "@R0,@R8,R9");
        ERRT("TRIB @R7,@R0,R9", REGISTER_NOT_ALLOWED, "@R0,R9");
    }

    // Translate, Increment, and Repeat
    if (z8001()) {
        TEST("TRIRB @RR8,@RR10,R12", 0xB884, 0x0CA0);
        ERRT("TRIRB @RR0,@RR10,R12", REGISTER_NOT_ALLOWED, "@RR0,@RR10,R12");
        ERRT("TRIRB @RR8,@RR0,R12",  REGISTER_NOT_ALLOWED, "@RR0,R12");
    } else {
        TEST("TRIRB @R10,@R11,R12", 0xB8A4, 0x0CB0);
        ERRT("TRIRB @R0,@R11,R12",  REGISTER_NOT_ALLOWED, "@R0,@R11,R12");
        ERRT("TRIRB @R10,@R0,R12",  REGISTER_NOT_ALLOWED, "@R0,R12");
    }

    // Translate, Test, and Decrement
    if (z8001()) {
        TEST("TRTDB @RR10,@RR12,R9", 0xB8AA, 0x09C0);
        ERRT("TRTDB @RR0,@RR12,R9",  REGISTER_NOT_ALLOWED, "@RR0,@RR12,R9");
        ERRT("TRTDB @RR10,@RR0,R9",  REGISTER_NOT_ALLOWED, "@RR0,R9");
    } else {
        TEST("TRTDB @R13,@R14,R15", 0xB8DA, 0x0FE0);
        ERRT("TRTDB @R0,@R14,R15",  REGISTER_NOT_ALLOWED, "@R0,@R14,R15");
        ERRT("TRTDB @R13,@R0,R15",  REGISTER_NOT_ALLOWED, "@R0,R15");
    }

    // Translate, Test, Decrement, and Repeat
    if (z8001()) {
        TEST("TRTDRB @RR12,@RR14,R0", 0xB8CE, 0x00EE);
        ERRT("TRTDRB @RR0,@RR14,R0",  REGISTER_NOT_ALLOWED, "@RR0,@RR14,R0");
        ERRT("TRTDRB @RR12,@RR0,R0",  REGISTER_NOT_ALLOWED, "@RR0,R0");
    } else {
        TEST("TRTDRB @R15,@R14,R13", 0xB8FE, 0x0DEE);
        ERRT("TRTDRB @R0,@R14,R13",  REGISTER_NOT_ALLOWED, "@R0,@R14,R13");
        ERRT("TRTDRB @R15,@R0,R13",  REGISTER_NOT_ALLOWED, "@R0,R13");
    }

    // Translate, Test, and Increment
    if (z8001()) {
        TEST("TRTIB @RR14,@RR12,R11", 0xB8E2, 0x0BC0);
        ERRT("TRTIB @RR0,@RR12,R11",  REGISTER_NOT_ALLOWED, "@RR0,@RR12,R11");
        ERRT("TRTIB @RR14,@RR0,R11",  REGISTER_NOT_ALLOWED, "@RR0,R11");
    } else {
        TEST("TRTIB @R12,@R11,R10", 0xB8C2, 0x0AB0);
        ERRT("TRTIB @R0,@R11,R10",  REGISTER_NOT_ALLOWED, "@R0,@R11,R10");
        ERRT("TRTIB @R12,@R0,R10",  REGISTER_NOT_ALLOWED, "@R0,R10");
    }

    // Translate, Test, Increment, and Repeat
    if (z8001()) {
        TEST("TRTIRB @RR10,@RR8,R7", 0xB8A6, 0x078E);
        ERRT("TRTIRB @RR0,@RR8,R7",  REGISTER_NOT_ALLOWED, "@RR0,@RR8,R7");
        ERRT("TRTIRB @RR10,@RR0,R7", REGISTER_NOT_ALLOWED, "@RR0,R7");
    } else {
        TEST("TRTIRB @R9,@R8,R7", 0xB896, 0x078E);
        ERRT("TRTIRB @R0,@R8,R7", REGISTER_NOT_ALLOWED, "@R0,@R8,R7");
        ERRT("TRTIRB @R9,@R0,R7", REGISTER_NOT_ALLOWED, "@R0,R7");
    }
}
...
static void test_input() {
    ...
    ERRT("IN  R1,@R0",      REGISTER_NOT_ALLOWED, "@R0");
    ERRT("INB RH1,@R0",     REGISTER_NOT_ALLOWED, "@R0");
    TEST("IN  R1, 0x1234",  0x3B14, 0x1234);
    TEST("INB RH1, 0x1234", 0x3A14, 0x1234);
    TEST("IN  R1, 0xFFFF",  0x3B14, 0xFFFF);
    ERRT("IN  R1, 0x10000", OVERFLOW_RANGE, "0x10000");
    ...
    if (z8001()) {
        ...
        ERRT("IND  @RR0,@R4,R6", REGISTER_NOT_ALLOWED, "@RR0,@R4,R6");
        ERRT("IND  @RR2,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
        ERRT("INDB @RR0,@R4,R6", REGISTER_NOT_ALLOWED, "@RR0,@R4,R6");
        ERRT("INDB @RR2,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
    } else {
        TEST("IND  @R1,@R2,R0", 0x3B28, 0x0018);
        TEST("INDB @R1,@R2,R0", 0x3A28, 0x0018);
        ERRT("IND  @R0,@R2,R0", REGISTER_NOT_ALLOWED, "@R0,@R2,R0");
        ERRT("IND  @R1,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
        ERRT("INDB @R0,@R2,R0", REGISTER_NOT_ALLOWED, "@R0,@R2,R0");
        ERRT("INDB @R1,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SIND  @RR0,@R3,R0", REGISTER_NOT_ALLOWED, "@RR0,@R3,R0");
        ERRT("SIND  @RR4,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
        ERRT("SINDB @RR0,@R3,R0", REGISTER_NOT_ALLOWED, "@RR0,@R3,R0");
        ERRT("SINDB @RR4,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
    } else {
        TEST("SIND  @R3,@R4,R5", 0x3B49, 0x0538);
        TEST("SINDB @R3,@R4,R5", 0x3A49, 0x0538);
        ERRT("SIND  @R0,@R4,R5", REGISTER_NOT_ALLOWED, "@R0,@R4,R5");
        ERRT("SIND  @R3,@R0,R5", REGISTER_NOT_ALLOWED, "@R0,R5");
        ERRT("SINDB @R0,@R4,R5", REGISTER_NOT_ALLOWED, "@R0,@R4,R5");
        ERRT("SINDB @R3,@R0,R5", REGISTER_NOT_ALLOWED, "@R0,R5");
    }
    ...
    if (z8001()) {
        ...
        ERRT("INDR  @RR0,@R4,R8", REGISTER_NOT_ALLOWED, "@RR0,@R4,R8");
        ERRT("INDR  @RR6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
        ERRT("INDRB @RR0,@R4,R8", REGISTER_NOT_ALLOWED, "@RR0,@R4,R8");
        ERRT("INDRB @RR6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
    } else {
        TEST("INDR  @R6,@R7,R8", 0x3B78, 0x0860);
        TEST("INDRB @R6,@R7,R8", 0x3A78, 0x0860);
        ERRT("INDR  @R0,@R7,R8", REGISTER_NOT_ALLOWED, "@R0,@R7,R8");
        ERRT("INDR  @R6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
        ERRT("INDRB @R0,@R7,R8", REGISTER_NOT_ALLOWED, "@R0,@R7,R8");
        ERRT("INDRB @R6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINDR  @RR0,@R10,R12", REGISTER_NOT_ALLOWED, "@RR0,@R10,R12");
        ERRT("SINDR  @RR8,@R0,R12",  REGISTER_NOT_ALLOWED, "@R0,R12");
        ERRT("SINDRB @RR0,@R10,R12", REGISTER_NOT_ALLOWED, "@RR0,@R10,R12");
        ERRT("SINDRB @RR8,@R0,R12",  REGISTER_NOT_ALLOWED, "@R0,R12");
    } else {
        TEST("SINDR  @R9,@R10,R11", 0x3BA9, 0x0B90);
        TEST("SINDRB @R9,@R10,R11", 0x3AA9, 0x0B90);
        ERRT("SINDR  @R0,@R10,R11", REGISTER_NOT_ALLOWED, "@R0,@R10,R11");
        ERRT("SINDR  @R9,@R0,R11",  REGISTER_NOT_ALLOWED, "@R0,R11");
        ERRT("SINDRB @R0,@R10,R11", REGISTER_NOT_ALLOWED, "@R0,@R10,R11");
        ERRT("SINDRB @R9,@R0,R11",  REGISTER_NOT_ALLOWED, "@R0,R11");
    }
    ...
    if (z8001()) {
        ...
        ERRT("INI  @RR0,@R2,R1",  REGISTER_NOT_ALLOWED, "@RR0,@R2,R1");
        ERRT("INI  @RR14,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
        ERRT("INIB @RR0,@R2,R1",  REGISTER_NOT_ALLOWED, "@RR0,@R2,R1");
        ERRT("INIB @RR14,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
    } else {
        TEST("INI  @R12,@R13,R14", 0x3BD0, 0x0EC8);
        TEST("INIB @R12,@R13,R14", 0x3AD0, 0x0EC8);
        ERRT("INI  @R0,@R13,R14",  REGISTER_NOT_ALLOWED, "@R0,@R13,R14");
        ERRT("INI  @R12,@R0,R14",  REGISTER_NOT_ALLOWED, "@R0,R14");
        ERRT("INIB @R0,@R13,R14",  REGISTER_NOT_ALLOWED, "@R0,@R13,R14");
        ERRT("INIB @R12,@R0,R14",  REGISTER_NOT_ALLOWED, "@R0,R14");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINI  @RR0,@R11,R10",  REGISTER_NOT_ALLOWED, "@RR0,@R11,R10");
        ERRT("SINI  @RR12,@R0,R10",  REGISTER_NOT_ALLOWED, "@R0,R10");
        ERRT("SINIB @RR0,@R11,R10",  REGISTER_NOT_ALLOWED, "@RR0,@R11,R10");
        ERRT("SINIB @RR12,@R0,R10",  REGISTER_NOT_ALLOWED, "@R0,R10");
    } else {
        TEST("SINI  @R15,@R1,R0", 0x3B11, 0x00F8);
        TEST("SINIB @R15,@R1,R0", 0x3A11, 0x00F8);
        ERRT("SINI  @R0,@R1,R0",  REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("SINI  @R15,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
        ERRT("SINIB @R0,@R1,R0",  REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("SINIB @R15,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
    }
    ...
    if (z8001()) {
        ...
        ERRT("INIR  @RR0,@R9,R8",  REGISTER_NOT_ALLOWED, "@RR0,@R9,R8");
        ERRT("INIR  @RR10,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
        ERRT("INIRB @RR0,@R9,R8",  REGISTER_NOT_ALLOWED, "@RR0,@R9,R8");
        ERRT("INIRB @RR10,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
    } else {
        TEST("INIR  @R3,@R2,R1", 0x3B20, 0x0130);
        TEST("INIRB @R3,@R2,R1", 0x3A20, 0x0130);
        ERRT("INIR  @R0,@R2,R1", REGISTER_NOT_ALLOWED, "@R0,@R2,R1");
        ERRT("INIR  @R3,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
        ERRT("INIRB @R0,@R2,R1", REGISTER_NOT_ALLOWED, "@R0,@R2,R1");
        ERRT("INIRB @R3,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SINIR  @RR0,@R7,R6", REGISTER_NOT_ALLOWED, "@RR0,@R7,R6");
        ERRT("SINIR  @RR8,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
        ERRT("SINIRB @RR0,@R7,R6", REGISTER_NOT_ALLOWED, "@RR0,@R7,R6");
        ERRT("SINIRB @RR8,@R0,R6", REGISTER_NOT_ALLOWED, "@R0,R6");
    } else {
        TEST("SINIR  @R4,@R3,R2", 0x3B31, 0x0240);
        TEST("SINIRB @R4,@R3,R2", 0x3A31, 0x0240);
        ERRT("SINIR  @R0,@R3,R2", REGISTER_NOT_ALLOWED, "@R0,@R3,R2");
        ERRT("SINIR  @R4,@R0,R2", REGISTER_NOT_ALLOWED, "@R0,R2");
        ERRT("SINIRB @R0,@R3,R2", REGISTER_NOT_ALLOWED, "@R0,@R3,R2");
        ERRT("SINIRB @R4,@R0,R2", REGISTER_NOT_ALLOWED, "@R0,R2");
    }
}
...
static void test_output() {
    ...
    ERRT("OUT  @R0,R1",      REGISTER_NOT_ALLOWED, "@R0,R1");
    ERRT("OUTB @R0,RH1",     REGISTER_NOT_ALLOWED, "@R0,RH1");
    TEST("OUT   0x1234,R1",  0x3B16, 0x1234);
    TEST("OUTB  0x1234,RH1", 0x3A16, 0x1234);
    TEST("OUT   0xFFFF,R1",  0x3B16, 0xFFFF);
    ERRT("OUT  0x10000,R1",  OVERFLOW_RANGE, "0x10000,R1");
    // GNU as compatibility
    TEST("OUT  #0x1234,R1",  0x3B16, 0x1234);
    TEST("OUTB #0x1234,RH1", 0x3A16, 0x1234);
    ...
    if (z8001()) {
        ...
        ERRT("OUTD  @R0,@RR4,R6", REGISTER_NOT_ALLOWED, "@R0,@RR4,R6");
        ERRT("OUTD  @R2,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
        ERRT("OUTDB @R0,@RR4,R6", REGISTER_NOT_ALLOWED, "@R0,@RR4,R6");
        ERRT("OUTDB @R2,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
    } else {
        TEST("OUTD  @R2,@R1,R0", 0x3B1A, 0x0028);
        TEST("OUTDB @R2,@R1,R0", 0x3A1A, 0x0028);
        ERRT("OUTD  @R0,@R1,R0", REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("OUTD  @R2,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
        ERRT("OUTDB @R0,@R1,R0", REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("OUTDB @R2,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOUTD  @R0,@RR4,R0", REGISTER_NOT_ALLOWED, "@R0,@RR4,R0");
        ERRT("SOUTD  @R3,@RR0,R0", REGISTER_NOT_ALLOWED, "@RR0,R0");
        ERRT("SOUTDB @R0,@RR4,R0", REGISTER_NOT_ALLOWED, "@R0,@RR4,R0");
        ERRT("SOUTDB @R3,@RR0,R0", REGISTER_NOT_ALLOWED, "@RR0,R0");
    } else {
        TEST("SOUTD  @R3,@R4,R5", 0x3B4B, 0x0538);
        TEST("SOUTDB @R3,@R4,R5", 0x3A4B, 0x0538);
        ERRT("SOUTD  @R0,@R4,R5", REGISTER_NOT_ALLOWED, "@R0,@R4,R5");
        ERRT("SOUTD  @R3,@R0,R5", REGISTER_NOT_ALLOWED, "@R0,R5");
        ERRT("SOUTDB @R0,@R4,R5", REGISTER_NOT_ALLOWED, "@R0,@R4,R5");
        ERRT("SOUTDB @R3,@R0,R5", REGISTER_NOT_ALLOWED, "@R0,R5");
    }
    ...
    if (z8001()) {
        ...
        ERRT("OTDR  @R0,@RR6,R8", REGISTER_NOT_ALLOWED, "@R0,@RR6,R8");
        ERRT("OTDR  @R4,@RR0,R8", REGISTER_NOT_ALLOWED, "@RR0,R8");
        ERRT("OTDRB @R0,@RR6,R8", REGISTER_NOT_ALLOWED, "@R0,@RR6,R8");
        ERRT("OTDRB @R4,@RR0,R8", REGISTER_NOT_ALLOWED, "@RR0,R8");
    } else {
        TEST("OTDR  @R6,@R7,R8", 0x3B7A, 0x0860);
        TEST("OTDRB @R6,@R7,R8", 0x3A7A, 0x0860);
        ERRT("OTDR  @R0,@R7,R8", REGISTER_NOT_ALLOWED, "@R0,@R7,R8");
        ERRT("OTDR  @R6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
        ERRT("OTDRB @R0,@R7,R8", REGISTER_NOT_ALLOWED, "@R0,@R7,R8");
        ERRT("OTDRB @R6,@R0,R8", REGISTER_NOT_ALLOWED, "@R0,R8");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOTDR  @R0,@RR10,R12", REGISTER_NOT_ALLOWED, "@R0,@RR10,R12");
        ERRT("SOTDR  @R8,@RR0,R12",  REGISTER_NOT_ALLOWED, "@RR0,R12");
        ERRT("SOTDRB @R0,@RR10,R12", REGISTER_NOT_ALLOWED, "@R0,@RR10,R12");
        ERRT("SOTDRB @R8,@RR0,R12",  REGISTER_NOT_ALLOWED, "@RR0,R12");
    } else {
        TEST("SOTDR  @R9,@R10,R11", 0x3BAB, 0x0B90);
        TEST("SOTDRB @R9,@R10,R11", 0x3AAB, 0x0B90);
        ERRT("SOTDR  @R0,@R10,R11", REGISTER_NOT_ALLOWED, "@R0,@R10,R11");
        ERRT("SOTDR  @R9,@R0,R11",  REGISTER_NOT_ALLOWED, "@R0,R11");
        ERRT("SOTDRB @R0,@R10,R11", REGISTER_NOT_ALLOWED, "@R0,@R10,R11");
        ERRT("SOTDRB @R9,@R0,R11",  REGISTER_NOT_ALLOWED, "@R0,R11");
    }
    ...
    if (z8001()) {
        ...
        ERRT("OUTI  @R0,@RR2,R1",  REGISTER_NOT_ALLOWED, "@R0,@RR2,R1");
        ERRT("OUTI  @R14,@RR0,R1", REGISTER_NOT_ALLOWED, "@RR0,R1");
        ERRT("OUTIB @R0,@RR2,R1",  REGISTER_NOT_ALLOWED, "@R0,@RR2,R1");
        ERRT("OUTIB @R14,@RR0,R1", REGISTER_NOT_ALLOWED, "@RR0,R1");
    } else {
        TEST("OUTI  @R12,@R13,R14", 0x3BD2, 0x0EC8);
        TEST("OUTIB @R12,@R13,R14", 0x3AD2, 0x0EC8);
        ERRT("OUTI  @R0,@R13,R14",  REGISTER_NOT_ALLOWED, "@R0,@R13,R14");
        ERRT("OUTI  @R12,@R0,R14",  REGISTER_NOT_ALLOWED, "@R0,R14");
        ERRT("OUTIB @R0,@R13,R14",  REGISTER_NOT_ALLOWED, "@R0,@R13,R14");
        ERRT("OUTIB @R12,@R0,R14",  REGISTER_NOT_ALLOWED, "@R0,R14");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOUTI  @R0,@RR12,R11",  REGISTER_NOT_ALLOWED, "@R0,@RR12,R11");
        ERRT("SOUTI  @R10,@RR0,R11",  REGISTER_NOT_ALLOWED, "@RR0,R11");
        ERRT("SOUTIB @R0,@RR12,R11",  REGISTER_NOT_ALLOWED, "@R0,@RR12,R11");
        ERRT("SOUTIB @R10,@RR0,R11",  REGISTER_NOT_ALLOWED, "@RR0,R11");
    } else {
        TEST("SOUTI  @R15,@R1,R0", 0x3B13, 0x00F8);
        TEST("SOUTIB @R15,@R1,R0", 0x3A13, 0x00F8);
        ERRT("SOUTI  @R0,@R1,R0",  REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("SOUTI  @R15,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
        ERRT("SOUTIB @R0,@R1,R0",  REGISTER_NOT_ALLOWED, "@R0,@R1,R0");
        ERRT("SOUTIB @R15,@R0,R0", REGISTER_NOT_ALLOWED, "@R0,R0");
    }
    ...
    if (z8001()) {
        ...
        ERRT("OTIR  @R0,@RR10,R8", REGISTER_NOT_ALLOWED, "@R0,@RR10,R8");
        ERRT("OTIR  @R9,@RR0,R8",  REGISTER_NOT_ALLOWED, "@RR0,R8");
        ERRT("OTIRB @R0,@RR10,R8", REGISTER_NOT_ALLOWED, "@R0,@RR10,R8");
        ERRT("OTIRB @R9,@RR0,R8",  REGISTER_NOT_ALLOWED, "@RR0,R8");
    } else {
        TEST("OTIR  @R3,@R2,R1", 0x3B22, 0x0130);
        TEST("OTIRB @R3,@R2,R1", 0x3A22, 0x0130);
        ERRT("OTIR  @R0,@R2,R1", REGISTER_NOT_ALLOWED, "@R0,@R2,R1");
        ERRT("OTIR  @R3,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
        ERRT("OTIRB @R0,@R2,R1", REGISTER_NOT_ALLOWED, "@R0,@R2,R1");
        ERRT("OTIRB @R3,@R0,R1", REGISTER_NOT_ALLOWED, "@R0,R1");
    }
    ...
    if (z8001()) {
        ...
        ERRT("SOTIR  @R0,@RR8,R6", REGISTER_NOT_ALLOWED, "@R0,@RR8,R6");
        ERRT("SOTIR  @R7,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
        ERRT("SOTIRB @R0,@RR8,R6", REGISTER_NOT_ALLOWED, "@R0,@RR8,R6");
        ERRT("SOTIRB @R7,@RR0,R6", REGISTER_NOT_ALLOWED, "@RR0,R6");
    } else {
        TEST("SOTIR  @R4,@R3,R2", 0x3B33, 0x0240);
        TEST("SOTIRB @R4,@R3,R2", 0x3A33, 0x0240);
        ERRT("SOTIR  @R0,@R3,R2", REGISTER_NOT_ALLOWED, "@R0,@R3,R2");
        ERRT("SOTIR  @R4,@R0,R2", REGISTER_NOT_ALLOWED, "@R0,R2");
        ERRT("SOTIRB @R0,@R3,R2", REGISTER_NOT_ALLOWED, "@R0,@R3,R2");
        ERRT("SOTIRB @R4,@R0,R2", REGISTER_NOT_ALLOWED, "@R0,R2");
    }
}
...
static void test_cpu_conrtol() {
    ...
    ERRT("LDCTL R14,FLAGS",   ILLEGAL_SIZE, "FLAGS");
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL R10,PSAP",    ILLEGAL_REGISTER, "PSAP");
        ERRT("LDCTL R11,NSP",     ILLEGAL_REGISTER, "NSP");
    } else {
        TEST("LDCTL R10,PSAP",   0x7DA5);
        TEST("LDCTL R9,NSP",     0x7D97);
        ERRT("LDCTL R8,PSAPSEG", ILLEGAL_REGISTER, "PSAPSEG");
        ERRT("LDCTL R7,PSAPOFF", ILLEGAL_REGISTER, "PSAPOFF");
        ERRT("LDCTL R6,NSPSEG",  ILLEGAL_REGISTER, "NSPSEG");
        ERRT("LDCTL R5,NSPOFF",  ILLEGAL_REGISTER, "NSPOFF");
    }
    ERRT("LDCTL FLAGS,R6",   ILLEGAL_SIZE, "FLAGS,R6");
    ...
    if (z8001()) {
        ...
        ERRT("LDCTL PSAP,R15",   ILLEGAL_REGISTER, "PSAP,R15");
        ERRT("LDCTL NSP,R14",    ILLEGAL_REGISTER, "NSP,R14");
    } else {
        TEST("LDCTL PSAP,R2",     0x7D2D);
        TEST("LDCTL NSP,R1",      0x7D1F);
        ERRT("LDCTL PSAPSEG,R15", ILLEGAL_REGISTER, "PSAPSEG,R15");
        ERRT("LDCTL PSAPOFF,R14", ILLEGAL_REGISTER, "PSAPOFF,R14");
        ERRT("LDCTL NSPSEG,R13",  ILLEGAL_REGISTER, "NSPSEG,R13");
        ERRT("LDCTL NSPOFF,R12",  ILLEGAL_REGISTER, "NSPOFF,R12");
    }
    ERRT("LDCTLB RL0,FCW",     ILLEGAL_SIZE, "FCW");
    ERRT("LDCTLB RL1,REFRESH", ILLEGAL_SIZE, "REFRESH");
    if (z8001()) {
        ERRT("LDCTLB RL2,PSAPSEG", ILLEGAL_SIZE, "PSAPSEG");
        ERRT("LDCTLB RL3,PSAPOFF", ILLEGAL_SIZE, "PSAPOFF");
        ERRT("LDCTLB RL4,NSPSEG",  ILLEGAL_SIZE, "NSPSEG");
        ERRT("LDCTLB RL5,NSPOFF",  ILLEGAL_SIZE, "NSPOFF");
    } else {
        ERRT("LDCTLB RL3,PSAP", ILLEGAL_SIZE, "PSAP");
        ERRT("LDCTLB RL5,NSP",  ILLEGAL_SIZE, "NSP");
    }
    TEST("LDCTLB RL6,FLAGS",   0x8CE1);
    ERRT("LDCTLB FCW,RH0",     ILLEGAL_SIZE, "FCW,RH0");
    ERRT("LDCTLB REFRESH,RH1", ILLEGAL_SIZE, "REFRESH,RH1");
    if (z8001()) {
        ERRT("LDCTLB PSAPSEG,RH2", ILLEGAL_SIZE, "PSAPSEG,RH2");
        ERRT("LDCTLB PSAPOFF,RH3", ILLEGAL_SIZE, "PSAPOFF,RH3");
        ERRT("LDCTLB NSPSEG,RH4",  ILLEGAL_SIZE, "NSPSEG,RH4");
        ERRT("LDCTLB NSPOFF,RH5",  ILLEGAL_SIZE, "NSPOFF,RH5");
    } else {
        ERRT("LDCTLB PSAP,RH3", ILLEGAL_SIZE, "PSAP,RH3");
        ERRT("LDCTLB NSP,RH5",  ILLEGAL_SIZE, "NSP,RH5");
    }
...
static void test_short_direct() {
    ...
    TEST("CLR |(seg+soff)|(R2) ; short direct", 0x4D28, 0x5634);
    ERRT("CLR |0x561234|       ; long offset",  OVERFLOW_RANGE, "|0x561234|       ; long offset");
    ERRT("CLR |0x561234|(R2)   ; long offset",  OVERFLOW_RANGE, "|0x561234|(R2)   ; long offset");
    ERRT("CLR |seg+loff|       ; long offset",  OVERFLOW_RANGE, "|seg+loff|       ; long offset");
    ERRT("CLR |(seg|loff)|     ; long offset",  OVERFLOW_RANGE, "|(seg|loff)|     ; long offset");
    ERRT("CLR |(seg|loff)|(R2) ; long offset",  OVERFLOW_RANGE, "|(seg|loff)|(R2) ; long offset");
}
