...
static void test_load_and_exchange() {
    ...
    if (z8001()) {
        ...
        ERRT("LD  R9,RR2(#32768)",   OVERFLOW_RANGE, "RR2(#32768)",  0x3129, 0x8000);
        ERRT("LD  R9,RR2(#-32769)",  OVERFLOW_RANGE, "RR2(#-32769)", 0x3129, 0x7FFF);
    ...
    if (z8001()) {
        ...
        ERRT("POP  R5,@RR4",           REGISTERS_OVERLAPPED, "R5,@RR4",   0x9745);
        ERRT("POP  @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4", 0x1744);
        ERRT("POP  0x120034(R4),@RR4", REGISTERS_OVERLAPPED, "0x120034(R4),@RR4", 0x5744, 0x1234);
        ERRT("POPL RR4,@RR4",          REGISTERS_OVERLAPPED, "RR4,@RR4",  0x9544);
        ERRT("POPL @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4", 0x1544);
        ERRT("POPL 0x120034(R5),@RR4", REGISTERS_OVERLAPPED, "0x120034(R5),@RR4", 0x5545, 0x1234);
    } else {
        ...
        ERRT("POP  R4,@R4",         REGISTERS_OVERLAPPED, "R4,@R4",         0x9744);
        ERRT("POP  @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4",        0x1744);
        ERRT("POP  0x1234(R4),@R4", REGISTERS_OVERLAPPED, "0x1234(R4),@R4", 0x5744, 0x1234);
        ERRT("POPL RR2,@R3",        REGISTERS_OVERLAPPED, "RR2,@R3",        0x9532);
        ERRT("POPL @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4",        0x1544);
        ERRT("POPL 0x1234(R4),@R4", REGISTERS_OVERLAPPED, "0x1234(R4),@R4", 0x5544, 0x1234);
    }
    ...
    if (z8001()) {
        ...
        ERRT("PUSH  @RR4,R5",           REGISTERS_OVERLAPPED, "@RR4,R5",   0x9345);
        ERRT("PUSH  @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4", 0x1344);
        ERRT("PUSH  @RR4,0x120034(R4)", REGISTERS_OVERLAPPED, "@RR4,0x120034(R4)", 0x5344, 0x1234);
        ERRT("PUSHL @RR4,RR4",          REGISTERS_OVERLAPPED, "@RR4,RR4",  0x9144);
        ERRT("PUSHL @RR4,@RR4",         REGISTERS_OVERLAPPED, "@RR4,@RR4", 0x1144);
        ERRT("PUSHL @RR4,0x120034(R5)", REGISTERS_OVERLAPPED, "@RR4,0x120034(R5)", 0x5145, 0x1234);
    } else {
        ...
        ERRT("PUSH  @R4,R4" ,        REGISTERS_OVERLAPPED, "@R4,R4",         0x9344);
        ERRT("PUSH  @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4",        0x1344);
        ERRT("PUSH  @R4,0x1234(R4)", REGISTERS_OVERLAPPED, "@R4,0x1234(R4)", 0x5344, 0x1234);
        ERRT("PUSHL @R5,RR4",        REGISTERS_OVERLAPPED, "@R5,RR4",        0x9154);
        ERRT("PUSHL @R4,@R4",        REGISTERS_OVERLAPPED, "@R4,@R4",        0x1144);
        ERRT("PUSHL @R4,0x1234(R4)", REGISTERS_OVERLAPPED, "@R4,0x1234(R4)", 0x5144, 0x1234);
    }
}
...
static void test_block_transfer() {
    ...
    if (z8001()) {
        ...
        ERRT("CPDB RL0,@RR0,R4,LT", REGISTER_NOT_ALLOWED, "@RR0,R4,LT", 0xBA08, 0x0481);
    } else {
...
static void test_string_manipulation() {
    ...
    if (z8001()) {
        ...
        ERRT("TRDB @R2,@R2,R3", REGISTERS_OVERLAPPED, "@R2,@R2,R3", 0xB828, 0x0320);
    ...
    if (z8001()) {
        ...
        ERRT("TRTDRB @RR0,@RR14,R0",  REGISTER_NOT_ALLOWED, "@RR0,@RR14,R0", 0xB80E, 0x00EE);
        ERRT("TRTDRB @RR12,@RR0,R0",  REGISTER_NOT_ALLOWED, "@RR0,R0",       0xB8CE, 0x000E);
    } else {
