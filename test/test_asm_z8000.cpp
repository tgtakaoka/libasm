...
static void test_cpu_conrtol() {
    ...
    if (z8001()) {
        ...
        ETEST(ILLEGAL_REGISTER, "LDCTL R10,PSAP");
        ETEST(ILLEGAL_REGISTER, "LDCTL R11,NSP");
    } else {
        TEST("LDCTL R10,PSAP", 0x7DA5);
        TEST("LDCTL R9,NSP",   0x7D97);
        ETEST(ILLEGAL_REGISTER, "LDCTL R8,PSAPSEG");
        ETEST(ILLEGAL_REGISTER, "LDCTL R7,PSAPOFF");
        ETEST(ILLEGAL_REGISTER, "LDCTL R6,NSPSEG");
        ETEST(ILLEGAL_REGISTER, "LDCTL R5,NSPOFF");
    }
    ...
    if (z8001()) {
        ...
        ETEST(ILLEGAL_REGISTER, "LDCTL PSAP,R15");
        ETEST(ILLEGAL_REGISTER, "LDCTL NSP,R14");
    } else {
        TEST("LDCTL PSAP,R2",  0x7D2D);
        TEST("LDCTL NSP,R1",   0x7D1F);
        ETEST(ILLEGAL_REGISTER, "LDCTL PSAPSEG,R15");
        ETEST(ILLEGAL_REGISTER, "LDCTL PSAPOFF,R14");
        ETEST(ILLEGAL_REGISTER, "LDCTL NSPSEG,R13");
        ETEST(ILLEGAL_REGISTER, "LDCTL NSPOFF,R12");
    }
    ...
    if (z8001()) {
        ...
        ETEST(ILLEGAL_SIZE, "LDCTLB RL3,PSAP");
        ETEST(ILLEGAL_SIZE, "LDCTLB RL5,NSP");
    }
    ...
    if (z8001()) {
        ...
        ETEST(ILLEGAL_SIZE, "LDCTLB PSAP,RH3");
        ETEST(ILLEGAL_SIZE, "LDCTLB NSP,RH5");
    }
...
static void test_short_direct() {
    ...
    ETEST(OVERFLOW_RANGE, "CLR |0x561234|       ; long offset");
    ETEST(OVERFLOW_RANGE, "CLR |0x561234|(R2)   ; long offset");
    ETEST(OVERFLOW_RANGE, "CLR |seg+loff|       ; long offset");
    ETEST(OVERFLOW_RANGE, "CLR |(seg|loff)|(R2) ; long offset");
}
...
static void test_undefined_symbol() {
    ...
    if (z8001()) {
        ETEST(UNDEFINED_SYMBOL, "LD  R9,UNDEF",         0x6109, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LD  R9,UNDEF(R2)",     0x6129, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LD  UNDEF,R9",         0x6F09, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LD  UNDEF(R2),R9",     0x6F29, 0x8000, 0x0000);
        ...
        ETEST(UNDEFINED_SYMBOL, "LDA RR8,UNDEF",        0x7608, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LDA RR8,UNDEF(R2)",    0x7628, 0x8000, 0x0000);
        ...
        ETEST(UNDEFINED_SYMBOL, "LDM R1,UNDEF,#2",      0x5C01, 0x0101, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LDM R1,UNDEF,#UNDEF",  0x5C01, 0x0100, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "CALL UNDEF",           0x5F00, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "CALL UNDEF(R2)",       0x5F20, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "JP UNDEF",             0x5E08, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "JP C,UNDEF",           0x5E07, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "JP C,UNDEF(R2)",       0x5E27, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "BIT UNDEF,#4",         0x6704, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "BIT UNDEF(R2),#4",     0x6724, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "BIT UNDEF,#UNDEF",     0x6700, 0x8000, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "BIT UNDEF(R2),#UNDEF", 0x6720, 0x8000, 0x0000);
    } else {
        ETEST(UNDEFINED_SYMBOL, "LD  R9,UNDEF",         0x6109, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LD  R9,UNDEF(R2)",     0x6129, 0x0000);
        ETEST(UNDEFINED_SYMBOL, "LD  UNDEF,R9",         0x6F09, 0x0000);
