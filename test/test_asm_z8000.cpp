...
static void test_string_manipulation() {
    ...
    if (z8001()) {
        ...
        ETEST(REGISTER_NOT_ALLOWED, "CPSD  R1,@RR0,R0");
        ETEST(REGISTER_NOT_ALLOWED, "CPSDB RH1,@RR0,R4,GE");
    } else {
        TEST("CPSD  R0,@R1,R2",      0xBB1A, 0x0208);
        TEST("CPSDB RL0,@R1,R2,GE",  0xBA1A, 0x0289);
        ETEST(REGISTER_NOT_ALLOWED, "CPSD  R0,@R0,R2");
        ETEST(REGISTER_NOT_ALLOWED, "CPSDB RL0,@R0,R2,GE");
    }
    ...
    if (z8001()) {
        ...
        ETEST(REGISTER_NOT_ALLOWED, "CPSDR  R2,@RR0,R5,GT");
        ETEST(REGISTER_NOT_ALLOWED, "CPSDRB RH2,@RR0,R5,UGT");
    } else {
        TEST("CPSDR  R3,@R4,R5,GT",    0xBB4E, 0x053A);
        TEST("CPSDRB RL3,@R4,R0,UGT",  0xBA4E, 0x00BB);
        ETEST(REGISTER_NOT_ALLOWED, "CPSDR  R3,@R0,R5,GT");
        ETEST(REGISTER_NOT_ALLOWED, "CPSDRB RL3,@R0,R0,UGT");
    }
    ...
    if (z8001()) {
        ...
        ETEST(REGISTER_NOT_ALLOWED, "CPSI  R3,@RR0,R5,NOV");
        ETEST(REGISTER_NOT_ALLOWED, "CPSIB RH3,@RR0,R5,PL");
    } else {
        TEST("CPSI  R6,@R7,R8,NOV",  0xBB72, 0x086C);
        TEST("CPSIB RL6,@R7,R8,PL",  0xBA72, 0x08ED);
        ETEST(REGISTER_NOT_ALLOWED, "CPSI  R6,@R0,R8,NOV");
        ETEST(REGISTER_NOT_ALLOWED, "CPSIB RL6,@R0,R8,PL");
    }
    ...
    if (z8001()) {
        ...
        ETEST(REGISTER_NOT_ALLOWED, "CPSIR  R4,@RR0,R6,NZ");
        ETEST(REGISTER_NOT_ALLOWED, "CPSIRB RH4,@RR0,R6,NC");
    } else {
        ...
        ETEST(REGISTER_NOT_ALLOWED, "CPSIRB RH1,@R0,R11,NC");
    }
