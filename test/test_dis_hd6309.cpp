...
static void test_indexed_mode() {
    ...
    ATEST(0x1000, LDA, "$1004,PC",   0xA6, 0x8D, 0x00, 0x00);
    ATEST(0x1000, LDA, "$9003,PC",   0xA6, 0x8D, 0x7F, 0xFF);
    ATEST(0x1000, LDA, "$9004,PC",   0xA6, 0x8D, 0x80, 0x00);
    ATEST(0x1000, LDA, "[$1004,PC]", 0xA6, 0x9D, 0x00, 0x00);
    ...
    ATEST(0x1000, LDA, "label1004,PC",   0xA6, 0x8D, 0x00, 0x00);
    ATEST(0x1000, LDA, "label9003,PC",   0xA6, 0x8D, 0x7F, 0xFF);
    ATEST(0x1000, LDA, "label9004,PC",   0xA6, 0x8D, 0x80, 0x00);
    ATEST(0x1000, LDA, "[label1004,PC]", 0xA6, 0x9D, 0x00, 0x00);
...
static void test_bit_position() {
    TEST(BAND,  "A.1,$34.2", 0x11, 0x30, 0x4A, 0x34);
    TEST(BIAND, "A.1,$34.2", 0x11, 0x31, 0x4A, 0x34);
    TEST(BOR,   "A.1,$34.2", 0x11, 0x32, 0x4A, 0x34);
    TEST(BIOR,  "A.1,$34.2", 0x11, 0x33, 0x4A, 0x34);
    TEST(BEOR,  "A.1,$34.2", 0x11, 0x34, 0x4A, 0x34);
    TEST(BIEOR, "A.1,$34.2", 0x11, 0x35, 0x4A, 0x34);
    TEST(LDBT,  "A.1,$34.2", 0x11, 0x36, 0x4A, 0x34);
    TEST(STBT,  "A.1,$34.2", 0x11, 0x37, 0x4A, 0x34);

    TEST(LDBT, "CC.0,$34.7", 0x11, 0x36, 0x07, 0x34);
    TEST(LDBT, "CC.1,$34.7", 0x11, 0x36, 0x0F, 0x34);
    TEST(LDBT, "CC.2,$34.7", 0x11, 0x36, 0x17, 0x34);
    TEST(LDBT, "CC.3,$34.7", 0x11, 0x36, 0x1F, 0x34);
    TEST(LDBT, "CC.4,$34.7", 0x11, 0x36, 0x27, 0x34);
    TEST(LDBT, "CC.5,$34.7", 0x11, 0x36, 0x2F, 0x34);
    TEST(LDBT, "CC.6,$34.7", 0x11, 0x36, 0x37, 0x34);
    TEST(LDBT, "CC.7,$34.7", 0x11, 0x36, 0x3F, 0x34);
    TEST(LDBT, "A.7,$34.0",  0x11, 0x36, 0x78, 0x34);
    TEST(LDBT, "B.2,$34.4",  0x11, 0x36, 0x94, 0x34);

    symtab.put(0x0034, "dir34");

    TEST(LDBT, "CC.0,<dir34.7", 0x11, 0x36, 0x07, 0x34);
    TEST(LDBT, "B.2,<dir34.4",  0x11, 0x36, 0x94, 0x34);
}
