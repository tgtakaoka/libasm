...
static void test_relative() {
    if (m6805()) {
        ATEST(0x100, BRA, "$102", 0x20, 0x00);
        ATEST(0x100, BHI, "$104", 0x22, 0x02);
        ATEST(0x100, BLS, "$102", 0x23, 0x00);
        ATEST(0x100, BHS, "$102", 0x24, 0x00);
        ATEST(0x100, BLO, "$102", 0x25, 0x00);
        ATEST(0x100, BNE, "$102", 0x26, 0x00);
        ATEST(0x100, BEQ, "$102", 0x27, 0x00);
        ATEST(0x100, BPL, "$102", 0x2A, 0x00);
        ATEST(0x100, BMI, "$102", 0x2B, 0x00);

        ATEST(0x100, BHCC, "$102", 0x28, 0x00);
        ATEST(0x100, BHCS, "$102", 0x29, 0x00);
        ATEST(0x100, BMC,  "$102", 0x2C, 0x00);
        ATEST(0x100, BMS,  "$102", 0x2D, 0x00);
        ATEST(0x100, BIL,  "$102", 0x2E, 0x00);
        ATEST(0x100, BIH,  "$102", 0x2F, 0x00);

        ATEST(0x100, BSR,  "$142", 0xAD, 0x40);
    } else {
