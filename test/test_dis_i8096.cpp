...
static void test_2_operands() {
    ...
    ERRT("ADD",   "53, 18",          REGISTER_NOT_ALLOWED, 0x64, 0x12, 0x35);
    ERRT("ADD",   "52, 19",          REGISTER_NOT_ALLOWED, 0x64, 0x13, 0x34);
    TEST("ADD",   "86, #3412H",                            0x65, 0x12, 0x34, 0x56);
    ERRT("ADD",   "87, #3412H",      REGISTER_NOT_ALLOWED, 0x65, 0x12, 0x34, 0x57);
    TEST("ADD",   "52, [18]",                              0x66, 0x12, 0x34);
    ERRT("ADD",   "53, [18]",        REGISTER_NOT_ALLOWED, 0x66, 0x12, 0x35);
    ERRT("ADD",   "52, [19]",        REGISTER_NOT_ALLOWED, 0x66, 0x13, 0x34);
    TEST("ADD",   "86, 52[18]",                            0x67, 0x12, 0x34, 0x56);
    ERRT("ADD",   "87, 52[18]",      REGISTER_NOT_ALLOWED, 0x67, 0x12, 0x34, 0x57);
    TEST("ADD",   "120, 5634H[18]",                        0x67, 0x13, 0x34, 0x56, 0x78);
    ERRT("ADD",   "121, 5634H[18]",  REGISTER_NOT_ALLOWED, 0x67, 0x13, 0x34, 0x56, 0x79);
    TEST("ADDB",  "35, 18",                                0x74, 0x12, 0x23);
    TEST("ADDB",  "34, 19",                                0x74, 0x13, 0x22);
    TEST("ADDB",  "35, #18",                               0x75, 0x12, 0x23);
    TEST("ADDB",  "35, [18]",                              0x76, 0x12, 0x23);
    ERRT("ADDB",  "35, [19]",        REGISTER_NOT_ALLOWED, 0x76, 0x13, 0x23);
    ...
    ERRT("MUL",   "52, 17",          REGISTER_NOT_ALLOWED, 0xFE, 0x6C, 0x11, 0x34);
    ERRT("MUL",   "53, 16",          REGISTER_NOT_ALLOWED, 0xFE, 0x6C, 0x10, 0x35);
    ERRT("MUL",   "54, 16",          REGISTER_NOT_ALLOWED, 0xFE, 0x6C, 0x10, 0x36);
    ERRT("MUL",   "55, 16",          REGISTER_NOT_ALLOWED, 0xFE, 0x6C, 0x10, 0x37);
    TEST("MUL",   "84, #3412H",      0xFE, 0x6D, 0x12, 0x34, 0x54);
    ERRT("MUL",   "85, #3412H",      REGISTER_NOT_ALLOWED, 0xFE, 0x6D, 0x12, 0x34, 0x55);
    ERRT("MUL",   "86, #3412H",      REGISTER_NOT_ALLOWED, 0xFE, 0x6D, 0x12, 0x34, 0x56);
    ERRT("MUL",   "87, #3412H",      REGISTER_NOT_ALLOWED, 0xFE, 0x6D, 0x12, 0x34, 0x57);
    TEST("MUL",   "52, [18]",        0xFE, 0x6E, 0x12, 0x34);
    ERRT("MUL",   "52, [19]",        REGISTER_NOT_ALLOWED, 0xFE, 0x6E, 0x13, 0x34);
    ERRT("MUL",   "53, [18]",        REGISTER_NOT_ALLOWED, 0xFE, 0x6E, 0x12, 0x35);
    ERRT("MUL",   "54, [18]",        REGISTER_NOT_ALLOWED, 0xFE, 0x6E, 0x12, 0x36);
    ERRT("MUL",   "55, [18]",        REGISTER_NOT_ALLOWED, 0xFE, 0x6E, 0x12, 0x37);
    TEST("MUL",   "84, 52[18]",      0xFE, 0x6F, 0x12, 0x34, 0x54);
    ERRT("MUL",   "85, 52[18]",      REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x12, 0x34, 0x55);
    ERRT("MUL",   "86, 52[18]",      REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x12, 0x34, 0x56);
    ERRT("MUL",   "87, 52[18]",      REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x12, 0x34, 0x57);
    TEST("MUL",   "120, 5634H[18]",  0xFE, 0x6F, 0x13, 0x34, 0x56, 0x78);
    ERRT("MUL",   "121, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x13, 0x34, 0x56, 0x79);
    ERRT("MUL",   "122, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x13, 0x34, 0x56, 0x7A);
    ERRT("MUL",   "123, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x6F, 0x13, 0x34, 0x56, 0x7B);
    TEST("MULB",  "36, 19",          0xFE, 0x7C, 0x13, 0x24);
    ERRT("MULB",  "37, 18",          REGISTER_NOT_ALLOWED, 0xFE, 0x7C, 0x12, 0x25);
    TEST("MULB",  "36, #18",         0xFE, 0x7D, 0x12, 0x24);
    ERRT("MULB",  "37, #18",         REGISTER_NOT_ALLOWED, 0xFE, 0x7D, 0x12, 0x25);
    TEST("MULB",  "36, [18]",        0xFE, 0x7E, 0x12, 0x24);
    ERRT("MULB",  "36, [19]",        REGISTER_NOT_ALLOWED, 0xFE, 0x7E, 0x13, 0x24);
    ERRT("MULB",  "37, [18]",        REGISTER_NOT_ALLOWED, 0xFE, 0x7E, 0x12, 0x25);
    TEST("MULB",  "52, 35[18]",      0xFE, 0x7F, 0x12, 0x23, 0x34);
    ERRT("MULB",  "53, 35[18]",      REGISTER_NOT_ALLOWED, 0xFE, 0x7F, 0x12, 0x23, 0x35);
    TEST("MULB",  "70, 3423H[18]",   0xFE, 0x7F, 0x13, 0x23, 0x34, 0x46);
    ERRT("MULB",  "71, 3423H[18]",   REGISTER_NOT_ALLOWED, 0xFE, 0x7F, 0x13, 0x23, 0x34, 0x47);
    ...
    ERRT("DIV",   "121, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x8F, 0x13, 0x34, 0x56, 0x79);
    ERRT("DIV",   "122, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x8F, 0x13, 0x34, 0x56, 0x7A);
    ERRT("DIV",   "123, 5634H[18]",  REGISTER_NOT_ALLOWED, 0xFE, 0x8F, 0x13, 0x34, 0x56, 0x7B);
    ...
    ERRT("DIVU",  "52, 19",          REGISTER_NOT_ALLOWED, 0x8C, 0x13, 0x34);
    ERRT("DIVU",  "53, 18",          REGISTER_NOT_ALLOWED, 0x8C, 0x12, 0x35);
    ERRT("DIVU",  "54, 18",          REGISTER_NOT_ALLOWED, 0x8C, 0x12, 0x36);
    ERRT("DIVU",  "55, 18",          REGISTER_NOT_ALLOWED, 0x8C, 0x12, 0x37);
    TEST("DIVU",  "84, #3412H",      0x8D, 0x12, 0x34, 0x54);
    ERRT("DIVU",  "85, #3412H",      REGISTER_NOT_ALLOWED, 0x8D, 0x12, 0x34, 0x55);
    ERRT("DIVU",  "86, #3412H",      REGISTER_NOT_ALLOWED, 0x8D, 0x12, 0x34, 0x56);
    ERRT("DIVU",  "87, #3412H",      REGISTER_NOT_ALLOWED, 0x8D, 0x12, 0x34, 0x57);
    TEST("DIVU",  "52, [18]",        0x8E, 0x12, 0x34);
    ERRT("DIVU",  "52, [19]",        REGISTER_NOT_ALLOWED, 0x8E, 0x13, 0x34);
    ERRT("DIVU",  "53, [18]",        REGISTER_NOT_ALLOWED, 0x8E, 0x12, 0x35);
    ERRT("DIVU",  "54, [18]",        REGISTER_NOT_ALLOWED, 0x8E, 0x12, 0x36);
    ERRT("DIVU",  "55, [18]",        REGISTER_NOT_ALLOWED, 0x8E, 0x12, 0x37);
    TEST("DIVU",  "84, 52[18]",      0x8F, 0x12, 0x34, 0x54);
    ERRT("DIVU",  "85, 52[18]",      REGISTER_NOT_ALLOWED, 0x8F, 0x12, 0x34, 0x55);
    ERRT("DIVU",  "86, 52[18]",      REGISTER_NOT_ALLOWED, 0x8F, 0x12, 0x34, 0x56);
    ERRT("DIVU",  "87, 52[18]",      REGISTER_NOT_ALLOWED, 0x8F, 0x12, 0x34, 0x57);
    TEST("DIVU",  "120, 5634H[18]",  0x8F, 0x13, 0x34, 0x56, 0x78);
    ERRT("DIVU",  "121, 5634H[18]",  REGISTER_NOT_ALLOWED, 0x8F, 0x13, 0x34, 0x56, 0x79);
    ERRT("DIVU",  "122, 5634H[18]",  REGISTER_NOT_ALLOWED, 0x8F, 0x13, 0x34, 0x56, 0x7A);
    ERRT("DIVU",  "123, 5634H[18]",  REGISTER_NOT_ALLOWED, 0x8F, 0x13, 0x34, 0x56, 0x7B);
    TEST("DIVUB", "36, 19",          0x9C, 0x13, 0x24);
    ERRT("DIVUB", "37, 18",          REGISTER_NOT_ALLOWED, 0x9C, 0x12, 0x25);
    TEST("DIVUB", "36, #18",         0x9D, 0x12, 0x24);
    ERRT("DIVUB", "37, #18",         REGISTER_NOT_ALLOWED, 0x9D, 0x12, 0x25);
    TEST("DIVUB", "36, [18]",        0x9E, 0x12, 0x24);
    ERRT("DIVUB", "36, [19]",        REGISTER_NOT_ALLOWED, 0x9E, 0x13, 0x24);
    ERRT("DIVUB", "37, [18]",        REGISTER_NOT_ALLOWED, 0x9E, 0x12, 0x25);
    TEST("DIVUB", "52, 35[18]",      0x9F, 0x12, 0x23, 0x34);
    ERRT("DIVUB", "53, 35[18]",      REGISTER_NOT_ALLOWED, 0x9F, 0x12, 0x23, 0x35);
    TEST("DIVUB", "70, 3423H[18]",   0x9F, 0x13, 0x23, 0x34, 0x46);
    ERRT("DIVUB", "71, 3423H[18]",   REGISTER_NOT_ALLOWED, 0x9F, 0x13, 0x23, 0x34, 0x47);
...
static void test_3_operands() {
    ...
    ERRT("MULU",  "84, 52, 19",          REGISTER_NOT_ALLOWED, 0x4C, 0x13, 0x34, 0x54);
    ERRT("MULU",  "84, 53, 18",          REGISTER_NOT_ALLOWED, 0x4C, 0x12, 0x35, 0x54);
    ERRT("MULU",  "85, 52, 18",          REGISTER_NOT_ALLOWED, 0x4C, 0x12, 0x34, 0x55);
    ERRT("MULU",  "86, 52, 18",          REGISTER_NOT_ALLOWED, 0x4C, 0x12, 0x34, 0x56);
    ERRT("MULU",  "87, 52, 18",          REGISTER_NOT_ALLOWED, 0x4C, 0x12, 0x34, 0x57);
    TEST("MULU",  "120, 86, #3412H",     0x4D, 0x12, 0x34, 0x56, 0x78);
    ERRT("MULU",  "120, 87, #3412H",     REGISTER_NOT_ALLOWED, 0x4D, 0x12, 0x34, 0x57, 0x78);
    ERRT("MULU",  "121, 86, #3412H",     REGISTER_NOT_ALLOWED, 0x4D, 0x12, 0x34, 0x56, 0x79);
    ERRT("MULU",  "122, 86, #3412H",     REGISTER_NOT_ALLOWED, 0x4D, 0x12, 0x34, 0x56, 0x7A);
    ERRT("MULU",  "123, 86, #3412H",     REGISTER_NOT_ALLOWED, 0x4D, 0x12, 0x34, 0x56, 0x7B);
    TEST("MULU",  "84, 52, [18]",        0x4E, 0x12, 0x34, 0x54);
    ERRT("MULU",  "84, 52, [19]",        REGISTER_NOT_ALLOWED, 0x4E, 0x13, 0x34, 0x54);
    ERRT("MULU",  "84, 53, [18]",        REGISTER_NOT_ALLOWED, 0x4E, 0x12, 0x35, 0x54);
    ERRT("MULU",  "85, 52, [18]",        REGISTER_NOT_ALLOWED, 0x4E, 0x12, 0x34, 0x55);
    ERRT("MULU",  "86, 52, [18]",        REGISTER_NOT_ALLOWED, 0x4E, 0x12, 0x34, 0x56);
    ERRT("MULU",  "87, 52, [18]",        REGISTER_NOT_ALLOWED, 0x4E, 0x12, 0x34, 0x57);
    TEST("MULU",  "120, 86, 52[18]",     0x4F, 0x12, 0x34, 0x56, 0x78);
    ERRT("MULU",  "120, 87, 52[18]",     REGISTER_NOT_ALLOWED, 0x4F, 0x12, 0x34, 0x57, 0x78);
    ERRT("MULU",  "121, 86, 52[18]",     REGISTER_NOT_ALLOWED, 0x4F, 0x12, 0x34, 0x56, 0x79);
    ERRT("MULU",  "122, 86, 52[18]",     REGISTER_NOT_ALLOWED, 0x4F, 0x12, 0x34, 0x56, 0x7A);
    ERRT("MULU",  "123, 86, 52[18]",     REGISTER_NOT_ALLOWED, 0x4F, 0x12, 0x34, 0x56, 0x7B);
    TEST("MULU",  "152, 120, 5634H[18]", 0x4F, 0x13, 0x34, 0x56, 0x78, 0x98);
    ERRT("MULU",  "152, 121, 5634H[18]", REGISTER_NOT_ALLOWED, 0x4F, 0x13, 0x34, 0x56, 0x79, 0x98);
    ERRT("MULU",  "153, 120, 5634H[18]", REGISTER_NOT_ALLOWED, 0x4F, 0x13, 0x34, 0x56, 0x78, 0x99);
    ERRT("MULU",  "154, 120, 5634H[18]", REGISTER_NOT_ALLOWED, 0x4F, 0x13, 0x34, 0x56, 0x78, 0x9A);
    ERRT("MULU",  "155, 120, 5634H[18]", REGISTER_NOT_ALLOWED, 0x4F, 0x13, 0x34, 0x56, 0x78, 0x9B);
    TEST("MULUB", "52, 36, 19",          0x5C, 0x13, 0x24, 0x34);
    TEST("MULUB", "52, 35, 18",          0x5C, 0x12, 0x23, 0x34);
    ERRT("MULUB", "53, 36, 18",          REGISTER_NOT_ALLOWED, 0x5C, 0x12, 0x24, 0x35);
    TEST("MULUB", "52, 35, #18",         0x5D, 0x12, 0x23, 0x34);
    ERRT("MULUB", "53, 35, #18",         REGISTER_NOT_ALLOWED, 0x5D, 0x12, 0x23, 0x35);
    TEST("MULUB", "52, 35, [18]",        0x5E, 0x12, 0x23, 0x34);
    ERRT("MULUB", "52, 35, [19]",        REGISTER_NOT_ALLOWED, 0x5E, 0x13, 0x23, 0x34);
    ERRT("MULUB", "53, 35, [18]",        REGISTER_NOT_ALLOWED, 0x5E, 0x12, 0x23, 0x35);
    TEST("MULUB", "70, 53, 35[18]",      0x5F, 0x12, 0x23, 0x35, 0x46);
    ERRT("MULUB", "71, 53, 35[18]",      REGISTER_NOT_ALLOWED, 0x5F, 0x12, 0x23, 0x35, 0x47);
    TEST("MULUB", "86, 69, 3423H[18]",   0x5F, 0x13, 0x23, 0x34, 0x45, 0x56);
    ERRT("MULUB", "87, 69, 3423H[18]",   REGISTER_NOT_ALLOWED, 0x5F, 0x13, 0x23, 0x34, 0x45, 0x57);
...
static void test_move() {
    ...
    ERRT("LDBSE", "53, 19",           REGISTER_NOT_ALLOWED, 0xBC, 0x13, 0x35);
    TEST("LDBSE", "52, #18",          0xBD, 0x12, 0x34);
    ERRT("LDBSE", "53, #18",          REGISTER_NOT_ALLOWED, 0xBD, 0x12, 0x35);
    TEST("LDBSE", "52, [18]",         0xBE, 0x12, 0x34);
    ERRT("LDBSE", "52, [19]",         REGISTER_NOT_ALLOWED, 0xBE, 0x13, 0x34);
    ERRT("LDBSE", "53, [18]",         REGISTER_NOT_ALLOWED, 0xBE, 0x12, 0x35);
    TEST("LDBSE", "86, 52[18]",       0xBF, 0x12, 0x34, 0x56);
    ERRT("LDBSE", "87, 52[18]",       REGISTER_NOT_ALLOWED, 0xBF, 0x12, 0x34, 0x57);
    TEST("LDBSE", "120, 5634H[18]",   0xBF, 0x13, 0x34, 0x56, 0x78);
    ERRT("LDBSE", "121, 5634H[18]",   REGISTER_NOT_ALLOWED, 0xBF, 0x13, 0x34, 0x56, 0x79);
    ...
    ERRT("PUSH",  "19",           REGISTER_NOT_ALLOWED, 0xC8, 0x13);
    TEST("PUSH",  "#3412H",       0xC9, 0x12, 0x34);
    TEST("PUSH",  "[18]",         0xCA, 0x12);
    ERRT("PUSH",  "[19]",         REGISTER_NOT_ALLOWED, 0xCA, 0x13);
    TEST("PUSH",  "52[18]",       0xCB, 0x12, 0x34);
    TEST("PUSH",  "5634H[18]",    0xCB, 0x13, 0x34, 0x56);
    TEST("POP",   "18",           0xCC, 0x12);
    ERRT("POP",   "19",           REGISTER_NOT_ALLOWED, 0xCC, 0x13);
    UNKN(0xCD, 0x12, 0x34);
    TEST("POP",   "[18]",         0xCE, 0x12);
    ERRT("POP",   "[19]",         REGISTER_NOT_ALLOWED, 0xCE, 0x13);
...
static void test_jump() {
    ...
    ERRT("BR",  "[19]", REGISTER_NOT_ALLOWED, 0xE3, 0x13);
    TEST("RET", "",     0xF0);
...
static void test_jump_relative() {
    ...
    AERRT(0xA000, "LJMP", "$-7FFEH", OVERFLOW_RANGE, 0xE7, 0xFF, 0x7F);
...
static void test_modify() {
    ...
    ERRT("SHL",  "11, 17",  REGISTER_NOT_ALLOWED, 0x09, 0x11, 0x0B);
    TEST("SHLB", "23, #11", 0x19, 0x0B, 0x17);
    TEST("SHLB", "23, 17",  0x19, 0x11, 0x17);
    TEST("SHLL", "24, #11", 0x0D, 0x0B, 0x18);
    TEST("SHLL", "24, 17",  0x0D, 0x11, 0x18);
    ERRT("SHLL", "25, 17",  REGISTER_NOT_ALLOWED, 0x0D, 0x11, 0x19);
    ERRT("SHLL", "26, 17",  REGISTER_NOT_ALLOWED, 0x0D, 0x11, 0x1A);
    ERRT("SHLL", "27, 17",  REGISTER_NOT_ALLOWED, 0x0D, 0x11, 0x1B);
