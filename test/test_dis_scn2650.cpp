...
void test_cpu() {
    ...
    EQUALS_P("cpu 2650", "2650", disassembler.config().cpu_P());

    EQUALS("cpu Scn2650", true,   disassembler.setCpu("Scn2650"));
    EQUALS_P("cpu Scn2650", "2650", disassembler.config().cpu_P());
}
...
void test_load_store() {
    ...
    TEST("STRZ,R2", "", 0xC2);
    TEST("STRZ,R3", "", 0xC3);
    TEST("STRR,R0",  "H'002B'", 0xC8, 0x29);
    TEST("STRR,R1", "*H'002C'", 0xC9, 0xAA);
    TEST("STRR,R2",  "H'002D'", 0xCA, 0x2B);
    TEST("STRR,R3",  "H'002E'", 0xCB, 0x2C);
    TEST("STRA,R0",  "H'0123'", 0xCC, 0x01, 0x23);
    TEST("STRA,R0", "*H'09AB'", 0xCC, 0x89, 0xAB);
    TEST("STRA,R1",  "H'0123'", 0xCD, 0x01, 0x23);
    TEST("STRA,R1", "*H'0123'", 0xCD, 0x81, 0x23);
...
void test_arithmetic() {
    ...
    TEST("ADDR,R0", "*H'000B'", 0x88, 0x89);
    TEST("ADDR,R1",  "H'000C'", 0x89, 0x0A);
    TEST("ADDR,R2",  "H'000D'", 0x8A, 0x0B);
    TEST("ADDR,R3",  "H'000E'", 0x8B, 0x0C);
    TEST("ADDA,R0",  "H'1123'", 0x8C, 0x11, 0x23);
    TEST("ADDA,R0", "*H'1123'", 0x8C, 0x91, 0x23);
    ...
    TEST("SUBR,R0", "*H'000B'", 0xA8, 0x89);
    TEST("SUBR,R1",  "H'000C'", 0xA9, 0x0A);
    TEST("SUBR,R2",  "H'000D'", 0xAA, 0x0B);
    TEST("SUBR,R3",  "H'000E'", 0xAB, 0x0C);
...
void test_logical() {
    ...
    TEST("ANDR,R0", "*H'000B'", 0x48, 0x89);
    TEST("ANDR,R1",  "H'000C'", 0x49, 0x0A);
    TEST("ANDR,R2",  "H'000D'", 0x4A, 0x0B);
    TEST("ANDR,R3",  "H'000E'", 0x4B, 0x0C);
    ...
    TEST("IORR,R0", "*H'000B'", 0x68, 0x89);
    TEST("IORR,R1",  "H'000C'", 0x69, 0x0A);
    TEST("IORR,R2",  "H'000D'", 0x6A, 0x0B);
    TEST("IORR,R3",  "H'000E'", 0x6B, 0x0C);
    ...
    TEST("EORR,R0", "*H'000B'", 0x28, 0x89);
    TEST("EORR,R1",  "H'000C'", 0x29, 0x0A);
    TEST("EORR,R2",  "H'000D'", 0x2A, 0x0B);
    TEST("EORR,R3",  "H'000E'", 0x2B, 0x0C);
...
void test_rotate_compare() {
    ...
    TEST("COMR,R0", "*H'000B'", 0xE8, 0x89);
    TEST("COMR,R1",  "H'000C'", 0xE9, 0x0A);
    TEST("COMR,R2",  "H'000D'", 0xEA, 0x0B);
    TEST("COMR,R3",  "H'000E'", 0xEB, 0x0C);
...
void test_branch() {
    ATEST(0x1000, "BCTR,EQ",  "H'101B'", 0x18, 0x19);
    ATEST(0x1000, "BCTR,EQ", "*H'101C'", 0x18, 0x9A);
    ATEST(0x1000, "BCTR,GT",  "H'101C'", 0x19, 0x1A);
    ATEST(0x1000, "BCTR,GT", "*H'102D'", 0x19, 0xAB);
    ...
    ATEST(0x1000, "BCFR,GT",  "H'101C'", 0x99, 0x1A);
    ATEST(0x1000, "BCFR,GT", "*H'102D'", 0x99, 0xAB);
    ATEST(0x1000, "BCFR,LT",  "H'101D'", 0x9A, 0x1B);
    ATEST(0x1000, "BCFR,LT", "*H'103E'", 0x9A, 0xBC);
    ...
    ATEST(0x1000, "BRNR,R0",  "H'101B'", 0x58, 0x19);
    ATEST(0x1000, "BRNR,R0", "*H'101C'", 0x58, 0x9A);
    ATEST(0x1000, "BRNR,R1",  "H'101C'", 0x59, 0x1A);
    ATEST(0x1000, "BRNR,R1", "*H'102D'", 0x59, 0xAB);
    ATEST(0x1000, "BRNR,R2",  "H'101D'", 0x5A, 0x1B);
    ATEST(0x1000, "BRNR,R2", "*H'103E'", 0x5A, 0xBC);
    ATEST(0x1000, "BRNR,R3",  "H'101E'", 0x5B, 0x1C);
    ATEST(0x1000, "BRNR,R3", "*H'0FCF'", 0x5B, 0xCD);
    ...
    ATEST(0x1000, "BIRR,R0",  "H'101B'", 0xD8, 0x19);
    ATEST(0x1000, "BIRR,R0", "*H'101C'", 0xD8, 0x9A);
    ATEST(0x1000, "BIRR,R1",  "H'101C'", 0xD9, 0x1A);
    ATEST(0x1000, "BIRR,R1", "*H'102D'", 0xD9, 0xAB);
    ATEST(0x1000, "BIRR,R2",  "H'101D'", 0xDA, 0x1B);
    ATEST(0x1000, "BIRR,R2", "*H'103E'", 0xDA, 0xBC);
    ATEST(0x1000, "BIRR,R3",  "H'101E'", 0xDB, 0x1C);
    ATEST(0x1000, "BIRR,R3", "*H'0FCF'", 0xDB, 0xCD);
    ...
    ATEST(0x1000, "BDRR,R0",  "H'101B'", 0xF8, 0x19);
    ATEST(0x1000, "BDRR,R0", "*H'101C'", 0xF8, 0x9A);
    ATEST(0x1000, "BDRR,R1",  "H'101C'", 0xF9, 0x1A);
    ATEST(0x1000, "BDRR,R1", "*H'102D'", 0xF9, 0xAB);
    ATEST(0x1000, "BDRR,R2",  "H'101D'", 0xFA, 0x1B);
    ATEST(0x1000, "BDRR,R2", "*H'103E'", 0xFA, 0xBC);
    ATEST(0x1000, "BDRR,R3",  "H'101E'", 0xFB, 0x1C);
    ATEST(0x1000, "BDRR,R3", "*H'0FCF'", 0xFB, 0xCD);
...
void test_subroutine() {
    ATEST(0x1000, "BSTR,EQ",  "H'101B'", 0x38, 0x19);
    ATEST(0x1000, "BSTR,EQ", "*H'101C'", 0x38, 0x9A);
    ATEST(0x1000, "BSTR,GT",  "H'101C'", 0x39, 0x1A);
    ATEST(0x1000, "BSTR,GT", "*H'102D'", 0x39, 0xAB);
    ATEST(0x1000, "BSTR,LT",  "H'101D'", 0x3A, 0x1B);
    ATEST(0x1000, "BSTR,LT", "*H'103E'", 0x3A, 0xBC);
    ATEST(0x1000, "BSTR,UN",  "H'101E'", 0x3B, 0x1C);
    ATEST(0x1000, "BSTR,UN", "*H'0FCF'", 0x3B, 0xCD);
    ...
    ATEST(0x1000, "BSFR,EQ",  "H'101B'", 0xB8, 0x19);
    ATEST(0x1000, "BSFR,EQ", "*H'101C'", 0xB8, 0x9A);
    ATEST(0x1000, "BSFR,GT",  "H'101C'", 0xB9, 0x1A);
    ATEST(0x1000, "BSFR,GT", "*H'102D'", 0xB9, 0xAB);
    ATEST(0x1000, "BSFR,LT",  "H'101D'", 0xBA, 0x1B);
    ATEST(0x1000, "BSFR,LT", "*H'103E'", 0xBA, 0xBC);
    ...
    ATEST(0x1000, "BSNR,R0",  "H'101B'", 0x78, 0x19);
    ATEST(0x1000, "BSNR,R0", "*H'101C'", 0x78, 0x9A);
    ATEST(0x1000, "BSNR,R1",  "H'101C'", 0x79, 0x1A);
    ATEST(0x1000, "BSNR,R1", "*H'102D'", 0x79, 0xAB);
    ATEST(0x1000, "BSNR,R2",  "H'101D'", 0x7A, 0x1B);
    ATEST(0x1000, "BSNR,R2", "*H'103E'", 0x7A, 0xBC);
    ATEST(0x1000, "BSNR,R3",  "H'101E'", 0x7B, 0x1C);
    ATEST(0x1000, "BSNR,R3", "*H'0FCF'", 0x7B, 0xCD);
