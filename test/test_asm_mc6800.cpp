...
static void test_error() {
    ...
    ETEST(UNKNOWN_OPERAND, "PULA A");
    ETEST(UNKNOWN_OPERAND, "PSHB A");
    ETEST(UNKNOWN_OPERAND, "NEGA B");
    ETEST(UNKNOWN_OPERAND, "COMB B");
    ETEST(UNKNOWN_OPERAND, "LSRA A");
    ETEST(UNKNOWN_OPERAND, "RORB A");
    ETEST(UNKNOWN_OPERAND, "ASRA B");
    ETEST(UNKNOWN_OPERAND, "LSLB B");
    ETEST(UNKNOWN_OPERAND, "ROLA A");
    ETEST(UNKNOWN_OPERAND, "DECB A");
    ETEST(UNKNOWN_OPERAND, "INCA B");
    ETEST(UNKNOWN_OPERAND, "TSTB B");
    ETEST(UNKNOWN_OPERAND, "CLRA A");
    ETEST(UNKNOWN_OPERAND, "SUBA B #1");
    ETEST(UNKNOWN_OPERAND, "ADDB A,$10");
    ETEST(UNKNOWN_OPERAND, "SUBA A, 0,X");
    ETEST(UNKNOWN_OPERAND, "STAB B,$1000");
}
