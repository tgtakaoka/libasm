...
static void test_cpu() {
    ...
    asserter.equals(
        "get cpu", "6809", disassembler.getCpu());

    asserter.equals(
        "cpu 6309", true, disassembler.setCpu("6309"));
    asserter.equals(
        "get cpu", "6309", disassembler.getCpu());
...
static void test_indexed_mode() {
    ...
    ATEST(0x1000, LDA, "*-$7D,PCR",   0xA6, 0x8C, 0x80);
    ATEST(0x1000, LDA, "*,PCR",       0xA6, 0x8C, 0xFD);
    ATEST(0x1000, LDA, "*+3,PCR",     0xA6, 0x8C, 0x00);
    ATEST(0x1000, LDA, "*+$82,PCR",   0xA6, 0x8C, 0x7F);
    ATEST(0x1000, LDA, "[*-$7D,PCR]", 0xA6, 0x9C, 0x80);
    ATEST(0x1000, LDA, "[*,PCR]",     0xA6, 0x9C, 0xFD);
    ATEST(0x1000, LDA, "[*+3,PCR]",   0xA6, 0x9C, 0x00);
    ATEST(0x1000, LDA, "[*+$82,PCR]", 0xA6, 0x9C, 0x7F);
    ...
    if (is6309()) {
        ...
        TEST(LDA, ">127,W",   0xA6, 0xAF, 0x00, 0x7F);
        TEST(LDA, ">-128,W",  0xA6, 0xAF, 0xFF, 0x80);
        TEST(LDA, "128,W",    0xA6, 0xAF, 0x00, 0x80);
        TEST(LDA, "-129,W",   0xA6, 0xAF, 0xFF, 0x7F);
        ...
        TEST(LDA, "[>127,W]",   0xA6, 0xB0, 0x00, 0x7F);
        TEST(LDA, "[>-128,W]",  0xA6, 0xB0, 0xFF, 0x80);
        TEST(LDA, "[128,W]",    0xA6, 0xB0, 0x00, 0x80);
        TEST(LDA, "[-129,W]",   0xA6, 0xB0, 0xFF, 0x7F);
