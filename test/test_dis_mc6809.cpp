...
static void test_indexed_mode() {
    ...
    ATEST(0x1000, LDA, "*-$7FFC,PCR",   0xA6, 0x8D, 0x80, 0x00);
    ATEST(0x1000, LDA, "*,PCR",         0xA6, 0x8D, 0xFF, 0xFC);
    ATEST(0x1000, LDA, "*+4,PCR",       0xA6, 0x8D, 0x00, 0x00);
    ATEST(0x1000, LDA, "*-$7FFD,PCR",   0xA6, 0x8D, 0x7F, 0xFF);
    ATEST(0x1000, LDA, "[*-$7FFC,PCR]", 0xA6, 0x9D, 0x80, 0x00);
...
static void test_relative() {
    ...
    ATEST(0x1000, LBLS, "$9004", 0x10, 0x23, 0x80, 0x00);
    ...
    ATEST(0x9000, LBSR, "*-$7FFD", 0x17, 0x80, 0x00);
    ATEST(0x2000, LBSR, "*",       0x17, 0xFF, 0xFD);
    ATEST(0x2000, LBSR, "*+3",     0x17, 0x00, 0x00);
    ATEST(0x2000, LBSR, "*-$7FFE", 0x17, 0x7F, 0xFF);
}
