...
// clang-format off
void test_cpu() {
    EQUALS("cpu 68hc12", true, assembler.setCpu("68hc12"));
    EQUALS_P("cpu 68hc12", "68HC12", assembler.config().cpu_P());

    EQUALS("cpu MC68HC12", true, assembler.setCpu("MC68HC12"));
    EQUALS_P("cpu MC68HC12", "68HC12", assembler.config().cpu_P());
}
...
void test_load() {
    ...
    ERRT("LEAY [$1000,PC]", OPERAND_NOT_ALLOWED, "[$1000,PC]", 0x19, 0xFB);
...
void test_transfer() {
    ...
    TEST("TAP",        0xB7, 0x02);
    ERRT("SEX A, A", REGISTER_NOT_ALLOWED, "A", 0xB7, 0x04);
    ERRT("SEX A, B", REGISTER_NOT_ALLOWED, "B", 0xB7, 0x05);
    ERRT("SEX A, CCR", REGISTER_NOT_ALLOWED, "CCR", 0xB7, 0x06);
    ...
    ERRT("SEX D, A", REGISTER_NOT_ALLOWED, "D, A", 0xB7, 0x44);
    ...
    TEST("TXS",        0xB7, 0x57);
    ERRT("SEX X, B", REGISTER_NOT_ALLOWED, "X, B", 0xB7, 0x55);
    ...
    TEST("TYS",        0xB7, 0x67);
    ERRT("SEX Y, D",   REGISTER_NOT_ALLOWED, "Y, D", 0xB7, 0x64);
    ...
    TEST("TSX",         0xB7, 0x75);
    TEST("TSY",         0xB7, 0x76);
    ERRT("SEX SP, D", REGISTER_NOT_ALLOWED, "SP, D", 0xB7, 0x74);
}
...
void test_move() {
    ...
    TEST("MOVW $0304, A,X",    0x18, 0x01, 0xE4, 0x03, 0x04);
    ...
    ERRT("MOVW #$E3E4, $E2,X",
         OPERAND_NOT_ALLOWED, "$E2,X",         0x18, 0x00, 0xE0, 0xE3, 0xE4);
    ERRT("MOVW $EDEE, $EBEC,Y",
         OPERAND_NOT_ALLOWED, "$EBEC,Y",       0x18, 0x01, 0xEA, 0xED, 0xEE);
    ERRT("MOVW [D,Y], 4,X",
         OPERAND_NOT_ALLOWED, "[D,Y], 4,X",    0x18, 0x02, 0xEF, 0x04);
    ERRT("MOVW 3,X, $F1,SP",
         OPERAND_NOT_ALLOWED, "$F1,SP",        0x18, 0x02, 0x03, 0xF0);
    ERRT("MOVW $F1,SP, 3,X",
         OPERAND_NOT_ALLOWED, "$F1,SP, 3,X",   0x18, 0x02, 0xF0, 0x03);
    ERRT("MOVW [D,PC], $0708",
    ...
    ERRT("MOVB #$EB, -22,Y",
         OPERAND_NOT_ALLOWED, "-22,Y",         0x18, 0x08, 0xE9, 0xEB);
    ERRT("MOVB $E5E6, $E3E4,X",
         OPERAND_NOT_ALLOWED, "$E3E4,X",       0x18, 0x09, 0xE2, 0xE5, 0xE6);
    ERRT("MOVB [D,Y], 4,X",
         OPERAND_NOT_ALLOWED, "[D,Y], 4,X",    0x18, 0x0A, 0xEF, 0x04);
    ERRT("MOVB 4,X, [D,Y]",
         OPERAND_NOT_ALLOWED, "[D,Y]",         0x18, 0x0A, 0x04, 0xEF);
    ERRT("MOVB 3,X, $F1,SP",
         OPERAND_NOT_ALLOWED, "$F1,SP",        0x18, 0x0A, 0x03, 0xF0);
    ERRT("MOVB $F1,SP, 3,X",
         OPERAND_NOT_ALLOWED, "$F1,SP, 3,X",   0x18, 0x0A, 0xF0, 0x03);
    ERRT("MOVB [D,PC], $0708",
...
void test_bit_manip() {
    ...
    ERRT("BCLR [$1000,PC], #$FE",
         OPERAND_NOT_ALLOWED, "[$1000,PC], #$FE", 0x0D, 0xFB, 0xFE);
    ERRT("BCLR [D,X], #$E8",
...
void test_shift_rotate() {
    ...
    TEST("LSL 7,-Y",  0x68, 0x69);
    TEST("LSL $797A", 0x78, 0x79, 0x7A);
    TEST("LSLA", 0x48);
    TEST("LSLB", 0x58);
    TEST("LSLD", 0x59);
...
void test_table() {
    ...
    ERRT("ETBL $E1,X",    OPERAND_NOT_ALLOWED, "$E1,X",    0x18, 0x3F, 0xE0);
    ERRT("ETBL -22,Y",    OPERAND_NOT_ALLOWED, "-22,Y",    0x18, 0x3F, 0xE9);
    ERRT("ETBL $F3F4,SP", OPERAND_NOT_ALLOWED, "$F3F4,SP", 0x18, 0x3F, 0xF2);
    ERRT("ETBL $1000,PC", OPERAND_NOT_ALLOWED, "$1000,PC", 0x18, 0x3F, 0xFA);
    ...
    ERRT("TBL $E1,X",    OPERAND_NOT_ALLOWED, "$E1,X",    0x18, 0x3D, 0xE0);
    ERRT("TBL -22,Y",    OPERAND_NOT_ALLOWED, "-22,Y",    0x18, 0x3D, 0xE9);
    ERRT("TBL $F3F4,SP", OPERAND_NOT_ALLOWED, "$F3F4,SP", 0x18, 0x3D, 0xF2);
    ERRT("TBL $1000,PC", OPERAND_NOT_ALLOWED, "$1000,PC", 0x18, 0x3D, 0xFA);
...
void test_branch() {
    ...
    ATEST(0x1000, "LBHS $1004", 0x18, 0x24, 0x00, 0x00);
    ATEST(0x1000, "LBCS $1004", 0x18, 0x25, 0x00, 0x00);
    ATEST(0x1000, "LBLO $1004", 0x18, 0x25, 0x00, 0x00);
    ...
    ATEST(0x1000, "BRA  $1081", 0x20, 0x7F);
    ATEST(0x1000, "LBRA $1081", 0x20, 0x7F);
    ATEST(0x1000, "BRA  $1082", 0x18, 0x20, 0x00, 0x7E);
    ATEST(0x1000, "LBRA $1082", 0x18, 0x20, 0x00, 0x7E);
    ATEST(0x1000, "BRA  $0F82", 0x20, 0x80);
    ATEST(0x1000, "LBRA $0F82", 0x20, 0x80);
    ATEST(0x1000, "BRA  $0F81", 0x18, 0x20, 0xFF, 0x7D);
    ATEST(0x1000, "LBRA $0F81", 0x18, 0x20, 0xFF, 0x7D);

    ATEST(0x1000, "BRN  $1081", 0x21, 0x7F);
    ATEST(0x1000, "LBRN $1081", 0x18, 0x21, 0x00, 0x7D);
    AERRT(0x1000, "BRN  $1082", OPERAND_TOO_FAR, "$1082", 0x21, 0x80);
    ATEST(0x1000, "BRN  $0F82", 0x21, 0x80);
    ATEST(0x1000, "LBRN $0F82", 0x18, 0x21, 0xFF, 0x7E);
    AERRT(0x1000, "BRN  $0F81", OPERAND_TOO_FAR, "$0F81", 0x21, 0x7F);
}
...
void test_interrupt() {
    ...
    ERRT("TRAP $00",  OVERFLOW_RANGE, "$00",  0x18, 0x30);
    ERRT("TRAP $2F",  OVERFLOW_RANGE, "$2F",  0x18, 0x30);
    TEST("TRAP $30", 0x18, 0x30);
    TEST("TRAP $37", 0x18, 0x37);
    TEST("TRAP $38", 0x18, 0x38);
    TEST("TRAP $39", 0x18, 0x39);
    ERRT("TRAP $3A",  OVERFLOW_RANGE, "$3A",  0x18, 0x30);
    ERRT("TRAP $3F",  OVERFLOW_RANGE, "$3F",  0x18, 0x30);
    TEST("TRAP $40", 0x18, 0x40);
    TEST("TRAP $7F", 0x18, 0x7F);
    TEST("TRAP $80", 0x18, 0x80);
    TEST("TRAP $FF", 0x18, 0xFF);
    ERRT("TRAP $100", OVERFLOW_RANGE, "$100", 0x18, 0x30);
}
// clang-format on
