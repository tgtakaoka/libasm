...
static void test_move_immediate() {
    TEST(MVI,  "B,0F6H", "246", 0x06, 0xF6);
    TEST(MVI,  "C,9FH",  "159", 0x0E, 0x9F);
    TEST(MVI,  "D,3AH",  "58",  0x16, 0x3A);
    TEST(MVI,  "E,80H",  "128", 0x1E, 0x80);
    TEST(MVI,  "H,0F6H", "246", 0x26, 0xF6);
    TEST(MVI,  "L,0F6H", "246", 0x2E, 0xF6);
    TEST(MVI,  "M,0F6H", "246", 0x36, 0xF6);
    TEST(MVI,  "A,0FEH", "254", 0x3E, 0xFE);

    TEST(LXI,  "B,0BEEFH", "-16657", 0x01, 0xEF, 0xBE);
...
static void test_alu_immediate() {
    TEST(ADI, "02H",  "2",   0xC6, 0x02);
    TEST(ACI, "0FFH", "255", 0xCE, 0xFF);

    TEST(SUI, "02H",  "2",   0xD6, 0x02);
    TEST(SBI, "0FFH", "255", 0xDE, 0xFF);

    TEST(ANI, "02H",  "2",   0xE6, 0x02);
    TEST(XRI, "0FFH", "255", 0xEE, 0xFF);
    TEST(ORI, "02H",  "2",   0xF6, 0x02);
    TEST(CPI, "0FFH", "255", 0xFE, 0xFF);
}
