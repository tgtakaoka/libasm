...
void test_cpu() {
    ...
    EQUALS_P("cpu 8070", "8070", assembler.config().cpu_P());
...
static void test_immediate() {
    ...
    ERRT("AND S,=-129", OVERFLOW_RANGE, "=-129", 0x39, 0x7F);
    ERRT("AND S,=256",  OVERFLOW_RANGE, "=256",  0x39, 0x00);
...
static void test_indexed() {
    ...
    ERRT("BRA -129,P2", OVERFLOW_RANGE, "-129,P2", 0x76, 0x7F);
...
static void test_auto_indexed() {
    ...
    ERRT("LD  EA,@128,P3",  OVERFLOW_RANGE, "@128,P3",  0x87, 0x80);
...
static void test_data_constant() {
    ...
    TEST(".addr  x'1000",    0xFF, 0x0F);
    ERUS(".byte  1, UNDEF, 2", "UNDEF, 2", 0x01, 0x00, 0x02);
    ERUS(".dbyte 1, UNDEF, 2", "UNDEF, 2", 0x01, 0x00, 0x00, 0x00, 0x02, 0x00);
    ERUS(".addr  2, UNDEF, 3", "UNDEF, 3", 0x01, 0x00, 0xFF, 0xFF, 0x02, 0x00);
