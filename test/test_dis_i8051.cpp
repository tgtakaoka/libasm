...
static void test_cpu() {
    asserter.equals(
        "cpu 8051", true, disassembler.setCpu("8051"));
    asserter.equals(
        "get cpu", "8051", disassembler.getCpu());

    asserter.equals(
        "cpu I8051", true, disassembler.setCpu("I8051"));
    asserter.equals(
        "get cpu", "8051", disassembler.getCpu());
}
...
static void test_relative() {
    ...
    ATEST(0x2000, JB, "22H.1,$-7DH", 0x20, 0x11, 0x80);
    ATEST(0x2000, JB, "22H.1,$",     0x20, 0x11, 0xFD);
    ATEST(0x2000, JB, "22H.1,$+3",   0x20, 0x11, 0x00);
    ATEST(0x2000, JB, "22H.1,$+82H", 0x20, 0x11, 0x7F);
    ATEST(0x2000, CJNE, "A,#0B5H,$-7DH", 0xB4, 0xB5, 0x80);
    ATEST(0x2000, CJNE, "A,#0B5H,$",     0xB4, 0xB5, 0xFD);
    ATEST(0x2000, CJNE, "A,#0B5H,$+3",   0xB4, 0xB5, 0x00);
    ATEST(0x2000, CJNE, "A,#0B5H,$+82H", 0xB4, 0xB5, 0x7F);
    ATEST(0x2000, DJNZ, "0D6H,$-7DH", 0xD5, 0xD6, 0x80);
    ATEST(0x2000, DJNZ, "0D6H,$",     0xD5, 0xD6, 0xFD);
    ATEST(0x2000, DJNZ, "0D6H,$+3",   0xD5, 0xD6, 0x00);
    ATEST(0x2000, DJNZ, "0D6H,$+82H", 0xD5, 0xD6, 0x7F);
    ATEST(0x2000, JZ, "$-7EH", 0x60, 0x80);
    ATEST(0x2000, JZ, "$",     0x60, 0xFE);
    ATEST(0x2000, JZ, "$+2",   0x60, 0x00);
    ATEST(0x2000, JZ, "$+81H", 0x60, 0x7F);
    ATEST(0x2000, DJNZ, "R0,$-7EH", 0xD8, 0x80);
    ATEST(0x2000, DJNZ, "R0,$",     0xD8, 0xFE);
    ATEST(0x2000, DJNZ, "R0,$+2",   0xD8, 0x00);
    ATEST(0x2000, DJNZ, "R0,$+81H", 0xD8, 0x7F);
}
