...
static void test_formatter_8bit() {
    ...
    F8(0,     2, true,  "0");
    F8(16,    2, true,  "16");
    F8(17,    2, true,  "00010001b");
    F8(128,   2, true,  "10000000b");
    F8(255,   2, true,  "11111111b");
    F8(256,   2, true,  "0");
    F8(-16,   2, true,  "11110000b");
    F8(-17,   2, true,  "11101111b");
    F8(-128,  2, true,  "10000000b");
    F8(-255,  2, true,  "1");
    F8(-256,  2, true,  "0");
...
static void test_formatter_16bit() {
    ...
    F16(0,          2, true,  "0");
    F16(16,         2, true,  "16");
    F16(17,         2, true,  "0000000000010001b");
    F16(0x8000,     2, true,  "1000000000000000b");
    F16(0xffff,     2, true,  "1111111111111111b");
    F16(0x10000,    2, true,  "0");
    F16(-16,        2, true,  "1111111111110000b");
    F16(-17,        2, true,  "1111111111101111b");
    F16(-0x8000,    2, true,  "1000000000000000b");
    F16(-0xffff,    2, true,  "1");
    F16(-0x10000,   2, true,  "0");
...
static void test_formatter_24bit() {
    ...
    F24(-16,          2, true,  "111111111111111111110000b");
    F24(-17,          2, true,  "111111111111111111101111b");
    F24(-0x800000,    2, true,  "100000000000000000000000b");
    ...
    F24(0,           -2, true,  "0");
    F24(16,          -2, true,  "16");
    F24(17,          -2, true,  "000000000000000000010001b");
    F24(0x800000,    -2, true,  "-100000000000000000000000b");
    F24(0xffffff,    -2, true,  "-1");
    F24(0x1000000,   -2, true,  "0");
    F24(-16,         -2, true,  "-16");
    ...
    F24(16,           2, false, "000000000000000000010000b");
    ...
    F24(-16,          2, false, "111111111111111111110000b");
    F24(-0x800000,    2, false, "100000000000000000000000b");
    ...
    F24(-16,          8, true,  "77777760o");
    F24(-17,          8, true,  "77777757o");
    F24(-0x800000,    8, true,  "40000000o");
    ...
    F24(-16,         16, true,  "0fffff0h");
    F24(-17,         16, true,  "0ffffefh");
    F24(-0x800000,   16, true,  "800000h");
...
static void test_formatter_32bit() {
    ...
    F32(-16,          2, true,  "11111111111111111111111111110000b");
    F32(-17,          2, true,  "11111111111111111111111111101111b");
    F32(-0x80000000,  2, true,  "10000000000000000000000000000000b");
    F32(-0xffffffff,  2, true,  "1");

    F32(0,           -2, true,  "0");
    F32(16,          -2, true,  "16");
    F32(17,          -2, true,  "00000000000000000000000000010001b");
    F32(0x80000000,  -2, true,  "-10000000000000000000000000000000b");
    F32(0xffffffff,  -2, true,  "-1");
    F32(-16,         -2, true,  "-16");
    F32(-17,         -2, true,  "-00000000000000000000000000010001b");
    ...
    F32(-16,          8, true,  "37777777760o");
    F32(-17,          8, true,  "37777777757o");
    F32(-0x80000000,  8, true,  "20000000000o");
    F32(-0xffffffff,  8, true,  "1");

    F32(0,           -8, true,  "0");
    F32(16,          -8, true,  "16");
    F32(17,          -8, true,  "00000000021o");
    F32(0x80000000,  -8, true,  "-20000000000o");
    F32(0xffffffff,  -8, true,  "-1");
    F32(-16,         -8, true,  "-16");
    F32(-17,         -8, true,  "-00000000021o");
    ...
    F32(-16,         16, true,  "0fffffff0h");
    F32(-17,         16, true,  "0ffffffefh");
    F32(-0x80000000, 16, true,  "80000000h");
    F32(-0xffffffff, 16, true,  "1");

    F32(0,           -16, true,  "0");
    F32(16,          -16, true,  "16");
    F32(17,          -16, true,  "00000011h");
    F32(0x80000000,  -16, true,  "-80000000h");
    F32(0xffffffff,  -16, true,  "-1");
    F32(-16,         -16, true,  "-16");
    F32(-17,         -16, true,  "-00000011h");
