...
static void test_binary_operator() {
    ...
    E8("0001B|0100B", 0x05, OK);
    E8("1011B&0110B", 0x02, OK);
    E8("0110B^0011B", 0x05, OK);
    ...
    E32("08H<<28", 0x80000000, OK);
    E32("80H>>7",  0x01, OK);

    E32("0001b|0100b", 0x05, OK);
    E32("1011b&0110b", 0x02, OK);
    E32("0110b^-1",    0xfffffff9, OK);
}
