...
static void test_relative() {
    ...
    ATEST(0x1000, "BRA  $1042", 0x20, 0x40);
    ATEST(0x1000, "BRA  $2043", 0x16, 0x10, 0x40);
    AERRT(0x0010, "BRA $FF92",  OVERFLOW_RANGE, "$FF92", 0x20, 0x80);
    AERRT(0xFFF0, "BRA $0071",  OVERFLOW_RANGE, "$0071", 0x20, 0x7F);
    ATEST(0x1000, "LBRA $1042", 0x20, 0x40);
    ATEST(0x1000, "LBRA $2043", 0x16, 0x10, 0x40);
    AERRT(0x9000, "LBRA $1002", OVERFLOW_RANGE, "$1002", 0x16, 0x7F, 0xFF);
    AERRT(0x1000, "LBLS $9004", OVERFLOW_RANGE, "$9004", 0x10, 0x23, 0x80, 0x00);

    ATEST(0x1000, "BSR  $1042", 0x8D, 0x40);
    ATEST(0x1000, "BSR  $2043", 0x17, 0x10, 0x40);
    ATEST(0x1000, "LBSR $1042", 0x8D, 0x40);
    ATEST(0x1000, "LBSR $2043", 0x17, 0x10, 0x40);

    ATEST(0x1000, "BRN  $1042", 0x21, 0x40);
    AERRT(0x1000, "BRN  $2042", OPERAND_TOO_FAR, "$2042", 0x21, 0x40);
    ATEST(0x1000, "LBRN $1042", 0x10, 0x21, 0x00, 0x3E);
    ATEST(0x1000, "LBRN $2044", 0x10, 0x21, 0x10, 0x40);

    ATEST(0x1000, " BHI $1004", 0x22, 0x02);
    ATEST(0x1000, " BLS $1082", 0x10, 0x23, 0x00, 0x7E);
    ATEST(0x1000, " BHS $0F81", 0x10, 0x24, 0xFF, 0x7D);
    ATEST(0x1000, " BLO $2004", 0x10, 0x25, 0x10, 0x00);
    ATEST(0x1000, " BNE $0004", 0x10, 0x26, 0xF0, 0x00);
    ATEST(0x1000, "LBEQ $1081", 0x27, 0x7F);
    ATEST(0x1000, "LBVC $0F82", 0x28, 0x80);
    ATEST(0x1000, "LBVS $2004", 0x10, 0x29, 0x10, 0x00);
    ATEST(0x1000, "LBPL $0004", 0x10, 0x2A, 0xF0, 0x00);
    ATEST(0x1000, " BMI $9003", 0x10, 0x2B, 0x7F, 0xFF);
    ATEST(0x9000, " BGE $1004", 0x10, 0x2C, 0x80, 0x00);
    ATEST(0x1000, "LBLT $9003", 0x10, 0x2D, 0x7F, 0xFF);
    ATEST(0x9000, "LBGT $1004", 0x10, 0x2E, 0x80, 0x00);
    ATEST(0x1000, "LBLE $1000", 0x2F, 0xFE);
...
static void test_direct() {
    ...
    if (is6309()) {
        ...
        TEST("TIM #$30,    ,X",  0x6B, 0x30, 0x84);
        TEST("TIM #$30,   0,X",  0x6B, 0x30, 0x84);
        TEST("TIM #$30, <<0,X",  0x6B, 0x30, 0x00);
        TEST("TIM #$30,  <0,X",  0x6B, 0x30, 0x88, 0x00);
        TEST("TIM #$30,  >0,X",  0x6B, 0x30, 0x89, 0x00, 0x00);
        TEST("TIM #$30,[   ,X]", 0x6B, 0x30, 0x94);
        TEST("TIM #$30,[  0,X]", 0x6B, 0x30, 0x94);
        ERRT("TIM #$30,[<<0,X]", UNKNOWN_OPERAND, "[<<0,X]", 0x6B, 0x30, 0x00);
        TEST("TIM #$30,[ <0,X]", 0x6B, 0x30, 0x98, 0x00);
        TEST("TIM #$30,[ >0,X]", 0x6B, 0x30, 0x99, 0x00, 0x00);
        ATEST(0x1000, "TIM #$30, $1004,PCR",  0x6B, 0x30, 0x8C, 0x00);
        ATEST(0x1000, "TIM #$30, $1083,PCR",  0x6B, 0x30, 0x8C, 0x7F);
        ATEST(0x1000, "TIM #$30, $1084,PCR",  0x6B, 0x30, 0x8D, 0x00, 0x7F);
        ATEST(0x1000, "TIM #$30, $1085,PCR",  0x6B, 0x30, 0x8D, 0x00, 0x80);
        ATEST(0x1000, "TIM #$30, $0F84,PCR",  0x6B, 0x30, 0x8C, 0x80);
        ATEST(0x1000, "TIM #$30, $0F83,PCR",  0x6B, 0x30, 0x8D, 0xFF, 0x7E);
        ATEST(0x1000, "TIM #$30,[$1004,PCR]", 0x6B, 0x30, 0x9C, 0x00);
        ATEST(0x1000, "TIM #$30,[$1083,PCR]", 0x6B, 0x30, 0x9C, 0x7F);
        ATEST(0x1000, "TIM #$30,[$1084,PCR]", 0x6B, 0x30, 0x9D, 0x00, 0x7F);
        ATEST(0x1000, "TIM #$30,[$1085,PCR]", 0x6B, 0x30, 0x9D, 0x00, 0x80);
        ATEST(0x1000, "TIM #$30,[$0F84,PCR]", 0x6B, 0x30, 0x9C, 0x80);
        ATEST(0x1000, "TIM #$30,[$0F83,PCR]", 0x6B, 0x30, 0x9D, 0xFF, 0x7E);
    } else {
        ERUI("SBCD    $90");
        ERUI("ANDD    $90");
        ERUI("BITD    $90");
...
static void test_indexed_mode() {
    ...
    ATEST(0x1000, "LDA  >$1082,PCR",  0xA6, 0x8D, 0x00, 0x7E);
    ATEST(0x1000, "LDA  >$1083,PCR",  0xA6, 0x8D, 0x00, 0x7F);
    ATEST(0x1000, "LDA   $0F83,PCR",  0xA6, 0x8C, 0x80);
    ATEST(0x1000, "LDA  >$0F83,PCR",  0xA6, 0x8D, 0xFF, 0x7F);
    ATEST(0x1000, "LDA  >$0F84,PCR",  0xA6, 0x8D, 0xFF, 0x80);
    ATEST(0x1000, "LDA [ $1003,PCR]", 0xA6, 0x9C, 0x00);
    ATEST(0x1000, "LDA [>$1003,PCR]", 0xA6, 0x9D, 0xFF, 0xFF);
    ATEST(0x1000, "LDA [ $1082,PCR]", 0xA6, 0x9C, 0x7F);
    ATEST(0x1000, "LDA [>$1082,PCR]", 0xA6, 0x9D, 0x00, 0x7E);
    ATEST(0x1000, "LDA [>$1083,PCR]", 0xA6, 0x9D, 0x00, 0x7F);
    ATEST(0x1000, "LDA [ $0F83,PCR]", 0xA6, 0x9C, 0x80);
    ATEST(0x1000, "LDA [>$0F83,PCR]", 0xA6, 0x9D, 0xFF, 0x7F);
    ATEST(0x1000, "LDA [>$0F84,PCR]", 0xA6, 0x9D, 0xFF, 0x80);

    ATEST(0x1000, "LDY   $1003,PCR",  0x10, 0xAE, 0x8C, 0xFF);
    ATEST(0x1000, "LDY  >$1003,PCR",  0x10, 0xAE, 0x8D, 0xFF, 0xFE);
    ATEST(0x1000, "LDY   $1083,PCR",  0x10, 0xAE, 0x8C, 0x7F);
    ATEST(0x1000, "LDY  >$1083,PCR",  0x10, 0xAE, 0x8D, 0x00, 0x7E);
    ATEST(0x1000, "LDY  >$1084,PCR",  0x10, 0xAE, 0x8D, 0x00, 0x7F);
    ATEST(0x1000, "LDY   $0F84,PCR",  0x10, 0xAE, 0x8C, 0x80);
    ATEST(0x1000, "LDY  >$0F84,PCR",  0x10, 0xAE, 0x8D, 0xFF, 0x7F);
    ATEST(0x1000, "LDY  >$0F85,PCR",  0x10, 0xAE, 0x8D, 0xFF, 0x80);
    ATEST(0x1000, "LDY [ $1004,PCR]", 0x10, 0xAE, 0x9C, 0x00);
    ATEST(0x1000, "LDY [>$1004,PCR]", 0x10, 0xAE, 0x9D, 0xFF, 0xFF);
    ATEST(0x1000, "LDY [ $1083,PCR]", 0x10, 0xAE, 0x9C, 0x7F);
    ATEST(0x1000, "LDY [>$1083,PCR]", 0x10, 0xAE, 0x9D, 0x00, 0x7E);
    ATEST(0x1000, "LDY [>$1084,PCR]", 0x10, 0xAE, 0x9D, 0x00, 0x7F);
    ATEST(0x1000, "LDY [ $0F84,PCR]", 0x10, 0xAE, 0x9C, 0x80);
    ATEST(0x1000, "LDY [>$0F84,PCR]", 0x10, 0xAE, 0x9D, 0xFF, 0x7F);
    ATEST(0x1000, "LDY [>$0F85,PCR]", 0x10, 0xAE, 0x9D, 0xFF, 0x80);
    ...
    ATEST(0x1000, "LDY  $1005,PCR",  0x10, 0xAE, 0x8C, 0x01);
    ATEST(0x1000, "LDY  $9004,PCR",  0x10, 0xAE, 0x8D, 0x7F, 0xFF);
    ATEST(0x1000, "LDY  $9005,PCR",  0x10, 0xAE, 0x8D, 0x80, 0x00);
    ATEST(0x1000, "LDY [$1005,PCR]", 0x10, 0xAE, 0x9C, 0x01);
    ATEST(0x1000, "LDY [$9004,PCR]", 0x10, 0xAE, 0x9D, 0x7F, 0xFF);
    ATEST(0x1000, "LDY [$9005,PCR]", 0x10, 0xAE, 0x9D, 0x80, 0x00);
...
static void test_undef() {
    ...
    TEST("option smart-branch, on");
    ERUS("BRA  UNDEF", "UNDEF", 0x16, 0x00, 0x00);
    ERUS("LBRA UNDEF", "UNDEF", 0x16, 0x00, 0x00);
    ERUS("BSR  UNDEF", "UNDEF", 0x17, 0x00, 0x00);
    ERUS("LBSR UNDEF", "UNDEF", 0x17, 0x00, 0x00);
    ERUS("BCC  UNDEF", "UNDEF", 0x10, 0x24, 0x00, 0x00);
    ERUS("LBCC UNDEF", "UNDEF", 0x10, 0x24, 0x00, 0x00);
}
