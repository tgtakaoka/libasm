...
static void test_cpu() {
    ...
    asserter.equals(
        "get cpu", "6809", assembler.getCpu());

    asserter.equals(
        "cpu 6309", true, assembler.setCpu("6309"));
    asserter.equals(
        "get cpu", "6309", assembler.getCpu());

    asserter.equals(
        "cpu mc6809", true, assembler.setCpu("mc6809"));
    asserter.equals(
        "get cpu", "6809", assembler.getCpu());

    asserter.equals(
        "cpu hd6309", true, assembler.setCpu("hd6309"));
    asserter.equals(
        "get cpu", "6309", assembler.getCpu());
}
...
static void test_stack() {
    ...
    if (is6809()) {
        ETEST(OPERAND_NOT_ALLOWED, "PULS E");
        ETEST(OPERAND_NOT_ALLOWED, "PSHU F");
        ETEST(OPERAND_NOT_ALLOWED, "PSHS V");
        ETEST(OPERAND_NOT_ALLOWED, "PULU W");
        ETEST(OPERAND_NOT_ALLOWED, "PULS E,X");
        ETEST(OPERAND_NOT_ALLOWED, "PSHU F,Y");
        ETEST(OPERAND_NOT_ALLOWED, "PSHS V,U");
    } else {
...
static void test_register() {
    ...
    if (is6309()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "TFR A,E");
        ETEST(OPERAND_NOT_ALLOWED, "TFR A,F");
        ETEST(OPERAND_NOT_ALLOWED, "TFR E,A");
        ETEST(OPERAND_NOT_ALLOWED, "TFR F,A");
        ETEST(OPERAND_NOT_ALLOWED, "TFR A,Z");
        ETEST(OPERAND_NOT_ALLOWED, "TFR Z,A");
        ETEST(OPERAND_NOT_ALLOWED, "TFR A,0");
        ETEST(OPERAND_NOT_ALLOWED, "TFR 0,A");
        ETEST(OPERAND_NOT_ALLOWED, "TFR CC,0");
        ETEST(OPERAND_NOT_ALLOWED, "TFR 0,CC");
        ETEST(OPERAND_NOT_ALLOWED, "TFR D,W");
        ETEST(OPERAND_NOT_ALLOWED, "TFR D,V");
        ETEST(OPERAND_NOT_ALLOWED, "TFR W,D");
        ETEST(OPERAND_NOT_ALLOWED, "TFR V,D");
        ETEST(OPERAND_NOT_ALLOWED, "TFR W,PC");
        ETEST(OPERAND_NOT_ALLOWED, "TFR S,W");
        ETEST(OPERAND_NOT_ALLOWED, "TFR Z,V");
        ETEST(OPERAND_NOT_ALLOWED, "TFR X,Z");
        ETEST(OPERAND_NOT_ALLOWED, "TFR 0,V");
        ETEST(OPERAND_NOT_ALLOWED, "TFR X,0");
    }
}
...
static void test_indexed_mode() {
    ...
    if (is6309()) {
        ...
        ETEST(OPERAND_NOT_ALLOWED, "LDA 0,W");
        ETEST(OPERAND_NOT_ALLOWED, "LDA >0,W");
        ETEST(OPERAND_NOT_ALLOWED, "LDA 32767,W");
        ETEST(OPERAND_NOT_ALLOWED, "LDA -32768,W");
        ETEST(UNKNOWN_OPERAND, "LDA ,W++");
        ETEST(UNKNOWN_OPERAND, "LDA ,--W");
        ETEST(UNKNOWN_OPERAND, "LDA [,W]");
