...
void test_logical() {
    ...
    TEST("CLR R0",      0x6000|(0<<8)|(0<<4)|0);
    TEST("CLR R1, SKP", 0x6000|(1<<8)|(1<<4)|1);
    TEST("CLR R2",      0x6000|(2<<8)|(0<<4)|2);
    TEST("CLR R3",      0x6000|(3<<8)|(0<<4)|3);
    TEST("CLR X1",      0x6000|(4<<8)|(0<<4)|4);
    TEST("CLR SP",      0x6000|(5<<8)|(0<<4)|5);
    TEST("CLR STR",     0x6000|(6<<8)|(0<<4)|6);

    TEST("TST R0, SKP", 0x6008|(0<<8)|(1<<4)|0);
    TEST("TST R1, M",   0x6008|(1<<8)|(2<<4)|1);
    TEST("TST R2, PZ",  0x6008|(2<<8)|(3<<4)|2);
    TEST("TST R3, Z",   0x6008|(3<<8)|(4<<4)|3);
    TEST("TST R4, NZ",  0x6008|(4<<8)|(5<<4)|4);
    TEST("TST SP, MZ",  0x6008|(5<<8)|(6<<4)|5);
    TEST("TST STR, P",  0x6008|(6<<8)|(7<<4)|6);
