...
static void test_indexed() {
    ...
    ATEST(0x2000, "LD",  "EA, $-127", 0x80, 0x80);
    ATEST(0x2000, "LD",  "EA, $",     0x80, 0xFF);
    ATEST(0x2000, "LD",  "EA, $+1",   0x80, 0x00);
    ATEST(0x2000, "LD",  "EA, $+128", 0x80, 0x7F);
}
