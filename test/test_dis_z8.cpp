...
static void test_one_operand() {
    ...
    TEST(DECW, "RR2",  0x80, 0xE2);
    TEST(DECW, "@81H", 0x81, 0x81);
    TEST(DECW, "@R1",  0x81, 0xE1);
    ...
    TEST(INCW, "RR2",   0xA0, 0xE2);
    TEST(INCW, "@0A1H", 0xA1, 0xA1);
    TEST(INCW, "@R1",   0xA1, 0xE1);
...
static void test_two_operands() {
    ...
    TEST(ADD, "R7,@06H",   0x05, 0x06, 0xE7);
    TEST(ADD, ">07H,#8",   0x06, 0x07, 0x08);
    TEST(ADD, "R7,#8",     0x06, 0xE7, 0x08);
    TEST(ADD, "@08H,#9",   0x07, 0x08, 0x09);
    ...
    TEST(LD, "R6,R5",      0xE4, 0xE5, 0xE6);
    TEST(LD, "R7,@R6",     0xE5, 0xE6, 0xE7);
