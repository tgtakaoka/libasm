...
// clang-format off
void test_cpu() {
    EQUALS("cpu 68hc16", true, assembler.setCpu("68hc16"));
    EQUALS_P("cpu 68hc16", "68HC16", assembler.config().cpu_P());

    EQUALS("cpu MC68HC16", true, assembler.setCpu("MC68HC16"));
    EQUALS_P("cpu MC68HC16", "68HC16", assembler.config().cpu_P());
}
...
void test_shift_rotate() {
    ...
    TEST("LSL 21,Y",    0x14, 0x15);
    TEST("LSL $2526,Z", 0x17, 0x24, 0x25, 0x26);
    TEST("LSL $3536",   0x17, 0x34, 0x35, 0x36);
    ...
    TEST("LSLW $0506,X", 0x27, 0x04, 0x05, 0x06);
    TEST("LSLW $3536",   0x27, 0x34, 0x35, 0x36);
...
void test_branch() {
    ...
    ATEST(0x10010, "BRA $0FF96", 0xB0, 0x80);
    ATEST(0x0FFF0, "BRA $10074", 0xB0, 0x7E);
    AERRT(0x10010, "BRA $0FF94",
          OPERAND_TOO_FAR, "$0FF94", 0xB0, 0x7E);
    AERRT(0x0FFF0, "BRA $10076",
          OPERAND_TOO_FAR, "$10076", 0xB0, 0x80);
    ...
    ATEST(0x01000, "BHS $00FBA", 0xB4, 0xB4);
    ATEST(0x01000, "BLO $00FBC", 0xB5, 0xB6);
    ...
    ATEST(0x10000, "LBHS $0858C", 0x37, 0x84, 0x85, 0x86);
    ATEST(0x10000, "LBLO $0868C", 0x37, 0x85, 0x86, 0x86);
    ...
    ATEST(0x10000, "BRA  $10084", 0xB0, 0x7E);
    ATEST(0x10000, "LBRA $10084", 0xB0, 0x7E);
    ATEST(0x10000, "BRA  $10086", 0x37, 0x80, 0x00, 0x80);
    ATEST(0x10000, "LBRA $10086", 0x37, 0x80, 0x00, 0x80);
    ATEST(0x10000, "BRA  $0FF86", 0xB0, 0x80);
    ATEST(0x10000, "LBRA $0FF86", 0xB0, 0x80);
    ATEST(0x10000, "BRA  $0FF84", 0x37, 0x80, 0xFF, 0x7E);
    ATEST(0x10000, "LBRA $0FF84", 0x37, 0x80, 0xFF, 0x7E);

    ATEST(0x10000, "BRN  $10084", 0xB1, 0x7E);
    ATEST(0x10000, "LBRN $10084", 0x37, 0x81, 0x00, 0x7E);
    AERRT(0x10000, "BRN  $10086", OPERAND_TOO_FAR, "$10086", 0xB1, 0x80);
    ATEST(0x10000, "BRN  $0FF86", 0xB1, 0x80);
    ATEST(0x10000, "LBRN $0FF86", 0x37, 0x81, 0xFF, 0x80);
    AERRT(0x10000, "BRN  $0FF84", OPERAND_TOO_FAR, "$0FF84", 0xB1, 0x7E);
}

void test_bit_branch() {
    ATEST(0x10000, "BRCLR   $CD,X, #$CC, $0FFD4", 0xCB, 0xCC, 0xCD, 0xCE);
    ATEST(0x10000, "BRCLR $1C1D,Y,  #27, $11E24", 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1E);
    ATEST(0x10000, "BRCLR   $3C3D, #$3B, $13E44", 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3E);

    ATEST(0x10000, "BRSET   $9D,Y, #$9C, $0FFA4", 0x9B, 0x9C, 0x9D, 0x9E);
    ATEST(0x10000, "BRSET $2D2E,Z, #$2C, $12F36", 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30);
    ATEST(0x10000, "BRSET   $3D3E, #$3C, $13F46", 0x3B, 0x3C, 0x3D, 0x3E, 0x3F, 0x40);

    ATEST(0x10000, "BRCLR >$CD,X, #$CC, $10086", 0x0A, 0xCC, 0x00, 0xCD, 0x00, 0x80);
    AERRT(0x10000, "BRCLR  $CD,X, #$CC, $10086",
          OPERAND_TOO_FAR, "$10086",             0xCB, 0xCC, 0xCD, 0x80);
    AERRT(0x10000, "BRCLR <$CD,X, #$CC, $10086",
          OPERAND_TOO_FAR, "$10086",             0xCB, 0xCC, 0xCD, 0x80);

    ATEST(0x10000, "BRSET >$9D,Y, #$9C, $0FF84", 0x1B, 0x9C, 0x00, 0x9D, 0xFF, 0x7E);
    AERRT(0x10000, "BRSET  $9D,Y, #$9C, $0FF84",
          OPERAND_TOO_FAR, "$0FF84",             0x9B, 0x9C, 0x9D, 0x7E);
    AERRT(0x10000, "BRSET <$9D,Y, #$9C, $0FF84",
          OPERAND_TOO_FAR, "$0FF84",             0x9B, 0x9C, 0x9D, 0x7E);
...
void test_jump() {
    ...
    TEST("option smart-branch, on");
    ATEST(0x10000, "BSR  $10084", 0x36, 0x7E);
    ATEST(0x10000, "LBSR $10084", 0x36, 0x7E);
    ATEST(0x10000, "BSR  $10086", 0x27, 0xF9, 0x00, 0x80);
    ATEST(0x10000, "LBSR $10086", 0x27, 0xF9, 0x00, 0x80);
...
void test_stacking() {
    ...
    TEST("PSHM CCR,D,E,K,X,Y,Z", 0x34, 0x7F);
    TEST("PSHM E,X,Z,K",         0x34, 0x36);
    TEST("PSHM E,Y",             0x34, 0x0A);
    TEST("PSHM E,Z",             0x34, 0x12);
    ...
    TEST("PSHX",     0x34, 0x04);
    TEST("PSHY",     0x34, 0x08);
    ERRT("PSHM X,A,Y", UNKNOWN_OPERAND, "A,Y");

    TEST("PULA", 0x37, 0x09);
    TEST("PULB", 0x37, 0x19);

    TEST("PULM CCR,D,E,K,X,Y,Z", 0x35, 0x7F);
    TEST("PULM E,Z,X,K",         0x35, 0x36);
    TEST("PULM E,Y",             0x35, 0x28);
    TEST("PULM E,X",             0x35, 0x30);
    ...
    TEST("PULX",     0x35, 0x10);
    TEST("PULY",     0x35, 0x08);
    ERRT("PSHM Y,B,Z", UNKNOWN_OPERAND, "B,Z");
}

void test_condition_code() {
    TEST("ANDP #$3B3C", 0x37, 0x3A, 0x3B, 0x3C);
    TEST("CLC",         0x37, 0x3A, 0xFE, 0xFF);
    TEST("CLI",         0x37, 0x3A, 0xFF, 0x1F);
    TEST("CLV",         0x37, 0x3A, 0xFD, 0xFF);

    TEST("ORP #$3C3D", 0x37, 0x3B, 0x3C, 0x3D);
    TEST("SEC",        0x37, 0x3B, 0x01, 0x00);
    TEST("SEI",        0x37, 0x3B, 0x00, 0xE0);
    TEST("SEV",        0x37, 0x3B, 0x02, 0x00);
