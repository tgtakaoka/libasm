...
static void test_cpu() {
    ...
    EQUALS("cpu ns32032", "NS32032", assembler.getCpu());

    EQUALS("cpu ns32016", true,      assembler.setCpu("ns32016"));
    EQUALS("cpu ns32016", "NS32032", assembler.getCpu());

    EQUALS("cpu ns32008", true,      assembler.setCpu("ns32008"));
    EQUALS("cpu ns32008", "NS32032", assembler.getCpu());
}
...
static void test_generic_addressing() {
    ...
    TEST("ADDL 0, F1", 0xBE, 0x40, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
    // Absolute
