...
void test_load_store() {
    ...
    TEST("LODI,R1 <H'4567'+1", 0x05, 0x68);
    TEST("LODI,R2 >H'4567'*2", 0x06, 0x8A);
    TEST("LODI,R3 H'89'",    0x07, 0x89);
    TEST("LODI,R3  255",     0x07, 0xFF);
    TEST("LODI,R3 -128",     0x07, 0x80);
    ERRT("LODI,R3 H'100'",   OVERFLOW_RANGE,  "H'100'", 0x07, 0x00);
    ERRT("LODI,R3  256",     OVERFLOW_RANGE,  "256",    0x07, 0x00);
    ERRT("LODI,R3 -129",     OVERFLOW_RANGE,  "-129",   0x07, 0x7F);
...
void test_data_constant() {
    ...
    TEST(R"(ALIT A'TE"XT')", 0x54, 0x45, 0x22, 0x58, 0x54);
    TEST(R"(DATA 'TE"XT')",  0x54, 0x45, 0x22, 0x58, 0x54);
    TEST("ALIT 'TE''XT'",  0x54, 0x45, 0x27, 0x58, 0x54);
    ERUS("DATA 1, UNDEF, 2", "UNDEF, 2", 0x01, 0x00, 0x02);
    ERUS("ACON 1, UNDEF, 2", "UNDEF, 2", 0x00, 0x01, 0x00, 0x00, 0x00, 0x02);
    ...
    ERRT("ACON "
         "H'1234', H'5678', H'9ABC', H'DEF0', H'1234', H'5678', H'9ABC', H'DEF0', "
         "H'1234', H'5678', H'9ABC', H'DEF0', H'1234', H'5678', H'9ABC', H'DEF0', "
         "H'1234', H'5678', H'9ABC', H'DEF0', H'1234', H'5678', H'9ABC', H'DEF0', "
         "H'1234', H'5678', H'9ABC', H'DEF0', H'1234', H'5678', H'9ABC', H'DE', "
         "H'AAAA', H'BBBB'",
         NO_MEMORY,
         "H'AAAA', H'BBBB'",
