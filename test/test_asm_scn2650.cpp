...
static void test_load_store() {
    ...
    ERRT("STRZ,R0",             OPERAND_NOT_ALLOWED);
    TEST("STRZ,R1",             0xC1);
    TEST("STRZ,R2",             0xC2);
    TEST("STRZ,R3",             0xC3);
...
static void test_logical() {
    ERRT("ANDZ,R0",             OPERAND_NOT_ALLOWED);
    TEST("ANDZ,R1",             0x41);
    TEST("ANDZ,R2",             0x42);
    TEST("ANDZ,R3",             0x43);
...
static void test_branch() {
    ...
    AERRT(0x1000, "BCFR,UN $+1EH",  OPERAND_NOT_ALLOWED);
    AERRT(0x1000, "BCFR,UN *$-31H", OPERAND_NOT_ALLOWED);
    ...
    AERRT(0x7000, "BCFA,UN 2021H",  OPERAND_NOT_ALLOWED);
    AERRT(0x0000, "BCFA,UN *49ABH", OPERAND_NOT_ALLOWED);
...
static void test_subroutine() {
    ...
    AERRT(0x1000, "BSFR,UN $+1EH",  OPERAND_NOT_ALLOWED);
    AERRT(0x1000, "BSFR,UN *$-31H", OPERAND_NOT_ALLOWED);
    ...
    AERRT(0x7000, "BSFA,UN 2021H",  OPERAND_NOT_ALLOWED);
    AERRT(0x0000, "BSFA,UN *49ABH", OPERAND_NOT_ALLOWED);
...
static void test_undefined() {
    ERUS("LODI,R0 UNDEF",       0x04, 0x00);
    ERUS("LODR,R1 UNDEF",       0x09, 0x00);
    ERUS("LODA,R2 UNDEF",       0x0E, 0x00, 0x00);
    ERUS("LODA,R0 UNDEF,R2,+",  0x0E, 0x20, 0x00);
    ERUS("LODA,R0 UNDEF,R2,-",  0x0E, 0x40, 0x00);
    ERUS("LODA,R0 UNDEF,R2",    0x0E, 0x60, 0x00);
    ERUS("LODA,R2 *UNDEF",      0x0E, 0x80, 0x00);
    ERUS("LODA,R0 *UNDEF,R2,+", 0x0E, 0xA0, 0x00);
    ERUS("LODA,R0 *UNDEF,R2,-", 0x0E, 0xC0, 0x00);
    ERUS("LODA,R0 *UNDEF,R2",   0x0E, 0xE0, 0x00);

    ERUS("BCTR,EQ  UNDEF", 0x18, 0x00);
    ERUS("BCTR,EQ *UNDEF", 0x18, 0x80);
    ERUS("BCTA,GT  UNDEF", 0x1D, 0x00, 0x00);
    ERUS("BCTA,GT *UNDEF", 0x1D, 0x80, 0x00);

    ERUS("BRNR,R2  UNDEF", 0x5A, 0x00);
    ERUS("BRNR,R2 *UNDEF", 0x5A, 0x80);
    ERUS("BRNA,R2  UNDEF", 0x5E, 0x00, 0x00);
    ERUS("BRNA,R2 *UNDEF", 0x5E, 0x80, 0x00);

    ERUS("ZBRR  UNDEF", 0x9B, 0x00);
    ERUS("ZBRR *UNDEF", 0x9B, 0x80);

    ERUS("BXA  UNDEF",    0x9F, 0x00, 0x00);
    ERUS("BXA *UNDEF",    0x9F, 0x80, 0x00);
    ERUS("BXA  UNDEF,R3", 0x9F, 0x00, 0x00);
    ERUS("BXA *UNDEF,R3", 0x9F, 0x80, 0x00);

    ERUS("WRTE,R3 UNDEF", 0xD7, 0x00);
    ERUS("REDE,R0 UNDEF", 0x54, 0x00);
    ERUS("TMI,R0  UNDEF", 0xF4, 0x00);
    ERUS("TMI,R1  UNDEF", 0xF5, 0x00);
    ERUS("PPSL    UNDEF", 0x77, 0x00);
    ERUS("TPSU    UNDEF", 0xB4, 0x00);
}

static void test_error() {
    ERRT("LODA,R1 1345H,R2,+",  OPERAND_NOT_ALLOWED);
    ERRT("STRZ,R0",             OPERAND_NOT_ALLOWED);
    ERRT("ANDZ,R0",             OPERAND_NOT_ALLOWED);

    ATEST(0x1000, "BCTR,EQ  1041H", 0x18, 0x3F);
    ATEST(0x1000, "BCTR,EQ *0FC2H", 0x18, 0xC0);
    AERRT(0x1000, "BCTR,EQ  1042H", OPERAND_TOO_FAR);
    AERRT(0x1000, "BCTR,EQ *0FC1H", OPERAND_TOO_FAR);
    ATEST(0x3FF0, "BCTR,EQ  2031H", 0x18, 0x3F);
    ATEST(0x2000, "BCTR,EQ *3FC2H", 0x18, 0xC0);
    AERRT(0x3FF0, "BCTR,EQ  2032H", OPERAND_TOO_FAR);
    AERRT(0x2000, "BCTR,EQ *3FC1H", OPERAND_TOO_FAR);
    AERRT(0x3FF0, "BCTR,EQ  4000H", OVERWRAP_PAGE);
    AERRT(0x2000, "BCTR,EQ *1FF0H", OVERWRAP_PAGE);
    AERRT(0x1000, "BCTA,EQ  8000H", OVERFLOW_RANGE);

    ATEST(0x3000, "ZBRR 003FH", 0x9B, 0x3F);
    AERRT(0x3000, "ZBRR 0040H", OPERAND_TOO_FAR);
    AERRT(0x3000, "ZBRR 1FBFH", OPERAND_TOO_FAR);
    ATEST(0x3000, "ZBRR 1FC0H", 0x9B, 0x40);
    AERRT(0x3000, "ZBRR 2000H", OVERFLOW_RANGE);
    ATEST(0x3000, "ZBSR 003FH", 0xBB, 0x3F);
    AERRT(0x3000, "ZBSR 0040H", OPERAND_TOO_FAR);
    AERRT(0x3000, "ZBSR 1FBFH", OPERAND_TOO_FAR);
    ATEST(0x3000, "ZBSR 1FC0H", 0xBB, 0x40);

    AERRT(0x3000, "LODA,R0  1000H,R1,+", OVERWRAP_PAGE);
    AERRT(0x3000, "LODA,R0  4000H,R1,-", OVERWRAP_PAGE);
    AERRT(0x3000, "LODA,R0  8000H,R1,+", OVERFLOW_RANGE);
    AERRT(0x3000, "LODA,R0 0FFFFH,R1,-", OVERFLOW_RANGE);

    AERRT(0x3000, "BXA   1000H,R0", OPERAND_NOT_ALLOWED);
    AERRT(0x3000, "BXA   1000H,R1", OPERAND_NOT_ALLOWED);
    AERRT(0x3000, "BSXA  4000H,R2", OPERAND_NOT_ALLOWED);
    ATEST(0x3000, "BXA   1000H,R3", 0x9F, 0x10, 0x00);
    ATEST(0x3000, "BSXA  4000H,R3", 0xBF, 0x40, 0x00);
    AERRT(0x3000, "BXA  08000H,R3", OVERFLOW_RANGE);
    AERRT(0x3000, "BSXA 0FFFFH,R3", OVERFLOW_RANGE);
}
