...
static void test_move() {
    ...
    ERRT("ST    #5634H, 18",       OPERAND_NOT_ALLOWED);
    ...
    ERRT("STB   #23, 18",          OPERAND_NOT_ALLOWED);
    ...
    ERRT("POP   #3412H",       OPERAND_NOT_ALLOWED);
...
static void test_undefined_symbol() {
    ERUS("SKIP UNDEF", 0x00, 0x00);

    ERUS("ADD UNDEF, 18",      0x64, 0x12, 0x00);
    ERUS("ADD 52, UNDEF",      0x67, 0x01, 0x00, 0x00, 0x34);
    ERUS("ADD UNDEF, UNDEF",   0x67, 0x01, 0x00, 0x00, 0x00);
    ERUS("ADD UNDEF, #1234H",  0x65, 0x34, 0x12, 0x00);
    ERUS("ADD 86, #UNDEF",     0x65, 0x00, 0x00, 0x56);
    ERUS("ADD UNDEF, #UNDEF",  0x65, 0x00, 0x00, 0x00);
    ERUS("ADD UNDEF, [18]",    0x66, 0x12, 0x00);
    ERUS("ADD 86, [UNDEF]",    0x66, 0x00, 0x56);
    ERUS("ADD UNDEF, [UNDEF]", 0x66, 0x00, 0x00);
    ERUS("ADD UNDEF, 52[18]",  0x67, 0x12, 0x34, 0x00);
    ERUS("ADD 86, UNDEF[18]",  0x67, 0x13, 0x00, 0x00, 0x56);
    ERUS("ADD 86, 52[UNDEF]",  0x67, 0x00, 0x34, 0x56);
    ERUS("ADD UNDEF, UNDEF[18]",    0x67, 0x13, 0x00, 0x00, 0x00);
    ERUS("ADD UNDEF, 52[UNDEF]",    0x67, 0x00, 0x34, 0x00);
    ERUS("ADD 86, UNDEF[UNDEF]",    0x67, 0x01, 0x00, 0x00, 0x56);
    ERUS("ADD UNDEF, UNDEF[UNDEF]", 0x67, 0x01, 0x00, 0x00, 0x00);

    ERUS("SHLL 24, #UNDEF", 0x0D, 0x00, 0x18);
    ERUS("SHLL 24, UNDEF",  0x0D, 0x00, 0x18);

    AERRU(0x2000, "SJMP  UNDEF", 0x20, 0x00);
    AERRU(0x2000, "LJMP  UNDEF", 0xE7, 0x00, 0x00);
    AERRU(0x2000, "SCALL UNDEF", 0x28, 0x00);
    AERRU(0x2000, "LCALL UNDEF", 0xEF, 0x00, 0x00);
    AERRU(0x2000, "JNE   UNDEF", 0xD7, 0x00);
    AERRU(0x2000, "DJNZ UNDEF, $",  0xE0, 0x00, 0xFD);
    AERRU(0x2000, "DJNZ 18, UNDEF", 0xE0, 0x12, 0x00);

    AERRU(0x2000, "JBC 18, 0, UNDEF", 0x30, 0x12, 0x00);
    AERRU(0x2000, "JBS 18, 7, UNDEF", 0x3F, 0x12, 0x00);
}
