...
static void test_mem_ref() {
    ...
    TEST("LDI A.0(x'1234')", 0xF8, 0x34);
    TEST("LDI A.1(x'1234')", 0xF8, 0x12);
    ...
    if (cdp1804() || cdp1804a()) {
        ...
        TEST("RLDI  1,A(12H)", 0x68, 0xC1, 0x00, 0x12);
        ...
        ERRT("RLDI 16,1234H",  ILLEGAL_REGISTER, "16,1234H", 0x68, 0xC7, 0x12, 0x34);
        ERRT("RLDI -1,1234H",  ILLEGAL_REGISTER, "-1,1234H", 0x68, 0xC7, 0x12, 0x34);
    }

    // Load via N
    ERRT("LDN  0", REGISTER_NOT_ALLOWED, "0", 0x07);
    TEST("LDN  1", 0x01);
    TEST("LDN  2", 0x02);
    TEST("LDN  3", 0x03);
    TEST("LDN  4", 0x04);
    ...
    TEST("LDN 14", 0x0E);
    TEST("LDN 15", 0x0F);
    ERRT("LDN 16", ILLEGAL_REGISTER, "16", 0x07);
    ERRT("LDN -1", ILLEGAL_REGISTER, "-1", 0x07);
    ...
    TEST("LDA 14", 0x4E);
    TEST("LDA 15", 0x4F);
    ERRT("LDA 16", ILLEGAL_REGISTER, "16", 0x47);
    ERRT("LDA -1", ILLEGAL_REGISTER, "-1", 0x47);
    ...
    if (cdp1804() || cdp1804a()) {
        ...
        ERRT("RLXA 16", ILLEGAL_REGISTER, "16", 0x68, 0x67);
        ERRT("RLXA -1", ILLEGAL_REGISTER, "-1", 0x68, 0x67);
    }
    ...
    TEST("STR 14", 0x5E);
    TEST("STR 15", 0x5F);
    ERRT("STR 16", ILLEGAL_REGISTER, "16", 0x57);
    ERRT("STR -1", ILLEGAL_REGISTER, "-1", 0x57);
    ...
    if (cdp1804() || cdp1804a()) {
        ...
        ERRT("RSXD 16", ILLEGAL_REGISTER, "16", 0x68, 0xA7);
        ERRT("RSXD -1", ILLEGAL_REGISTER, "-1", 0x68, 0xA7);
    }
...
static void test_reg_op() {
    ...
    TEST("INC 14", 0x1E);
    TEST("INC 15", 0x1F);
    ERRT("INC 16", ILLEGAL_REGISTER, "16", 0x17);
    ERRT("INC -1", ILLEGAL_REGISTER, "-1", 0x17);
    ...
    TEST("DEC 14", 0x2E);
    TEST("DEC 15", 0x2F);
    ERRT("DEC 16", ILLEGAL_REGISTER, "16", 0x27);
    ERRT("DEC -1", ILLEGAL_REGISTER, "-1", 0x27);
    ...
    TEST("GLO 14", 0x8E);
    TEST("GLO 15", 0x8F);
    ERRT("GLO 16", ILLEGAL_REGISTER, "16", 0x87);
    ERRT("GLO -1", ILLEGAL_REGISTER, "-1", 0x87);
    ...
    TEST("PLO 14", 0xAE);
    TEST("PLO 15", 0xAF);
    ERRT("PLO 16", ILLEGAL_REGISTER, "16", 0xA7);
    ERRT("PLO -1", ILLEGAL_REGISTER, "-1", 0xA7);
    ...
    TEST("GHI 14", 0x9E);
    TEST("GHI 15", 0x9F);
    ERRT("GHI 16", ILLEGAL_REGISTER, "16", 0x97);
    ERRT("GHI -1", ILLEGAL_REGISTER, "-1", 0x97);
    ...
    TEST("PHI 14", 0xBE);
    TEST("PHI 15", 0xBF);
    ERRT("PHI 16", ILLEGAL_REGISTER, "16", 0xB7);
    ERRT("PHI -1", ILLEGAL_REGISTER, "-1", 0xB7);
    ...
    if (cdp1804() || cdp1804a()) {
        ...
        ERRT("RNX 16", ILLEGAL_REGISTER, "16", 0x68, 0xB7);
        ERRT("RNX -1", ILLEGAL_REGISTER, "-1", 0x68, 0xB7);
    }
}
...
static void test_logic_op() {
    ...
    ERRT("ORI -129", OVERFLOW_RANGE, "-129", 0xF9, 0x7F);
    ERRT("ORI 256",  OVERFLOW_RANGE, "256",  0xF9, 0x00);
    TEST("XOR",      0xF3);
...
static void test_arith_op() {
    ...
    ERRT("ADI -129",  OVERFLOW_RANGE, "-129", 0xFC, 0x7F);
    ERRT("ADI 256",   OVERFLOW_RANGE, "256",  0xFC, 0x00);
    TEST("ADC",       0x74);
...
static void test_branch() {
    ...
    TEST("LBPZ 0DEF0H", 0xC3, 0xDE, 0xF0);
    TEST("LBGE 0DEF0H", 0xC3, 0xDE, 0xF0);
    TEST("LBNF 9ABCH",  0xCB, 0x9A, 0xBC);
    TEST("LBM  9ABCH",  0xCB, 0x9A, 0xBC);
    TEST("LBL  9ABCH",  0xCB, 0x9A, 0xBC);
    TEST("LBQ  5678H",  0xC1, 0x56, 0x78);
    TEST("LBNQ 1234H",  0xC9, 0x12, 0x34);

    TEST("SKP",     0x38);
    TEST("NBR 12H", 0x38, 0x12);
    TEST("LSKP",       0xC8);
    TEST("NLBR 1234H", 0xC8, 0x12, 0x34);
    TEST("LSZ",  0xCE);
    TEST("LSNZ", 0xC6);
    TEST("LSDF", 0xCF);
    TEST("LSNF", 0xC7);
    ...
    ATEST(0x1280, "BPZ 5678H",  0xC3, 0x56, 0x78);
    ATEST(0x1280, "BGE 5678H",  0xC3, 0x56, 0x78);
    ATEST(0x12F0, "BNF 9ABCH",  0xCB, 0x9A, 0xBC);
    ATEST(0x12F0, "BM  9ABCH",  0xCB, 0x9A, 0xBC);
    ATEST(0x12F0, "BL  9ABCH",  0xCB, 0x9A, 0xBC);
    ATEST(0x1280, "BQ  5678H",  0xC1, 0x56, 0x78);
    ATEST(0x1300, "BNQ 1234H",  0xC9, 0x12, 0x34);

    ATEST(0x1200, "LBR  1234H",  0x30, 0x34);
    ATEST(0x1200, "NLBR 1234H",  0xC8, 0x12, 0x34);
    ATEST(0x9AF0, "LBZ  9ABCH",  0x32, 0xBC);
    ATEST(0x5680, "LBNZ 5678H",  0x3A, 0x78);
    ATEST(0xDE00, "LBDF 0DEF0H", 0x33, 0xF0);
    ATEST(0x5680, "LBPZ 5678H",  0x33, 0x78);
    ATEST(0x5680, "LBGE 5678H",  0x33, 0x78);
    ATEST(0x9AF0, "LBNF 9ABCH",  0x3B, 0xBC);
    ATEST(0x9AF0, "LBM  9ABCH",  0x3B, 0xBC);
    ATEST(0x9AF0, "LBL  9ABCH",  0x3B, 0xBC);
    ATEST(0x5680, "LBQ  5678H",  0x31, 0x78);
    ATEST(0x1200, "LBNQ 1234H",  0x39, 0x34);

    ATEST(0x11FD, "BR  1234H",  0xC0, 0x12, 0x34);
    ATEST(0x11FE, "BR  1234H",  0x30, 0x34);
    ATEST(0x12FD, "BR  1234H",  0x30, 0x34);
    ATEST(0x12FE, "BR  1234H",  0xC0, 0x12, 0x34);

    ATEST(0x11FD, "LBR  1234H",  0xC0, 0x12, 0x34);
    ATEST(0x11FE, "LBR  1234H",  0x30, 0x34);
    ATEST(0x12FD, "LBR  1234H",  0x30, 0x34);
...
static void test_control() {
    ...
    TEST("SEP 14", 0xDE);
    TEST("SEP 15", 0xDF);
    ERRT("SEP 16", ILLEGAL_REGISTER, "16", 0xD7);
    ERRT("SEP -1", ILLEGAL_REGISTER, "-1", 0xD7);
    ...
    TEST("SEX 14", 0xEE);
    TEST("SEX 15", 0xEF);
    ERUS("SEX R16", "R16", 0xE7);
    ERUS("SEX R-1", "R-1", 0xE7);
...
static void test_io() {
    ...
    TEST("OUT 6", 0x66);
    TEST("OUT 7", 0x67);
    ERRT("OUT 0", OPERAND_NOT_ALLOWED, "0",   0x61);
    ERRT("OUT 8", OPERAND_NOT_ALLOWED, "8",   0x61);
    ERRT("OUT -1", OPERAND_NOT_ALLOWED, "-1", 0x61);
    ...
    TEST("INP 6", 0x6E);
    TEST("INP 7", 0x6F);
    ERRT("INP 0", OPERAND_NOT_ALLOWED, "0",  0x69);
    ERRT("INP 8", OPERAND_NOT_ALLOWED, "8",  0x69);
    ERRT("INP -1", OPERAND_NOT_ALLOWED, "-1", 0x69);
...
static void test_call() {
    ...
    ERRT("SCAL 16,1234H", ILLEGAL_REGISTER, "16,1234H", 0x68, 0x87, 0x12, 0x34);
    ERRT("SCAL -1,1234H", ILLEGAL_REGISTER, "-1,1234H", 0x68, 0x87, 0x12, 0x34);
    ...
    ERRT("SRET 16", ILLEGAL_REGISTER, "16", 0x68, 0x97);
