...
static void test_program() {
    ...
    */
    ...
    ETEST(OPERAND_NOT_ALLOWED, "TST.B (*+$1234,PC)");
    ETEST(OPERAND_NOT_ALLOWED, "TST.B (*-16,PC,D3.L)");
    ...
    ETEST(OPERAND_NOT_ALLOWED, "TST.W (*+$1234,PC)");
    ETEST(OPERAND_NOT_ALLOWED, "TST.W (*-16,PC,D3.L)");
    ...
    ETEST(OPERAND_NOT_ALLOWED, "TST.L (*+$1234,PC)");
    ETEST(OPERAND_NOT_ALLOWED, "TST.L (*-16,PC,D3.L)");
