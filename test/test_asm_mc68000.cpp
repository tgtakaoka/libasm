...
void test_integer() {
    ...
    if (!firstGen()) {
        ...
        TEST("MULS.L (A2), D7",             0046022, 074000);
        TEST("MULS.L (A2)+, D7",            0046032, 074000);
        TEST("MULS.L -(A2), D7",            0046042, 074000);
    ...
    if (!firstGen()) {
        ...
        TEST("MULU.L (A2), D7",             0046022, 070000);
        TEST("MULU.L (A2)+, D7",            0046032, 070000);
        TEST("MULU.L -(A2), D7",            0046042, 070000);
...
void test_mmu_move() {
    ...
    ERRT("PMOVE.Q D2, SRP", REGISTER_NOT_ALLOWED, "D2, SRP", 0xF000|002, 0x4000|(2<<10));
    ERRT("PMOVE.Q D2, CRP", REGISTER_NOT_ALLOWED, "D2, CRP", 0xF000|002, 0x4000|(3<<10));
    TEST("PMOVE.W D2, PSR", 0xF000|002, 0x6000|(8<<10));
    TEST("PMOVE.L D2, TT0", 0xF000|002, 0x0000|(2<<10));
    TEST("PMOVE.L D2, TT1", 0xF000|002, 0x0000|(3<<10));
    ...
    TEST("PMOVE.W A2, PSR", 0xF000|012, 0x6000|(8<<10));
    TEST("PMOVE.L A2, TT0", 0xF000|012, 0x0000|(2<<10));
    TEST("PMOVE.L A2, TT1", 0xF000|012, 0x0000|(3<<10));
    ...
    TEST("PMOVE.W (A2)+, PSR", 0xF000|032, 0x6000|(8<<10));
    TEST("PMOVE.L (A2)+, TT0", 0xF000|032, 0x0000|(2<<10));
    TEST("PMOVE.L (A2)+, TT1", 0xF000|032, 0x0000|(3<<10));
    ...
    TEST("PMOVE.W -(A2), PSR", 0xF000|042, 0x6000|(8<<10));
    TEST("PMOVE.L -(A2), TT0", 0xF000|042, 0x0000|(2<<10));
    TEST("PMOVE.L -(A2), TT1", 0xF000|042, 0x0000|(3<<10));
    ...
    TEST("PMOVE.W (*+$1234,PC), PSR", 0xF000|072, 0x6000|(8<<10), 0x1230);
    TEST("PMOVE.L (*+$1234,PC), TT0", 0xF000|072, 0x0000|(2<<10), 0x1230);
    TEST("PMOVE.L (*+$1234,PC), TT1", 0xF000|072, 0x0000|(3<<10), 0x1230);
    ...
    TEST("PMOVE.W (*+52,PC,D3.W), PSR", 0xF000|073, 0x6000|(8<<10), 0x3030);
    TEST("PMOVE.L (*+52,PC,D3.W), TT0", 0xF000|073, 0x0000|(2<<10), 0x3030);
    TEST("PMOVE.L (*+52,PC,D3.W), TT1", 0xF000|073, 0x0000|(3<<10), 0x3030);
    ...
    TEST("PMOVE.Q #$123456789ABCDEF0, CRP", 0xF000|074, 0x4000|(3<<10),
         0x1234, 0x5678, 0x9ABC, 0xDEF0);
    TEST("PMOVE.W #$1234, PSR", 0xF000|074, 0x6000|(8<<10), 0x1234);
    TEST("PMOVE.L #$12345678, TT0",         0xF000|074, 0x0000|(2<<10), 0x1234, 0x5678);
    TEST("PMOVE.L #$12345678, TT1",         0xF000|074, 0x0000|(3<<10), 0x1234, 0x5678);

    TEST("PMOVEFD.L D2, TC",  0xF000|002, 0x4100|(0<<10));
    ERRT("PMOVEFD.Q D2, SRP", REGISTER_NOT_ALLOWED, "D2, SRP", 0xF000|002, 0x4100|(2<<10));
    ERRT("PMOVEFD.Q D2, CRP", REGISTER_NOT_ALLOWED, "D2, CRP", 0xF000|002, 0x4100|(3<<10));
    ERRT("PMOVEFD.W D2, PSR", REGISTER_NOT_ALLOWED, "PSR",     0xF000|002, 0x6100|(8<<10));
    TEST("PMOVEFD.L D2, TT0", 0xF000|002, 0x0100|(2<<10));
    TEST("PMOVEFD.L D2, TT1", 0xF000|002, 0x0100|(3<<10));

    TEST("PMOVEFD.L A2, TC",  0xF000|012, 0x4100|(0<<10));
    ERRT("PMOVEFD.Q A2, SRP", REGISTER_NOT_ALLOWED, "A2, SRP", 0xF000|012, 0x4100|(2<<10));
    ERRT("PMOVEFD.Q A2, CRP", REGISTER_NOT_ALLOWED, "A2, CRP", 0xF000|012, 0x4100|(3<<10));
    ERRT("PMOVEFD.W A2, PSR", REGISTER_NOT_ALLOWED, "PSR",     0xF000|012, 0x6100|(8<<10));
    TEST("PMOVEFD.L A2, TT0", 0xF000|012, 0x0100|(2<<10));
    TEST("PMOVEFD.L A2, TT1", 0xF000|012, 0x0100|(3<<10));
    ...
    TEST("PMOVEFD.L (A2)+, TC",  0xF000|032, 0x4100|(0<<10));
    TEST("PMOVEFD.Q (A2)+, SRP", 0xF000|032, 0x4100|(2<<10));
    TEST("PMOVEFD.Q (A2)+, CRP", 0xF000|032, 0x4100|(3<<10));
    ERRT("PMOVEFD.W (A2)+, PSR", REGISTER_NOT_ALLOWED, "PSR", 0xF000|032, 0x6100|(8<<10));
    TEST("PMOVEFD.L (A2)+, TT0", 0xF000|032, 0x0100|(2<<10));
    TEST("PMOVEFD.L (A2)+, TT1", 0xF000|032, 0x0100|(3<<10));

    TEST("PMOVEFD.L -(A2), TC",  0xF000|042, 0x4100|(0<<10));
    TEST("PMOVEFD.Q -(A2), SRP", 0xF000|042, 0x4100|(2<<10));
    TEST("PMOVEFD.Q -(A2), CRP", 0xF000|042, 0x4100|(3<<10));
    ERRT("PMOVEFD.W -(A2), PSR", REGISTER_NOT_ALLOWED, "PSR", 0xF000|042, 0x6100|(8<<10));
    TEST("PMOVEFD.L -(A2), TT0", 0xF000|042, 0x0100|(2<<10));
    TEST("PMOVEFD.L -(A2), TT1", 0xF000|042, 0x0100|(3<<10));
    ...
    TEST("PMOVEFD.L (*+$1234,PC), TC",  0xF000|072, 0x4100|(0<<10), 0x1230);
    TEST("PMOVEFD.Q (*+$1234,PC), SRP", 0xF000|072, 0x4100|(2<<10), 0x1230);
    TEST("PMOVEFD.Q (*+$1234,PC), CRP", 0xF000|072, 0x4100|(3<<10), 0x1230);
    ERRT("PMOVEFD.W (*+$1234,PC), PSR",
         REGISTER_NOT_ALLOWED, "PSR",   0xF000|072, 0x6100|(8<<10), 0x1230);
    TEST("PMOVEFD.L (*+$1234,PC), TT0", 0xF000|072, 0x0100|(2<<10), 0x1230);
    TEST("PMOVEFD.L (*+$1234,PC), TT1", 0xF000|072, 0x0100|(3<<10), 0x1230);

    TEST("PMOVEFD.L (*+52,PC,D3.W), TC",  0xF000|073, 0x4100|(0<<10), 0x3030);
    TEST("PMOVEFD.Q (*+52,PC,D3.W), SRP", 0xF000|073, 0x4100|(2<<10), 0x3030);
    TEST("PMOVEFD.Q (*+52,PC,D3.W), CRP", 0xF000|073, 0x4100|(3<<10), 0x3030);
    ERRT("PMOVEFD.W (*+52,PC,D3.W), PSR",
         REGISTER_NOT_ALLOWED, "PSR",     0xF000|073, 0x6100|(8<<10), 0x3030);
    TEST("PMOVEFD.L (*+52,PC,D3.W), TT0", 0xF000|073, 0x0100|(2<<10), 0x3030);
    TEST("PMOVEFD.L (*+52,PC,D3.W), TT1", 0xF000|073, 0x0100|(3<<10), 0x3030);

    TEST("PMOVEFD.L #$12345678, TC",          0xF000|074, 0x4100|(0<<10), 0x1234, 0x5678);
    TEST("PMOVEFD.Q #$123456789ABCDEF0, SRP", 0xF000|074, 0x4100|(2<<10),
         0x1234, 0x5678, 0x9ABC, 0xDEF0);
    TEST("PMOVEFD.Q #$123456789ABCDEF0, CRP", 0xF000|074, 0x4100|(3<<10),
         0x1234, 0x5678, 0x9ABC, 0xDEF0);
    ERRT("PMOVEFD.W #$1234, PSR",
         REGISTER_NOT_ALLOWED, "PSR",         0xF000|074, 0x6100|(8<<10), 0x1234);
    TEST("PMOVEFD.L #$12345678, TT0",         0xF000|074, 0x0100|(2<<10), 0x1234, 0x5678);
    TEST("PMOVEFD.L #$12345678, TT1",         0xF000|074, 0x0100|(3<<10), 0x1234, 0x5678);
    ...
    TEST("PMOVE.W PSR, D2", 0xF000|002, 0x6200|(8<<10));
    TEST("PMOVE.L TT0, D2", 0xF000|002, 0x0200|(2<<10));
    TEST("PMOVE.L TT1, D2", 0xF000|002, 0x0200|(3<<10));

    TEST("PMOVE.L TC, A2",  0xF000|012, 0x4200|(0<<10));
    ERRT("PMOVE.Q SRP, A2", REGISTER_NOT_ALLOWED, "A2", 0xF000|012, 0x4200|(2<<10));
    ERRT("PMOVE.Q CRP, A2", REGISTER_NOT_ALLOWED, "A2", 0xF000|012, 0x4200|(3<<10));
    TEST("PMOVE.W PSR, A2", 0xF000|012, 0x6200|(8<<10));
    TEST("PMOVE.L TT0, A2", 0xF000|012, 0x0200|(2<<10));
    TEST("PMOVE.L TT1, A2", 0xF000|012, 0x0200|(3<<10));
    ...
    TEST("PMOVE.W PSR, (A2)+", 0xF000|032, 0x6200|(8<<10));
    TEST("PMOVE.L TT0, (A2)+", 0xF000|032, 0x0200|(2<<10));
    TEST("PMOVE.L TT1, (A2)+", 0xF000|032, 0x0200|(3<<10));
    ...
    TEST("PMOVE.W PSR, -(A2)", 0xF000|042, 0x6200|(8<<10));
    TEST("PMOVE.L TT0, -(A2)", 0xF000|042, 0x0200|(2<<10));
    TEST("PMOVE.L TT1, -(A2)", 0xF000|042, 0x0200|(3<<10));
