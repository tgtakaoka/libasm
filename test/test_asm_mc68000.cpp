...
static void test_data_move() {
    ...
    ERRT("EXG.B D1,D2", OPERAND_NOT_ALLOWED);
    ERRT("EXG.W D1,D2", OPERAND_NOT_ALLOWED);
    TEST("EXG.L D1,D2", 0141502); // 014|Dx|50|Dy
    TEST("EXG   A1,A2", 0141512); // 014|Ax|51|Ay
    ERRT("EXG.B A1,A2", OPERAND_NOT_ALLOWED);
    ERRT("EXG.W A1,A2", OPERAND_NOT_ALLOWED);
    TEST("EXG.L A1,A2", 0141512); // 014|Ax|51|Ay
    TEST("EXG   D1,A2", 0141612); // 014|Dx|61|Ay
    ERRT("EXG.B D1,A2", OPERAND_NOT_ALLOWED);
    ERRT("EXG.W D1,A2", OPERAND_NOT_ALLOWED);
    TEST("EXG.L D1,A2", 0141612); // 014|Dx|61|Ay
    TEST("EXG   A2,D1", 0141612); // 014|Dx|61|Ay
    ERRT("EXG.B A2,D1", OPERAND_NOT_ALLOWED);
    ERRT("EXG.W A2,D1", OPERAND_NOT_ALLOWED);
    TEST("EXG.L A2,D1", 0141612); // 014|Dx|61|Ay

    // LEA ea,Ad: 004|An|7|M|Rn
    ERRT("LEA D2,A1",              OPERAND_NOT_ALLOWED);
    ERRT("LEA A2,A1",              OPERAND_NOT_ALLOWED);
    TEST("LEA (A2),A1",            0041722);
    TEST("LEA.L (A2),A1",          0041722);
    ERRT("LEA (A2)+",              OPERAND_NOT_ALLOWED);
    ERRT("LEA -(A2)",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("LEA #$1234",             OPERAND_NOT_ALLOWED);

    // LINK An,#nn: 004712|An
    ERRT("LINK A3,D2",              OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,(A2)",            OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,(A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,-(A2)",           OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,($1234,A2)",      OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,($FFFF00).W",     OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,($001234).L",     OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,(*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("LINK A3,(*+$12,PC,A3.L)", OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B (-$8001,A2),D7",     OVERFLOW_RANGE);
    ERRT("MOVE.B ($8000,A2),D7",      OVERFLOW_RANGE);
    TEST("MOVE.B ($12,A2,D3.L),D7",   0017062, 0x3812);
    TEST("MOVE.B (-$80,A2,D3.L),D7",  0017062, 0x3880);
    TEST("MOVE.B ($7F,A2,D3.L),D7",   0017062, 0x387F);
    ERRT("MOVE.B (-$81,A2,D3.L),D7",  OVERFLOW_RANGE);
    ERRT("MOVE.B ($80,A2,D3.L),D7",   OVERFLOW_RANGE);
    ...
    ERRT("MOVE.B ($1000000),D7",      OVERFLOW_RANGE);
    ...
    ERRT("MOVE.B (*-$7FFF,PC),D7",    OVERFLOW_RANGE);
    ERRT("MOVE.B (*+$8002,PC),D7",    OVERFLOW_RANGE);
    TEST("MOVE.B (*-$7E,PC,D3),D7",   0017073, 0x3080);
    TEST("MOVE.B (*+$81,PC,D3),D7",   0017073, 0x307F);
    ERRT("MOVE.B (*-$7F,PC,D3),D7",   OVERFLOW_RANGE);
    ERRT("MOVE.B (*+$82,PC,D3),D7",   OVERFLOW_RANGE);
    TEST("MOVE.B #$34,D7",            0017074, 0x0034);
    TEST("MOVE.B #$FF,D7",            0017074, 0x00FF);
    TEST("MOVE.B #-$80,D7",           0017074, 0x0080);
    ERRT("MOVE.B #$100,D7",           OVERFLOW_RANGE);
    ERRT("MOVE.B #-$81,D7",           OVERFLOW_RANGE);
    ...
    ERRT("MOVE.W #$10000,D7",         OVERFLOW_RANGE);
    ERRT("MOVE.W #-$8001,D7",         OVERFLOW_RANGE);
    ...
    ERRT("MOVE.B A2,(A6)",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B A2,($5678,A6)",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B A2,($56,A6,D5.W)",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B A2,($005678).W",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B A2,D2",                       OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE.B D2,($1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("MOVE.B D2,($12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("MOVE.B D2,#$34",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.W D0-D6,D2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.W D0-D6,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.W D0-D6,($1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.W D0-D6,($12,PC,D3)",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.W D0-D6,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.L D1/A0,D2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.L D1/A0,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.L D1/A0,($1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.L D1/A0,($12,PC,A3)",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.L D1/A0,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.W D2,A3-A6",              OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.W A2,A3-A6",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.W #$1234,A3-A6",          OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.L D2,A3-A6",              OPERAND_NOT_ALLOWED);
    ERRT("MOVEM.L A2,A3-A6",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEM.L #$1234,A3-A6",          OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEP.W D7,D2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(A2)",          OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(A2)+",         OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,-(A2)",         OPERAND_NOT_ALLOWED);
    TEST("MOVEP.W D7,($1234,A2)",    0007612, 0x1234);
    ERRT("MOVEP.W D7,($12,A2,D3)",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,($123456).L",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,D2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(A2)",          OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W D7,(A2)+",         OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVEP.W D2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W A2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W (A2),D7",          OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W (A2)+,D7",         OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W -(A2),D7",         OPERAND_NOT_ALLOWED);
    TEST("MOVEP.W ($1234,A2),D7",    0007412, 0x1234);
    ERRT("MOVEP.W ($12,A2,D3),D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W ($001234).W,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W ($123456).L,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W (*+$1234,PC),D7",  OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W (*+$12,PC,D3),D7", OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.W #$1234,D7",        OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L D2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L A2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L (A2),D7",          OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L (A2)+,D7",         OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L -(A2),D7",         OPERAND_NOT_ALLOWED);
    TEST("MOVEP.L ($1234,A2),D7",    0007512, 0x1234);
    ERRT("MOVEP.L ($12,A2,D3),D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L ($001234).W,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L ($123456).L,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L (*+$1234,PC),D7",  OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L (*+$12,PC,D3),D7", OPERAND_NOT_ALLOWED);
    ERRT("MOVEP.L #$1234,D7",        OPERAND_NOT_ALLOWED);

    // MOVEQ #nn,Dn: 007|Dn|000 + nn
    ERRT("MOVEQ D2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ A2,D7",            OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ (A2),D7",          OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ (A2)+,D7",         OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ -(A2),D7",         OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ ($12,A2,D3),D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ ($001234).W,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ ($123456).L,D7",   OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ (*+$1234,PC),D7",  OPERAND_NOT_ALLOWED);
    ERRT("MOVEQ (*+$12,PC,D3),D7", OPERAND_NOT_ALLOWED);
    TEST("MOVEQ #0,D0",            0070000 | 0x00);
    TEST("MOVEQ #$7F,D0",          0070000 | 0x7F);
    ERRT("MOVEQ #$80,D0",          OVERFLOW_RANGE);
    TEST("MOVEQ #-1,D7",           0077000 | 0xFF);
    TEST("MOVEQ #-$80,D0",         0070000 | 0x80);
    ERRT("MOVEQ #-$81,D0",         OVERFLOW_RANGE);

    // PEA src: 00441|M|Rn
    ERRT("PEA D2",              OPERAND_NOT_ALLOWED);
    ERRT("PEA A2",              OPERAND_NOT_ALLOWED);
    TEST("PEA (A2)",            0044122);
    ERRT("PEA (A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("PEA -(A2)",           OPERAND_NOT_ALLOWED);
    ...
    ERRT("PEA #$1234",          OPERAND_NOT_ALLOWED);

    // UNLK An: 004713|An
    ERRT("UNLK D2",              OPERAND_NOT_ALLOWED);
    TEST("UNLK A2",              0047132);
    ERRT("UNLK (A2)",            OPERAND_NOT_ALLOWED);
    ERRT("UNLK (A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("UNLK -(A2)",           OPERAND_NOT_ALLOWED);
    ERRT("UNLK ($1234,A2)",      OPERAND_NOT_ALLOWED);
    ERRT("UNLK ($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    ERRT("UNLK ($FFFF00).W",     OPERAND_NOT_ALLOWED);
    ERRT("UNLK ($001234).L",     OPERAND_NOT_ALLOWED);
    ERRT("UNLK (*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("UNLK (*+$12,PC,A3.L)", OPERAND_NOT_ALLOWED);
    ERRT("UNLK #$1234",          OPERAND_NOT_ALLOWED);
}

static void test_integer() {
    // ADD Dn,dst: 015|Dn|Sz|M|Rn, Sz:B=4/W=5/L=6
    TEST("ADD.B D7,D2",            0152007);
    ERRT("ADD.B D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADD.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADD.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADD.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ADD.W D7,D2",            0152107);
    ERRT("ADD.W D7,A2",            OPERAND_NOT_ALLOWED); // ADDA.W
    ...
    ERRT("ADD.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADD.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADD.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ADD.L D7,D2",            0152207);
    ERRT("ADD.L D7,A2",            OPERAND_NOT_ALLOWED); // ADDA.L;
    ...
    ERRT("ADD.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADD.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADD.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // ADD src,Dn: 015|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ADD.B D2,D7",              0157002);
    ERRT("ADD.B A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ADDI.W #$5678,D2",            0003102, 0x5678);
    ERRT("ADDI.W #$5678,A2",            OPERAND_NOT_ALLOWED); // ADDA.W
    ...
    ERRT("ADDI.W #$5678,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDI.W #$5678,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDI.W #$5678,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ADDI.L #$3456789A,D2",            0003202, 0x3456, 0x789A);
    ERRT("ADDI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED); // ADDA.L
    ...
    ERRT("ADDI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);

    // ADDQ #nn,dst: 005|nn|Sz|M|Rn, Sz:B=0/W=1/L=2
    ERRT("ADDQ.B #0,D2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDQ.B #9,D2",            OVERFLOW_RANGE);
    ERRT("ADDQ.B #-1,D2",           OVERFLOW_RANGE);
    ERRT("ADDQ.B #8,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDQ.B #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.B #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.B #8,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDQ.W #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.W #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.W #8,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("ADDQ.L #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.L #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ADDQ.L #8,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("CLR.B A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("CLR.B (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("CLR.B (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("CLR.B #$1234",        OPERAND_NOT_ALLOWED);
    TEST("CLR.W D2",            0041102);
    ERRT("CLR.W A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("CLR.W (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("CLR.W (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("CLR.W #$1234",        OPERAND_NOT_ALLOWED);
    TEST("CLR.L D2",            0041202);
    ERRT("CLR.L A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("CLR.L (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("CLR.L (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("CLR.L #$1234",        OPERAND_NOT_ALLOWED);

    // CMP src,Dn: 013|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("CMP.B D2,D7",              0137002);
    ERRT("CMP.B A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("CMPI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("CMPI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("CMPI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("CMPI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("CMPI.W #$5678,D2",               0006102, 0x5678);
    ERRT("CMPI.W #$5678,A2",               OPERAND_NOT_ALLOWED); // CMPA.W
    ...
    ERRT("CMPI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("CMPI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("CMPI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("CMPI.L #$3456789A,D2",            0006202, 0x3456, 0x789A);
    ERRT("CMPI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED); // CMPA.L
    ...
    ERRT("CMPM.B -(A2),-(A7)", OPERAND_NOT_ALLOWED);

    // DIVS src,Dn: 010|Dn|7|M|Rn
    TEST("DIVS.W D2,D7",              0107702);
    ERRT("DIVS.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("DIVU.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("EXT.L A2", OPERAND_NOT_ALLOWED);

    // MULS src,Dn: 014|Dn|7|M|Rn
    TEST("MULS.W D2,D7",              0147702);
    ERRT("MULS.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MULU.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEG.B A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEG.B (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEG.B (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEG.B #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NEG.W D2",            0042102);
    ERRT("NEG.W A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEG.W (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEG.W (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEG.W #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NEG.L D2",            0042202);
    ERRT("NEG.L A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEG.L (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEG.L (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEG.L #$1234",        OPERAND_NOT_ALLOWED);

    // NEGX dst: 0040|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("NEGX.B D2",            0040002);
    ERRT("NEGX.B A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEGX.B (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEGX.B (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEGX.B #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NEGX.W D2",            0040102);
    ERRT("NEGX.W A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEGX.W (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEGX.W (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEGX.W #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NEGX.L D2",            0040202);
    ERRT("NEGX.L A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NEGX.L (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NEGX.L (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NEGX.L #$1234",        OPERAND_NOT_ALLOWED);

    // SUB src,Dn: 011|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("SUB.B D2,D7",              0117002);
    ERRT("SUB.B A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUB.B D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUB.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUB.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUB.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("SUB.W D7,D2",            0112107);
    ERRT("SUB.W D7,A2",            OPERAND_NOT_ALLOWED); // SUBA.W
    ...
    ERRT("SUB.W (*+$1234,PC)",     OPERAND_NOT_ALLOWED);
    ERRT("SUB.W (*+$12,PC,D3)",    OPERAND_NOT_ALLOWED);
    ERRT("SUB.W #$1234",           OPERAND_NOT_ALLOWED);
    TEST("SUB.L D7,D2",            0112207);
    ERRT("SUB.L D7,A2",            OPERAND_NOT_ALLOWED); // SUBA.L
    ...
    ERRT("SUB.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUB.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUB.L D7,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUBI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUBI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("SUBI.W #$5678,D2",            0002102, 0x5678);
    ERRT("SUBI.W #$5678,A2",            OPERAND_NOT_ALLOWED); // SUBA.W
    ...
    ERRT("SUBI.W #$5678,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBI.W #$5678,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBI.W #$5678,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("SUBI.L #$3456789A,D2",            0002202, 0x3456, 0x789A);
    ERRT("SUBI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED); // SUBA.L
    ...
    ERRT("SUBI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);

    // SUBQ #nn,dst: 005|nn|Sz|M\En, Sz:B=4/W=5/L=6
    TEST("SUBQ.B #8,D2",            0050402);
    ERRT("SUBQ.B #8,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUBQ.B #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.B #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.B #8,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUBQ.W #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.W #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.W #8,#$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("SUBQ.L #8,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.L #8,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SUBQ.L #8,#$1234",        OPERAND_NOT_ALLOWED);
...
static void test_logical() {
    ...
    ERRT("AND.B A2",                 OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.L A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.B D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("AND.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("AND.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("AND.W D7,D2",            0142107);
    ERRT("AND.W D7,A7",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("AND.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("AND.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("AND.L D7,D2",            0142207);
    ERRT("AND.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("AND.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("AND.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("AND.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // ANDI #nn,dst: 0001|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ANDI.B #$12,D2",            0001002, 0x0012);
    ERRT("ANDI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ANDI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ANDI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ANDI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ANDI.W #$5678,D2",            0001102, 0x5678);
    ERRT("ANDI.W #$5678,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ANDI.W #$5678,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ANDI.W #$5678,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ANDI.W #$5678,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ANDI.L #$3456789A,D2",            0001202, 0x3456, 0x789A);
    ERRT("ANDI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ANDI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ANDI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ANDI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);

    // EOR Dn,dst: 013|Dn|Sz|M|Rn, Sz:B=4/W=5/L=6
    TEST("EOR.B D7,D2",            0137402);
    ERRT("EOR.B D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EOR.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EOR.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EOR.B #$12,#$1234",      OPERAND_NOT_ALLOWED);
    TEST("EOR.W D7,D2",            0137502);
    ERRT("EOR.W D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EOR.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EOR.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EOR.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("EOR.L D7,D2",            0137602);
    ERRT("EOR.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EOR.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EOR.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EOR.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // EORI #nn,dst: 0005|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("EORI.B #$12,D2",            0005002, 0x0012);
    ERRT("EORI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EORI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EORI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EORI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("EORI.W #$5678,D2",            0005102, 0x5678);
    ERRT("EORI.W #$5678,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EORI.W #$5678,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EORI.W #$5678,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EORI.W #$5678,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("EORI.L #$3456789A,D2",            0005202, 0x3456, 0x789A);
    ERRT("EORI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("EORI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("EORI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("EORI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);

    // NOT dst: 0043|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("NOT.B D2",            0043002);
    ERRT("NOT.B A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NOT.B (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NOT.B (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NOT.B #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NOT.W D2",            0043102);
    ERRT("NOT.W A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NOT.W (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NOT.W (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NOT.W #$1234",        OPERAND_NOT_ALLOWED);
    TEST("NOT.L D2",            0043202);
    ERRT("NOT.L A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NOT.L (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NOT.L (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NOT.L #$1234",        OPERAND_NOT_ALLOWED);

    // OR src,Dn, 010|Dn|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("OR.B D2,D7",              0107002);
    ERRT("OR.B D2,A2",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.L A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.B D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("OR.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("OR.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("OR.W D7,D2",            0102107);
    ERRT("OR.W D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("OR.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("OR.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("OR.L D7,D2",            0102207);
    ERRT("OR.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("OR.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("OR.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("OR.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // ORI #nn,dst: 0000|Sz|M|Rn, Sz:B=0/W=1/L=2
    TEST("ORI.B #$12,D2",            0000002, 0x0012);
    ERRT("ORI.B #$12,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ORI.B #$12,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ORI.B #$12,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ORI.B #$12,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ORI.W #$5678,D2",            0000102, 0x5678);
    ERRT("ORI.W #$5678,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ORI.W #$5678,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ORI.W #$5678,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ORI.W #$5678,#$1234",        OPERAND_NOT_ALLOWED);
    TEST("ORI.L #$3456789A,D2",            0000202, 0x3456, 0x789A);
    ERRT("ORI.L #$3456789A,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ORI.L #$3456789A,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ORI.L #$3456789A,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ORI.L #$3456789A,#$1234",        OPERAND_NOT_ALLOWED);
}
...
static void test_shift_rotate() {
    ...
    ERRT("ASL.B #0,D7",  OPERAND_NOT_ALLOWED);
    TEST("ASL.B #1,D7",  0161407);
    TEST("ASL.B #2,D7",  0162407);
    TEST("ASL.W #4,D7",  0164507);
    TEST("ASL.L #8,D7",  0160607);
    ERRT("ASL.B #9,D7",  OVERFLOW_RANGE);
    ERRT("ASL.B #-1,D7", OVERFLOW_RANGE);

    // ASL dst: 01607|M|Rn
    ERRT("ASL D2",            OPERAND_NOT_ALLOWED);
    ERRT("ASL A2",            OPERAND_NOT_ALLOWED);
    TEST("ASL   (A2)",        0160722);
    ...
    ERRT("ASL (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ASL (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ...
    // ASR dst: 01603|M|Rn
    ERRT("ASR D2",            OPERAND_NOT_ALLOWED);
    ERRT("ASR A2",            OPERAND_NOT_ALLOWED);
    TEST("ASR (A2)",          0160322);
    TEST("ASR   (A2)+",       0160332);
    ...
    ERRT("ASR (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ASR (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ...
    // LSL dst: 01617|M|Rn
    ERRT("LSL D2",            OPERAND_NOT_ALLOWED);
    ERRT("LSL A2",            OPERAND_NOT_ALLOWED);
    TEST("LSL (A2)",          0161722);
    TEST("LSL (A2)+",         0161732);
    TEST("LSL   -(A2)",       0161742);
    ...
    ERRT("LSL (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("LSL (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("LSL #$1234",        OPERAND_NOT_ALLOWED);
    ...
    // LSR dst: 01613|M|Rn
    ERRT("LSR D2",            OPERAND_NOT_ALLOWED);
    ERRT("LSR A2",            OPERAND_NOT_ALLOWED);
    TEST("LSR (A2)",          0161322);
    TEST("LSR (A2)+",         0161332);
    TEST("LSR -(A2)",         0161342);
    ...
    ERRT("LSR (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("LSR (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("LSR #$1234",        OPERAND_NOT_ALLOWED);
    ...
    // ROL dst: 01637|M|Rn
    ERRT("ROL D2",            OPERAND_NOT_ALLOWED);
    ERRT("ROL A2",            OPERAND_NOT_ALLOWED);
    TEST("ROL   (A2)",        0163722);
    ...
    ERRT("ROL (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ROL (*+$12,PC,D3)",  OPERAND_NOT_ALLOWED);
    ...
    // ROR dst: 01633|M|Rn
    ERRT("ROR D2",            OPERAND_NOT_ALLOWED);
    ERRT("ROR A2",            OPERAND_NOT_ALLOWED);
    TEST("ROR (A2)",          0163322);
    TEST("ROR   (A2)+",       0163332);
    ...
    ERRT("ROR (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ROR (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ...
    // ROXL dst: 01627|M|Rn
    ERRT("ROXL D2",            OPERAND_NOT_ALLOWED);
    ERRT("ROXL A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ROXL (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ROXL (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ROXL #$1234",        OPERAND_NOT_ALLOWED);
    ...
    // ROXR dst: 01623|M|Rn
    ERRT("ROXR D2",            OPERAND_NOT_ALLOWED);
    ERRT("ROXR A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ROXR (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ROXR (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ROXR #$1234",        OPERAND_NOT_ALLOWED);

    // SWAP Dn: 004410|Dn
    TEST("SWAP   D0", 0044100);
    TEST("SWAP   D7", 0044107);
    TEST("SWAP.L D7", 0044107);
    ERRT("SWAP A0", OPERAND_NOT_ALLOWED);
}

static void test_bit() {
    // BCHG Dx,dst: 000|Dx|5|M|Rn
    TEST("BCHG   D7,D2",            0007502);
    ERRT("BCHG.B D7,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W D7,D2",            OPERAND_NOT_ALLOWED);
    TEST("BCHG.L D7,D2",            0007502);
    ERRT("BCHG   D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.B D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("BCHG.W D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BCHG   D7,($12,A2,D3.W)", 0007562, 0x3012);
    TEST("BCHG.B D7,($12,A2,D3.W)", 0007562, 0x3012);
    ERRT("BCHG.W D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BCHG   D7,($001234).W",   0007570, 0x1234);
    TEST("BCHG.B D7,($001234).W",   0007570, 0x1234);
    ERRT("BCHG.W D7,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BCHG   D7,($012345).L",   0007571, 0x0001, 0x2345);
    TEST("BCHG.B D7,($012345).L",   0007571, 0x0001, 0x2345);
    ERRT("BCHG.W D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG   D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG   D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG   D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG   D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // BCHG #n,dst: 00041|M|Rn
    TEST("BCHG   #0,D2",            0004102, 0x0000);
    ERRT("BCHG.B #0,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W #0,D2",            OPERAND_NOT_ALLOWED);
    TEST("BCHG.L #0,D2",            0004102, 0x0000);
    TEST("BCHG.L #31,D2",           0004102, 0x001F);
    ERRT("BCHG.L #32,D2",           ILLEGAL_BIT_NUMBER);
    ERRT("BCHG   #0,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #0,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W #0,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #0,A2",            OPERAND_NOT_ALLOWED);
    TEST("BCHG   #7,(A2)",          0004122, 0x0007);
    TEST("BCHG.B #7,(A2)",          0004122, 0x0007);
    ERRT("BCHG.B #8,(A2)",          ILLEGAL_BIT_NUMBER);
    ERRT("BCHG.W #7,(A2)",          OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #7,(A2)",          OPERAND_NOT_ALLOWED);
    TEST("BCHG   #6,(A2)+",         0004132, 0x0006);
    TEST("BCHG.B #6,(A2)+",         0004132, 0x0006);
    ERRT("BCHG.W #6,(A2)+",         OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #6,(A2)+",         OPERAND_NOT_ALLOWED);
    TEST("BCHG   #5,-(A2)",         0004142, 0x0005);
    TEST("BCHG.B #5,-(A2)",         0004142, 0x0005);
    ERRT("BCHG.W #5,-(A2)",         OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #5,-(A2)",         OPERAND_NOT_ALLOWED);
    TEST("BCHG   #4,($1234,A2)",    0004152, 0x0004, 0x1234);
    TEST("BCHG.B #4,($1234,A2)",    0004152, 0x0004, 0x1234);
    ERRT("BCHG.W #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BCHG   #3,($12,A2,D3.W)", 0004162, 0x0003, 0x3012);
    TEST("BCHG.B #3,($12,A2,D3.W)", 0004162, 0x0003, 0x3012);
    ERRT("BCHG.W #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BCHG   #2,($001234).W",   0004170, 0x0002, 0x1234);
    TEST("BCHG.B #2,($001234).W",   0004170, 0x0002, 0x1234);
    ERRT("BCHG.W #2,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #2,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BCHG   #1,($012345).L",   0004171, 0x0001, 0x0001, 0x2345);
    TEST("BCHG.B #1,($012345).L",   0004171, 0x0001, 0x0001, 0x2345);
    ERRT("BCHG.W #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCHG   #1,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #1,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W #1,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #1,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCHG   #2,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #2,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W #2,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #2,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCHG   #3,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #3,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.W #3,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCHG.L #3,#$1234",        OPERAND_NOT_ALLOWED);

    // BCLR Dx,dst: 000|Dx|6|M|Rn
    TEST("BCLR   D7,D2",            0007602);
    ERRT("BCLR.B D7,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W D7,D2",            OPERAND_NOT_ALLOWED);
    TEST("BCLR.L D7,D2",            0007602);
    ERRT("BCLR   D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("BCLR.W D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BCLR   D7,($12,A2,D3.W)", 0007662, 0x3012);
    TEST("BCLR.B D7,($12,A2,D3.W)", 0007662, 0x3012);
    ERRT("BCLR.W D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BCLR   D7,($001234).W",   0007670, 0x1234);
    TEST("BCLR.B D7,($001234).W",   0007670, 0x1234);
    ERRT("BCLR.W D7,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BCLR   D7,($012345).L",   0007671, 0x0001, 0x2345);
    TEST("BCLR.B D7,($012345).L",   0007671, 0x0001, 0x2345);
    ERRT("BCLR.W D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR   D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR   D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR   D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // BCLR #n,dst: 00042|M|Rn
    TEST("BCLR   #0,D2",            0004202, 0x0000);
    ERRT("BCLR.B #0,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W #0,D2",            OPERAND_NOT_ALLOWED);
    TEST("BCLR.L #0,D2",            0004202, 0x0000);
    ERRT("BCLR   #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #1,A2",            OPERAND_NOT_ALLOWED);
    TEST("BCLR   #7,(A2)",          0004222, 0x0007);
    TEST("BCLR.B #7,(A2)",          0004222, 0x0007);
    ERRT("BCLR.W #7,(A2)",          OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #7,(A2)",          OPERAND_NOT_ALLOWED);
    TEST("BCLR   #6,(A2)+",         0004232, 0x0006);
    TEST("BCLR.B #6,(A2)+",         0004232, 0x0006);
    ERRT("BCLR.W #6,(A2)+",         OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #6,(A2)+",         OPERAND_NOT_ALLOWED);
    TEST("BCLR   #5,-(A2)",         0004242, 0x0005);
    TEST("BCLR.B #5,-(A2)",         0004242, 0x0005);
    ERRT("BCLR.W #5,-(A2)",         OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #5,-(A2)",         OPERAND_NOT_ALLOWED);
    TEST("BCLR   #4,($1234,A2)",    0004252, 0x0004, 0x1234);
    TEST("BCLR.B #4,($1234,A2)",    0004252, 0x0004, 0x1234);
    ERRT("BCLR.W #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BCLR   #3,($12,A2,D3.W)", 0004262, 0x0003, 0x3012);
    TEST("BCLR.B #3,($12,A2,D3.W)", 0004262, 0x0003, 0x3012);
    ERRT("BCLR.W #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BCLR   #2,($001234).W",   0004270, 0x0002, 0x1234);
    TEST("BCLR.B #2,($001234).W",   0004270, 0x0002, 0x1234);
    ERRT("BCLR.W #2,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #2,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BCLR   #1,($012345).L",   0004271, 0x0001, 0x0001, 0x2345);
    TEST("BCLR.B #1,($012345).L",   0004271, 0x0001, 0x0001, 0x2345);
    ERRT("BCLR.W #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BCLR   #4,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B #4,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W #4,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #4,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BCLR   #5,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B #5,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W #5,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #5,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BCLR   #6,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.B #6,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.W #6,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BCLR.L #6,#$1234",        OPERAND_NOT_ALLOWED);

    // BSET Dx,dst: 000|Dx|7|M|Rn
    TEST("BSET   D7,D2",            0007702);
    ERRT("BSET.B D7,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.W D7,D2",            OPERAND_NOT_ALLOWED);
    TEST("BSET.L D7,D2",            0007702);
    ERRT("BSET   D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.B D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.W D7,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("BSET.W D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BSET   D7,($12,A2,D3.W)", 0007762, 0x3012);
    TEST("BSET.B D7,($12,A2,D3.W)", 0007762, 0x3012);
    ERRT("BSET.W D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BSET   D7,($001234).W",   0007770, 0x1234);
    TEST("BSET.B D7,($001234).W",   0007770, 0x1234);
    ERRT("BSET.W D7,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BSET   D7,($012345).L",   0007771, 0x0001, 0x2345);
    TEST("BSET.B D7,($012345).L",   0007771, 0x0001, 0x2345);
    ERRT("BSET.W D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BSET   D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.B D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.W D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET   D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.B D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.W D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET   D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.B D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.W D7,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.L D7,#$1234",        OPERAND_NOT_ALLOWED);

    // BSET #n,dst: 00043|M|Rn
    TEST("BSET   #0,D2",            0004302, 0x0000);
    ERRT("BSET.B #0,D2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.W #0,D2",            OPERAND_NOT_ALLOWED);
    TEST("BSET.L #0,D2",            0004302, 0x0000);
    ERRT("BSET   #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.B #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.W #1,A2",            OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #1,A2",            OPERAND_NOT_ALLOWED);
    TEST("BSET   #7,(A2)",          0004322, 0x0007);
    TEST("BSET.B #7,(A2)",          0004322, 0x0007);
    ERRT("BSET.W #7,(A2)",          OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #7,(A2)",          OPERAND_NOT_ALLOWED);
    TEST("BSET   #6,(A2)+",         0004332, 0x0006);
    TEST("BSET.B #6,(A2)+",         0004332, 0x0006);
    ERRT("BSET.W #6,(A2)+",         OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #6,(A2)+",         OPERAND_NOT_ALLOWED);
    TEST("BSET   #5,-(A2)",         0004342, 0x0005);
    TEST("BSET.B #5,-(A2)",         0004342, 0x0005);
    ERRT("BSET.W #5,-(A2)",         OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #5,-(A2)",         OPERAND_NOT_ALLOWED);
    TEST("BSET   #4,($1234,A2)",    0004352, 0x0004, 0x1234);
    TEST("BSET.B #4,($1234,A2)",    0004352, 0x0004, 0x1234);
    ERRT("BSET.W #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #4,($1234,A2)",    OPERAND_NOT_ALLOWED);
    TEST("BSET   #3,($12,A2,D3.W)", 0004362, 0x0003, 0x3012);
    TEST("BSET.B #3,($12,A2,D3.W)", 0004362, 0x0003, 0x3012);
    ERRT("BSET.W #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #3,($12,A2,D3.W)", OPERAND_NOT_ALLOWED);
    TEST("BSET   #2,($001234).W",   0004370, 0x0002, 0x1234);
    TEST("BSET.B #2,($001234).W",   0004370, 0x0002, 0x1234);
    ERRT("BSET.W #2,($001234).W",   OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #2,($001234).W",   OPERAND_NOT_ALLOWED);
    TEST("BSET   #1,($012345).L",   0004371, 0x0001, 0x0001, 0x2345);
    TEST("BSET.B #1,($012345).L",   0004371, 0x0001, 0x0001, 0x2345);
    ERRT("BSET.W #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #1,($012345).L",   OPERAND_NOT_ALLOWED);
    ERRT("BSET   #3,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.B #3,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.W #3,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #3,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("BSET   #4,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.B #4,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.W #4,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #4,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("BSET   #5,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.B #5,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.W #5,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("BSET.L #5,#$1234",        OPERAND_NOT_ALLOWED);

    // BTST Dx,dst: 000|Dx|4|M|Rn
    TEST("BTST   D7,D2",              0007402);
    ERRT("BTST.B D7,D2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.W D7,D2",              OPERAND_NOT_ALLOWED);
    TEST("BTST.L D7,D2",              0007402);
    ERRT("BTST   D7,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.B D7,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.W D7,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,A2",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("BTST.W D7,($1234,A2)",      OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,($1234,A2)",      OPERAND_NOT_ALLOWED);
    TEST("BTST   D7,($12,A2,D3.W)",   0007462, 0x3012);
    TEST("BTST.B D7,($12,A2,D3.W)",   0007462, 0x3012);
    ERRT("BTST.W D7,($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    TEST("BTST   D7,($001234).W",     0007470, 0x1234);
    TEST("BTST.B D7,($001234).W",     0007470, 0x1234);
    ERRT("BTST.W D7,($001234).W",     OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,($001234).W",     OPERAND_NOT_ALLOWED);
    TEST("BTST   D7,($012345).L",     0007471, 0x0001, 0x2345);
    TEST("BTST.B D7,($012345).L",     0007471, 0x0001, 0x2345);
    ERRT("BTST.W D7,($012345).L",     OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,($012345).L",     OPERAND_NOT_ALLOWED);
    TEST("BTST   D7,(*+$1234,PC)",    0007472, 0x1232);
    TEST("BTST.B D7,(*+$1234,PC)",    0007472, 0x1232);
    ERRT("BTST.W D7,(*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,(*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    TEST("BTST   D7,(*+$23,PC,D3.L)", 0007473, 0x3821);
    TEST("BTST.B D7,(*+$23,PC,D3.L)", 0007473, 0x3821);
    ERRT("BTST.W D7,(*+$23,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,(*+$23,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("BTST   D7,#$12",            OPERAND_NOT_ALLOWED);
    ERRT("BTST.B D7,#$12",            OPERAND_NOT_ALLOWED);
    ERRT("BTST.W D7,#$12",            OPERAND_NOT_ALLOWED);
    ERRT("BTST.L D7,#$12",            OPERAND_NOT_ALLOWED);

    // BTST #n,dst: 00040|M|Rn
    TEST("BTST   #0,D2",              0004002, 0x0000);
    ERRT("BTST.B #0,D2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.W #0,D2",              OPERAND_NOT_ALLOWED);
    TEST("BTST.L #0,D2",              0004002, 0x0000);
    ERRT("BTST   #1,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.B #1,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.W #1,A2",              OPERAND_NOT_ALLOWED);
    ERRT("BTST.B #1,A2",              OPERAND_NOT_ALLOWED);
    TEST("BTST   #7,(A2)",            0004022, 0x0007);
    TEST("BTST.B #7,(A2)",            0004022, 0x0007);
    ERRT("BTST.W #7,(A2)",            OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #7,(A2)",            OPERAND_NOT_ALLOWED);
    TEST("BTST   #6,(A2)+",           0004032, 0x0006);
    TEST("BTST.B #6,(A2)+",           0004032, 0x0006);
    ERRT("BTST.W #6,(A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #6,(A2)+",           OPERAND_NOT_ALLOWED);
    TEST("BTST   #5,-(A2)",           0004042, 0x0005);
    TEST("BTST.B #5,-(A2)",           0004042, 0x0005);
    ERRT("BTST.W #5,-(A2)",           OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #5,-(A2)",           OPERAND_NOT_ALLOWED);
    TEST("BTST   #4,($1234,A2)",      0004052, 0x0004, 0x1234);
    TEST("BTST.B #4,($1234,A2)",      0004052, 0x0004, 0x1234);
    ERRT("BTST.W #4,($1234,A2)",      OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #4,($1234,A2)",      OPERAND_NOT_ALLOWED);
    TEST("BTST   #3,($12,A2,D3.W)",   0004062, 0x0003, 0x3012);
    TEST("BTST.B #3,($12,A2,D3.W)",   0004062, 0x0003, 0x3012);
    ERRT("BTST.W #3,($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #3,($12,A2,D3.W)",   OPERAND_NOT_ALLOWED);
    TEST("BTST   #2,($001234).W",     0004070, 0x0002, 0x1234);
    TEST("BTST.B #2,($001234).W",     0004070, 0x0002, 0x1234);
    ERRT("BTST.W #2,($001234).W",     OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #2,($001234).W",     OPERAND_NOT_ALLOWED);
    TEST("BTST   #1,($012345).L",     0004071, 0x0001, 0x0001, 0x2345);
    TEST("BTST.B #1,($012345).L",     0004071, 0x0001, 0x0001, 0x2345);
    ERRT("BTST.W #1,($012345).L",     OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #1,($012345).L",     OPERAND_NOT_ALLOWED);
    TEST("BTST   #0,(*+$1234,PC)",    0004072, 0x0000, 0x1230);
    TEST("BTST.B #0,(*+$1234,PC)",    0004072, 0x0000, 0x1230);
    ERRT("BTST.W #0,(*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #0,(*+$1234,PC)",    OPERAND_NOT_ALLOWED);
    TEST("BTST   #7,(*+$23,PC,D3.L)", 0004073, 0x0007, 0x381F);
    TEST("BTST.B #7,(*+$23,PC,D3.L)", 0004073, 0x0007, 0x381F);
    ERRT("BTST.W #7,(*+$23,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #7,(*+$23,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("BTST   #6,#$1234",          OPERAND_NOT_ALLOWED);
    ERRT("BTST.B #6,#$1234",          OPERAND_NOT_ALLOWED);
    ERRT("BTST.W #6,#$1234",          OPERAND_NOT_ALLOWED);
    ERRT("BTST.L #6,#$1234",          OPERAND_NOT_ALLOWED);
}
...
static void test_bcd() {
    ...
    ERRT("NBCD A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("NBCD (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("NBCD (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("NBCD #$1234",        OPERAND_NOT_ALLOWED);
...
static void test_program() {
    ...
    ERRT("DBRA D2,*+3",     OPERAND_NOT_ALIGNED);
    ERRT("DBRA D2,*-3",     OPERAND_NOT_ALIGNED);
    ...
    ERRT("ST A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("ST (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("ST (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("ST #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SF D2",            0050302 | 0x100);
    ERRT("SF A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SF (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SF (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SF #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SHI D2",            0050302 | 0x200);
    ERRT("SHI A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SHI (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SHI (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SHI #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SLS D2",            0050302 | 0x300);
    ERRT("SLS A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SLS (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SLS (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SLS #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SCC D2",            0050302 | 0x400);
    ERRT("SCC A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SCC (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SCC (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SCC #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SCS D2",            0050302 | 0x500);
    ERRT("SCS A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SCS (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SCS (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SCS #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SNE D2",            0050302 | 0x600);
    ERRT("SNE A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SNE (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SNE (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SNE #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SEQ D2",            0050302 | 0x700);
    ERRT("SEQ A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SEQ (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SEQ (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SEQ #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SVC D2",            0050302 | 0x800);
    ERRT("SVC A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SVC (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SVC (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SVC #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SVS D2",            0050302 | 0x900);
    ERRT("SVS A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SVS (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SVS (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SVS #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SPL D2",            0050302 | 0xA00);
    ERRT("SPL A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SPL (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SPL (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SPL #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SMI D2",            0050302 | 0xB00);
    ERRT("SMI A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SMI (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SMI (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SMI #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SGE D2",            0050302 | 0xC00);
    ERRT("SGE A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SGE (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SGE (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SGE #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SLT D2",            0050302 | 0xD00);
    ERRT("SLT A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SLT (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SLT (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SLT #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SGT D2",            0050302 | 0xE00);
    ERRT("SGT A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SGT (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SGT (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SGT #$1234",        OPERAND_NOT_ALLOWED);
    TEST("SLE D2",            0050302 | 0xF00);
    ERRT("SLE A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("SLE (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("SLE (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("SLE #$1234",        OPERAND_NOT_ALLOWED);
    ...
    ERRT("BRA *+3",       OPERAND_NOT_ALIGNED);
    ERRT("BRA *-3",       OPERAND_NOT_ALIGNED);
    ...
    ERRT("BSR *+3",       OPERAND_NOT_ALIGNED);
    ERRT("BSR *-3",       OPERAND_NOT_ALIGNED);

    // JMP dst: 00473|M|Rn
    ERRT("JMP D2",              OPERAND_NOT_ALLOWED);
    ERRT("JMP A2",              OPERAND_NOT_ALLOWED);
    TEST("JMP (A2)",            0047322);
    ERRT("JMP (A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("JMP -(A2)",           OPERAND_NOT_ALLOWED);
    ...
    ERRT("JMP ($003455).W",     OPERAND_NOT_ALIGNED);
    ERRT("JMP ($123455).L",     OPERAND_NOT_ALIGNED);
    ERRT("JMP (*+$1235,PC)",    OPERAND_NOT_ALIGNED);

    // JSR dst, 00472|M|Rn
    ERRT("JSR D2",              OPERAND_NOT_ALLOWED);
    ERRT("JSR A2",              OPERAND_NOT_ALLOWED);
    TEST("JSR (A2)",            0047222);
    ERRT("JSR (A2)+",           OPERAND_NOT_ALLOWED);
    ERRT("JSR -(A2)",           OPERAND_NOT_ALLOWED);
    ...
    ERRT("JSR #$1234",          OPERAND_NOT_ALLOWED);
    ERRT("JSR ($003455).W",     OPERAND_NOT_ALIGNED);
    ERRT("JSR ($123455).L",     OPERAND_NOT_ALIGNED);
    ERRT("JSR (*+$1235,PC)",    OPERAND_NOT_ALIGNED);
    ...
    ERRT("TST.B A2",             OPERAND_NOT_ALLOWED);
    ...
    ERRT("TST.B (*+$1234,PC)",   OPERAND_NOT_ALLOWED);
    ERRT("TST.B (*-16,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("TST.B #$12",           OPERAND_NOT_ALLOWED);
    TEST("TST.W D2",             0045102);
    ERRT("TST.W A2",             OPERAND_NOT_ALLOWED);
    ...
    ERRT("TST.W (*+$1234,PC)",   OPERAND_NOT_ALLOWED);
    ERRT("TST.W (*-16,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("TST.W #$1234",         OPERAND_NOT_ALLOWED);
    TEST("TST.L D2",             0045202);
    ERRT("TST.L A2",             OPERAND_NOT_ALLOWED);
    ...
    ERRT("TST.L (*+$1234,PC)",   OPERAND_NOT_ALLOWED);
    ERRT("TST.L (*-16,PC,D3.L)", OPERAND_NOT_ALLOWED);
    ERRT("TST.L #$1234",         OPERAND_NOT_ALLOWED);
}
...
static void test_system() {
    ...
    ERRT("MOVE A2,SR",             OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE ($001235).W,SR",    OPERAND_NOT_ALIGNED);
    ERRT("MOVE ($234567).L,SR",    OPERAND_NOT_ALIGNED);
    ERRT("MOVE (*+$1233,PC),SR",   OPERAND_NOT_ALIGNED);

    // MOVE SR,dst: 00403|M|Rn
    TEST("MOVE SR,D2",            0040302);
    ERRT("MOVE SR,A2",            OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE SR,(*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("MOVE SR,(*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("MOVE SR,#$1234",        OPERAND_NOT_ALLOWED);
    ERRT("MOVE SR,($001235).W",   OPERAND_NOT_ALIGNED);
    ERRT("MOVE SR,($234567).L",   OPERAND_NOT_ALIGNED);
    ...
    ERRT("CHK.W A2,D7",              OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE A2,CCR",             OPERAND_NOT_ALLOWED);
    ...
    ERRT("MOVE ($001235).W,CCR",    OPERAND_NOT_ALIGNED);
    ERRT("MOVE ($234567).L,CCR",    OPERAND_NOT_ALIGNED);
    ERRT("MOVE (*+$1235,PC),CCR",   OPERAND_NOT_ALIGNED);
...
static void test_multiproc() {
    // TAS dst: 00453|M|Rn
    TEST("TAS D2",            0045302);
    ERRT("TAS A2",            OPERAND_NOT_ALLOWED);
    TEST("TAS (A2)",          0045322);
    TEST("TAS (A2)+",         0045332);
    TEST("TAS -(A2)",         0045342);
    ...
    ERRT("TAS (*+$1234,PC)",  OPERAND_NOT_ALLOWED);
    ERRT("TAS (*+$12,PC,D3)", OPERAND_NOT_ALLOWED);
    ERRT("TAS #$1234",        OPERAND_NOT_ALLOWED);
}
...
static void test_undefined_symbol() {
    ERUS("ORI  #UNDEF,CCR", 0000074, 0x0000);
    ERUS("ANDI #UNDEF,SR",  0001174, 0x0000);
    ERUS("MOVE (UNDEF),D1",       0031070, 0x0000);
    ERUS("MOVE #UNDEF,D1",        0031074, 0x0000);
    ERUS("MOVE D1,(UNDEF)",       0030701, 0x0000);
    ERUS("MOVE D2,(UNDEF,A3)",    0033502, 0x0000);
    ERUS("MOVE (UNDEF,A1,D2),D3", 0033061, 0x2000);
    ERUS("MOVEP D1,(UNDEF,A1)", 0001611, 0x0000);
    ERUS("MOVEP (UNDEF,A1),D1", 0001411, 0x0000);
    ERUS("MOVEQ #UNDEF,D1", 0071000);
    ERUS("ADDQ  #UNDEF,D1",     0050101);
    ERUS("ADDQ  #1,(UNDEF,A1)", 0051151, 0x0000);
    ERUS("LSR   #UNDEF,D1",  0160111);
    ERUS("ROR   (UNDEF,A1)", 0163351, 0x0000);

    AERRU(0x1000, "BRA UNDEF",      0060000);
    AERRU(0x1000, "DBRA  D0,UNDEF", 0050710, 0x0000);
    AERRU(0x1000, "MOVEA (UNDEF,PC),A1",      0031172, 0x0000);
