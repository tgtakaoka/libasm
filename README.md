...
It can generate Intel HEX or Motorola S-Record output.
    ...
    libasm assembler (version 1.6.65)
    usage: asm [-o <output>] [-l <list>] <input>
      -C <CPU>          : target CPU
         ...
         TLCS900 TLCS900L TLCS900H TLCS900H2 INS8060 INS8070 CP1600 CDP1802
         CDP1804 CDP1804A SCN2650 F3850 IM6100 HD6120 TMS7000 TMS370 TMS32010
         TMS32015 TMS32020 TMS320C25 TMS320C26 TMS320C20X TMS320C5X TMS320C30
         TMS320C31 TMS320C32 AM29030 AM29040 AM29050 AM29200 AM29240 AM29245
         i8086 i80186 i80286 i80386 i80486 V30 i8096 i80196 MC68000 MC68010
         MC68020 MC68030 MC68040 H16 H8/300 H8/300H H8S/2000 H8S/2600 H8/500
         H8/520 H8/530 SH-1 SH-2 SH-DSP SH-2E SH-2A TMS9900 TMS9980 TMS9995
      ...
      --fpu             : enable floating point instructions (bool: AM29200)
      ...
      --intmult         : enable integer multiply instructions (bool: AM29200)
      ...
      --silicon         : silicon revision (default C30 1, C31 5, C32 2) (int: 320C30)
...
It can read Intel HEX or Motorola S-Record input.
    ...
    libasm disassembler (version 1.6.65)
    usage: dis -C <CPU> [-o <output>] [-l <list>] <input>
      -C <CPU>         : target CPU
         ...
         TMS32015 TMS32020 TMS320C25 TMS320C26 TMS320C20X TMS320C5X TMS320C30
         TMS320C31 TMS320C32 AM29030 AM29040 AM29050 AM29200 AM29240 AM29245
         80960 i8086 i80186 i80286 i80386 i80486 V30 i8096 i80196 MC68000
         MC68010 MC68020 MC68030 MC68040 H16 H8/300 H8/300H H8S/2000 H8S/2600
         H8/500 H8/520 H8/530 SH-1 SH-2 SH-DSP SH-2E SH-2A TMS9900 TMS9980
      ...
      --intel-style    : Intel style hexadecimal/octal/binary (bool)
      --motorola-style : Motorola style hexadecimal/octal/binary (bool)
      --origin-char    : letter for origin symbol (char)
      --gnu-as         : GNU assembler compatible (bool)
      --advanced-mode  : H8/300H 24-bit advanced mode (bool: H8/300)
      --canonical-mem  : reject memory operand which has a shorter encoding (bool: 80960)
      --extern-symbol  : emit absolute branch target as A_XXXXXXXX symbol (bool: AM29200)
      --extern-symbol  : emit direct address as seg_SS_off_XXXX symbol (bool: Z8001)
      --external-paren : disp2(disp(ext)) as external addressing (bool: 32032)
      --extmode        : Extended mode (bool: Z380)
      --far-insn       : use callf/jmpf for far call/jump (bool: 8086)
      --fp-alias       : emit FP alias for R6 (bool: H8/500)
      --fpu            : enable 80960KB floating point and decimal instructions (bool: 80960)
      --fpu            : enable floating point instructions (bool: AM29200)
      --fpu            : floating point co-processor (text: 8086, 68000, SH-1, 32032)
      --indirect-long  : [] for indirect long operand (bool: 6502)
      --intmult        : enable integer multiply instructions (bool: AM29200)
      --ip-operand     : IP-relative operand: offset (default) or target (text: 80960)
      ...
      --lwordmode      : Long word mode (bool: Z380)
      --maximum-mode   : enable maximum mode (bool: TLCS900, H8/500)
      --mode-bits      : value of the mode bit of an unused operand field (int: 80960)
      --pc-alias       : decode R7 as PC (bool: CP1600)
      --pc-bits        : program counter width in bit (default 13) (int: 6805)
      --pmmu           : memory management unit (text: 68000, 32032)
      ...
      --silicon        : silicon revision (default C30 1, C31 5, C32 2) (int: 320C30)
      --sp-alias       : decode R6 as SP (bool: CP1600)
      --sp-alias       : emit SP alias for ER7/R7 in indirect addressing (bool: H8/300)
      --sp-alias       : emit SP alias for R7 in indirect addressing (bool: H8/500)
