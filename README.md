...
It can generate Intel HEX or Motorola S-Record output.
    ...
    usage: asm [-o <output>] [-l <list>] <input>
      -C <CPU>          : target CPU
         ...
         TLCS900 TLCS900L TLCS900H TLCS900L1 TLCS900H2 INS8060 INS8070 CDP1802
         ...
         TMS320C31 TMS320C32 i8086 i80186 i80286 V30 i8096 i80196 MC68000
         MC68010 MC68020 MC68030 MC68040 H8/300 H8/300H H8S/2000 H8S/2600
...
It can read Intel HEX or Motorola S-Record input.
    ...
    usage: dis -C <CPU> [-o <output>] [-l <list>] <input>
      -C <CPU>         : target CPU
         ...
         H8S/2600 TMS9900 TMS9980 TMS9995 TMS99105 TMS99110 Z8001 Z8002
      ...
      --sp-alias       : decode R6 as SP (bool: CP1600, H8/300)
