...
// clang-format off
static constexpr Entry TABLE_DCT11[] PROGMEM = {
    ...
    E1(0005700, SZ_WORD, TEXT_TST,   M_GEND, P_0077),
    E1(0105700, SZ_BYTE, TEXT_TSTB,  M_GEND, P_0077),
...
static constexpr uint8_t INDEX_DCT11[] PROGMEM = {
};

static constexpr Entry TABLE_DCJ11[] PROGMEM = {
    E2(0070000, SZ_INTG, TEXT_MUL,   M_GENS, P_0077, M_GENR, P_0700),
    E2(0071000, SZ_INTG, TEXT_DIV,   M_GENS, P_0077, M_GENR, P_0700),
    E2(0072000, SZ_INTG, TEXT_ASH,   M_GENS, P_0077, M_GENR, P_0700),
    E2(0073000, SZ_INTG, TEXT_ASHC,  M_GENS, P_0077, M_GENR, P_0700),
    ...
    E2(0174000, SZ_DUBL, TEXT_STD,   M_AC03, P_0300, M_GENG, P_0077),
    E2(0174000, SZ_FLOT, TEXT_STF,   M_AC03, P_0300, M_GENG, P_0077),
    E2(0175400, SZ_LONG, TEXT_STCDL, M_AC03, P_0300, M_GENG, P_0077),
    E2(0175400, SZ_INTG, TEXT_STCDI, M_AC03, P_0300, M_GENG, P_0077),
    E2(0175400, SZ_LONG, TEXT_STCFL, M_AC03, P_0300, M_GENG, P_0077),
    E2(0175400, SZ_INTG, TEXT_STCFI, M_AC03, P_0300, M_GENG, P_0077),
...
static constexpr uint8_t INDEX_DCJ11[] PROGMEM = {
};
// clang-format on
...
static constexpr EntryPage DCT11_PAGES[] PROGMEM = {
        {ARRAY_RANGE(TABLE_DCT11), ARRAY_RANGE(INDEX_DCT11)},
};

static constexpr EntryPage DCJ11_PAGES[] PROGMEM = {
        {ARRAY_RANGE(TABLE_DCT11), ARRAY_RANGE(INDEX_DCT11)},
        {ARRAY_RANGE(TABLE_DCJ11), ARRAY_RANGE(INDEX_DCJ11)},
};

using Cpu = entry::CpuBase<CpuType, EntryPage>;

static constexpr Cpu CPU_TABLE[] PROGMEM = {
        {DCT11, TEXT_CPU_DCT11, ARRAY_RANGE(DCT11_PAGES)},
        {DCJ11, TEXT_CPU_DCJ11, ARRAY_RANGE(DCJ11_PAGES)},
};
...
static Config::opcode_t getInsnMask(OprPos pos) {
    static constexpr Config::opcode_t MASKS[] = {
            00000,  // P_NONE
            00077,  // P_0077
            07700,  // P_7700
            00700,  // P_0700
...
static bool matchOpCode(DisInsn &insn, const Entry *entry, const EntryPage *page) {
    ...
    opc &= ~getInsnMask(flags.srcPos());
    opc &= ~getInsnMask(flags.dstPos());
...
Error TablePDP11::searchCpuName(StrScanner &name, CpuType &cpuType) const {
    ...
    if (name.iequals_P(TEXT_CPU_T11)) {
        cpuType = DCT11;
        return OK;
    }
    if (name.iequals_P(TEXT_CPU_J11)) {
        cpuType = DCJ11;
        return OK;
    }
