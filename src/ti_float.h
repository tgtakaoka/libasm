...
#define TI_FLT16_MAX_POS 255.94
#define TI_FLT16_MIN_POS 0.0078125
#define TI_FLT16_MIN_NEG -0.0078163
#define TI_FLT16_MAX_NEG -256
#define TI_FLT32_MAX_POS 3.4028234e+38
#define TI_FLT32_MIN_POS 5.8774717e-39
#define TI_FLT32_MAX_NEG -3.4028234e+38
#define TI_FLT32_MIN_NEG -5.8774717e-39
#define TI_FLT40_MAX_POS 3.4028234e+38
#define TI_FLT40_MIN_POS 5.8774717e-39
#define TI_FLT40_MAX_NEG -3.4028234e+38
#define TI_FLT40_MIN_NEG -5.8774717e-39
...
struct __ti_float16 {
    ...
    static constexpr auto SGN_POS = 11;
...
struct __ti_float32 {
    ...
    static uint16_t bits(bool sign, int8_t exp, uint32_t frac);

    const char *str() const;

    static constexpr auto EXP_POS = 24;
    static constexpr auto SGN_POS = 23;
    ...
    static constexpr auto FRAC_MASK = UINT16_C(0x007FFFFF);
