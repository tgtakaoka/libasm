...
static const Entry FORMAT_2_0[] PROGMEM = {
    ...
    E(0x0F, TEXT_ADDQD, LONG, M_INT4, M_GENW, P_SHORT, P_GEN1),
    E(0x1C, TEXT_CMPQB, BYTE, M_INT4, M_GENW, P_SHORT, P_GEN1),
    E(0x1D, TEXT_CMPQW, WORD, M_INT4, M_GENW, P_SHORT, P_GEN1),
    E(0x1F, TEXT_CMPQD, LONG, M_INT4, M_GENW, P_SHORT, P_GEN1),
    E(0x2C, TEXT_SPRB,  BYTE, M_PREG, M_GENW, P_SHORT, P_GEN1),
    E(0x2D, TEXT_SPRW,  WORD, M_PREG, M_GENW, P_SHORT, P_GEN1),
    E(0x2F, TEXT_SPRD,  LONG, M_PREG, M_GENW, P_SHORT, P_GEN1),
...
static const Entry FORMAT_2_5[] PROGMEM = {
    E(0x00, TEXT_SEQD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x01, TEXT_SCSD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x02, TEXT_SHID, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x03, TEXT_SGTD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x04, TEXT_SFSD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x05, TEXT_SLOD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x06, TEXT_SLTD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
};
static const Entry FORMAT_2_6[] PROGMEM = {
    E(0x00, TEXT_SNED, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x01, TEXT_SCCD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x02, TEXT_SLSD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x03, TEXT_SLED, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x04, TEXT_SFCD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x05, TEXT_SHSD, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
    E(0x06, TEXT_SGED, LONG, M_GENW, M_NONE, P_GEN1, P_NONE),
};
...
static const Entry FORMAT_3_3[] PROGMEM = {
    E(0x00, TEXT_CXPD,    LONG, M_GENA, M_NONE, P_GEN1, P_NONE),
    E(0x02, TEXT_JUMP,    LONG, M_GENA, M_NONE, P_GEN1, P_NONE),
    E(0x05, TEXT_ADJSPD,  LONG, M_GENR, M_NONE, P_GEN1, P_NONE),
    E(0x06, TEXT_JSR,     LONG, M_GENA, M_NONE, P_GEN1, P_NONE),
    E(0x07, TEXT_CASED,   LONG, M_GENR, M_NONE, P_GEN1, P_NONE),
};
...
static const Entry FORMAT_5_1[] PROGMEM = {
    ...
    E(0x03, TEXT_MOVSD,  LONG, M_SOPT, M_NONE, P_SHORT, P_NONE),
    ...
    E(0x07, TEXT_CMPSD,  LONG, M_SOPT, M_NONE, P_SHORT, P_NONE),
    ...
    E(0x0F, TEXT_SKPSD,  LONG, M_SOPT, M_NONE, P_SHORT, P_NONE),
...
static const Entry FORMAT_6[] PROGMEM = {
    ...
    E(0x03, TEXT_ROTD,   LONG, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x04, TEXT_ASHB,   BYTE, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x05, TEXT_ASHW,   WORD, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x07, TEXT_ASHD,   LONG, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x08, TEXT_CBITB,  BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x09, TEXT_CBITW,  WORD, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x0B, TEXT_CBITD,  LONG, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x0C, TEXT_CBITIB, BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x0D, TEXT_CBITIW, WORD, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x0F, TEXT_CBITID, LONG, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x14, TEXT_LSHB,   BYTE, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x15, TEXT_LSHW,   WORD, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x17, TEXT_LSHD,   LONG, M_GENC, M_GENW, P_GEN1, P_GEN2),
    E(0x18, TEXT_SBITB,  BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x19, TEXT_SBITW,  WORD, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x1B, TEXT_SBITD,  LONG, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x1C, TEXT_SBITIB, BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x1D, TEXT_SBITIW, WORD, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x1F, TEXT_SBITID, LONG, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x20, TEXT_NEGB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x21, TEXT_NEGW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x23, TEXT_NEGD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x24, TEXT_NOTB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x25, TEXT_NOTW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x27, TEXT_NOTD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2C, TEXT_SUBPB,  BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2D, TEXT_SUBPW,  WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2F, TEXT_SUBPD,  LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x30, TEXT_ABSB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x31, TEXT_ABSW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x33, TEXT_ABSD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x34, TEXT_COMB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x35, TEXT_COMW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x37, TEXT_COMD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x38, TEXT_IBITB,  BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x39, TEXT_IBITW,  WORD, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x3B, TEXT_IBITD,  LONG, M_GENR, M_GENA, P_GEN1, P_GEN2),
    E(0x3C, TEXT_ADDPB,  BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3D, TEXT_ADDPW,  WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3F, TEXT_ADDPD,  LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
};
...
static const Entry FORMAT_7[] PROGMEM = {
    ...
    X(0x03, TEXT_MOVMD,  LONG, M_GENA, M_GENA, P_GEN1, P_GEN2, M_LEN4,  M_NONE,  P_DISP, P_NONE),
    ...
    X(0x07, TEXT_CMPMD,  LONG, M_GENA, M_GENA, P_GEN1, P_GEN2, M_LEN4,  M_NONE,  P_DISP, P_NONE),
    X(0x08, TEXT_INSSB,  BYTE, M_GENR, M_GENA, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    X(0x09, TEXT_INSSW,  WORD, M_GENR, M_GENA, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    X(0x0B, TEXT_INSSD,  LONG, M_GENR, M_GENA, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    X(0x0C, TEXT_EXTSB,  BYTE, M_GENA, M_GENW, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    X(0x0D, TEXT_EXTSW,  WORD, M_GENA, M_GENW, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    X(0x0F, TEXT_EXTSD,  LONG, M_GENA, M_GENW, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    ...
    E(0x23, TEXT_MULD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x24, TEXT_MEIB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x25, TEXT_MEIW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x27, TEXT_MEID,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2C, TEXT_DEIB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2D, TEXT_DEIW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2F, TEXT_DEID,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x30, TEXT_QUOB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x31, TEXT_QUOW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x33, TEXT_QUOD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x34, TEXT_REMB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x35, TEXT_REMW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x37, TEXT_REMD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x38, TEXT_MODB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x39, TEXT_MODW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3B, TEXT_MODD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3C, TEXT_DIVB,   BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3D, TEXT_DIVW,   WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3F, TEXT_DIVD,   LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
};

// Format 8: |gen1_|gen| |2_|reg|o|ii| |op|10|1110|
static const Entry FORMAT_8_1[] PROGMEM = {
    X(0x00, TEXT_EXTB,   BYTE, M_GREG, M_GENA, P_REG, P_GEN1, M_GENW, M_LEN32, P_GEN2, P_DISP),
    X(0x01, TEXT_EXTW,   WORD, M_GREG, M_GENA, P_REG, P_GEN1, M_GENW, M_LEN32, P_GEN2, P_DISP),
    X(0x03, TEXT_EXTD,   LONG, M_GREG, M_GENA, P_REG, P_GEN1, M_GENW, M_LEN32, P_GEN2, P_DISP),
    ...
    X(0x07, TEXT_INDEXD, LONG, M_GREG, M_GENR, P_REG, P_GEN1, M_GENR, M_NONE,  P_GEN2, P_NONE),
};
static const Entry FORMAT_8_2[] PROGMEM = {
    X(0x03, TEXT_CVTP, LONG, M_GREG, M_GENA, P_REG,  P_GEN1,  M_GENW, M_NONE,  P_GEN2, P_NONE),
    E(0x04, TEXT_FFSB, BYTE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x05, TEXT_FFSW, WORD, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x07, TEXT_FFSD, LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
};
static const Entry FORMAT_8_3[] PROGMEM = {
    X(0x00, TEXT_INSB,   BYTE, M_GREG, M_GENR, P_REG, P_GEN1, M_GENA, M_LEN32, P_GEN2, P_DISP),
    X(0x01, TEXT_INSW,   WORD, M_GREG, M_GENR, P_REG, P_GEN1, M_GENA, M_LEN32, P_GEN2, P_DISP),
    X(0x03, TEXT_INSD,   LONG, M_GREG, M_GENR, P_REG, P_GEN1, M_GENA, M_LEN32, P_GEN2, P_DISP),
};
static const Entry FORMAT_8_3_1[] PROGMEM = {
    ...
    E(0x0F, TEXT_MOVSUD, LONG, M_GENA, M_GENA, P_GEN1, P_GEN2),
    E(0x1C, TEXT_MOVUSB, BYTE, M_GENA, M_GENA, P_GEN1, P_GEN2),
    E(0x1D, TEXT_MOVUSW, WORD, M_GENA, M_GENA, P_GEN1, P_GEN2),
    E(0x1F, TEXT_MOVUSD, LONG, M_GENA, M_GENA, P_GEN1, P_GEN2),
};
...
static const Entry FORMAT_9[] PROGMEM = {
    ...
    E(0x01, TEXT_MOVWL,   WORD,   M_GENR, M_FENW, P_GEN1, P_GEN2),
    E(0x03, TEXT_MOVDL,   LONG,   M_GENR, M_FENW, P_GEN1, P_GEN2),
    E(0x04, TEXT_MOVBF,   BYTE,   M_GENR, M_FENW, P_GEN1, P_GEN2),
    E(0x05, TEXT_MOVWF,   WORD,   M_GENR, M_FENW, P_GEN1, P_GEN2),
    E(0x07, TEXT_MOVDF,   LONG,   M_GENR, M_FENW, P_GEN1, P_GEN2),
    E(0x0F, TEXT_LFSR,    LONG,   M_GENR, M_NONE, P_GEN1, P_NONE),
    E(0x37, TEXT_SFSR,    LONG,   M_GENW, M_NONE, P_GEN2, P_NONE),
    E(0x16, TEXT_MOVLF,   DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x1B, TEXT_MOVFL,   FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x20, TEXT_ROUNDLB, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x21, TEXT_ROUNDLW, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x23, TEXT_ROUNDLD, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    ...
    E(0x28, TEXT_TRUNCLB, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x29, TEXT_TRUNCLW, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2B, TEXT_TRUNCLD, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    ...
    E(0x38, TEXT_FLOORLB, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x39, TEXT_FLOORLW, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
    E(0x3B, TEXT_FLOORLD, DOUBLE, M_FENR, M_GENW, P_GEN1, P_GEN2),
...
static const Entry FORMAT_11[] PROGMEM = {
    E(0x00, TEXT_ADDL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x01, TEXT_ADDF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x04, TEXT_MOVL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x05, TEXT_MOVF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x08, TEXT_CMPL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x09, TEXT_CMPF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x10, TEXT_SUBL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x11, TEXT_SUBF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x14, TEXT_NEGL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x15, TEXT_NEGF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x20, TEXT_DIVL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x21, TEXT_DIVF, FLOAT,  M_FENR, M_FENW, P_GEN1, P_GEN2),
    E(0x30, TEXT_MULL, DOUBLE, M_FENR, M_FENW, P_GEN1, P_GEN2),
...
static const Entry FORMAT_14_1[] PROGMEM = {
    ...
    E(0x07, TEXT_WRVAL, LONG, M_GENA, M_NONE, P_GEN1,  P_NONE),
};
