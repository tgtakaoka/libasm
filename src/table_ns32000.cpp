...
static const Entry FORMAT_4[] PROGMEM = {
    ...
    E(0x37, TEXT_TBITD,  LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
...
static const Entry FORMAT_2_0[] PROGMEM = {
    ...
    E(0x1F, TEXT_CMPQD, LONG, M_INT4, M_GENR, P_SHORT, P_GEN1),
...
static const Entry FORMAT_6[] PROGMEM = {
    ...
    E(0x3B, TEXT_IBITD,  LONG, M_GENR, M_GENW, P_GEN1, P_GEN2),
...
static const Entry FORMAT_7[] PROGMEM = {
    ...
    X(0x0B, TEXT_INSSD,  LONG, M_GENR, M_GENW, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
    ...
    X(0x0F, TEXT_EXTSD,  LONG, M_GENW, M_GENW, P_GEN1, P_GEN2, M_BFOFF, M_BFLEN, P_IMPL, P_IMPL),
...
static const Entry FORMAT_8_1[] PROGMEM = {
    ...
    X(0x03, TEXT_EXTD,   LONG, M_GREG, M_GENW, P_REG, P_GEN1, M_GENW, M_LEN32, P_GEN2, P_DISP),
...
static const Entry FORMAT_8_3[] PROGMEM = {
    ...
    X(0x03, TEXT_INSD,   LONG, M_GREG, M_GENR, P_REG, P_GEN1, M_GENW, M_LEN32, P_GEN2, P_DISP),
};
...
static const Entry FORMAT_11[] PROGMEM = {
    ...
    E(0x08, TEXT_CMPL, DOUBLE, M_FENR, M_FENR, P_GEN1, P_GEN2),
