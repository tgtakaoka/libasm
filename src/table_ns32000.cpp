...
static const Entry FORMAT_7[] PROGMEM = {
    ...
    E(0x27, TEXT_MEID,   DOUBLE, M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2C, TEXT_DEIB,   BYTE,   M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2D, TEXT_DEIW,   WORD,   M_GENR, M_GENW, P_GEN1, P_GEN2),
    E(0x2F, TEXT_DEID,   DOUBLE, M_GENR, M_GENW, P_GEN1, P_GEN2),
...
static const Entry FORMAT_9[] PROGMEM = {
    ...
    E(0x03, TEXT_MOVDL,   DOUBLE, M_GENR, M_FENW, P_GEN1, P_GEN2),
    ...
    E(0x16, TEXT_MOVLF,   LONG,   M_FENR, M_FENW, P_GEN1, P_GEN2),
