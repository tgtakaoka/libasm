...
static constexpr uint16_t PM_BIT(PrefixMode pm) { return uint16_t(1) << pm; }
static constexpr uint16_t PM_BITS_REG =
        PM_BIT(PM_REG8)  | PM_BIT(PM_REG16)  | PM_BIT(PM_REG32);
static constexpr uint16_t PM_BITS_ABREG =
        PM_BIT(PM_ABREG8) | PM_BIT(PM_ABREG16) | PM_BIT(PM_ABREG32);
static constexpr uint16_t PM_BITS_MEM =
        PM_BIT(PM_MEM8)  | PM_BIT(PM_MEM16)  | PM_BIT(PM_MEM32);
...
struct EntryPage : entry::PrefixTableBase<Entry> {
    ...
    constexpr EntryPage(uint16_t pm_mask, uint16_t prefix,
            const Entry *head_P, const Entry *tail_P,
...
constexpr Cpu CPU_TABLE[] PROGMEM = {
    ...
    {TLCS900L1, TEXT_CPU_TLCS900L1, ARRAY_RANGE(TLCS900H_PAGES)},
};
// clang-format on
...
static AddrMode resolveMode(
        AddrMode expected, PrefixMode pm, bool dstSlot, const Operand &op) {
    switch (expected) {
    case M_DST:
        switch (pm) {
        case PM_REG8: case PM_MEM8: case PM_ABREG8:    return M_REG8;
        case PM_REG16: case PM_MEM16: case PM_ABREG16: return M_REG16;
        case PM_REG32: case PM_MEM32: case PM_ABREG32: return M_REG32;
        default: return expected;
        }
    case M_SRC:
        switch (pm) {
        case PM_REG8:    return M_REG8;
        case PM_REG16:   return M_REG16;
        case PM_REG32:   return M_REG32;
        case PM_ABREG8:  return M_ABREG8;
        case PM_ABREG16: return M_ABREG16;
        case PM_ABREG32: return M_ABREG32;
        case PM_MEM8: case PM_MEM16: case PM_MEM32:
    ...
    case M_IMMX:
        switch (pm) {
        case PM_REG8: case PM_MEM8: case PM_ABREG8:    return M_IMM8;
        case PM_REG16: case PM_MEM16: case PM_ABREG16: return M_IMM16;
        case PM_REG32: case PM_MEM32: case PM_ABREG32: return M_IMM32;
        default: return M_IMM8;
        }
    default:
        return expected;
    }
...
static bool acceptMode(
        const Operand &op, AddrMode expected, PrefixMode pm, bool dstSlot) {
...
static bool prefixMatcher(DisInsn &insn, const EntryPage *page) {
    ...
    if (prefix > UINT8_MAX) {
        ...
        pm = PM_LDAR;
            ...
            !isPrefix(TLCS900, static_cast<Config::opcode_t>(prefix), pm)) {
        return false;
    }
    if ((mask & PM_BIT(pm)) == 0)
        return false;
