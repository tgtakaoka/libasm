...
#define E2(_opc, _mask, _name, _dst, _src) {_opc, _mask, Entry::Flags::create(_dst, _src), _name}
...
constexpr Entry TABLE_Z80[] PROGMEM = {
    ...
    E2(0x01, 0060, TEXT_LD,   M_R16, M_IM16),
    E2(0x09, 0060, TEXT_ADD,  R_HL,  M_R16),
    E2(0x02, 0020, TEXT_LD,   I_PTR, R_A),
    E2(0x0A, 0020, TEXT_LD,   R_A,   I_PTR),
    E2(0x22, 0000, TEXT_LD,   M_ABS, R_HL),
    E2(0x2A, 0000, TEXT_LD,   R_HL,  M_ABS),
    E2(0x32, 0000, TEXT_LD,   M_ABS, R_A),
    E2(0x3A, 0000, TEXT_LD,   R_A,   M_ABS),
    ...
    E1(0xC1, 0060, TEXT_POP,  M_STK),
    E0(0xC9, 0000, TEXT_RET),
    E2(0xF9, 0000, TEXT_LD,   R_SP,  R_HL),
    E2(0xC2, 0070, TEXT_JP,   M_CC8, M_IM16),
    E1(0xC3, 0000, TEXT_JP,   M_IM16),
    E1(0xE9, 0000, TEXT_JP,   I_HL),
    E2(0xD3, 0000, TEXT_OUT,  M_IOA, R_A),
    E2(0xDB, 0000, TEXT_IN,   R_A,   M_IOA),
    E2(0xE3, 0000, TEXT_EX,   I_SP,  R_HL),
    E2(0xE3, 0000, TEXT_EX,   R_HL,  I_SP),
    E2(0xEB, 0000, TEXT_EX,   R_DE,  R_HL),
    E2(0xEB, 0000, TEXT_EX,   R_HL,  R_DE),
    E0(0xF3, 0000, TEXT_DI),
    E0(0xFB, 0000, TEXT_EI),
    E2(0xC4, 0070, TEXT_CALL, M_CC8, M_IM16),
    E1(0xC5, 0060, TEXT_PUSH, M_STK),
    E1(0xCD, 0000, TEXT_CALL, M_IM16),
...
constexpr Entry TABLE_IDX[] PROGMEM = {
    ...
    E2(0x21, 0000, TEXT_LD,   R_IDX,  M_IM16),
    E2(0x22, 0000, TEXT_LD,   M_ABS,  R_IDX),
    E2(0x2A, 0000, TEXT_LD,   R_IDX,  M_ABS),
    E1(0x23, 0000, TEXT_INC,  R_IDX),
    E1(0x2B, 0000, TEXT_DEC,  R_IDX),
    E1(0x34, 0000, TEXT_INC,  M_IDX8),
    E1(0x35, 0000, TEXT_DEC,  M_IDX8),
    E2(0x36, 0000, TEXT_LD,   M_IDX8, M_IM8),
    E2(0x46, 0070, TEXT_LD,   M_DR8,  M_IDX8),
    E2(0x70, 0007, TEXT_LD,   M_IDX8, M_SR8),
    E2(0x86, 0000, TEXT_ADD,  R_A,    M_IDX8),
    E2(0x8E, 0000, TEXT_ADC,  R_A,    M_IDX8),
    E2(0x96, 0000, TEXT_SUB,  R_A,    M_IDX8),
    E1(0x96, 0000, TEXT_SUB,  M_IDX8),
    E2(0x9E, 0000, TEXT_SBC,  R_A,    M_IDX8),
    E2(0xA6, 0000, TEXT_AND,  R_A,    M_IDX8),
    E1(0xA6, 0000, TEXT_AND,  M_IDX8),
    E2(0xAE, 0000, TEXT_XOR,  R_A,    M_IDX8),
    E1(0xAE, 0000, TEXT_XOR,  M_IDX8),
    E2(0xB6, 0000, TEXT_OR,   R_A,    M_IDX8),
    E1(0xB6, 0000, TEXT_OR,   M_IDX8),
    E2(0xBE, 0000, TEXT_CP,   R_A,    M_IDX8),
    E1(0xBE, 0000, TEXT_CP,   M_IDX8),
    E1(0xE1, 0000, TEXT_POP,  R_IDX),
    E1(0xE9, 0000, TEXT_JP,   I_IDX),
    E2(0xF9, 0000, TEXT_LD,   R_SP,   R_IDX),
    E2(0xE3, 0000, TEXT_EX,   I_SP,   R_IDX),
    E2(0xE3, 0000, TEXT_EX,   R_IDX,  I_SP),
    E1(0xE5, 0000, TEXT_PUSH, R_IDX),
};
...
constexpr Entry TABLE_IDXBIT[] PROGMEM = {
    E1(0x06, 0000, TEXT_RLC, M_IDX),
    E1(0x0E, 0000, TEXT_RRC, M_IDX),
    E1(0x16, 0000, TEXT_RL,  M_IDX),
    E1(0x1E, 0000, TEXT_RR,  M_IDX),
    E1(0x26, 0000, TEXT_SLA, M_IDX),
    E1(0x2E, 0000, TEXT_SRA, M_IDX),
    E1(0x3E, 0000, TEXT_SRL, M_IDX),
    E2(0x46, 0070, TEXT_BIT, M_BIT, M_IDX),
    E2(0x86, 0070, TEXT_RES, M_BIT, M_IDX),
    E2(0xC6, 0070, TEXT_SET, M_BIT, M_IDX),
};
...
constexpr Entry TABLE_Z280_EXT[] PROGMEM = {
    ...
    E2(0x6B, 0000, TEXT_LDW,    R_HL,   M_ABS),
...
constexpr Entry TABLE_Z380_EXT[] PROGMEM = {
    ...
    E2(0x05, 0000, TEXT_EX,    R_BC,    R_DE),
    E2(0x05, 0000, TEXT_EX,    R_DE,    R_BC),
    E2(0x07, 0070, TEXT_EX,    R_A,     M_DST),
    E2(0x07, 0070, TEXT_EX,    M_DR8,   R_A),
    E2(0x0D, 0000, TEXT_EX,    R_BC,    R_HL),
    E2(0x0D, 0000, TEXT_EX,    R_HL,    R_BC),
    E2(0x06, 0020, TEXT_LDW,   I_PTR,   M_IM16),
    E2(0x36, 0000, TEXT_LDW,   I_HL,    M_IM16),
    E2(0x02, 0020, TEXT_LDW,   R_PTRH,  R_BC),
    E2(0x32, 0000, TEXT_LDW,   R_HL,    R_BC),
    E2(0x02, 0020, TEXT_LD,    R_PTRH,  R_BC),
    E2(0x32, 0000, TEXT_LD,    R_HL,    R_BC),
    E2(0x03, 0020, TEXT_EX,    R_PTRH,  R_IX),
    E2(0x03, 0020, TEXT_EX,    R_IX,    R_PTRH),
    E2(0x33, 0000, TEXT_EX,    R_HL,    R_IX),
    E2(0x33, 0000, TEXT_EX,    R_IX,    R_HL),
    E2(0x0B, 0020, TEXT_EX,    R_PTRH,  R_IY),
    E2(0x0B, 0020, TEXT_EX,    R_IY,    R_PTRH),
    E2(0x3B, 0000, TEXT_EX,    R_HL,    R_IY),
    E2(0x3B, 0000, TEXT_EX,    R_IY,    R_HL),
    E2(0x2B, 0000, TEXT_EX,    R_IX,    R_IY),
    E2(0x2B, 0000, TEXT_EX,    R_IY,    R_IX),
    E1(0x0E, 0020, TEXT_SWAP,  R_PTRH),
    E1(0x3E, 0000, TEXT_SWAP,  R_HL),
    E2(0x63, 0000, TEXT_LDW,   M_ABS,   R_HL),
    E1(0x65, 0000, TEXT_EXTS,  R_A),
    ...
    E2(0x82, 0000, TEXT_ADD,   R_SP,    M_IM16),
    E2(0x92, 0000, TEXT_SUB,   R_SP,    M_IM16),
    E2(0xC0, 0000, TEXT_LDCTL, R_HL,    R_SR),
    E2(0xC8, 0000, TEXT_LDCTL, R_SR,    R_HL),
    E2(0xC6, 0000, TEXT_ADD,   R_HL,    M_ABS),
    E2(0xD6, 0000, TEXT_SUB,   R_HL,    M_ABS),
    ...
    E1(0xC1, 0000, TEXT_POP,   R_SR),
    E1(0xC5, 0000, TEXT_PUSH,  R_SR),
...
constexpr Entry TABLE_Z380_IDX[] PROGMEM = {
    E1(0x34, 0000, TEXT_INC,  M_IDX),
    E1(0x35, 0000, TEXT_DEC,  M_IDX),
    E2(0x36, 0000, TEXT_LD,   M_IDX,  M_IM8),
    E2(0x46, 0070, TEXT_LD,   M_DR8,  M_IDX),
    E2(0x70, 0007, TEXT_LD,   M_IDX,  M_SR8),
    E2(0x86, 0000, TEXT_ADD,  R_A,    M_IDX),
    E2(0x8E, 0000, TEXT_ADC,  R_A,    M_IDX),
    E2(0x96, 0000, TEXT_SUB,  R_A,    M_IDX),
    E2(0x9E, 0000, TEXT_SBC,  R_A,    M_IDX),
    E2(0xA6, 0000, TEXT_AND,  R_A,    M_IDX),
    E2(0xAE, 0000, TEXT_XOR,  R_A,    M_IDX),
    E2(0xB6, 0000, TEXT_OR,   R_A,    M_IDX),
    E2(0xBE, 0000, TEXT_CP,   R_A,    M_IDX),
    E2(0x01, 0020, TEXT_LDW,  I_PTR,  R_IDX),
    E2(0x31, 0000, TEXT_LDW,  I_HL,   R_IDX),
    E2(0x03, 0020, TEXT_LDW,  R_IDX,  I_PTR),
    E2(0x33, 0000, TEXT_LDW,  R_IDX,  I_HL),
    E2(0x07, 0020, TEXT_LDW,  R_IDX,  R_PTRH),
    E2(0x37, 0000, TEXT_LDW,  R_IDX,  R_HL),
    E2(0x0B, 0020, TEXT_LDW,  R_PTRH, R_IDX),
    E2(0x3B, 0000, TEXT_LDW,  R_HL,   R_IDX),
    E2(0x01, 0020, TEXT_LD,   I_PTR,  R_IDX),
    E2(0x31, 0000, TEXT_LD,   I_HL,   R_IDX),
    E2(0x03, 0020, TEXT_LD,   R_IDX,  I_PTR),
    E2(0x33, 0000, TEXT_LD,   R_IDX,  I_HL),
    E2(0x07, 0020, TEXT_LD,   R_IDX,  R_PTRH),
    E2(0x37, 0000, TEXT_LD,   R_IDX,  R_HL),
    E2(0x0B, 0020, TEXT_LD,   R_PTRH, R_IDX),
    E2(0x3B, 0000, TEXT_LD,   R_HL,   R_IDX),
    E1(0x23, 0000, TEXT_INC,  R_IDX),
    E1(0x23, 0000, TEXT_INCW, R_IDX),
    E1(0x24, 0010, TEXT_INC,  R_DXY),
    E2(0x26, 0010, TEXT_LD,   R_DXY,  M_IM8),
    ...
    E2(0xC6, 0000, TEXT_ADDW, R_HL,   M_IDX),
    E2(0xCE, 0000, TEXT_ADCW, R_HL,   M_IDX),
    E2(0xD6, 0000, TEXT_SUBW, R_HL,   M_IDX),
    E2(0xDE, 0000, TEXT_SBCW, R_HL,   M_IDX),
    E2(0xE6, 0000, TEXT_ANDW, R_HL,   M_IDX),
    E2(0xEE, 0000, TEXT_XORW, R_HL,   M_IDX),
    E2(0xF6, 0000, TEXT_ORW,  R_HL,   M_IDX),
    E2(0xFE, 0000, TEXT_CPW,  R_HL,   M_IDX),
    E1(0x86, 0000, TEXT_ADD,  M_IDX),
    E1(0x8E, 0000, TEXT_ADC,  M_IDX),
    E1(0x96, 0000, TEXT_SUB,  M_IDX),
    E1(0x9E, 0000, TEXT_SBC,  M_IDX),
    E1(0x96, 0000, TEXT_SUB,  M_IDX),
    E1(0xA6, 0000, TEXT_AND,  M_IDX),
    E1(0xAE, 0000, TEXT_XOR,  M_IDX),
    E1(0xB6, 0000, TEXT_OR,   M_IDX),
    E1(0xBE, 0000, TEXT_CP,   M_IDX),
    E1(0x84, 0001, TEXT_ADD,  R_SXY),
    E1(0x8C, 0001, TEXT_ADC,  R_SXY),
    E1(0x94, 0001, TEXT_SUB,  R_SXY),
    E1(0x9C, 0001, TEXT_SBC,  R_SXY),
    ...
    E1(0xC6, 0000, TEXT_ADDW, M_IDX),
    E1(0xCE, 0000, TEXT_ADCW, M_IDX),
    E1(0xD6, 0000, TEXT_SUBW, M_IDX),
    E1(0xDE, 0000, TEXT_SBCW, M_IDX),
    E1(0xE6, 0000, TEXT_ANDW, M_IDX),
    E1(0xEE, 0000, TEXT_XORW, M_IDX),
    E1(0xF6, 0000, TEXT_ORW,  M_IDX),
    E1(0xFE, 0000, TEXT_CPW,  M_IDX),
};
...
constexpr Entry TABLE_Z380_IX[] PROGMEM = {
    ...
    E1(0x10, 0000, TEXT_DJNZ,  M_REL16),
    E2(0x02, 0020, TEXT_LDW,   R_PTRH, R_DE),
    E2(0x32, 0000, TEXT_LDW,   R_HL,   R_DE),
    E2(0x0C, 0021, TEXT_LDW,   R_PTRH, I_PTRL),
    E2(0x0F, 0020, TEXT_LDW,   R_PTRH, I_HL),
    E2(0x27, 0000, TEXT_LDW,   R_IX,   R_IY),
    E2(0x3C, 0001, TEXT_LDW,   R_HL,   I_PTRL),
    E2(0x3F, 0000, TEXT_LDW,   R_HL,   I_HL),
    E2(0x02, 0020, TEXT_LD,    R_PTRH, R_DE),
    E2(0x32, 0000, TEXT_LD,    R_HL,   R_DE),
    E2(0x0C, 0021, TEXT_LD,    R_PTRH, I_PTRL),
    E2(0x0F, 0020, TEXT_LD,    R_PTRH, I_HL),
    E2(0x27, 0000, TEXT_LD,    R_IX,   R_IY),
    E2(0x3C, 0001, TEXT_LD,    R_HL,   I_PTRL),
    E2(0x3F, 0000, TEXT_LD,    R_HL,   I_HL),
    E1(0x2F, 0000, TEXT_CPLW,  R_HL),
    E1(0xC0, 0000, TEXT_DDIR,  M_DD),
    E1(0xF3, 0000, TEXT_DI,    M_IM8),
    E1(0xFB, 0000, TEXT_EI,    M_IM8),
    E1(0xF7, 0000, TEXT_SETC,  M_LCK),
    E1(0xFF, 0000, TEXT_RESC,  M_LCK),
    E2(0x47, 0000, TEXT_LDW,   R_I,    R_HL),
    E2(0x57, 0000, TEXT_LDW,   R_HL,   R_I),
    E2(0x47, 0000, TEXT_LD,    R_I,    R_HL),
    E2(0x57, 0000, TEXT_LD,    R_HL,   R_I),
...
constexpr Entry TABLE_Z380_IY[] PROGMEM = {
    ...
    E2(0x02, 0020, TEXT_LDW,   R_PTRH, R_HL),
    E2(0x27, 0000, TEXT_LDW,   R_IY,   R_IX),
    E2(0x32, 0000, TEXT_LDW,   R_HL,   R_HL),
    E2(0x0C, 0021, TEXT_LDW,   I_PTRL, R_PTRH),
    E2(0x3C, 0001, TEXT_LDW,   I_PTRL, R_HL),
    E2(0x0F, 0020, TEXT_LDW,   I_HL,   R_PTRH),
    E2(0x3F, 0000, TEXT_LDW,   I_HL,   R_HL),
    E2(0x02, 0020, TEXT_LD,    R_PTRH, R_HL),
    E2(0x27, 0000, TEXT_LD,    R_IY,   R_IX),
    E2(0x32, 0000, TEXT_LD,    R_HL,   R_HL),
    E2(0x0C, 0021, TEXT_LD,    I_PTRL, R_PTRH),
    E2(0x3C, 0001, TEXT_LD,    I_PTRL, R_HL),
    E2(0x0F, 0020, TEXT_LD,    I_HL,   R_PTRH),
    E2(0x3F, 0000, TEXT_LD,    I_HL,   R_HL),
    ...
    E2(0xD3, 0000, TEXT_OUTAW, M_IO16, R_HL),
    E2(0xDB, 0000, TEXT_INAW,  R_HL,   M_IO16),
    E1(0xF5, 0000, TEXT_PUSH,  M_IM16),
...
constexpr Entry TABLE_Z380_BIT[] PROGMEM = {
    E2(0x30, 0007, TEXT_EX,     M_SR8,  R_ALT),
};
...
constexpr Entry TABLE_Z380_EXTBIT[] PROGMEM = {
    E2(0x30, 0001, TEXT_EX,     R_PTRL, R_ALT),
    E2(0x33, 0000, TEXT_EX,     R_HL,   R_ALT),
    E2(0x34, 0001, TEXT_EX,     R_IDXL, R_ALT),
...
constexpr Entry TABLE_Z380_IDXBIT[] PROGMEM = {
    E2(0x01, 0020, TEXT_LDW,    R_PTRH, M_SPX),
    E2(0x21, 0000, TEXT_LDW,    R_IDX,  M_SPX),
    E2(0x31, 0000, TEXT_LDW,    R_HL,   M_SPX),
    E2(0x09, 0020, TEXT_LDW,    M_SPX,  R_PTRH),
    E2(0x29, 0000, TEXT_LDW,    M_SPX,  R_IDX),
    E2(0x39, 0000, TEXT_LDW,    M_SPX,  R_HL),
    E2(0x03, 0020, TEXT_LDW,    R_PTRH, M_IDX),
    E2(0x33, 0000, TEXT_LDW,    R_HL,   M_IDX),
    E2(0x0B, 0020, TEXT_LDW,    M_IDX,  R_PTRH),
    E2(0x2B, 0000, TEXT_LDW,    M_IDX,  R_IY),
    E2(0x3B, 0000, TEXT_LDW,    M_IDX,  R_HL),
    E2(0x01, 0020, TEXT_LD,     R_PTRH, M_SPX),
    E2(0x21, 0000, TEXT_LD,     R_IDX,  M_SPX),
    E2(0x31, 0000, TEXT_LD,     R_HL,   M_SPX),
    E2(0x09, 0020, TEXT_LD,     M_SPX,  R_PTRH),
    E2(0x29, 0000, TEXT_LD,     M_SPX,  R_IDX),
    E2(0x39, 0000, TEXT_LD,     M_SPX,  R_HL),
    E2(0x03, 0020, TEXT_LD,     R_PTRH, M_IDX),
    E2(0x33, 0000, TEXT_LD,     R_HL,   M_IDX),
    E2(0x0B, 0020, TEXT_LD,     M_IDX,  R_PTRH),
    E2(0x2B, 0000, TEXT_LD,     M_IDX,  R_IY),
    E2(0x3B, 0000, TEXT_LD,     M_IDX,  R_HL),
    E1(0x02, 0000, TEXT_RLCW,   M_IDX),
    E1(0x0A, 0000, TEXT_RRCW,   M_IDX),
    E1(0x12, 0000, TEXT_RLW,    M_IDX),
    E1(0x1A, 0000, TEXT_RRW,    M_IDX),
    E1(0x22, 0000, TEXT_SLAW,   M_IDX),
    E1(0x2A, 0000, TEXT_SRAW,   M_IDX),
    E1(0x3A, 0000, TEXT_SRLW,   M_IDX),
    E2(0x92, 0000, TEXT_MULTW,  R_HL,   M_IDX),
    E2(0x9A, 0000, TEXT_MULTUW, R_HL,   M_IDX),
    E2(0xBA, 0000, TEXT_DIVUW,  R_HL,   M_IDX),
    E1(0x92, 0000, TEXT_MULTW,  M_IDX),
    E1(0x9A, 0000, TEXT_MULTUW, M_IDX),
    E1(0xBA, 0000, TEXT_DIVUW,  M_IDX),
};
...
constexpr Entry TABLE_Z380_IXBIT[] PROGMEM = {
    E2(0x23, 0000, TEXT_LDW,   R_IY,   M_IDX),
    E2(0x2B, 0000, TEXT_LDW,   M_IDX,  R_IY),
    E2(0x23, 0000, TEXT_LD,    R_IY,   M_IDX),
    E2(0x2B, 0000, TEXT_LD,    M_IDX,  R_IY),
};
...
constexpr Entry TABLE_Z380_IYBIT[] PROGMEM = {
    E2(0x23, 0000, TEXT_LDW,   R_IX,   M_IDX),
    E2(0x2B, 0000, TEXT_LDW,   M_IDX,  R_IX),
    E2(0x23, 0000, TEXT_LD,    R_IX,   M_IDX),
    E2(0x2B, 0000, TEXT_LD,    M_IDX,  R_IX),
};
...
bool acceptMode(AddrMode opr, AddrMode table) {
    ...
    if (opr == M_ABS)
        return table == M_IOA || table == M_IO16 || table == M_MPTR;
    if (opr == M_CC4)
        return table == M_CC8;
    return false;
}
