...
#define X3(_opc, _cf, _name, _sz, _dst, _src, _ext, _dpos, _spos, _epos, _nsz) \
    {_opc, Entry::Flags::create(_cf, _dst, _src, _ext, _dpos, _spos, _epos, _sz, _nsz), _name}
#define X2(_opc, _cf, _name, _sz, _dst, _src, _nsz) \
    {_opc, Entry::Flags::strInst(_cf, _dst, _src, _sz, _nsz), _name}
...
#define S2(_opc, _cf, _name, _sz, _dst, _src) X2(_opc, _cf, _name, _sz, _dst, _src, false)
...
#define T2(_opc, _cf, _name, _sz, _dst, _src) X2(_opc, _cf, _name, _sz, _dst, _src, true)
...
constexpr Entry T8086_00[] PROGMEM = {
    ...
    E2(0x01, CF_00, TEXT_ADD,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E2(0x09, CF_00, TEXT_OR,     SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E2(0x11, CF_00, TEXT_ADC,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E2(0x19, CF_00, TEXT_SBB,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E2(0x21, CF_00, TEXT_AND,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E0(0x26, CF_00, TEXT_SEGES,  SZ_NONE),
    E0(0x27, CF_00, TEXT_DAA,    SZ_NONE),
    E2(0x28, CF_00, TEXT_SUB,    SZ_BYTE, M_BMOD, M_BREG, P_MOD,  P_REG),
    E2(0x2A, CF_00, TEXT_SUB,    SZ_BYTE, M_BREG, M_BMOD, P_REG,  P_MOD),
    E2(0x29, CF_00, TEXT_SUB,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E0(0x2E, CF_00, TEXT_SEGCS,  SZ_NONE),
    E0(0x2F, CF_00, TEXT_DAS,    SZ_NONE),
    E2(0x30, CF_00, TEXT_XOR,    SZ_BYTE, M_BMOD, M_BREG, P_MOD,  P_REG),
    E2(0x32, CF_00, TEXT_XOR,    SZ_BYTE, M_BREG, M_BMOD, P_REG,  P_MOD),
    E2(0x31, CF_00, TEXT_XOR,    SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    ...
    E2(0x87, CF_00, TEXT_XCHG,   SZ_DATA, M_WMOD, M_WREG, P_MOD,  P_REG),
    E2(0x87, CF_00, TEXT_XCHG,   SZ_DATA, M_WREG, M_WMOD, P_REG,  P_MOD),
...
constexpr Entry T8086_80[] PROGMEM = {
    N2(000, CF_00, TEXT_ADD, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(010, CF_00, TEXT_OR,  SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(020, CF_00, TEXT_ADC, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(030, CF_00, TEXT_SBB, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(040, CF_00, TEXT_AND, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(050, CF_00, TEXT_SUB, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
    N2(060, CF_00, TEXT_XOR, SZ_BYTE, M_BMOD, M_WIMM, P_OMOD, P_OPR),
...
constexpr Entry T8086_81[] PROGMEM = {
    N2(000, CF_00, TEXT_ADD, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(010, CF_00, TEXT_OR,  SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(020, CF_00, TEXT_ADC, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(030, CF_00, TEXT_SBB, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(040, CF_00, TEXT_AND, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(050, CF_00, TEXT_SUB, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(060, CF_00, TEXT_XOR, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
    N2(070, CF_00, TEXT_CMP, SZ_DATA, M_WMOD, M_WIMM, P_OMOD, P_OPR),
};

constexpr Entry T8086_83[] PROGMEM = {
    N2(000, CF_00, TEXT_ADD, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(010, CF_00, TEXT_OR,  SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(020, CF_00, TEXT_ADC, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(030, CF_00, TEXT_SBB, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(040, CF_00, TEXT_AND, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(050, CF_00, TEXT_SUB, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
    N2(060, CF_00, TEXT_XOR, SZ_DATA, M_WMOD, M_BIMM, P_OMOD, P_OPR),
...
constexpr Entry T8086_F6[] PROGMEM = {
    ...
    N1(020, CF_00, TEXT_NOT,  SZ_BYTE, M_BMOD, P_OMOD),
    N1(030, CF_00, TEXT_NEG,  SZ_BYTE, M_BMOD, P_OMOD),
...
constexpr Entry T8086_F7[] PROGMEM = {
    ...
    N1(020, CF_00, TEXT_NOT,  SZ_DATA, M_WMOD, P_OMOD),
    N1(030, CF_00, TEXT_NEG,  SZ_DATA, M_WMOD, P_OMOD),
...
constexpr Entry T8086_FE[] PROGMEM = {
    N1(000, CF_00, TEXT_INC, SZ_BYTE, M_BMOD, P_OMOD),
    N1(010, CF_00, TEXT_DEC, SZ_BYTE, M_BMOD, P_OMOD),
};
...
constexpr Entry T8086_FF[] PROGMEM = {
    N1(000, CF_00, TEXT_INC,   SZ_WORD, M_WMOD, P_OMOD),
    N1(010, CF_00, TEXT_DEC,   SZ_WORD, M_WMOD, P_OMOD),
...
constexpr Entry T80386_FF[] PROGMEM = {
    N1(000, CF_00, TEXT_INC,   SZ_DATA, M_WMOD, P_OMOD),
    N1(010, CF_00, TEXT_DEC,   SZ_DATA, M_WMOD, P_OMOD),
