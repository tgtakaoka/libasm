...
extern const char OPT_BOOL_MAXIMUM_MODE[] PROGMEM;
extern const char OPT_DESC_MAXIMUM_MODE[] PROGMEM;
...
extern const char TEXT_POPW[] PROGMEM;
using common::TEXT_PUSH;
extern const char TEXT_PUSHW[]  PROGMEM;
...
extern const char TEXT_SLLW[] PROGMEM;
...
extern const char TEXT_REG_XNSP[] PROGMEM;
extern const char TEXT_REG_INTNEST[] PROGMEM;
