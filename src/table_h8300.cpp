...
SuperPrefix toSuperPrefix(CpuType cpuType, Config::opcode_t code) {
    if (cpuType == H8300)
        return SPRX_NONE;
    switch (code) {
    case 0x0100: return SPRX_0100;
    case 0x0140: return SPRX_0140;
    case 0x0141: return (cpuType == H8S2000 || cpuType == H8S2600) ? SPRX_0141 : SPRX_NONE;
    default:     return SPRX_NONE;
    }
}

Config::opcode_t fromSuperPrefix(SuperPrefix rprx) {
    switch (rprx) {
    case SPRX_0100: return 0x0100;
    case SPRX_0140: return 0x0140;
    case SPRX_0141: return 0x0141;
    default:        return 0;
    }
}
...
bool acceptModesSized(AsmInsn &insn, const Entry *entry) {
    ...
    if (insn.sizeSuffix != SZ_NONE) {
        ...
        const auto expected = (flags.insnSize() == ISZ_ADDR)
