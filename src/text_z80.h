...
// Z380
extern const char TEXT_REG_Ap[]  PROGMEM;
extern const char TEXT_REG_BCp[] PROGMEM;
extern const char TEXT_REG_Bp[]  PROGMEM;
extern const char TEXT_REG_Cp[]  PROGMEM;
extern const char TEXT_REG_DEp[] PROGMEM;
extern const char TEXT_REG_Dp[]  PROGMEM;
extern const char TEXT_REG_DSR[] PROGMEM;
extern const char TEXT_REG_Ep[]  PROGMEM;
extern const char TEXT_REG_HLp[] PROGMEM;
extern const char TEXT_REG_Hp[]  PROGMEM;
extern const char TEXT_REG_IXp[] PROGMEM;
extern const char TEXT_REG_IXU[] PROGMEM;
extern const char TEXT_REG_IYp[] PROGMEM;
extern const char TEXT_REG_IYU[] PROGMEM;
extern const char TEXT_REG_Lp[]  PROGMEM;
