...
// Z380
constexpr char TEXT_REG_Ap[]  PROGMEM = "A'";
constexpr char TEXT_REG_BCp[] PROGMEM = "BC'";
constexpr char TEXT_REG_Bp[]  PROGMEM = "B'";
constexpr char TEXT_REG_Cp[]  PROGMEM = "C'";
constexpr char TEXT_REG_DEp[] PROGMEM = "DE'";
constexpr char TEXT_REG_Dp[]  PROGMEM = "D'";
constexpr char TEXT_REG_DSR[] PROGMEM = "DSR";
constexpr char TEXT_REG_Ep[]  PROGMEM = "E'";
constexpr char TEXT_REG_HLp[] PROGMEM = "HL'";
constexpr char TEXT_REG_Hp[]  PROGMEM = "H'";
constexpr char TEXT_REG_IXp[] PROGMEM = "IX'";
constexpr char TEXT_REG_IXU[] PROGMEM = "IXU";
constexpr char TEXT_REG_IYp[] PROGMEM = "IY'";
constexpr char TEXT_REG_IYU[] PROGMEM = "IYU";
constexpr char TEXT_REG_Lp[]  PROGMEM = "L'";
