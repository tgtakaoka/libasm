...
constexpr char TEXT_AMD[]  PROGMEM = "AMD";
constexpr char TEXT_AS[]   PROGMEM = "AS";
constexpr char TEXT_ASD[]  PROGMEM = "ASD";
...
constexpr char TEXT_BR7[]  PROGMEM = "BR7";
...
constexpr char TEXT_XS[]   PROGMEM = "XS";

// constexpr char TEXT_REG_A[]  PROGMEM = "A";
constexpr char TEXT_REG_DC[] PROGMEM = "DC";
// constexpr char TEXT_REG_D[]  PROGMEM = "D";
// constexpr char TEXT_REG_HL[] PROGMEM = "HL";
// constexpr char TEXT_REG_H[]  PROGMEM = "H";
constexpr char TEXT_REG_HU[] PROGMEM = "HU";
// constexpr char TEXT_REG_I[]  PROGMEM = "I";
constexpr char TEXT_REG_IS[] PROGMEM = "IS";
constexpr char TEXT_REG_J[]  PROGMEM = "J";
