...
const char TEXT_CLRMAC[]  PROGMEM = "CLRMAC";
...
const char TEXT_SHLR[]    PROGMEM = "SHLR";
...
const char TEXT_SLEEP[]   PROGMEM = "SLEEP";
...
const char TEXT_TRAPA[]   PROGMEM = "TRAPA";
...
const char TEXT_REG_VBR[]  PROGMEM = "VBR";
const char TEXT_REG_MACH[] PROGMEM = "MACH";
