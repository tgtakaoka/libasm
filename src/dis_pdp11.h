...
private:
    void decodeRelative(DisInsn &insn, StrBuffer &out, int16_t delta) const;
    ...
    StrBuffer &outDecFloat32(StrBuffer &out, uint32_t value) const;
    StrBuffer &outDecFloat64(StrBuffer &out, uint64_t value) const;
