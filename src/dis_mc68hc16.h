...
#ifndef __LIBASM_DIS_MC68hc16_H__
#define __LIBASM_DIS_MC68hc16_H__

#include "config_mc68hc16.h"
#include "dis_base.h"
#include "insn_mc68hc16.h"

namespace libasm {
namespace mc68hc16 {

struct DisMc68HC16 final : Disassembler, Config {
    DisMc68HC16(const ValueFormatter::Plugins &plugins = defaultPlugins());
...
private:
    ...
    void decodeExtended(DisInsn &insn, StrBuffer &out, AddrMode mode) const;
...
#endif  // __LIBASM_DIS_MC68hc16_H__
