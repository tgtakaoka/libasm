...
static const Entry Z8000_TABLE[] PROGMEM = {
    ...
    X(0xBA02, 0x00F0, BYTE, CPSIB,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBA04, 0x00F0, BYTE, CPIRB,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBA06, 0x00F0, BYTE, CPSIRB, M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    ...
    X(0xBA0A, 0x00F0, BYTE, CPSDB,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBA0C, 0x00F0, BYTE, CPDRB,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBA0E, 0x00F0, BYTE, CPSDRB, M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    ...
    X(0xBB02, 0x00F0, WORD, CPSI,   M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBB04, 0x00F0, WORD, CPIR,   M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBB06, 0x00F0, WORD, CPSIR,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    ...
    X(0xBB0A, 0x00F0, WORD, CPSD,   M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBB0C, 0x00F0, WORD, CPDR,   M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
    X(0xBB0E, 0x00F0, WORD, CPSDR,  M_R,    M_IR,   P4, C4, M_WR, M_CC, P_0XXX)
