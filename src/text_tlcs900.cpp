...
constexpr char TEXT_TLCS900_LIST[] PROGMEM = "TLCS900, TLCS900L, TLCS900H, TLCS900L1, TLCS900H2";
...
constexpr char TEXT_PUSHW[]  PROGMEM = "PUSHW";
...
constexpr char TEXT_REG_XNSP[] PROGMEM = "XNSP";
constexpr char TEXT_REG_INTNEST[] PROGMEM = "INTNEST";
...
// constexpr char TEXT_CC_T[]   PROGMEM = "T";
