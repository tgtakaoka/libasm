...
enum AddrMode : uint8_t {
    ...
    R_IDX = 33,    // IX/IY
    M_REL16 = 34,  // 16-bit PC-Relative: nnnn
    M_PDX = 35,    // Pointer index: (HL+d16)/(SP+d16)/(IX+d16)/(IY+d16)
    M_BDX = 36,    // Base and index: (HL+IX)/(HL+IY)/(IX+IY)
    I_BASE = 37,
