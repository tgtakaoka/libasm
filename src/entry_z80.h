...
enum AddrMode : uint8_t {
    ...
    I_PTR = 13,   // |...|i|....|: (BC)/(DE)
    M_SRC = 14,   // |......|rrr|: B/C/D/E/H/L/(HL)/A
    M_DST = 15,   // |..|rrr|...|: B/C/D/E/H/L/(HL)/A
    M_SR8 = 16,   // |......|rrr|: B/C/D/E/H/L/___/A
    M_DR8 = 17,   // |..|rrr|...|: B/C/D/E/H/L/___/A
    M_VEC = 18,   // |..|vvv|...|: vector 0~7
    M_BIT = 19,   // |..|bbb|...|: bit 0-7
    M_IMMD = 20,  // |...|mm|...|: interrupt mode 0-2
    R_IR = 21,    // |....|r|...|: I/R
    I_HL = 22,    // (HL)
    I_SP = 23,    // (SP)
    I_IDX = 24,   // (IX)/(IY)
    I_C = 25,     // (C)
    T_IXB = 26,   // DD/FD CB nn xx
    R_IDX = 27,   // IX/IY
    R_BASE = 28,
    R_BC = R_BASE + REG_BC,
    R_DE = R_BASE + REG_DE,
