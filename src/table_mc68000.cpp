...
constexpr Entry MC68020_TABLE[] PROGMEM = {
    ...
    P3(0164700, TEXT_BFEXTU, ISZ_NONE, M_BITFR, M_BITOW, M_DREG,  OP_10, EX_OW, EX_RR, SZ_NONE, 0x0000),
    P3(0165700, TEXT_BFEXTS, ISZ_NONE, M_BITFR, M_BITOW, M_DREG,  OP_10, EX_OW, EX_RR, SZ_NONE, 0x0000),
    P3(0166700, TEXT_BFFFO,  ISZ_NONE, M_BITFR, M_BITOW, M_DREG,  OP_10, EX_OW, EX_RR, SZ_NONE, 0x0000),
    P3(0167700, TEXT_BFINS,  ISZ_NONE, M_DREG,  M_BITFR, M_BITOW, EX_RR, OP_10, EX_OW, SZ_NONE, 0x0000),
    ...
    P3(0004374, TEXT_CAS2,   ISZ_DATA, M_GPAIR, M_GPAIR, M_PPAIR, EX_RP, EX_RP, EX_RR, SZ_CAS2, 0x0000),
    E2(0040400, TEXT_CHK,    ISZ_LONG, M_RDATA, M_DREG,  OP_10, OP__3, SZ_LONG),
    P2(0000300, TEXT_CHK2,   ISZ_DATA, M_JADDR, M_GREG,  OP_10, EX_RR, SZ_DATH, 0x0800),
    P2(0000300, TEXT_CMP2,   ISZ_DATA, M_JADDR, M_GREG,  OP_10, EX_RR, SZ_DATA, 0x0000),
    P2(0046100, TEXT_DIVS,   ISZ_LONG, M_RDATA, M_DPAIR, OP_10, EX_QR, SZ_LONG, 0x0C00),
    P2(0046100, TEXT_DIVS,   ISZ_LONG, M_RDATA, M_DREG,  OP_10, EX_QR, SZ_LONG, 0x0800),
    ...
    P2(0046100, TEXT_DIVU,   ISZ_LONG, M_RDATA, M_DREG,  OP_10, EX_QR, SZ_LONG, 0x0000),
    ...
    P2(0046000, TEXT_MULS,   ISZ_LONG, M_RDATA, M_DREG,  OP_10, EX_QR, SZ_LONG, 0x0800),
    P2(0046000, TEXT_MULU,   ISZ_LONG, M_RDATA, M_DPAIR, OP_10, EX_QR, SZ_LONG, 0x0400),
    P2(0046000, TEXT_MULU,   ISZ_LONG, M_RDATA, M_DREG,  OP_10, EX_QR, SZ_LONG, 0x0000),
