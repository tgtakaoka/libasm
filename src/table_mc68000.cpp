...
static constexpr Entry TABLE_MC68000[] PROGMEM = {
    ...
    E(0004000, BTST,  DEST_OPR)
    E(0004100, BCHG,  DEST_OPR)
    E(0004200, BCLR,  DEST_OPR)
    E(0004300, BSET,  DEST_OPR)
    E(0000410, MOVEP, MOVE_PER)
    E(0000400, BTST,  DREG_DST)
    E(0000500, BCHG,  DREG_DST)
    E(0000600, BCLR,  DREG_DST)
    E(0000700, BSET,  DREG_DST)
    E(0020100, MOVEA, MOVA_OPR)
    E(0030100, MOVEA, MOVA_OPR)
    E(0010000, MOVE,  MOVE_OPR)
    E(0020000, MOVE,  MOVE_OPR)
    E(0030000, MOVE,  MOVE_OPR)
    E(0040300, MOVE,  MOVE_SR)
    E(0042300, MOVE,  MOVE_SR)
    E(0043300, MOVE,  MOVE_SR)
    ...
    E(0140500, EXG,   REGS_EXG)
    E(0140510, EXG,   REGS_EXG)
    E(0140610, EXG,   REGS_EXG)
    E(0140000, AND,   DMEM_SIZ)
    E(0150300, ADDA,  AREG_SIZ)
    E(0150400, ADDX,  DMEM_OPR)
    E(0150000, ADD,   DMEM_SIZ)
    E(0160300, ASR,   DEST_OPR)
    E(0160700, ASL,   DEST_OPR)
    E(0161300, LSR,   DEST_OPR)
    E(0161700, LSL,   DEST_OPR)
    E(0162300, ROXR,  DEST_OPR)
    E(0162700, ROXL,  DEST_OPR)
    E(0163300, ROR,   DEST_OPR)
    E(0163700, ROL,   DEST_OPR)
    E(0160000, ASR,   DREG_ROT)
    E(0160400, ASL,   DREG_ROT)
    E(0160010, LSR,   DREG_ROT)
    E(0160410, LSL,   DREG_ROT)
    E(0160020, ROXR,  DREG_ROT)
    E(0160420, ROXL,  DREG_ROT)
    E(0160030, ROR,   DREG_ROT)
    E(0160430, ROL,   DREG_ROT)
};
