...
constexpr EntryPage Z80_PAGES[] PROGMEM = {
        ...
        {TableZ380::EXT, ARRAY_RANGE(TABLE_EXT), ARRAY_RANGE(INDEX_EXT)},
        {TableZ380::BIT, ARRAY_RANGE(TABLE_BIT), ARRAY_RANGE(INDEX_BIT)},
        {TableZ380::IX, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IY, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IXBIT, ARRAY_RANGE(TABLE_IDXBIT), ARRAY_RANGE(INDEX_IDXBIT)},
        {TableZ380::IYBIT, ARRAY_RANGE(TABLE_IDXBIT), ARRAY_RANGE(INDEX_IDXBIT)},
};

constexpr EntryPage Z180_PAGES[] PROGMEM = {
        {0x0000, ARRAY_RANGE(TABLE_Z80), ARRAY_RANGE(INDEX_Z80)},
        {TableZ380::EXT, ARRAY_RANGE(TABLE_EXT), ARRAY_RANGE(INDEX_EXT)},
        {TableZ380::EXT, ARRAY_RANGE(TABLE_Z180_EXT), ARRAY_RANGE(INDEX_Z180_EXT)},
        {TableZ380::BIT, ARRAY_RANGE(TABLE_BIT), ARRAY_RANGE(INDEX_BIT)},
        {TableZ380::IX, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IY, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IXBIT, ARRAY_RANGE(TABLE_IDXBIT), ARRAY_RANGE(INDEX_IDXBIT)},
...
constexpr EntryPage Z380_PAGES[] PROGMEM = {
        ...
        {TableZ380::EXT, ARRAY_RANGE(TABLE_EXT), ARRAY_RANGE(INDEX_EXT)},
        {TableZ380::EXT, ARRAY_RANGE(TABLE_Z180_EXT), ARRAY_RANGE(INDEX_Z180_EXT)},
        {TableZ380::EXT, ARRAY_RANGE(TABLE_Z380_EXT), ARRAY_RANGE(INDEX_Z380_EXT)},
        {TableZ380::EXTBIT, ARRAY_RANGE(TABLE_Z380_EXTBIT), ARRAY_RANGE(INDEX_Z380_EXTBIT)},
        {TableZ380::BIT, ARRAY_RANGE(TABLE_BIT), ARRAY_RANGE(INDEX_BIT)},
        {TableZ380::BIT, ARRAY_RANGE(TABLE_Z380_BIT), ARRAY_RANGE(INDEX_Z380_BIT)},
        {TableZ380::IX, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IY, ARRAY_RANGE(TABLE_IDX), ARRAY_RANGE(INDEX_IDX)},
        {TableZ380::IX, ARRAY_RANGE(TABLE_Z380_IDX), ARRAY_RANGE(INDEX_Z380_IDX)},
        {TableZ380::IY, ARRAY_RANGE(TABLE_Z380_IDX), ARRAY_RANGE(INDEX_Z380_IDX)},
        {TableZ380::IX, ARRAY_RANGE(TABLE_Z380_IX), ARRAY_RANGE(INDEX_Z380_IX)},
        {TableZ380::IY, ARRAY_RANGE(TABLE_Z380_IY), ARRAY_RANGE(INDEX_Z380_IY)},
        {TableZ380::IXBIT, ARRAY_RANGE(TABLE_IDXBIT), ARRAY_RANGE(INDEX_IDXBIT)},
        {TableZ380::IYBIT, ARRAY_RANGE(TABLE_IDXBIT), ARRAY_RANGE(INDEX_IDXBIT)},
        {TableZ380::IXBIT, ARRAY_RANGE(TABLE_Z380_IXBIT), ARRAY_RANGE(INDEX_Z380_IXBIT)},
        {TableZ380::IYBIT, ARRAY_RANGE(TABLE_Z380_IYBIT), ARRAY_RANGE(INDEX_Z380_IYBIT)},
        {TableZ380::IXBIT, ARRAY_RANGE(TABLE_Z380_IDXBIT), ARRAY_RANGE(INDEX_Z380_IDXBIT)},
        {TableZ380::IYBIT, ARRAY_RANGE(TABLE_Z380_IDXBIT), ARRAY_RANGE(INDEX_Z380_IDXBIT)},
};
...
bool EntryInsn::ixBit() const {
    return (prefix() == TableZ380::IXBIT || prefix() == TableZ380::IYBIT);
}
