...
void DisZ280::decodeImmediate16(DisInsn &insn, StrBuffer &out, AddrMode mode) const {
    outAbsAddr(out, insn.readUint16(), 16);
}

void DisZ280::decodeAbsolute(DisInsn &insn, StrBuffer &out, AddrMode mode) const {
