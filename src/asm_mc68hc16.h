...
#ifndef __LIBASM_ASM_MC68HC16_H__
#define __LIBASM_ASM_MC68HC16_H__
...
struct AsmMc68HC16 final : Assembler, Config {
    AsmMc68HC16(const ValueParser::Plugins &plugins = defaultPlugins());
...
#endif  // __LIBASM_ASM_MC68HC16_H__
